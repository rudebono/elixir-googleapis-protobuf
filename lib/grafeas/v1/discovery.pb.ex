...
defmodule Grafeas.V1.DiscoveryNote do
  ...
  field :analysis_kind, 1, type: Grafeas.V1.NoteKind, enum: true
end
...
defmodule Grafeas.V1.DiscoveryOccurrence do
  ...
  field :analysis_status, 2, type: Grafeas.V1.DiscoveryOccurrence.AnalysisStatus, enum: true
  field :analysis_status_error, 3, type: Google.Rpc.Status
  field :cpe, 4, type: :string
  field :last_scan_time, 5, type: Google.Protobuf.Timestamp
end
