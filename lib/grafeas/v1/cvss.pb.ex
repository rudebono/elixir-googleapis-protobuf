...
defmodule Grafeas.V1.CVSS do
  ...
  @type t :: %__MODULE__{
          ...
          exploitability_score: float | :infinity | :negative_infinity | :nan,
          impact_score: float | :infinity | :negative_infinity | :nan,
          attack_vector: Grafeas.V1.CVSS.AttackVector.t(),
          attack_complexity: Grafeas.V1.CVSS.AttackComplexity.t(),
          authentication: Grafeas.V1.CVSS.Authentication.t(),
          privileges_required: Grafeas.V1.CVSS.PrivilegesRequired.t(),
          user_interaction: Grafeas.V1.CVSS.UserInteraction.t(),
          scope: Grafeas.V1.CVSS.Scope.t(),
          confidentiality_impact: Grafeas.V1.CVSS.Impact.t(),
          integrity_impact: Grafeas.V1.CVSS.Impact.t(),
          availability_impact: Grafeas.V1.CVSS.Impact.t()
        }
