...
defmodule Grafeas.V1.CVSSv3 do
  ...
  @type t :: %__MODULE__{
          ...
          attack_vector: Grafeas.V1.CVSSv3.AttackVector.t(),
          attack_complexity: Grafeas.V1.CVSSv3.AttackComplexity.t(),
          privileges_required: Grafeas.V1.CVSSv3.PrivilegesRequired.t(),
          user_interaction: Grafeas.V1.CVSSv3.UserInteraction.t(),
          scope: Grafeas.V1.CVSSv3.Scope.t(),
          confidentiality_impact: Grafeas.V1.CVSSv3.Impact.t(),
          integrity_impact: Grafeas.V1.CVSSv3.Impact.t(),
          availability_impact: Grafeas.V1.CVSSv3.Impact.t()
        }
  ...
  field :attack_vector, 5, type: Grafeas.V1.CVSSv3.AttackVector, enum: true
  field :attack_complexity, 6, type: Grafeas.V1.CVSSv3.AttackComplexity, enum: true
  field :privileges_required, 7, type: Grafeas.V1.CVSSv3.PrivilegesRequired, enum: true
  field :user_interaction, 8, type: Grafeas.V1.CVSSv3.UserInteraction, enum: true
  field :scope, 9, type: Grafeas.V1.CVSSv3.Scope, enum: true
  field :confidentiality_impact, 10, type: Grafeas.V1.CVSSv3.Impact, enum: true
  field :integrity_impact, 11, type: Grafeas.V1.CVSSv3.Impact, enum: true
  field :availability_impact, 12, type: Grafeas.V1.CVSSv3.Impact, enum: true
end
