defmodule Google.Apps.Drive.Labels.V2beta.InvalidArgument.FieldViolation.Reason do
  @moduledoc false
...
defmodule Google.Apps.Drive.Labels.V2beta.PreconditionFailure.Violation.Reason do
  @moduledoc false
  use Protobuf, enum: true, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Apps.Drive.Labels.V2beta.InvalidArgument.FieldViolation do
  ...
  field :reason, 2,
    type: Google.Apps.Drive.Labels.V2beta.InvalidArgument.FieldViolation.Reason,
    enum: true

  field :display_message, 3, type: :string, json_name: "displayMessage"
end

defmodule Google.Apps.Drive.Labels.V2beta.InvalidArgument do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :field_violations, 1,
    repeated: true,
    type: Google.Apps.Drive.Labels.V2beta.InvalidArgument.FieldViolation,
    json_name: "fieldViolations"
end

defmodule Google.Apps.Drive.Labels.V2beta.PreconditionFailure.Violation do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :reason, 2,
    type: Google.Apps.Drive.Labels.V2beta.PreconditionFailure.Violation.Reason,
    enum: true

  field :display_message, 3, type: :string, json_name: "displayMessage"
end

defmodule Google.Apps.Drive.Labels.V2beta.PreconditionFailure do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :violation, 1,
    repeated: true,
    type: Google.Apps.Drive.Labels.V2beta.PreconditionFailure.Violation
end