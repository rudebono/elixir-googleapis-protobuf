defmodule Google.Apps.Drive.Labels.V2beta.ExceptionType do
  @moduledoc false
...
defmodule Google.Apps.Drive.Labels.V2beta.ExceptionDetail do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :error_type, 1,
    type: Google.Apps.Drive.Labels.V2beta.ExceptionType,
    json_name: "errorType",
    enum: true
end
