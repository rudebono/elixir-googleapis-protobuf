...
defmodule Google.Apps.Drive.Labels.V2beta.Label do
  ...
  field :label_type, 4,
    type: Google.Apps.Drive.Labels.V2beta.Label.LabelType,
    json_name: "labelType",
    enum: true,
    deprecated: false

  field :creator, 5, type: Google.Apps.Drive.Labels.V2beta.UserInfo, deprecated: false
  ...
  field :revision_creator, 7,
    type: Google.Apps.Drive.Labels.V2beta.UserInfo,
  ...
  field :publisher, 9, type: Google.Apps.Drive.Labels.V2beta.UserInfo, deprecated: false
  ...
  field :disabler, 11, type: Google.Apps.Drive.Labels.V2beta.UserInfo, deprecated: false
  ...
  field :display_hints, 16,
    type: Google.Apps.Drive.Labels.V2beta.Label.DisplayHints,
    json_name: "displayHints",
    deprecated: false

  field :applied_capabilities, 17,
    type: Google.Apps.Drive.Labels.V2beta.Label.AppliedCapabilities,
    json_name: "appliedCapabilities",
    deprecated: false

  field :schema_capabilities, 18,
    type: Google.Apps.Drive.Labels.V2beta.Label.SchemaCapabilities,
    json_name: "schemaCapabilities",
    deprecated: false

  field :applied_label_policy, 19,
    type: Google.Apps.Drive.Labels.V2beta.Label.AppliedLabelPolicy,
    json_name: "appliedLabelPolicy",
    deprecated: false

  field :fields, 20, repeated: true, type: Google.Apps.Drive.Labels.V2beta.Field
