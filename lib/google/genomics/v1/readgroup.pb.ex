defmodule Google.Genomics.V1.ReadGroup.Experiment do
  ...
  field :library_id, 1, type: :string
  field :platform_unit, 2, type: :string
  field :sequencing_center, 3, type: :string
  field :instrument_model, 4, type: :string
end
...
defmodule Google.Genomics.V1.ReadGroup.Program do
  ...
  field :command_line, 1, type: :string
  field :id, 2, type: :string
  field :name, 3, type: :string
  field :prev_program_id, 4, type: :string
