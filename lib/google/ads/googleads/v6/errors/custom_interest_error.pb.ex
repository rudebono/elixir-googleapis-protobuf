defmodule Google.Ads.Googleads.V6.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V6.Errors.CustomInterestErrorEnum do
  @moduledoc false
