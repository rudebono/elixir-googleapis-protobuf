defmodule Google.Ads.Googleads.V6.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V6.Errors.AuthorizationErrorEnum do
  @moduledoc false
