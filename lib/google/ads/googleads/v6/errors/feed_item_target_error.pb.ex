defmodule Google.Ads.Googleads.V6.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V6.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
