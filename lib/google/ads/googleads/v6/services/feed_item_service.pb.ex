...
defmodule Google.Ads.Googleads.V6.Services.FeedItemService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v6.services.FeedItemService"

  rpc :GetFeedItem,
      Google.Ads.Googleads.V6.Services.GetFeedItemRequest,
      Google.Ads.Googleads.V6.Resources.FeedItem

  rpc :MutateFeedItems,
      Google.Ads.Googleads.V6.Services.MutateFeedItemsRequest,
      Google.Ads.Googleads.V6.Services.MutateFeedItemsResponse
end

defmodule Google.Ads.Googleads.V6.Services.FeedItemService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V6.Services.FeedItemService.Service
end
