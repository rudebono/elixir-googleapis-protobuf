...
defmodule Google.Ads.Googleads.V6.Services.AdService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v6.services.AdService"

  rpc :GetAd, Google.Ads.Googleads.V6.Services.GetAdRequest, Google.Ads.Googleads.V6.Resources.Ad

  rpc :MutateAds,
      Google.Ads.Googleads.V6.Services.MutateAdsRequest,
      Google.Ads.Googleads.V6.Services.MutateAdsResponse
end

defmodule Google.Ads.Googleads.V6.Services.AdService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V6.Services.AdService.Service
end
