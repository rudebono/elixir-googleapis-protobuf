...
defmodule Google.Ads.Googleads.V6.Services.CampaignAssetService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v6.services.CampaignAssetService"

  rpc :GetCampaignAsset,
      Google.Ads.Googleads.V6.Services.GetCampaignAssetRequest,
      Google.Ads.Googleads.V6.Resources.CampaignAsset

  rpc :MutateCampaignAssets,
      Google.Ads.Googleads.V6.Services.MutateCampaignAssetsRequest,
      Google.Ads.Googleads.V6.Services.MutateCampaignAssetsResponse
end

defmodule Google.Ads.Googleads.V6.Services.CampaignAssetService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V6.Services.CampaignAssetService.Service
end
