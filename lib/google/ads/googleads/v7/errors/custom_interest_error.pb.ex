defmodule Google.Ads.Googleads.V7.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Errors.CustomInterestErrorEnum do
  @moduledoc false
