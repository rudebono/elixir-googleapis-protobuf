defmodule Google.Ads.Googleads.V7.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
