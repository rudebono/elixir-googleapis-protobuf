defmodule Google.Ads.Googleads.V7.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
