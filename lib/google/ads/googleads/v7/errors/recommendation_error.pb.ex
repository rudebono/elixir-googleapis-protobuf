defmodule Google.Ads.Googleads.V7.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Errors.RecommendationErrorEnum do
  @moduledoc false
