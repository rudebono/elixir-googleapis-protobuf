defmodule Google.Ads.Googleads.V7.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
