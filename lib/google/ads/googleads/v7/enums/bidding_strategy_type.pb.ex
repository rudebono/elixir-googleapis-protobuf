defmodule Google.Ads.Googleads.V7.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
