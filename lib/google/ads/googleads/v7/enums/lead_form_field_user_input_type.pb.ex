defmodule Google.Ads.Googleads.V7.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Enums.LeadFormFieldUserInputTypeEnum do
  @moduledoc false
