defmodule Google.Ads.Googleads.V7.Enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Enums.RealEstatePlaceholderFieldEnum do
  @moduledoc false
