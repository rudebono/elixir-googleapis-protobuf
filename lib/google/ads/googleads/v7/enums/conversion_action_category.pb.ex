defmodule Google.Ads.Googleads.V7.Enums.ConversionActionCategoryEnum.ConversionActionCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Enums.ConversionActionCategoryEnum do
  @moduledoc false
