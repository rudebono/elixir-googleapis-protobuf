defmodule Google.Ads.Googleads.V7.Common.DynamicLocationSetFilter do
  ...
  @type t :: %__MODULE__{
          labels: [String.t()],
          business_name_filter: Google.Ads.Googleads.V7.Common.BusinessNameFilter.t() | nil
        }
  ...
  field :business_name_filter, 2,
    type: Google.Ads.Googleads.V7.Common.BusinessNameFilter,
...
defmodule Google.Ads.Googleads.V7.Common.BusinessNameFilter do
  ...
  @type t :: %__MODULE__{
          ...
          filter_type:
            Google.Ads.Googleads.V7.Enums.FeedItemSetStringFilterTypeEnum.FeedItemSetStringFilterType.t()
        }
