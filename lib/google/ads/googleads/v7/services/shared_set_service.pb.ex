...
defmodule Google.Ads.Googleads.V7.Services.SharedSetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.SharedSet.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.SharedSet.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.MutateSharedSetResult do
  ...
  field :resource_name, 1, type: :string, json_name: "resourceName"
  field :shared_set, 2, type: Google.Ads.Googleads.V7.Resources.SharedSet, json_name: "sharedSet"
