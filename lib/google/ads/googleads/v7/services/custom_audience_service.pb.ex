...
defmodule Google.Ads.Googleads.V7.Services.CustomAudienceOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.CustomAudience.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.CustomAudience.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.CustomAudienceService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v7.services.CustomAudienceService"

  rpc :GetCustomAudience,
      Google.Ads.Googleads.V7.Services.GetCustomAudienceRequest,
      Google.Ads.Googleads.V7.Resources.CustomAudience

  rpc :MutateCustomAudiences,
      Google.Ads.Googleads.V7.Services.MutateCustomAudiencesRequest,
      Google.Ads.Googleads.V7.Services.MutateCustomAudiencesResponse
end

defmodule Google.Ads.Googleads.V7.Services.CustomAudienceService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V7.Services.CustomAudienceService.Service
end
