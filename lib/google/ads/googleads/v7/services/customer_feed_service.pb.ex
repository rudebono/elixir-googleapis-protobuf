...
defmodule Google.Ads.Googleads.V7.Services.MutateCustomerFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.CustomerFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.CustomerFeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.CustomerFeed.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.CustomerFeed.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.MutateCustomerFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateCustomerFeedResult.t()]
        }
