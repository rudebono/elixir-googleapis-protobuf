...
defmodule Google.Ads.Googleads.V7.Services.MutateAdGroupBidModifiersRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.AdGroupBidModifierOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.AdGroupBidModifierOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.AdGroupBidModifier.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.AdGroupBidModifier.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.MutateAdGroupBidModifiersResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateAdGroupBidModifierResult.t()]
        }
