defmodule Google.Ads.Googleads.V7.Services.GetPaidOrganicSearchTermViewRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V7.Services.PaidOrganicSearchTermViewService.Service do
  @moduledoc false
  use GRPC.Service,
    name: "google.ads.googleads.v7.services.PaidOrganicSearchTermViewService",
