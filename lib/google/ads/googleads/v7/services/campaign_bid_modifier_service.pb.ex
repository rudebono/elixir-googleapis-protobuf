...
defmodule Google.Ads.Googleads.V7.Services.MutateCampaignBidModifiersRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.CampaignBidModifierOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.CampaignBidModifierOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.CampaignBidModifier.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.CampaignBidModifier.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.MutateCampaignBidModifiersResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateCampaignBidModifierResult.t()]
        }
