...
defmodule Google.Ads.Googleads.V7.Services.MutateCampaignExtensionSettingsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.CampaignExtensionSettingOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.MutateCampaignExtensionSettingsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateCampaignExtensionSettingResult.t()]
        }
