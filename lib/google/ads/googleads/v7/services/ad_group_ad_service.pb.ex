...
defmodule Google.Ads.Googleads.V7.Services.MutateAdGroupAdsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.AdGroupAdOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.AdGroupAdOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.AdGroupAd.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.AdGroupAd.t() | nil}
            | {:remove, String.t()},
          update_mask: Google.Protobuf.FieldMask.t() | nil,
          policy_validation_parameter:
            Google.Ads.Googleads.V7.Common.PolicyValidationParameter.t() | nil
        }
...
defmodule Google.Ads.Googleads.V7.Services.MutateAdGroupAdsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateAdGroupAdResult.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Services.MutateAdGroupAdResult do
  ...
  field :resource_name, 1, type: :string, json_name: "resourceName"
  field :ad_group_ad, 2, type: Google.Ads.Googleads.V7.Resources.AdGroupAd, json_name: "adGroupAd"
