...
defmodule Google.Ads.Googleads.V7.Services.MutateAdsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.AdOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.AdOperation do
  ...
  @type t :: %__MODULE__{
          operation: {:update, Google.Ads.Googleads.V7.Resources.Ad.t() | nil},
...
defmodule Google.Ads.Googleads.V7.Services.MutateAdsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateAdResult.t()]
        }
