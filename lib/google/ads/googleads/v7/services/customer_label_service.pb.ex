...
defmodule Google.Ads.Googleads.V7.Services.MutateCustomerLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.CustomerLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.CustomerLabelOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.CustomerLabel.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V7.Services.MutateCustomerLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateCustomerLabelResult.t()]
        }
