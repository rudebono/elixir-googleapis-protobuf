...
defmodule Google.Ads.Googleads.V7.Services.MutateFeedItemsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V7.Services.FeedItemOperation.t()],
...
defmodule Google.Ads.Googleads.V7.Services.FeedItemOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V7.Resources.FeedItem.t() | nil}
            | {:update, Google.Ads.Googleads.V7.Resources.FeedItem.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V7.Services.MutateFeedItemsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V7.Services.MutateFeedItemResult.t()]
        }
...
defmodule Google.Ads.Googleads.V7.Services.MutateFeedItemResult do
  ...
  field :feed_item, 2, type: Google.Ads.Googleads.V7.Resources.FeedItem, json_name: "feedItem"
end
