defmodule Google.Ads.Googleads.V16.Resources.HotelReconciliation do
  @moduledoc false
  ...
  field :status, 10,
    type: Google.Ads.Googleads.V16.Enums.HotelReconciliationStatusEnum.HotelReconciliationStatus,
    enum: true,
    deprecated: false
end