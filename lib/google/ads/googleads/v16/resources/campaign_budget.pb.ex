defmodule Google.Ads.Googleads.V16.Resources.CampaignBudget do
  @moduledoc false
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V16.Enums.BudgetStatusEnum.BudgetStatus,
    enum: true,
    deprecated: false

  field :delivery_method, 7,
    type: Google.Ads.Googleads.V16.Enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod,
  ...
  field :period, 13,
    type: Google.Ads.Googleads.V16.Enums.BudgetPeriodEnum.BudgetPeriod,
    enum: true,
    deprecated: false
  ...
  field :type, 18,
    type: Google.Ads.Googleads.V16.Enums.BudgetTypeEnum.BudgetType,
    enum: true,
    deprecated: false
