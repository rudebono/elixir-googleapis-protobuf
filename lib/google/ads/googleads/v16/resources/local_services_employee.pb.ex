defmodule Google.Ads.Googleads.V16.Resources.LocalServicesEmployee do
  @moduledoc false
  ...
  field :status, 4,
    type:
      Google.Ads.Googleads.V16.Enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus,
    enum: true,
    deprecated: false

  field :type, 5,
    type: Google.Ads.Googleads.V16.Enums.LocalServicesEmployeeTypeEnum.LocalServicesEmployeeType,
    enum: true,
    deprecated: false

  field :university_degrees, 6,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.UniversityDegree,
    json_name: "universityDegrees",
    deprecated: false

  field :residencies, 7,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.Residency,
    deprecated: false

  field :fellowships, 8,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.Fellowship,
    deprecated: false
...
defmodule Google.Ads.Googleads.V16.Resources.UniversityDegree do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.Residency do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.Fellowship do
  @moduledoc false
