defmodule Google.Ads.Googleads.V16.Resources.ProductCategoryConstant.ProductCategoryLocalization do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.ProductCategoryConstant do
  @moduledoc false
  ...
  field :state, 5,
    type: Google.Ads.Googleads.V16.Enums.ProductCategoryStateEnum.ProductCategoryState,
    enum: true,
    deprecated: false

  field :localizations, 6,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.ProductCategoryConstant.ProductCategoryLocalization,
    deprecated: false
end
