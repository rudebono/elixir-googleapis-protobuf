defmodule Google.Ads.Googleads.V16.Resources.ConversionValueRuleSet do
  @moduledoc false
  ...
  field :dimensions, 4,
    repeated: true,
    type: Google.Ads.Googleads.V16.Enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension,
    enum: true
  ...
  field :attachment_type, 6,
    type:
      Google.Ads.Googleads.V16.Enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType,
  ...
  field :status, 8,
    type:
      Google.Ads.Googleads.V16.Enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus,
    enum: true,
    deprecated: false
