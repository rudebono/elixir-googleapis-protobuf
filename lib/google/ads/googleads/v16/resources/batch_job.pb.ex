defmodule Google.Ads.Googleads.V16.Resources.BatchJob.BatchJobMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.BatchJob do
  @moduledoc false
  ...
  field :metadata, 4,
    type: Google.Ads.Googleads.V16.Resources.BatchJob.BatchJobMetadata,
    deprecated: false

  field :status, 5,
    type: Google.Ads.Googleads.V16.Enums.BatchJobStatusEnum.BatchJobStatus,
    enum: true,
    deprecated: false
