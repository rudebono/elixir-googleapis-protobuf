defmodule Google.Ads.Googleads.V16.Resources.AdGroupAd do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V16.Enums.AdGroupAdStatusEnum.AdGroupAdStatus,
    enum: true
  ...
  field :ad, 5, type: Google.Ads.Googleads.V16.Resources.Ad, deprecated: false

  field :policy_summary, 6,
    type: Google.Ads.Googleads.V16.Resources.AdGroupAdPolicySummary,
  ...
  field :primary_status, 16,
    type: Google.Ads.Googleads.V16.Enums.AdGroupAdPrimaryStatusEnum.AdGroupAdPrimaryStatus,
  ...
  field :primary_status_reasons, 17,
    repeated: true,
    type:
      Google.Ads.Googleads.V16.Enums.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason,
    json_name: "primaryStatusReasons",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V16.Resources.AdGroupAdPolicySummary do
  @moduledoc false
