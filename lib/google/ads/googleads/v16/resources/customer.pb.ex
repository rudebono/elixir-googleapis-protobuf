defmodule Google.Ads.Googleads.V16.Resources.Customer do
  @moduledoc false
  ...
  field :call_reporting_setting, 10,
    type: Google.Ads.Googleads.V16.Resources.CallReportingSetting,
    json_name: "callReportingSetting"

  field :conversion_tracking_setting, 14,
    type: Google.Ads.Googleads.V16.Resources.ConversionTrackingSetting,
    json_name: "conversionTrackingSetting",
    deprecated: false

  field :remarketing_setting, 15,
    type: Google.Ads.Googleads.V16.Resources.RemarketingSetting,
  ...
  field :pay_per_conversion_eligibility_failure_reasons, 16,
    repeated: true,
    type:
      Google.Ads.Googleads.V16.Enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason,
  ...
  field :customer_agreement_setting, 44,
    type: Google.Ads.Googleads.V16.Resources.CustomerAgreementSetting,
...
defmodule Google.Ads.Googleads.V16.Resources.ConversionTrackingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.RemarketingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.CustomerAgreementSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Resources.LocalServicesSettings do
  @moduledoc false
  ...
  field :granular_license_statuses, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.GranularLicenseStatus,
    json_name: "granularLicenseStatuses",
    deprecated: false

  field :granular_insurance_statuses, 2,
    repeated: true,
    type: Google.Ads.Googleads.V16.Resources.GranularInsuranceStatus,
    json_name: "granularInsuranceStatuses",
    deprecated: false
end

defmodule Google.Ads.Googleads.V16.Resources.GranularLicenseStatus do
  @moduledoc false
  ...
  field :verification_status, 3,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V16.Enums.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus,
    json_name: "verificationStatus",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V16.Resources.GranularInsuranceStatus do
  @moduledoc false
