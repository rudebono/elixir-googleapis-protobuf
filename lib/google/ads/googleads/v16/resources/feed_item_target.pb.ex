defmodule Google.Ads.Googleads.V16.Resources.FeedItemTarget do
  @moduledoc false
  ...
  field :feed_item_target_type, 3,
    type: Google.Ads.Googleads.V16.Enums.FeedItemTargetTypeEnum.FeedItemTargetType,
  ...
  field :status, 11,
    type: Google.Ads.Googleads.V16.Enums.FeedItemTargetStatusEnum.FeedItemTargetStatus,
    enum: true,
    deprecated: false
