defmodule Google.Ads.Googleads.V16.Resources.AssetGroup do
  @moduledoc false
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V16.Enums.AssetGroupStatusEnum.AssetGroupStatus,
    enum: true

  field :primary_status, 11,
    type: Google.Ads.Googleads.V16.Enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus,
  ...
  field :primary_status_reasons, 12,
    repeated: true,
    type:
      Google.Ads.Googleads.V16.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason,
