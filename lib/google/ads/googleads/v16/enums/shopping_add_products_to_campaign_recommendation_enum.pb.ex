defmodule Google.Ads.Googleads.V16.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
