defmodule Google.Ads.Googleads.V16.Enums.ConversionActionTypeEnum.ConversionActionType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Enums.ConversionActionTypeEnum do
  @moduledoc false
