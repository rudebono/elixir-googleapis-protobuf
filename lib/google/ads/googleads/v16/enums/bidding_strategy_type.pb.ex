defmodule Google.Ads.Googleads.V16.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
