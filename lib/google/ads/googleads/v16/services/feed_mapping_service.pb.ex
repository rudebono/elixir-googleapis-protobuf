...
defmodule Google.Ads.Googleads.V16.Services.FeedMappingOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V16.Resources.FeedMapping, oneof: 0
...
defmodule Google.Ads.Googleads.V16.Services.FeedMappingService.Service do
  @moduledoc false
  ...
  rpc :MutateFeedMappings,
      ...
      Google.Ads.Googleads.V16.Services.MutateFeedMappingsResponse
end

defmodule Google.Ads.Googleads.V16.Services.FeedMappingService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V16.Services.FeedMappingService.Service
end