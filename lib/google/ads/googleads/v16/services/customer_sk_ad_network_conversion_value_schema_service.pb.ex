...
defmodule Google.Ads.Googleads.V16.Services.CustomerSkAdNetworkConversionValueSchemaService.Service do
  ...
  rpc :MutateCustomerSkAdNetworkConversionValueSchema,
      ...
      Google.Ads.Googleads.V16.Services.MutateCustomerSkAdNetworkConversionValueSchemaResponse
end

defmodule Google.Ads.Googleads.V16.Services.CustomerSkAdNetworkConversionValueSchemaService.Stub do
  @moduledoc false

  use GRPC.Stub,
    service:
      Google.Ads.Googleads.V16.Services.CustomerSkAdNetworkConversionValueSchemaService.Service
end