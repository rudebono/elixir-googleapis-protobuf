...
defmodule Google.Ads.Googleads.V16.Services.SmartCampaignNotEligibleDetails do
  ...
  field :not_eligible_reason, 1,
    ...
    type:
      Google.Ads.Googleads.V16.Enums.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason,
...
defmodule Google.Ads.Googleads.V16.Services.GetSmartCampaignStatusResponse do
  ...
  field :smart_campaign_status, 1,
    type: Google.Ads.Googleads.V16.Enums.SmartCampaignStatusEnum.SmartCampaignStatus,
    json_name: "smartCampaignStatus",
    enum: true

  field :not_eligible_details, 2,
    type: Google.Ads.Googleads.V16.Services.SmartCampaignNotEligibleDetails,
    json_name: "notEligibleDetails",
    oneof: 0

  field :eligible_details, 3,
    type: Google.Ads.Googleads.V16.Services.SmartCampaignEligibleDetails,
    json_name: "eligibleDetails",
    oneof: 0

  field :paused_details, 4,
    type: Google.Ads.Googleads.V16.Services.SmartCampaignPausedDetails,
    json_name: "pausedDetails",
    oneof: 0

  field :removed_details, 5,
    type: Google.Ads.Googleads.V16.Services.SmartCampaignRemovedDetails,
    json_name: "removedDetails",
    oneof: 0

  field :ended_details, 6,
    type: Google.Ads.Googleads.V16.Services.SmartCampaignEndedDetails,
...
defmodule Google.Ads.Googleads.V16.Services.SmartCampaignSettingService.Service do
  @moduledoc false
  ...
  rpc :GetSmartCampaignStatus,
      ...
      Google.Ads.Googleads.V16.Services.GetSmartCampaignStatusResponse

  rpc :MutateSmartCampaignSettings,
      Google.Ads.Googleads.V16.Services.MutateSmartCampaignSettingsRequest,
      Google.Ads.Googleads.V16.Services.MutateSmartCampaignSettingsResponse
end

defmodule Google.Ads.Googleads.V16.Services.SmartCampaignSettingService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V16.Services.SmartCampaignSettingService.Service
end