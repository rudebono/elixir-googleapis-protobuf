defmodule Google.Ads.Googleads.V16.Services.ListPlannableLocationsRequest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V16.Services.ListPlannableLocationsResponse do
  @moduledoc false
  ...
  field :plannable_locations, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.PlannableLocation,
    json_name: "plannableLocations"
end

defmodule Google.Ads.Googleads.V16.Services.PlannableLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.ListPlannableProductsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.ListPlannableProductsResponse do
  @moduledoc false
  ...
  field :product_metadata, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.ProductMetadata,
    json_name: "productMetadata"
end

defmodule Google.Ads.Googleads.V16.Services.ProductMetadata do
  @moduledoc false
  ...
  field :plannable_targeting, 2,
    type: Google.Ads.Googleads.V16.Services.PlannableTargeting,
    json_name: "plannableTargeting"
end

defmodule Google.Ads.Googleads.V16.Services.PlannableTargeting do
  @moduledoc false
  ...
  field :age_ranges, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange,
    json_name: "ageRanges",
    enum: true

  field :genders, 2, repeated: true, type: Google.Ads.Googleads.V16.Common.GenderInfo
  field :devices, 3, repeated: true, type: Google.Ads.Googleads.V16.Common.DeviceInfo

  field :networks, 4,
    repeated: true,
    type: Google.Ads.Googleads.V16.Enums.ReachPlanNetworkEnum.ReachPlanNetwork,
    enum: true

  field :youtube_select_lineups, 5,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.YouTubeSelectLineUp,
    json_name: "youtubeSelectLineups"

  field :surface_targeting, 6,
    type: Google.Ads.Googleads.V16.Services.SurfaceTargetingCombinations,
    json_name: "surfaceTargeting"
end

defmodule Google.Ads.Googleads.V16.Services.GenerateReachForecastRequest do
  @moduledoc false
  ...
  field :campaign_duration, 3,
    type: Google.Ads.Googleads.V16.Services.CampaignDuration,
  ...
  field :cookie_frequency_cap_setting, 8,
    type: Google.Ads.Googleads.V16.Services.FrequencyCap,
  ...
  field :effective_frequency_limit, 12,
    proto3_optional: true,
    type: Google.Ads.Googleads.V16.Services.EffectiveFrequencyLimit,
    json_name: "effectiveFrequencyLimit"

  field :targeting, 6, type: Google.Ads.Googleads.V16.Services.Targeting

  field :planned_products, 7,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.PlannedProduct,
    json_name: "plannedProducts",
    deprecated: false

  field :forecast_metric_options, 13,
    type: Google.Ads.Googleads.V16.Services.ForecastMetricOptions,
...
defmodule Google.Ads.Googleads.V16.Services.EffectiveFrequencyLimit do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.FrequencyCap do
  @moduledoc false
  ...
  field :time_unit, 2,
    type: Google.Ads.Googleads.V16.Enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit,
    json_name: "timeUnit",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V16.Services.Targeting do
  @moduledoc false
  ...
  field :genders, 3, repeated: true, type: Google.Ads.Googleads.V16.Common.GenderInfo
  field :devices, 4, repeated: true, type: Google.Ads.Googleads.V16.Common.DeviceInfo
  ...
  field :audience_targeting, 7,
    type: Google.Ads.Googleads.V16.Services.AudienceTargeting,
    json_name: "audienceTargeting"
end

defmodule Google.Ads.Googleads.V16.Services.CampaignDuration do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :duration_in_days, 2, proto3_optional: true, type: :int32, json_name: "durationInDays"
  field :date_range, 3, type: Google.Ads.Googleads.V16.Common.DateRange, json_name: "dateRange"
end

defmodule Google.Ads.Googleads.V16.Services.PlannedProduct do
  @moduledoc false
  ...
  field :advanced_product_targeting, 5,
    type: Google.Ads.Googleads.V16.Services.AdvancedProductTargeting,
    json_name: "advancedProductTargeting"
end

defmodule Google.Ads.Googleads.V16.Services.GenerateReachForecastResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :on_target_audience_metrics, 1,
    type: Google.Ads.Googleads.V16.Services.OnTargetAudienceMetrics,
    json_name: "onTargetAudienceMetrics"

  field :reach_curve, 2,
    type: Google.Ads.Googleads.V16.Services.ReachCurve,
    json_name: "reachCurve"
end

defmodule Google.Ads.Googleads.V16.Services.ReachCurve do
  @moduledoc false
  ...
  field :reach_forecasts, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.ReachForecast,
    json_name: "reachForecasts"
end

defmodule Google.Ads.Googleads.V16.Services.ReachForecast do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :cost_micros, 5, type: :int64, json_name: "costMicros"
  field :forecast, 2, type: Google.Ads.Googleads.V16.Services.Forecast

  field :planned_product_reach_forecasts, 4,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.PlannedProductReachForecast,
    json_name: "plannedProductReachForecasts"
end

defmodule Google.Ads.Googleads.V16.Services.Forecast do
  @moduledoc false
  ...
  field :effective_frequency_breakdowns, 10,
    repeated: true,
    type: Google.Ads.Googleads.V16.Services.EffectiveFrequencyBreakdown,
...
defmodule Google.Ads.Googleads.V16.Services.PlannedProductReachForecast do
  @moduledoc false
  ...
  field :planned_product_forecast, 3,
    type: Google.Ads.Googleads.V16.Services.PlannedProductForecast,
    json_name: "plannedProductForecast"
end

defmodule Google.Ads.Googleads.V16.Services.PlannedProductForecast do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.OnTargetAudienceMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.EffectiveFrequencyBreakdown do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.ForecastMetricOptions do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.AudienceTargeting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.AdvancedProductTargeting do
  @moduledoc false
  ...
  field :surface_targeting_settings, 2,
    type: Google.Ads.Googleads.V16.Services.SurfaceTargeting,
    json_name: "surfaceTargetingSettings"

  field :target_frequency_settings, 3,
    type: Google.Ads.Googleads.V16.Services.TargetFrequencySettings,
    json_name: "targetFrequencySettings"

  field :youtube_select_settings, 1,
    type: Google.Ads.Googleads.V16.Services.YouTubeSelectSettings,
    json_name: "youtubeSelectSettings",
    oneof: 0
end

defmodule Google.Ads.Googleads.V16.Services.YouTubeSelectSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.YouTubeSelectLineUp do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.SurfaceTargetingCombinations do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.SurfaceTargeting do
  @moduledoc false
  ...
  field :surfaces, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Enums.ReachPlanSurfaceEnum.ReachPlanSurface,
    enum: true
end

defmodule Google.Ads.Googleads.V16.Services.TargetFrequencySettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Services.ReachPlanService.Service do
  @moduledoc false
  ...
  rpc :ListPlannableLocations,
      Google.Ads.Googleads.V16.Services.ListPlannableLocationsRequest,
      Google.Ads.Googleads.V16.Services.ListPlannableLocationsResponse

  rpc :ListPlannableProducts,
      Google.Ads.Googleads.V16.Services.ListPlannableProductsRequest,
      Google.Ads.Googleads.V16.Services.ListPlannableProductsResponse

  rpc :GenerateReachForecast,
      Google.Ads.Googleads.V16.Services.GenerateReachForecastRequest,
      Google.Ads.Googleads.V16.Services.GenerateReachForecastResponse
end

defmodule Google.Ads.Googleads.V16.Services.ReachPlanService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V16.Services.ReachPlanService.Service
end