defmodule Google.Ads.Googleads.V16.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.SmartCampaignErrorEnum do
  @moduledoc false
