defmodule Google.Ads.Googleads.V16.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
