defmodule Google.Ads.Googleads.V16.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
