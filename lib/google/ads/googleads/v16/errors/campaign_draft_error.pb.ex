defmodule Google.Ads.Googleads.V16.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.CampaignDraftErrorEnum do
  @moduledoc false
