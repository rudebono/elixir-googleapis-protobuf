defmodule Google.Ads.Googleads.V16.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
