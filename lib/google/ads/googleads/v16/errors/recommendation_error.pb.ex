defmodule Google.Ads.Googleads.V16.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.RecommendationErrorEnum do
  @moduledoc false
