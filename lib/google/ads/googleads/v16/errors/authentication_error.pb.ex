defmodule Google.Ads.Googleads.V16.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.AuthenticationErrorEnum do
  @moduledoc false
