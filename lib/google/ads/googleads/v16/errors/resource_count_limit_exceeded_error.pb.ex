defmodule Google.Ads.Googleads.V16.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
