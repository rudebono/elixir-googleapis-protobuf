defmodule Google.Ads.Googleads.V16.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.CampaignFeedErrorEnum do
  @moduledoc false
