defmodule Google.Ads.Googleads.V16.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.AuthorizationErrorEnum do
  @moduledoc false
