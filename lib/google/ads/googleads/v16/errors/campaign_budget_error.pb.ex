defmodule Google.Ads.Googleads.V16.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V16.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
