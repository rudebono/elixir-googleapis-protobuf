...
defmodule Google.Ads.Googleads.V16.Common.TargetingSetting do
  ...
  field :target_restrictions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V16.Common.TargetRestriction,
    json_name: "targetRestrictions"

  field :target_restriction_operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V16.Common.TargetRestrictionOperation,
...
defmodule Google.Ads.Googleads.V16.Common.TargetRestrictionOperation do
  ...
  field :value, 2, type: Google.Ads.Googleads.V16.Common.TargetRestriction
end
