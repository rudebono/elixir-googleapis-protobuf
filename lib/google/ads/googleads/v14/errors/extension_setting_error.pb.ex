defmodule Google.Ads.Googleads.V14.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
