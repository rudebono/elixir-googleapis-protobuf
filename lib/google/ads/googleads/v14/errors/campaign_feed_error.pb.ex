defmodule Google.Ads.Googleads.V14.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Errors.CampaignFeedErrorEnum do
  @moduledoc false
