defmodule Google.Ads.Googleads.V14.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
