defmodule Google.Ads.Googleads.V14.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V14.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
