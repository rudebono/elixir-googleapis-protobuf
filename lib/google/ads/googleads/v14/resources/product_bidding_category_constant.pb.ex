defmodule Google.Ads.Googleads.V14.Resources.ProductBiddingCategoryConstant do
  @moduledoc false
  ...
  field :status, 6,
    type:
      Google.Ads.Googleads.V14.Enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus,
    enum: true,
    deprecated: false
