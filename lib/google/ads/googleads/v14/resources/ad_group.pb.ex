defmodule Google.Ads.Googleads.V14.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.AdGroup do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V14.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true

  field :type, 12,
    type: Google.Ads.Googleads.V14.Enums.AdGroupTypeEnum.AdGroupType,
    enum: true,
    deprecated: false

  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V14.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :display_custom_bid_dimension, 23,
    type: Google.Ads.Googleads.V14.Enums.TargetingDimensionEnum.TargetingDimension,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V14.Resources.AdGroup.AudienceSetting,
