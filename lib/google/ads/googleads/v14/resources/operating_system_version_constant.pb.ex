defmodule Google.Ads.Googleads.V14.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V14.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
