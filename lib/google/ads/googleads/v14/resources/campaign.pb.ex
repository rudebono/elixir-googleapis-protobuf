defmodule Google.Ads.Googleads.V14.Resources.Campaign.PerformanceMaxUpgrade do
  @moduledoc false
  ...
  field :status, 3,
    type:
      Google.Ads.Googleads.V14.Enums.PerformanceMaxUpgradeStatusEnum.PerformanceMaxUpgradeStatus,
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.NetworkSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.HotelSettingInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.DynamicSearchAdsSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.ShoppingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.GeoTargetTypeSetting do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :positive_geo_target_type, 1,
    type: Google.Ads.Googleads.V14.Enums.PositiveGeoTargetTypeEnum.PositiveGeoTargetType,
    json_name: "positiveGeoTargetType",
    enum: true

  field :negative_geo_target_type, 2,
    type: Google.Ads.Googleads.V14.Enums.NegativeGeoTargetTypeEnum.NegativeGeoTargetType,
    json_name: "negativeGeoTargetType",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.LocalCampaignSetting do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :location_source_type, 1,
    type: Google.Ads.Googleads.V14.Enums.LocationSourceTypeEnum.LocationSourceType,
    json_name: "locationSourceType",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.AppCampaignSetting do
  @moduledoc false
  ...
  field :bidding_strategy_goal_type, 1,
    type:
      Google.Ads.Googleads.V14.Enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType,
  ...
  field :app_store, 3,
    type: Google.Ads.Googleads.V14.Enums.AppCampaignAppStoreEnum.AppCampaignAppStore,
    json_name: "appStore",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.VanityPharma do
  @moduledoc false
  ...
  field :vanity_pharma_display_url_mode, 1,
    type:
      Google.Ads.Googleads.V14.Enums.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode,
    json_name: "vanityPharmaDisplayUrlMode",
    enum: true

  field :vanity_pharma_text, 2,
    type: Google.Ads.Googleads.V14.Enums.VanityPharmaTextEnum.VanityPharmaText,
    json_name: "vanityPharmaText",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.SelectiveOptimization do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.OptimizationGoalSetting do
  @moduledoc false
  ...
  field :optimization_goal_types, 1,
    repeated: true,
    type: Google.Ads.Googleads.V14.Enums.OptimizationGoalTypeEnum.OptimizationGoalType,
    json_name: "optimizationGoalTypes",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.LocalServicesCampaignSettings do
  @moduledoc false
  ...
  field :category_bids, 1,
    repeated: true,
    type: Google.Ads.Googleads.V14.Resources.Campaign.CategoryBid,
    json_name: "categoryBids"
end

defmodule Google.Ads.Googleads.V14.Resources.Campaign.CategoryBid do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign.TravelCampaignSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.Campaign do
  ...
  field :primary_status, 81,
    type: Google.Ads.Googleads.V14.Enums.CampaignPrimaryStatusEnum.CampaignPrimaryStatus,
  ...
  field :primary_status_reasons, 82,
    repeated: true,
    type:
      Google.Ads.Googleads.V14.Enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason,
    json_name: "primaryStatusReasons",
    enum: true,
    deprecated: false

  field :status, 5,
    type: Google.Ads.Googleads.V14.Enums.CampaignStatusEnum.CampaignStatus,
    enum: true

  field :serving_status, 21,
    type: Google.Ads.Googleads.V14.Enums.CampaignServingStatusEnum.CampaignServingStatus,
  ...
  field :bidding_strategy_system_status, 78,
    type:
      Google.Ads.Googleads.V14.Enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus,
  ...
  field :ad_serving_optimization_status, 8,
    type:
      Google.Ads.Googleads.V14.Enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus,
    json_name: "adServingOptimizationStatus",
    enum: true

  field :advertising_channel_type, 9,
    type: Google.Ads.Googleads.V14.Enums.AdvertisingChannelTypeEnum.AdvertisingChannelType,
    json_name: "advertisingChannelType",
    enum: true,
    deprecated: false

  field :advertising_channel_sub_type, 10,
    type: Google.Ads.Googleads.V14.Enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType,
  ...
  field :url_custom_parameters, 12,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.CustomParameter,
    json_name: "urlCustomParameters"

  field :local_services_campaign_settings, 75,
    type: Google.Ads.Googleads.V14.Resources.Campaign.LocalServicesCampaignSettings,
  ...
  field :network_settings, 14,
    type: Google.Ads.Googleads.V14.Resources.Campaign.NetworkSettings,
    json_name: "networkSettings"

  field :hotel_setting, 32,
    type: Google.Ads.Googleads.V14.Resources.Campaign.HotelSettingInfo,
    json_name: "hotelSetting",
    deprecated: false

  field :dynamic_search_ads_setting, 33,
    type: Google.Ads.Googleads.V14.Resources.Campaign.DynamicSearchAdsSetting,
    json_name: "dynamicSearchAdsSetting"

  field :shopping_setting, 36,
    type: Google.Ads.Googleads.V14.Resources.Campaign.ShoppingSetting,
    json_name: "shoppingSetting"

  field :targeting_setting, 43,
    type: Google.Ads.Googleads.V14.Common.TargetingSetting,
    json_name: "targetingSetting"

  field :audience_setting, 73,
    proto3_optional: true,
    type: Google.Ads.Googleads.V14.Resources.Campaign.AudienceSetting,
    json_name: "audienceSetting",
    deprecated: false

  field :geo_target_type_setting, 47,
    type: Google.Ads.Googleads.V14.Resources.Campaign.GeoTargetTypeSetting,
    json_name: "geoTargetTypeSetting"

  field :local_campaign_setting, 50,
    type: Google.Ads.Googleads.V14.Resources.Campaign.LocalCampaignSetting,
    json_name: "localCampaignSetting"

  field :app_campaign_setting, 51,
    type: Google.Ads.Googleads.V14.Resources.Campaign.AppCampaignSetting,
    json_name: "appCampaignSetting"

  field :labels, 61, repeated: true, type: :string, deprecated: false

  field :experiment_type, 17,
    type: Google.Ads.Googleads.V14.Enums.CampaignExperimentTypeEnum.CampaignExperimentType,
  ...
  field :bidding_strategy_type, 22,
    type: Google.Ads.Googleads.V14.Enums.BiddingStrategyTypeEnum.BiddingStrategyType,
  ...
  field :frequency_caps, 40,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.FrequencyCapEntry,
    json_name: "frequencyCaps"

  field :video_brand_safety_suitability, 42,
    type: Google.Ads.Googleads.V14.Enums.BrandSafetySuitabilityEnum.BrandSafetySuitability,
    json_name: "videoBrandSafetySuitability",
    enum: true,
    deprecated: false

  field :vanity_pharma, 44,
    type: Google.Ads.Googleads.V14.Resources.Campaign.VanityPharma,
    json_name: "vanityPharma"

  field :selective_optimization, 45,
    type: Google.Ads.Googleads.V14.Resources.Campaign.SelectiveOptimization,
    json_name: "selectiveOptimization"

  field :optimization_goal_setting, 54,
    type: Google.Ads.Googleads.V14.Resources.Campaign.OptimizationGoalSetting,
    json_name: "optimizationGoalSetting"

  field :tracking_setting, 46,
    type: Google.Ads.Googleads.V14.Resources.Campaign.TrackingSetting,
    json_name: "trackingSetting",
    deprecated: false

  field :payment_mode, 52,
    type: Google.Ads.Googleads.V14.Enums.PaymentModeEnum.PaymentMode,
  ...
  field :excluded_parent_asset_set_types, 80,
    repeated: true,
    type: Google.Ads.Googleads.V14.Enums.AssetSetTypeEnum.AssetSetType,
  ...
  field :performance_max_upgrade, 77,
    type: Google.Ads.Googleads.V14.Resources.Campaign.PerformanceMaxUpgrade,
  ...
  field :listing_type, 86,
    proto3_optional: true,
    type: Google.Ads.Googleads.V14.Enums.ListingTypeEnum.ListingType,
  ...
  field :commission, 49, type: Google.Ads.Googleads.V14.Common.Commission, oneof: 0

  field :manual_cpa, 74,
    type: Google.Ads.Googleads.V14.Common.ManualCpa,
    json_name: "manualCpa",
    oneof: 0

  field :manual_cpc, 24,
    type: Google.Ads.Googleads.V14.Common.ManualCpc,
    json_name: "manualCpc",
    oneof: 0

  field :manual_cpm, 25,
    type: Google.Ads.Googleads.V14.Common.ManualCpm,
    json_name: "manualCpm",
    oneof: 0
  ...
  field :maximize_conversion_value, 31,
    type: Google.Ads.Googleads.V14.Common.MaximizeConversionValue,
    json_name: "maximizeConversionValue",
    oneof: 0

  field :target_cpa, 26,
    type: Google.Ads.Googleads.V14.Common.TargetCpa,
    json_name: "targetCpa",
    oneof: 0

  field :target_impression_share, 48,
    type: Google.Ads.Googleads.V14.Common.TargetImpressionShare,
    json_name: "targetImpressionShare",
    oneof: 0

  field :target_roas, 29,
    type: Google.Ads.Googleads.V14.Common.TargetRoas,
    json_name: "targetRoas",
    oneof: 0

  field :target_spend, 27,
    type: Google.Ads.Googleads.V14.Common.TargetSpend,
    json_name: "targetSpend",
    oneof: 0

  field :percent_cpc, 34,
    type: Google.Ads.Googleads.V14.Common.PercentCpc,
    json_name: "percentCpc",
    oneof: 0

  field :target_cpm, 41,
    type: Google.Ads.Googleads.V14.Common.TargetCpm,
    json_name: "targetCpm",
    oneof: 0
end