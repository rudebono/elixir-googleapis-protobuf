defmodule Google.Ads.Googleads.V14.Resources.KeywordPlanCampaign do
  @moduledoc false
  ...
  field :geo_targets, 8,
    repeated: true,
    type: Google.Ads.Googleads.V14.Resources.KeywordPlanGeoTarget,
    json_name: "geoTargets"
end

defmodule Google.Ads.Googleads.V14.Resources.KeywordPlanGeoTarget do
  @moduledoc false
