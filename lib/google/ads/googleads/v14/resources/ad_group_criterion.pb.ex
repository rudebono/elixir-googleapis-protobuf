defmodule Google.Ads.Googleads.V14.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
  ...
  field :creative_quality_score, 2,
    type: Google.Ads.Googleads.V14.Enums.QualityScoreBucketEnum.QualityScoreBucket,
...
defmodule Google.Ads.Googleads.V14.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Resources.AdGroupCriterion do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V14.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V14.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :type, 25,
    type: Google.Ads.Googleads.V14.Enums.CriterionTypeEnum.CriterionType,
    enum: true,
    deprecated: false
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V14.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V14.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
  ...
  field :effective_cpc_bid_source, 21,
    type: Google.Ads.Googleads.V14.Enums.BiddingSourceEnum.BiddingSource,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V14.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :placement, 28,
    type: Google.Ads.Googleads.V14.Common.PlacementInfo,
    oneof: 0,
    deprecated: false

  field :mobile_app_category, 29,
    type: Google.Ads.Googleads.V14.Common.MobileAppCategoryInfo,
    json_name: "mobileAppCategory",
    oneof: 0,
    deprecated: false

  field :mobile_application, 30,
    type: Google.Ads.Googleads.V14.Common.MobileApplicationInfo,
    json_name: "mobileApplication",
    oneof: 0,
    deprecated: false

  field :listing_group, 32,
    type: Google.Ads.Googleads.V14.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V14.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :user_list, 42,
    type: Google.Ads.Googleads.V14.Common.UserListInfo,
    json_name: "userList",
    oneof: 0,
    deprecated: false

  field :youtube_video, 40,
    type: Google.Ads.Googleads.V14.Common.YouTubeVideoInfo,
  ...
  field :topic, 43, type: Google.Ads.Googleads.V14.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :webpage, 46,
    type: Google.Ads.Googleads.V14.Common.WebpageInfo,
    oneof: 0,
    deprecated: false

  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V14.Common.AppPaymentModelInfo,
    json_name: "appPaymentModel",
    oneof: 0,
    deprecated: false

  field :custom_affinity, 48,
    type: Google.Ads.Googleads.V14.Common.CustomAffinityInfo,
    json_name: "customAffinity",
    oneof: 0,
    deprecated: false

  field :custom_intent, 49,
    type: Google.Ads.Googleads.V14.Common.CustomIntentInfo,
    json_name: "customIntent",
    oneof: 0,
    deprecated: false

  field :custom_audience, 74,
    type: Google.Ads.Googleads.V14.Common.CustomAudienceInfo,
    json_name: "customAudience",
    oneof: 0,
    deprecated: false

  field :combined_audience, 75,
    type: Google.Ads.Googleads.V14.Common.CombinedAudienceInfo,
