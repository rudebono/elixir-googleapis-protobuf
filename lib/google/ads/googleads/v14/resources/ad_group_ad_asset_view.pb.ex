defmodule Google.Ads.Googleads.V14.Resources.AdGroupAdAssetView do
  @moduledoc false
  ...
  field :policy_summary, 3,
    type: Google.Ads.Googleads.V14.Resources.AdGroupAdAssetPolicySummary,
  ...
  field :pinned_field, 11,
    type: Google.Ads.Googleads.V14.Enums.ServedAssetFieldTypeEnum.ServedAssetFieldType,
    json_name: "pinnedField",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V14.Resources.AdGroupAdAssetPolicySummary do
  @moduledoc false
