defmodule Google.Ads.Googleads.V14.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field :status, 7,
    type: Google.Ads.Googleads.V14.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true,
    deprecated: false
