defmodule Google.Ads.Googleads.V14.Resources.AdGroupCriterionCustomizer do
  @moduledoc false
  ...
  field :value, 5, type: Google.Ads.Googleads.V14.Common.CustomizerValue, deprecated: false
end