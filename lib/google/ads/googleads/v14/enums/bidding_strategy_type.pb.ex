defmodule Google.Ads.Googleads.V14.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
