defmodule Google.Ads.Googleads.V14.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
