defmodule Google.Ads.Googleads.V14.Common.OfflineUserAddressInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.UserIdentifier do
  @moduledoc false
  ...
  field :user_identifier_source, 6,
    type: Google.Ads.Googleads.V14.Enums.UserIdentifierSourceEnum.UserIdentifierSource,
  ...
  field :address_info, 5,
    type: Google.Ads.Googleads.V14.Common.OfflineUserAddressInfo,
    json_name: "addressInfo",
    oneof: 0
end

defmodule Google.Ads.Googleads.V14.Common.TransactionAttribute do
  @moduledoc false
  ...
  field :store_attribute, 6,
    type: Google.Ads.Googleads.V14.Common.StoreAttribute,
  ...
  field :item_attribute, 14,
    type: Google.Ads.Googleads.V14.Common.ItemAttribute,
    json_name: "itemAttribute"
end

defmodule Google.Ads.Googleads.V14.Common.StoreAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.ItemAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.UserData do
  @moduledoc false
  ...
  field :transaction_attribute, 2,
    type: Google.Ads.Googleads.V14.Common.TransactionAttribute,
    json_name: "transactionAttribute"

  field :user_attribute, 3,
    type: Google.Ads.Googleads.V14.Common.UserAttribute,
    json_name: "userAttribute"
end

defmodule Google.Ads.Googleads.V14.Common.UserAttribute do
  @moduledoc false
  ...
  field :shopping_loyalty, 7,
    proto3_optional: true,
    type: Google.Ads.Googleads.V14.Common.ShoppingLoyalty,
  ...
  field :event_attribute, 10,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.EventAttribute,
    json_name: "eventAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V14.Common.EventAttribute do
  @moduledoc false
  ...
  field :item_attribute, 3,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.EventItemAttribute,
    json_name: "itemAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V14.Common.EventItemAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.ShoppingLoyalty do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.CustomerMatchUserListMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.StoreSalesMetadata do
  @moduledoc false
  ...
  field :third_party_metadata, 3,
    type: Google.Ads.Googleads.V14.Common.StoreSalesThirdPartyMetadata,
    json_name: "thirdPartyMetadata"
end

defmodule Google.Ads.Googleads.V14.Common.StoreSalesThirdPartyMetadata do
  @moduledoc false
