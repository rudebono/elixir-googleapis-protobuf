defmodule Google.Ads.Googleads.V14.Common.Segments do
  @moduledoc false
  ...
  field :ad_destination_type, 136,
    type: Google.Ads.Googleads.V14.Enums.AdDestinationTypeEnum.AdDestinationType,
    json_name: "adDestinationType",
    enum: true

  field :ad_network_type, 3,
    type: Google.Ads.Googleads.V14.Enums.AdNetworkTypeEnum.AdNetworkType,
  ...
  field :conversion_action_category, 53,
    type: Google.Ads.Googleads.V14.Enums.ConversionActionCategoryEnum.ConversionActionCategory,
  ...
  field :conversion_attribution_event_type, 2,
    type:
      Google.Ads.Googleads.V14.Enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType,
    json_name: "conversionAttributionEventType",
    enum: true

  field :conversion_lag_bucket, 50,
    type: Google.Ads.Googleads.V14.Enums.ConversionLagBucketEnum.ConversionLagBucket,
    json_name: "conversionLagBucket",
    enum: true

  field :conversion_or_adjustment_lag_bucket, 51,
    type:
      Google.Ads.Googleads.V14.Enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket,
  ...
  field :device, 1, type: Google.Ads.Googleads.V14.Enums.DeviceEnum.Device, enum: true

  field :external_conversion_source, 55,
    type: Google.Ads.Googleads.V14.Enums.ExternalConversionSourceEnum.ExternalConversionSource,
  ...
  field :hotel_rate_type, 74,
    type: Google.Ads.Googleads.V14.Enums.HotelRateTypeEnum.HotelRateType,
    json_name: "hotelRateType",
    enum: true

  field :hotel_price_bucket, 78,
    type: Google.Ads.Googleads.V14.Enums.HotelPriceBucketEnum.HotelPriceBucket,
  ...
  field :keyword, 61, type: Google.Ads.Googleads.V14.Common.Keyword
  ...
  field :search_engine_results_page_type, 70,
    type:
      Google.Ads.Googleads.V14.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType,
  ...
  field :slot, 23, type: Google.Ads.Googleads.V14.Enums.SlotEnum.Slot, enum: true

  field :conversion_value_rule_primary_dimension, 138,
    type:
      Google.Ads.Googleads.V14.Enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension,
  ...
  field :sk_ad_network_user_type, 141,
    type: Google.Ads.Googleads.V14.Enums.SkAdNetworkUserTypeEnum.SkAdNetworkUserType,
    json_name: "skAdNetworkUserType",
    enum: true

  field :sk_ad_network_ad_event_type, 142,
    type: Google.Ads.Googleads.V14.Enums.SkAdNetworkAdEventTypeEnum.SkAdNetworkAdEventType,
    json_name: "skAdNetworkAdEventType",
    enum: true

  field :sk_ad_network_source_app, 143,
    proto3_optional: true,
    type: Google.Ads.Googleads.V14.Common.SkAdNetworkSourceApp,
    json_name: "skAdNetworkSourceApp"

  field :sk_ad_network_attribution_credit, 144,
    type:
      Google.Ads.Googleads.V14.Enums.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit,
...
defmodule Google.Ads.Googleads.V14.Common.Keyword do
  ...
  field :info, 2, type: Google.Ads.Googleads.V14.Common.KeywordInfo
end

defmodule Google.Ads.Googleads.V14.Common.BudgetCampaignAssociationStatus do
  @moduledoc false
  ...
  field :status, 2,
    type:
      Google.Ads.Googleads.V14.Enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus,
    enum: true
end

defmodule Google.Ads.Googleads.V14.Common.AssetInteractionTarget do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.SkAdNetworkSourceApp do
  @moduledoc false
