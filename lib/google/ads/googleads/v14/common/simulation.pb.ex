defmodule Google.Ads.Googleads.V14.Common.CpcBidSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V14.Common.CpcBidSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.CpvBidSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V14.Common.CpvBidSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.TargetCpaSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V14.Common.TargetCpaSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.TargetRoasSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.TargetRoasSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.PercentCpcBidSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.PercentCpcBidSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.BudgetSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V14.Common.BudgetSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.TargetImpressionShareSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.TargetImpressionShareSimulationPoint
end

defmodule Google.Ads.Googleads.V14.Common.CpcBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.CpvBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.TargetCpaSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.TargetRoasSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.PercentCpcBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.BudgetSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.TargetImpressionShareSimulationPoint do
  @moduledoc false
