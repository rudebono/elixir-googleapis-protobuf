defmodule Google.Ads.Googleads.V14.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.MediaBundleAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.ImageAsset do
  @moduledoc false
  ...
  field :mime_type, 3,
    type: Google.Ads.Googleads.V14.Enums.MimeTypeEnum.MimeType,
    json_name: "mimeType",
    enum: true

  field :full_size, 4, type: Google.Ads.Googleads.V14.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V14.Common.ImageDimension do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.TextAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.LeadFormAsset do
  @moduledoc false
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V14.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V14.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V14.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V14.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V14.Common.LeadFormField do
  @moduledoc false
  ...
  field :input_type, 1,
    type:
      Google.Ads.Googleads.V14.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V14.Common.LeadFormSingleChoiceAnswers,
...
defmodule Google.Ads.Googleads.V14.Common.LeadFormCustomQuestionField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.LeadFormDeliveryMethod do
  @moduledoc false
  ...
  field :webhook, 1, type: Google.Ads.Googleads.V14.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V14.Common.WebhookDelivery do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.BookOnGoogleAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V14.Common.PromotionAsset do
  @moduledoc false
  ...
  field :discount_modifier, 2,
    type:
      Google.Ads.Googleads.V14.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
  ...
  field :occasion, 9,
    type:
      Google.Ads.Googleads.V14.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
...
defmodule Google.Ads.Googleads.V14.Common.CalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.StructuredSnippetAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.SitelinkAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.PageFeedAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicEducationAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.MobileAppAsset do
  @moduledoc false
  ...
  field :app_store, 2,
    type: Google.Ads.Googleads.V14.Enums.MobileAppVendorEnum.MobileAppVendor,
    json_name: "appStore",
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V14.Common.HotelCalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.CallAsset do
  @moduledoc false
  ...
  field :call_conversion_reporting_state, 3,
    type:
      Google.Ads.Googleads.V14.Enums.CallConversionReportingStateEnum.CallConversionReportingState,
...
defmodule Google.Ads.Googleads.V14.Common.PriceAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V14.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false

  field :price_qualifier, 2,
    type:
      Google.Ads.Googleads.V14.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V14.Common.PriceOffering do
  @moduledoc false
  ...
  field :price, 3, type: Google.Ads.Googleads.V14.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V14.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V14.Common.CallToActionAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :call_to_action, 1,
    type: Google.Ads.Googleads.V14.Enums.CallToActionTypeEnum.CallToActionType,
    json_name: "callToAction",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Common.DynamicRealEstateAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicCustomAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicFlightsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DiscoveryCarouselCardAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicTravelAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicLocalAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.DynamicJobsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.LocationAsset do
  @moduledoc false
  ...
  field :business_profile_locations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V14.Common.BusinessProfileLocation,
    json_name: "businessProfileLocations"

  field :location_ownership_type, 3,
    type: Google.Ads.Googleads.V14.Enums.LocationOwnershipTypeEnum.LocationOwnershipType,
    json_name: "locationOwnershipType",
    enum: true
end

defmodule Google.Ads.Googleads.V14.Common.BusinessProfileLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V14.Common.HotelPropertyAsset do
  @moduledoc false
