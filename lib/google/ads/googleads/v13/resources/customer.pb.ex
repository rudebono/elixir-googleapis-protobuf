defmodule Google.Ads.Googleads.V13.Resources.Customer do
  ...
  field :call_reporting_setting, 10,
    type: Google.Ads.Googleads.V13.Resources.CallReportingSetting,
    json_name: "callReportingSetting"

  field :conversion_tracking_setting, 14,
    type: Google.Ads.Googleads.V13.Resources.ConversionTrackingSetting,
    json_name: "conversionTrackingSetting",
    deprecated: false

  field :remarketing_setting, 15,
    type: Google.Ads.Googleads.V13.Resources.RemarketingSetting,
  ...
  field :pay_per_conversion_eligibility_failure_reasons, 16,
    repeated: true,
    type:
      Google.Ads.Googleads.V13.Enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason,
  ...
  field :status, 36,
    type: Google.Ads.Googleads.V13.Enums.CustomerStatusEnum.CustomerStatus,
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionTrackingSetting do
  ...
  field :conversion_tracking_status, 6,
    type: Google.Ads.Googleads.V13.Enums.ConversionTrackingStatusEnum.ConversionTrackingStatus,
