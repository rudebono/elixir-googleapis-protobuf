...
defmodule Google.Ads.Googleads.V13.Resources.Invoice.AccountBudgetSummary do
  ...
  field :invalid_activity_summaries, 22,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.Invoice.InvalidActivitySummary,
...
defmodule Google.Ads.Googleads.V13.Resources.Invoice do
  ...
  field :type, 3,
    type: Google.Ads.Googleads.V13.Enums.InvoiceTypeEnum.InvoiceType,
    enum: true,
    deprecated: false
  ...
  field :account_budget_summaries, 18,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.Invoice.AccountBudgetSummary,
    json_name: "accountBudgetSummaries",
    deprecated: false

  field :account_summaries, 39,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.Invoice.AccountSummary,
