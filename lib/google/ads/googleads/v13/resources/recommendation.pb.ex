...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption do
  ...
  field :impact, 2,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.RecommendationImpact,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.CampaignBudgetRecommendation do
  ...
  field :budget_options, 3,
    repeated: true,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.CampaignBudgetRecommendation.CampaignBudgetRecommendationOption,
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption do
  ...
  field :goal, 1,
    type:
      Google.Ads.Googleads.V13.Enums.TargetCpaOptInRecommendationGoalEnum.TargetCpaOptInRecommendationGoal,
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.TargetCpaOptInRecommendation do
  ...
  field :options, 1,
    repeated: true,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.TargetCpaOptInRecommendation.TargetCpaOptInRecommendationOption,
    deprecated: false
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.MoveUnusedBudgetRecommendation do
  ...
  field :budget_recommendation, 2,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.CampaignBudgetRecommendation,
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation.ForecastingSetTargetRoasRecommendation do
  ...
  field :campaign_budget, 2,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.CampaignBudget,
...
defmodule Google.Ads.Googleads.V13.Resources.Recommendation do
  ...
  field :keyword_recommendation, 8,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.KeywordRecommendation,
    json_name: "keywordRecommendation",
    oneof: 0,
    deprecated: false

  field :text_ad_recommendation, 9,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.TextAdRecommendation,
    json_name: "textAdRecommendation",
    oneof: 0,
    deprecated: false

  field :target_cpa_opt_in_recommendation, 10,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.TargetCpaOptInRecommendation,
  ...
  field :maximize_conversions_opt_in_recommendation, 11,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.MaximizeConversionsOptInRecommendation,
    json_name: "maximizeConversionsOptInRecommendation",
    oneof: 0,
    deprecated: false

  field :enhanced_cpc_opt_in_recommendation, 12,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.EnhancedCpcOptInRecommendation,
    json_name: "enhancedCpcOptInRecommendation",
    oneof: 0,
    deprecated: false

  field :search_partners_opt_in_recommendation, 14,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.SearchPartnersOptInRecommendation,
    json_name: "searchPartnersOptInRecommendation",
    oneof: 0,
    deprecated: false

  field :maximize_clicks_opt_in_recommendation, 15,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.MaximizeClicksOptInRecommendation,
    json_name: "maximizeClicksOptInRecommendation",
    oneof: 0,
    deprecated: false

  field :optimize_ad_rotation_recommendation, 16,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.OptimizeAdRotationRecommendation,
    json_name: "optimizeAdRotationRecommendation",
    oneof: 0,
    deprecated: false

  field :keyword_match_type_recommendation, 20,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.KeywordMatchTypeRecommendation,
    json_name: "keywordMatchTypeRecommendation",
    oneof: 0,
    deprecated: false

  field :move_unused_budget_recommendation, 21,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.MoveUnusedBudgetRecommendation,
    json_name: "moveUnusedBudgetRecommendation",
    oneof: 0,
    deprecated: false

  field :target_roas_opt_in_recommendation, 23,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.TargetRoasOptInRecommendation,
    json_name: "targetRoasOptInRecommendation",
    oneof: 0,
    deprecated: false

  field :responsive_search_ad_recommendation, 28,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.ResponsiveSearchAdRecommendation,
  ...
  field :use_broad_match_keyword_recommendation, 30,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.UseBroadMatchKeywordRecommendation,
    json_name: "useBroadMatchKeywordRecommendation",
    oneof: 0,
    deprecated: false

  field :responsive_search_ad_asset_recommendation, 31,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.ResponsiveSearchAdAssetRecommendation,
  ...
  field :upgrade_smart_shopping_campaign_to_performance_max_recommendation, 32,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.UpgradeSmartShoppingCampaignToPerformanceMaxRecommendation,
  ...
  field :responsive_search_ad_improve_ad_strength_recommendation, 33,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.ResponsiveSearchAdImproveAdStrengthRecommendation,
    json_name: "responsiveSearchAdImproveAdStrengthRecommendation",
    oneof: 0,
    deprecated: false

  field :display_expansion_opt_in_recommendation, 34,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.DisplayExpansionOptInRecommendation,
  ...
  field :upgrade_local_campaign_to_performance_max_recommendation, 35,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.UpgradeLocalCampaignToPerformanceMaxRecommendation,
    json_name: "upgradeLocalCampaignToPerformanceMaxRecommendation",
    oneof: 0,
    deprecated: false

  field :raise_target_cpa_bid_too_low_recommendation, 36,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.RaiseTargetCpaBidTooLowRecommendation,
  ...
  field :forecasting_set_target_roas_recommendation, 37,
    type:
      Google.Ads.Googleads.V13.Resources.Recommendation.ForecastingSetTargetRoasRecommendation,
    json_name: "forecastingSetTargetRoasRecommendation",
    oneof: 0,
    deprecated: false

  field :callout_asset_recommendation, 39,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.CalloutAssetRecommendation,
    json_name: "calloutAssetRecommendation",
    oneof: 0,
    deprecated: false

  field :sitelink_asset_recommendation, 40,
    type: Google.Ads.Googleads.V13.Resources.Recommendation.SitelinkAssetRecommendation,
