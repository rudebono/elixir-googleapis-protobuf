defmodule Google.Ads.Googleads.V13.Resources.ConversionAction.AttributionModelSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :attribution_model, 1,
    type: Google.Ads.Googleads.V13.Enums.AttributionModelEnum.AttributionModel,
    json_name: "attributionModel",
    enum: true

  field :data_driven_model_status, 2,
    type: Google.Ads.Googleads.V13.Enums.DataDrivenModelStatusEnum.DataDrivenModelStatus,
    json_name: "dataDrivenModelStatus",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V13.Resources.ConversionAction.ValueSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionAction.FirebaseSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionAction do
  @moduledoc false
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V13.Enums.ConversionActionStatusEnum.ConversionActionStatus,
    enum: true

  field :type, 5,
    type: Google.Ads.Googleads.V13.Enums.ConversionActionTypeEnum.ConversionActionType,
    enum: true,
    deprecated: false
  ...
  field :value_settings, 11,
    type: Google.Ads.Googleads.V13.Resources.ConversionAction.ValueSettings,
    json_name: "valueSettings"

  field :counting_type, 12,
    type:
      Google.Ads.Googleads.V13.Enums.ConversionActionCountingTypeEnum.ConversionActionCountingType,
    json_name: "countingType",
    enum: true

  field :attribution_model_settings, 13,
    type: Google.Ads.Googleads.V13.Resources.ConversionAction.AttributionModelSettings,
  ...
  field :firebase_settings, 18,
    type: Google.Ads.Googleads.V13.Resources.ConversionAction.FirebaseSettings,
    json_name: "firebaseSettings",
    deprecated: false

  field :third_party_app_analytics_settings, 19,
    type: Google.Ads.Googleads.V13.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings,
