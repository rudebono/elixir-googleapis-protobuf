defmodule Google.Ads.Googleads.V13.Resources.UserInterest do
  @moduledoc false
  ...
  field :taxonomy_type, 2,
    type: Google.Ads.Googleads.V13.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
  ...
  field :availabilities, 7,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.CriterionCategoryAvailability,
    deprecated: false
end