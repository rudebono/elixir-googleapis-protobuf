defmodule Google.Ads.Googleads.V13.Resources.CampaignSimulation do
  @moduledoc false
  ...
  field :target_impression_share_point_list, 10,
    type: Google.Ads.Googleads.V13.Common.TargetImpressionShareSimulationPointList,
    json_name: "targetImpressionSharePointList",
    oneof: 0,
    deprecated: false

  field :budget_point_list, 11,
    type: Google.Ads.Googleads.V13.Common.BudgetSimulationPointList,
