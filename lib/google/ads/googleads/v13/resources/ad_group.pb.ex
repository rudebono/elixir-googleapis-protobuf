defmodule Google.Ads.Googleads.V13.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Resources.AdGroup do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V13.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true

  field :type, 12,
    type: Google.Ads.Googleads.V13.Enums.AdGroupTypeEnum.AdGroupType,
    enum: true,
    deprecated: false

  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V13.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :display_custom_bid_dimension, 23,
    type: Google.Ads.Googleads.V13.Enums.TargetingDimensionEnum.TargetingDimension,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V13.Resources.AdGroup.AudienceSetting,
