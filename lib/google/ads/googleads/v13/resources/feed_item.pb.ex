defmodule Google.Ads.Googleads.V13.Resources.FeedItem do
  ...
  field :attribute_values, 6,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.FeedItemAttributeValue,
    json_name: "attributeValues"

  field :geo_targeting_restriction, 7,
    type: Google.Ads.Googleads.V13.Enums.GeoTargetingRestrictionEnum.GeoTargetingRestriction,
  ...
  field :policy_infos, 10,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.FeedItemPlaceholderPolicyInfo,
...
defmodule Google.Ads.Googleads.V13.Resources.FeedItemAttributeValue do
  ...
  field :price_value, 6, type: Google.Ads.Googleads.V13.Common.Money, json_name: "priceValue"
...
defmodule Google.Ads.Googleads.V13.Resources.FeedItemPlaceholderPolicyInfo do
  ...
  field :validation_status, 6,
    type: Google.Ads.Googleads.V13.Enums.FeedItemValidationStatusEnum.FeedItemValidationStatus,
  ...
  field :validation_errors, 7,
    repeated: true,
    type: Google.Ads.Googleads.V13.Resources.FeedItemValidationError,
    json_name: "validationErrors",
    deprecated: false

  field :quality_approval_status, 8,
    type:
      Google.Ads.Googleads.V13.Enums.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus,
  ...
  field :quality_disapproval_reasons, 9,
    repeated: true,
    type:
      Google.Ads.Googleads.V13.Enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason,
