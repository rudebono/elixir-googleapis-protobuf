...
defmodule Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleGeoLocationCondition do
  ...
  field :excluded_geo_match_type, 2,
    type:
      Google.Ads.Googleads.V13.Enums.ValueRuleGeoLocationMatchTypeEnum.ValueRuleGeoLocationMatchType,
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleDeviceCondition do
  ...
  field :device_types, 1,
    repeated: true,
    type: Google.Ads.Googleads.V13.Enums.ValueRuleDeviceTypeEnum.ValueRuleDeviceType,
...
defmodule Google.Ads.Googleads.V13.Resources.ConversionValueRule do
  ...
  field :action, 3, type: Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleAction

  field :geo_location_condition, 4,
    type: Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleGeoLocationCondition,
    json_name: "geoLocationCondition"

  field :device_condition, 5,
    type: Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleDeviceCondition,
    json_name: "deviceCondition"

  field :audience_condition, 6,
    type: Google.Ads.Googleads.V13.Resources.ConversionValueRule.ValueRuleAudienceCondition,
    json_name: "audienceCondition"

  field :owner_customer, 7, type: :string, json_name: "ownerCustomer", deprecated: false

  field :status, 8,
    type: Google.Ads.Googleads.V13.Enums.ConversionValueRuleStatusEnum.ConversionValueRuleStatus,
    enum: true
end