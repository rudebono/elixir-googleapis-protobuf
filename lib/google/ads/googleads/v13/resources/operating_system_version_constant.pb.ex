defmodule Google.Ads.Googleads.V13.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V13.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
