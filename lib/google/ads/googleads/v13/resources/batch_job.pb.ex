defmodule Google.Ads.Googleads.V13.Resources.BatchJob.BatchJobMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Resources.BatchJob do
  @moduledoc false
  ...
  field :metadata, 4,
    type: Google.Ads.Googleads.V13.Resources.BatchJob.BatchJobMetadata,
    deprecated: false

  field :status, 5,
    type: Google.Ads.Googleads.V13.Enums.BatchJobStatusEnum.BatchJobStatus,
    enum: true,
    deprecated: false
