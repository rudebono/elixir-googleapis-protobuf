defmodule Google.Ads.Googleads.V13.Resources.CustomerExtensionSetting do
  @moduledoc false
  ...
  field :device, 4,
    type: Google.Ads.Googleads.V13.Enums.ExtensionSettingDeviceEnum.ExtensionSettingDevice,
    enum: true
end