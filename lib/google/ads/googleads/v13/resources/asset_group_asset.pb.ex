defmodule Google.Ads.Googleads.V13.Resources.AssetGroupAsset do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V13.Enums.AssetLinkStatusEnum.AssetLinkStatus,
    enum: true
  ...
  field :policy_summary, 7,
    type: Google.Ads.Googleads.V13.Common.PolicySummary,
