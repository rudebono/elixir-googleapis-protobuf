...
defmodule Google.Ads.Googleads.V13.Common.ImageAsset do
  ...
  field :full_size, 4, type: Google.Ads.Googleads.V13.Common.ImageDimension, json_name: "fullSize"
end
...
defmodule Google.Ads.Googleads.V13.Common.LeadFormAsset do
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V13.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V13.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V13.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V13.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V13.Common.LeadFormDeliveryMethod do
  ...
  field :webhook, 1, type: Google.Ads.Googleads.V13.Common.WebhookDelivery, oneof: 0
end
...
defmodule Google.Ads.Googleads.V13.Common.PriceAsset do
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.PriceOffering,
...
defmodule Google.Ads.Googleads.V13.Common.PriceOffering do
  ...
  field :price, 3, type: Google.Ads.Googleads.V13.Common.Money, deprecated: false
...
defmodule Google.Ads.Googleads.V13.Common.LocationAsset do
  ...
  field :business_profile_locations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.BusinessProfileLocation,
    json_name: "businessProfileLocations"

  field :location_ownership_type, 3,
    type: Google.Ads.Googleads.V13.Enums.LocationOwnershipTypeEnum.LocationOwnershipType,
