...
defmodule Google.Ads.Googleads.V13.Common.ListingGroupInfo do
  ...
  field :case_value, 2,
    type: Google.Ads.Googleads.V13.Common.ListingDimensionInfo,
    json_name: "caseValue"
...
defmodule Google.Ads.Googleads.V13.Common.ListingDimensionInfo do
  ...
  field :hotel_id, 2,
    type: Google.Ads.Googleads.V13.Common.HotelIdInfo,
    json_name: "hotelId",
    oneof: 0

  field :hotel_class, 3,
    type: Google.Ads.Googleads.V13.Common.HotelClassInfo,
    json_name: "hotelClass",
    oneof: 0

  field :hotel_country_region, 4,
    type: Google.Ads.Googleads.V13.Common.HotelCountryRegionInfo,
    json_name: "hotelCountryRegion",
    oneof: 0

  field :hotel_state, 5,
    type: Google.Ads.Googleads.V13.Common.HotelStateInfo,
    json_name: "hotelState",
    oneof: 0

  field :hotel_city, 6,
    type: Google.Ads.Googleads.V13.Common.HotelCityInfo,
    json_name: "hotelCity",
    oneof: 0

  field :product_bidding_category, 13,
    type: Google.Ads.Googleads.V13.Common.ProductBiddingCategoryInfo,
    json_name: "productBiddingCategory",
    oneof: 0

  field :product_brand, 15,
    type: Google.Ads.Googleads.V13.Common.ProductBrandInfo,
    json_name: "productBrand",
    oneof: 0

  field :product_channel, 8,
    type: Google.Ads.Googleads.V13.Common.ProductChannelInfo,
    json_name: "productChannel",
    oneof: 0

  field :product_channel_exclusivity, 9,
    type: Google.Ads.Googleads.V13.Common.ProductChannelExclusivityInfo,
    json_name: "productChannelExclusivity",
    oneof: 0

  field :product_condition, 10,
    type: Google.Ads.Googleads.V13.Common.ProductConditionInfo,
    json_name: "productCondition",
    oneof: 0

  field :product_custom_attribute, 16,
    type: Google.Ads.Googleads.V13.Common.ProductCustomAttributeInfo,
    json_name: "productCustomAttribute",
    oneof: 0

  field :product_item_id, 11,
    type: Google.Ads.Googleads.V13.Common.ProductItemIdInfo,
    json_name: "productItemId",
    oneof: 0

  field :product_type, 12,
    type: Google.Ads.Googleads.V13.Common.ProductTypeInfo,
    json_name: "productType",
    oneof: 0

  field :product_grouping, 17,
    type: Google.Ads.Googleads.V13.Common.ProductGroupingInfo,
    json_name: "productGrouping",
    oneof: 0

  field :product_labels, 18,
    type: Google.Ads.Googleads.V13.Common.ProductLabelsInfo,
    json_name: "productLabels",
    oneof: 0

  field :product_legacy_condition, 19,
    type: Google.Ads.Googleads.V13.Common.ProductLegacyConditionInfo,
    json_name: "productLegacyCondition",
    oneof: 0

  field :product_type_full, 20,
    type: Google.Ads.Googleads.V13.Common.ProductTypeFullInfo,
    json_name: "productTypeFull",
    oneof: 0

  field :activity_id, 21,
    type: Google.Ads.Googleads.V13.Common.ActivityIdInfo,
    json_name: "activityId",
    oneof: 0

  field :activity_rating, 22,
    type: Google.Ads.Googleads.V13.Common.ActivityRatingInfo,
    json_name: "activityRating",
    oneof: 0

  field :activity_country, 23,
    type: Google.Ads.Googleads.V13.Common.ActivityCountryInfo,
    json_name: "activityCountry",
    oneof: 0

  field :unknown_listing_dimension, 14,
    type: Google.Ads.Googleads.V13.Common.UnknownListingDimensionInfo,
...
defmodule Google.Ads.Googleads.V13.Common.ProductCustomAttributeInfo do
  ...
  field :index, 2,
    type:
      Google.Ads.Googleads.V13.Enums.ProductCustomAttributeIndexEnum.ProductCustomAttributeIndex,
    enum: true
end
...
defmodule Google.Ads.Googleads.V13.Common.ProductTypeInfo do
  ...
  field :level, 2,
    type: Google.Ads.Googleads.V13.Enums.ProductTypeLevelEnum.ProductTypeLevel,
    enum: true
end
...
defmodule Google.Ads.Googleads.V13.Common.ProximityInfo do
  ...
  field :radius_units, 3,
    type: Google.Ads.Googleads.V13.Enums.ProximityRadiusUnitsEnum.ProximityRadiusUnits,
    json_name: "radiusUnits",
    enum: true

  field :address, 4, type: Google.Ads.Googleads.V13.Common.AddressInfo
end
...
defmodule Google.Ads.Googleads.V13.Common.WebpageInfo do
  ...
  field :sample, 5, type: Google.Ads.Googleads.V13.Common.WebpageSampleInfo
end
...
defmodule Google.Ads.Googleads.V13.Common.WebpageConditionInfo do
  ...
  field :operator, 2,
    type: Google.Ads.Googleads.V13.Enums.WebpageConditionOperatorEnum.WebpageConditionOperator,
    enum: true
...
defmodule Google.Ads.Googleads.V13.Common.LocationGroupInfo do
  ...
  field :radius_units, 4,
    type: Google.Ads.Googleads.V13.Enums.LocationGroupRadiusUnitsEnum.LocationGroupRadiusUnits,
    json_name: "radiusUnits",
    enum: true
