defmodule Google.Ads.Googleads.V13.Common.CriterionCategoryAvailability do
  ...
  field :locale, 2,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.CriterionCategoryLocaleAvailability
end
...
defmodule Google.Ads.Googleads.V13.Common.CriterionCategoryChannelAvailability do
  ...
  field :availability_mode, 1,
    type:
      Google.Ads.Googleads.V13.Enums.CriterionCategoryChannelAvailabilityModeEnum.CriterionCategoryChannelAvailabilityMode,
...
defmodule Google.Ads.Googleads.V13.Common.CriterionCategoryLocaleAvailability do
  ...
  field :availability_mode, 1,
    type:
      Google.Ads.Googleads.V13.Enums.CriterionCategoryLocaleAvailabilityModeEnum.CriterionCategoryLocaleAvailabilityMode,
    json_name: "availabilityMode",
    enum: true
