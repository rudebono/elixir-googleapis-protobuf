defmodule Google.Ads.Googleads.V13.Common.LocationSet do
  ...
  field :business_profile_location_set, 1,
    type: Google.Ads.Googleads.V13.Common.BusinessProfileLocationSet,
    json_name: "businessProfileLocationSet",
    oneof: 0

  field :chain_location_set, 2,
    type: Google.Ads.Googleads.V13.Common.ChainSet,
    json_name: "chainLocationSet",
    oneof: 0

  field :maps_location_set, 5,
    type: Google.Ads.Googleads.V13.Common.MapsLocationSet,
...
defmodule Google.Ads.Googleads.V13.Common.ChainSet do
  ...
  field :chains, 2,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.ChainFilter,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V13.Common.MapsLocationSet do
  ...
  field :maps_locations, 1,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.MapsLocationInfo,
...
defmodule Google.Ads.Googleads.V13.Common.DynamicBusinessProfileLocationGroupFilter do
  ...
  field :business_name_filter, 2,
    ...
    type: Google.Ads.Googleads.V13.Common.BusinessProfileBusinessNameFilter,
...
defmodule Google.Ads.Googleads.V13.Common.BusinessProfileBusinessNameFilter do
  ...
  field :filter_type, 2,
    type: Google.Ads.Googleads.V13.Enums.LocationStringFilterTypeEnum.LocationStringFilterType,
