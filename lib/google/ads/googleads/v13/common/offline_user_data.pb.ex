...
defmodule Google.Ads.Googleads.V13.Common.UserIdentifier do
  ...
  field :user_identifier_source, 6,
    type: Google.Ads.Googleads.V13.Enums.UserIdentifierSourceEnum.UserIdentifierSource,
  ...
  field :address_info, 5,
    type: Google.Ads.Googleads.V13.Common.OfflineUserAddressInfo,
...
defmodule Google.Ads.Googleads.V13.Common.TransactionAttribute do
  ...
  field :store_attribute, 6,
    type: Google.Ads.Googleads.V13.Common.StoreAttribute,
  ...
  field :item_attribute, 14,
    type: Google.Ads.Googleads.V13.Common.ItemAttribute,
...
defmodule Google.Ads.Googleads.V13.Common.UserData do
  ...
  field :transaction_attribute, 2,
    type: Google.Ads.Googleads.V13.Common.TransactionAttribute,
    json_name: "transactionAttribute"

  field :user_attribute, 3,
    type: Google.Ads.Googleads.V13.Common.UserAttribute,
...
defmodule Google.Ads.Googleads.V13.Common.UserAttribute do
  ...
  field :shopping_loyalty, 7,
    proto3_optional: true,
    type: Google.Ads.Googleads.V13.Common.ShoppingLoyalty,
  ...
  field :event_attribute, 10,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.EventAttribute,
...
defmodule Google.Ads.Googleads.V13.Common.EventAttribute do
  ...
  field :item_attribute, 3,
    repeated: true,
    type: Google.Ads.Googleads.V13.Common.EventItemAttribute,
    json_name: "itemAttribute",
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V13.Common.StoreSalesMetadata do
  ...
  field :third_party_metadata, 3,
    type: Google.Ads.Googleads.V13.Common.StoreSalesThirdPartyMetadata,
