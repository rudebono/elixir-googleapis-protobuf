defmodule Google.Ads.Googleads.V13.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.CampaignDraftErrorEnum do
  @moduledoc false
