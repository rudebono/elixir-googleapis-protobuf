defmodule Google.Ads.Googleads.V13.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.CustomInterestErrorEnum do
  @moduledoc false
