defmodule Google.Ads.Googleads.V13.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.AuthorizationErrorEnum do
  @moduledoc false
