defmodule Google.Ads.Googleads.V13.Errors.OperationAccessDeniedErrorEnum.OperationAccessDeniedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.OperationAccessDeniedErrorEnum do
  @moduledoc false
