defmodule Google.Ads.Googleads.V13.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
