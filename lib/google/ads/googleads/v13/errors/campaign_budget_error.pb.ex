defmodule Google.Ads.Googleads.V13.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
