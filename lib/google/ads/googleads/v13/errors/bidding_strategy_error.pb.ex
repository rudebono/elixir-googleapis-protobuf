defmodule Google.Ads.Googleads.V13.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
