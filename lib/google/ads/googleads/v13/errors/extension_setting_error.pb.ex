defmodule Google.Ads.Googleads.V13.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
