defmodule Google.Ads.Googleads.V13.Errors.ConversionValueRuleErrorEnum.ConversionValueRuleError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Errors.ConversionValueRuleErrorEnum do
  @moduledoc false
