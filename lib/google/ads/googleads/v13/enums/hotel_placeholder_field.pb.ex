defmodule Google.Ads.Googleads.V13.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
