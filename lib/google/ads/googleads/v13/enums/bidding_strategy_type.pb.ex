defmodule Google.Ads.Googleads.V13.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V13.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
