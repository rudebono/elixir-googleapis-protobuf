defmodule Google.Ads.Googleads.V13.Services.SuggestTravelAssetsRequest do
  ...
  field :place_id, 3, repeated: true, type: :string, json_name: "placeId"
end
...
defmodule Google.Ads.Googleads.V13.Services.SuggestTravelAssetsResponse do
  ...
  field :hotel_asset_suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.HotelAssetSuggestion,
...
defmodule Google.Ads.Googleads.V13.Services.HotelAssetSuggestion do
  ...
  field :text_assets, 5,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.HotelTextAsset,
    json_name: "textAssets"

  field :image_assets, 6,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.HotelImageAsset,
    json_name: "imageAssets"

  field :status, 7,
    type:
      Google.Ads.Googleads.V13.Enums.HotelAssetSuggestionStatusEnum.HotelAssetSuggestionStatus,
    enum: true
end
...
defmodule Google.Ads.Googleads.V13.Services.TravelAssetSuggestionService.Service do
  ...
  rpc :SuggestTravelAssets,
      ...
      Google.Ads.Googleads.V13.Services.SuggestTravelAssetsResponse
end
