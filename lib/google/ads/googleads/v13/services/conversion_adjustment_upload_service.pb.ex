defmodule Google.Ads.Googleads.V13.Services.UploadConversionAdjustmentsRequest do
  ...
  field :conversion_adjustments, 2,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.ConversionAdjustment,
...
defmodule Google.Ads.Googleads.V13.Services.UploadConversionAdjustmentsResponse do
  ...
  field :results, 2,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.ConversionAdjustmentResult
end
...
defmodule Google.Ads.Googleads.V13.Services.ConversionAdjustment do
  ...
  field :adjustment_type, 5,
    type: Google.Ads.Googleads.V13.Enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType,
    json_name: "adjustmentType",
    enum: true

  field :restatement_value, 6,
    type: Google.Ads.Googleads.V13.Services.RestatementValue,
...
defmodule Google.Ads.Googleads.V13.Services.ConversionAdjustmentUploadService.Service do
  ...
  rpc :UploadConversionAdjustments,
      ...
      Google.Ads.Googleads.V13.Services.UploadConversionAdjustmentsResponse
end
