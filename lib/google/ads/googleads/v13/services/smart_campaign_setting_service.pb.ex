...
defmodule Google.Ads.Googleads.V13.Services.SmartCampaignNotEligibleDetails do
  ...
  field :not_eligible_reason, 1,
    ...
    type:
      Google.Ads.Googleads.V13.Enums.SmartCampaignNotEligibleReasonEnum.SmartCampaignNotEligibleReason,
...
defmodule Google.Ads.Googleads.V13.Services.GetSmartCampaignStatusResponse do
  ...
  field :smart_campaign_status, 1,
    type: Google.Ads.Googleads.V13.Enums.SmartCampaignStatusEnum.SmartCampaignStatus,
    json_name: "smartCampaignStatus",
    enum: true

  field :not_eligible_details, 2,
    type: Google.Ads.Googleads.V13.Services.SmartCampaignNotEligibleDetails,
    json_name: "notEligibleDetails",
    oneof: 0

  field :eligible_details, 3,
    type: Google.Ads.Googleads.V13.Services.SmartCampaignEligibleDetails,
    json_name: "eligibleDetails",
    oneof: 0

  field :paused_details, 4,
    type: Google.Ads.Googleads.V13.Services.SmartCampaignPausedDetails,
    json_name: "pausedDetails",
    oneof: 0

  field :removed_details, 5,
    type: Google.Ads.Googleads.V13.Services.SmartCampaignRemovedDetails,
    json_name: "removedDetails",
    oneof: 0

  field :ended_details, 6,
    type: Google.Ads.Googleads.V13.Services.SmartCampaignEndedDetails,
...
defmodule Google.Ads.Googleads.V13.Services.SmartCampaignSettingService.Service do
  ...
  rpc :GetSmartCampaignStatus,
      ...
      Google.Ads.Googleads.V13.Services.GetSmartCampaignStatusResponse

  rpc :MutateSmartCampaignSettings,
      Google.Ads.Googleads.V13.Services.MutateSmartCampaignSettingsRequest,
      Google.Ads.Googleads.V13.Services.MutateSmartCampaignSettingsResponse
end
