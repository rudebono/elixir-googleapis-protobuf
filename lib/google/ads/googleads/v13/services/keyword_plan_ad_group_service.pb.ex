...
defmodule Google.Ads.Googleads.V13.Services.KeywordPlanAdGroupOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V13.Resources.KeywordPlanAdGroup, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V13.Resources.KeywordPlanAdGroup, oneof: 0
...
defmodule Google.Ads.Googleads.V13.Services.KeywordPlanAdGroupService.Service do
  ...
  rpc :MutateKeywordPlanAdGroups,
      ...
      Google.Ads.Googleads.V13.Services.MutateKeywordPlanAdGroupsResponse
end
