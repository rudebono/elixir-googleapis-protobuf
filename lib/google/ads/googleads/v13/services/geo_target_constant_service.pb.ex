...
defmodule Google.Ads.Googleads.V13.Services.SuggestGeoTargetConstantsRequest do
  ...
  field :location_names, 1,
    type: Google.Ads.Googleads.V13.Services.SuggestGeoTargetConstantsRequest.LocationNames,
    json_name: "locationNames",
    oneof: 0

  field :geo_targets, 2,
    type: Google.Ads.Googleads.V13.Services.SuggestGeoTargetConstantsRequest.GeoTargets,
...
defmodule Google.Ads.Googleads.V13.Services.SuggestGeoTargetConstantsResponse do
  ...
  field :geo_target_constant_suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V13.Services.GeoTargetConstantSuggestion,
...
defmodule Google.Ads.Googleads.V13.Services.GeoTargetConstantService.Service do
  ...
  rpc :SuggestGeoTargetConstants,
      ...
      Google.Ads.Googleads.V13.Services.SuggestGeoTargetConstantsResponse
end
