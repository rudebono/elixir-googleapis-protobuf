defmodule Google.Ads.Googleads.V9.Common.TextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Common.ExpandedTextAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.ExpandedDynamicSearchAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.HotelAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V9.Common.ShoppingSmartAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V9.Common.ShoppingProductAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V9.Common.ShoppingComparisonListingAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.GmailAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :teaser, 1, type: Google.Ads.Googleads.V9.Common.GmailTeaser
  ...
  field :marketing_image_display_call_to_action, 6,
    type: Google.Ads.Googleads.V9.Common.DisplayCallToAction,
    json_name: "marketingImageDisplayCallToAction"

  field :product_images, 7,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.ProductImage,
    json_name: "productImages"

  field :product_videos, 8,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.ProductVideo,
    json_name: "productVideos"
end

defmodule Google.Ads.Googleads.V9.Common.GmailTeaser do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.DisplayCallToAction do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.ProductImage do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.ProductVideo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.ImageAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :mime_type, 10,
    type: Google.Ads.Googleads.V9.Enums.MimeTypeEnum.MimeType,
    json_name: "mimeType",
    enum: true
...
defmodule Google.Ads.Googleads.V9.Common.VideoBumperInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :companion_banner, 3,
    type: Google.Ads.Googleads.V9.Common.AdImageAsset,
    json_name: "companionBanner"
end

defmodule Google.Ads.Googleads.V9.Common.VideoNonSkippableInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.VideoTrueViewInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.VideoOutstreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.VideoTrueViewDiscoveryAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :thumbnail, 7,
    type: Google.Ads.Googleads.V9.Enums.VideoThumbnailEnum.VideoThumbnail,
    enum: true
end

defmodule Google.Ads.Googleads.V9.Common.VideoAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  oneof :format, 0

  field :video, 8, type: Google.Ads.Googleads.V9.Common.AdVideoAsset

  field :in_stream, 2,
    type: Google.Ads.Googleads.V9.Common.VideoTrueViewInStreamAdInfo,
    json_name: "inStream",
    oneof: 0

  field :bumper, 3, type: Google.Ads.Googleads.V9.Common.VideoBumperInStreamAdInfo, oneof: 0

  field :out_stream, 4,
    type: Google.Ads.Googleads.V9.Common.VideoOutstreamAdInfo,
    json_name: "outStream",
    oneof: 0

  field :non_skippable, 5,
    type: Google.Ads.Googleads.V9.Common.VideoNonSkippableInStreamAdInfo,
    json_name: "nonSkippable",
    oneof: 0

  field :discovery, 6, type: Google.Ads.Googleads.V9.Common.VideoTrueViewDiscoveryAdInfo, oneof: 0
end

defmodule Google.Ads.Googleads.V9.Common.VideoResponsiveAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset

  field :long_headlines, 2,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.AdTextAsset,
    json_name: "longHeadlines"

  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  ...
  field :videos, 5, repeated: true, type: Google.Ads.Googleads.V9.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V9.Common.ResponsiveSearchAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :path1, 5, proto3_optional: true, type: :string
  field :path2, 6, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V9.Common.LegacyResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :format_setting, 13,
    type: Google.Ads.Googleads.V9.Enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting,
...
defmodule Google.Ads.Googleads.V9.Common.AppAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 2, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :images, 4, repeated: true, type: Google.Ads.Googleads.V9.Common.AdImageAsset

  field :youtube_videos, 5,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.AdVideoAsset,
    json_name: "youtubeVideos"

  field :html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.AdMediaBundleAsset,
    json_name: "html5MediaBundles"
end

defmodule Google.Ads.Googleads.V9.Common.AppEngagementAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  field :images, 3, repeated: true, type: Google.Ads.Googleads.V9.Common.AdImageAsset
  field :videos, 4, repeated: true, type: Google.Ads.Googleads.V9.Common.AdVideoAsset
end

defmodule Google.Ads.Googleads.V9.Common.AppPreRegistrationAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.LegacyAppInstallAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :app_store, 2,
    type: Google.Ads.Googleads.V9.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V9.Common.ResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset

  field :long_headline, 6,
    type: Google.Ads.Googleads.V9.Common.AdTextAsset,
    json_name: "longHeadline"

  field :descriptions, 7, repeated: true, type: Google.Ads.Googleads.V9.Common.AdTextAsset
  ...
  field :control_spec, 24,
    type: Google.Ads.Googleads.V9.Common.ResponsiveDisplayAdControlSpec,
    json_name: "controlSpec"
end

defmodule Google.Ads.Googleads.V9.Common.LocalAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :videos, 6, repeated: true, type: Google.Ads.Googleads.V9.Common.AdVideoAsset
  field :path1, 9, proto3_optional: true, type: :string
  field :path2, 10, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V9.Common.DisplayUploadAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :display_upload_product_type, 1,
    type: Google.Ads.Googleads.V9.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType,
...
defmodule Google.Ads.Googleads.V9.Common.ResponsiveDisplayAdControlSpec do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.SmartCampaignAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.CallAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
