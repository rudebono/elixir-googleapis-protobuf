defmodule Google.Ads.Googleads.V9.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Common.MediaBundleAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.ImageAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :full_size, 4, type: Google.Ads.Googleads.V9.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V9.Common.ImageDimension do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.TextAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.LeadFormAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V9.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V9.Common.LeadFormField

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.LeadFormDeliveryMethod,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V9.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V9.Common.LeadFormField do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :input_type, 1,
    type: Google.Ads.Googleads.V9.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V9.Common.LeadFormSingleChoiceAnswers,
    json_name: "singleChoiceAnswers",
    oneof: 0
end

defmodule Google.Ads.Googleads.V9.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.LeadFormDeliveryMethod do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  oneof :delivery_details, 0

  field :webhook, 1, type: Google.Ads.Googleads.V9.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V9.Common.WebhookDelivery do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.BookOnGoogleAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V9.Common.PromotionAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :occasion, 9,
    type: Google.Ads.Googleads.V9.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
  ...
  field :money_amount_off, 4,
    type: Google.Ads.Googleads.V9.Common.Money,
...
defmodule Google.Ads.Googleads.V9.Common.CalloutAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.StructuredSnippetAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.SitelinkAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PageFeedAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.DynamicEducationAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.MobileAppAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :app_store, 2,
    type: Google.Ads.Googleads.V9.Enums.MobileAppVendorEnum.MobileAppVendor,
    json_name: "appStore",
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V9.Common.HotelCalloutAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.CallAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PriceAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V9.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V9.Common.PriceOffering do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :header, 1, type: :string, deprecated: false
  field :description, 2, type: :string, deprecated: false
  field :price, 3, type: Google.Ads.Googleads.V9.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V9.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V9.Common.CallToActionAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :call_to_action, 1,
    type: Google.Ads.Googleads.V9.Enums.CallToActionTypeEnum.CallToActionType,
