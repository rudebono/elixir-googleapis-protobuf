defmodule Google.Ads.Googleads.V9.Common.Segments do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :ad_destination_type, 136,
    type: Google.Ads.Googleads.V9.Enums.AdDestinationTypeEnum.AdDestinationType,
    json_name: "adDestinationType",
    enum: true

  field :ad_network_type, 3,
    type: Google.Ads.Googleads.V9.Enums.AdNetworkTypeEnum.AdNetworkType,
    json_name: "adNetworkType",
    enum: true

  field :budget_campaign_association_status, 134,
    type: Google.Ads.Googleads.V9.Common.BudgetCampaignAssociationStatus,
    json_name: "budgetCampaignAssociationStatus"

  field :click_type, 26,
    type: Google.Ads.Googleads.V9.Enums.ClickTypeEnum.ClickType,
    json_name: "clickType",
    enum: true
  ...
  field :conversion_attribution_event_type, 2,
    type:
      Google.Ads.Googleads.V9.Enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType,
    json_name: "conversionAttributionEventType",
    enum: true

  field :conversion_lag_bucket, 50,
    type: Google.Ads.Googleads.V9.Enums.ConversionLagBucketEnum.ConversionLagBucket,
    json_name: "conversionLagBucket",
    enum: true

  field :conversion_or_adjustment_lag_bucket, 51,
    type:
      Google.Ads.Googleads.V9.Enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket,
  ...
  field :external_conversion_source, 55,
    type: Google.Ads.Googleads.V9.Enums.ExternalConversionSourceEnum.ExternalConversionSource,
  ...
  field :hotel_rate_type, 74,
    type: Google.Ads.Googleads.V9.Enums.HotelRateTypeEnum.HotelRateType,
    json_name: "hotelRateType",
    enum: true

  field :hotel_price_bucket, 78,
    type: Google.Ads.Googleads.V9.Enums.HotelPriceBucketEnum.HotelPriceBucket,
  ...
  field :keyword, 61, type: Google.Ads.Googleads.V9.Common.Keyword
  ...
  field :search_engine_results_page_type, 70,
    type:
      Google.Ads.Googleads.V9.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType,
    json_name: "searchEngineResultsPageType",
    enum: true

  field :search_term_match_type, 22,
    type: Google.Ads.Googleads.V9.Enums.SearchTermMatchTypeEnum.SearchTermMatchType,
    json_name: "searchTermMatchType",
    enum: true

  field :slot, 23, type: Google.Ads.Googleads.V9.Enums.SlotEnum.Slot, enum: true

  field :conversion_value_rule_primary_dimension, 138,
    type:
      Google.Ads.Googleads.V9.Enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension,
  ...
  field :asset_interaction_target, 139,
    proto3_optional: true,
    type: Google.Ads.Googleads.V9.Common.AssetInteractionTarget,
    json_name: "assetInteractionTarget"
end

defmodule Google.Ads.Googleads.V9.Common.Keyword do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :info, 2, type: Google.Ads.Googleads.V9.Common.KeywordInfo
end

defmodule Google.Ads.Googleads.V9.Common.BudgetCampaignAssociationStatus do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.AssetInteractionTarget do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
