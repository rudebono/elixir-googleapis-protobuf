defmodule Google.Ads.Googleads.V9.Common.PolicyViolationKey do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Common.PolicyValidationParameter do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :exempt_policy_violation_keys, 2,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.PolicyViolationKey,
    json_name: "exemptPolicyViolationKeys"
end

defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEntry do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :type, 2,
    type: Google.Ads.Googleads.V9.Enums.PolicyTopicEntryTypeEnum.PolicyTopicEntryType,
    enum: true

  field :evidences, 3, repeated: true, type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence

  field :constraints, 4,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicConstraint
end

defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.TextList do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.WebsiteList do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationTextList do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationMismatch do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationNotWorking do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicEvidence do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :website_list, 3,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.WebsiteList,
    json_name: "websiteList",
    oneof: 0

  field :text_list, 4,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.TextList,
    json_name: "textList",
    oneof: 0
  ...
  field :destination_text_list, 6,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationTextList,
    json_name: "destinationTextList",
    oneof: 0

  field :destination_mismatch, 7,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationMismatch,
    json_name: "destinationMismatch",
    oneof: 0

  field :destination_not_working, 8,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicEvidence.DestinationNotWorking,
    json_name: "destinationNotWorking",
    oneof: 0
end

defmodule Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.CountryConstraintList do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :countries, 2,
    repeated: true,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.CountryConstraint
end

defmodule Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.ResellerConstraint do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.CountryConstraint do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V9.Common.PolicyTopicConstraint do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :country_constraint_list, 1,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.CountryConstraintList,
    json_name: "countryConstraintList",
    oneof: 0

  field :reseller_constraint, 2,
    type: Google.Ads.Googleads.V9.Common.PolicyTopicConstraint.ResellerConstraint,
