...
defmodule Google.Ads.Googleads.V9.Services.MutateConversionValueRuleSetsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.ConversionValueRuleSetOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.ConversionValueRuleSetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.ConversionValueRuleSet.t() | nil}
            | {:update, Google.Ads.Googleads.V9.Resources.ConversionValueRuleSet.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V9.Services.MutateConversionValueRuleSetsResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V9.Services.MutateConversionValueRuleSetResult.t()],
