...
defmodule Google.Ads.Googleads.V9.Services.MutateAdParametersRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.AdParameterOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.AdParameterOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.AdParameter.t() | nil}
            | {:update, Google.Ads.Googleads.V9.Resources.AdParameter.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V9.Resources.AdParameter, oneof: 0
...
defmodule Google.Ads.Googleads.V9.Services.MutateAdParametersResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V9.Services.MutateAdParameterResult.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.AdParameterService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.AdParameterService"

  rpc :GetAdParameter,
      Google.Ads.Googleads.V9.Services.GetAdParameterRequest,
      Google.Ads.Googleads.V9.Resources.AdParameter

  rpc :MutateAdParameters,
      Google.Ads.Googleads.V9.Services.MutateAdParametersRequest,
      Google.Ads.Googleads.V9.Services.MutateAdParametersResponse
end

defmodule Google.Ads.Googleads.V9.Services.AdParameterService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V9.Services.AdParameterService.Service
end
