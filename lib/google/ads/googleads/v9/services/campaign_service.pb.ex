...
defmodule Google.Ads.Googleads.V9.Services.MutateCampaignsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.CampaignOperation.t()],
  ...
  field :operations, 2, repeated: true, type: Google.Ads.Googleads.V9.Services.CampaignOperation
...
defmodule Google.Ads.Googleads.V9.Services.CampaignOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.Campaign.t() | nil}
            | {:update, Google.Ads.Googleads.V9.Resources.Campaign.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V9.Services.MutateCampaignsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V9.Services.MutateCampaignResult.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.CampaignService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.CampaignService"
