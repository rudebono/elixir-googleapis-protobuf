...
defmodule Google.Ads.Googleads.V9.Services.MutateKeywordPlanAdGroupKeywordsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.KeywordPlanAdGroupKeywordOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.KeywordPlanAdGroupKeywordOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.KeywordPlanAdGroupKeyword.t() | nil}
            | {:update, Google.Ads.Googleads.V9.Resources.KeywordPlanAdGroupKeyword.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V9.Services.MutateKeywordPlanAdGroupKeywordsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V9.Services.MutateKeywordPlanAdGroupKeywordResult.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.KeywordPlanAdGroupKeywordService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.KeywordPlanAdGroupKeywordService"
