...
defmodule Google.Ads.Googleads.V9.Services.MutateAdGroupAdLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.AdGroupAdLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.AdGroupAdLabelOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.AdGroupAdLabel.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V9.Services.MutateAdGroupAdLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V9.Services.MutateAdGroupAdLabelResult.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.AdGroupAdLabelService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.AdGroupAdLabelService"
