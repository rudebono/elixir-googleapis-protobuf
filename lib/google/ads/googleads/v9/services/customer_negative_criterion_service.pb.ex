...
defmodule Google.Ads.Googleads.V9.Services.MutateCustomerNegativeCriteriaRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.CustomerNegativeCriterionOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.CustomerNegativeCriterionOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.CustomerNegativeCriterion.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V9.Services.MutateCustomerNegativeCriteriaResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V9.Services.MutateCustomerNegativeCriteriaResult.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.CustomerNegativeCriterionService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.CustomerNegativeCriterionService"
  ...
  rpc :MutateCustomerNegativeCriteria,
      Google.Ads.Googleads.V9.Services.MutateCustomerNegativeCriteriaRequest,
      Google.Ads.Googleads.V9.Services.MutateCustomerNegativeCriteriaResponse
end

defmodule Google.Ads.Googleads.V9.Services.CustomerNegativeCriterionService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Ads.Googleads.V9.Services.CustomerNegativeCriterionService.Service
end
