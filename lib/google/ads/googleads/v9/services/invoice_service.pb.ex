defmodule Google.Ads.Googleads.V9.Services.ListInvoicesRequest do
  ...
  @type t :: %__MODULE__{
          ...
          issue_year: String.t(),
          issue_month: Google.Ads.Googleads.V9.Enums.MonthOfYearEnum.MonthOfYear.t()
        }
...
defmodule Google.Ads.Googleads.V9.Services.ListInvoicesResponse do
  ...
  @type t :: %__MODULE__{
          invoices: [Google.Ads.Googleads.V9.Resources.Invoice.t()]
        }
...
defmodule Google.Ads.Googleads.V9.Services.InvoiceService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v9.services.InvoiceService"
