...
defmodule Google.Ads.Googleads.V9.Services.MutateAssetsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V9.Services.AssetOperation.t()],
...
defmodule Google.Ads.Googleads.V9.Services.AssetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V9.Resources.Asset.t() | nil}
            | {:update, Google.Ads.Googleads.V9.Resources.Asset.t() | nil},
...
defmodule Google.Ads.Googleads.V9.Services.AssetService.Service do
  ...
  rpc :GetAsset,
      ...
      Google.Ads.Googleads.V9.Resources.Asset

  rpc :MutateAssets,
      Google.Ads.Googleads.V9.Services.MutateAssetsRequest,
      Google.Ads.Googleads.V9.Services.MutateAssetsResponse
end

defmodule Google.Ads.Googleads.V9.Services.AssetService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V9.Services.AssetService.Service
end
