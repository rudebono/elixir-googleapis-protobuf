defmodule Google.Ads.Googleads.V9.Resources.SharedSet do
  @moduledoc false
  ...
  field :type, 3,
    type: Google.Ads.Googleads.V9.Enums.SharedSetTypeEnum.SharedSetType,
    enum: true,
    deprecated: false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V9.Enums.SharedSetStatusEnum.SharedSetStatus,
    enum: true,
    deprecated: false
