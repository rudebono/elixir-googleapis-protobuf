defmodule Google.Ads.Googleads.V9.Resources.CustomAudience do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          id: integer,
          status: Google.Ads.Googleads.V9.Enums.CustomAudienceStatusEnum.CustomAudienceStatus.t(),
          name: String.t(),
          type: Google.Ads.Googleads.V9.Enums.CustomAudienceTypeEnum.CustomAudienceType.t(),
  ...
  field :type, 5,
    type: Google.Ads.Googleads.V9.Enums.CustomAudienceTypeEnum.CustomAudienceType,
    enum: true
