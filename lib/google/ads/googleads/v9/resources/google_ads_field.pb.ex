defmodule Google.Ads.Googleads.V9.Resources.GoogleAdsField do
  @moduledoc false
  ...
  field :category, 3,
    type: Google.Ads.Googleads.V9.Enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory,
    enum: true,
    deprecated: false
  ...
  field :data_type, 12,
    type: Google.Ads.Googleads.V9.Enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType,
    json_name: "dataType",
    enum: true,
    deprecated: false
