defmodule Google.Ads.Googleads.V9.Resources.AssetGroup do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V9.Enums.AssetGroupStatusEnum.AssetGroupStatus.t(),
          path1: String.t(),
          path2: String.t()
        }
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V9.Enums.AssetGroupStatusEnum.AssetGroupStatus,
    enum: true
