defmodule Google.Ads.Googleads.V9.Resources.Invoice.AccountBudgetSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Resources.Invoice do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :type, 3,
    type: Google.Ads.Googleads.V9.Enums.InvoiceTypeEnum.InvoiceType,
    enum: true,
    deprecated: false
  ...
  field :account_budget_summaries, 18,
    repeated: true,
    type: Google.Ads.Googleads.V9.Resources.Invoice.AccountBudgetSummary,
