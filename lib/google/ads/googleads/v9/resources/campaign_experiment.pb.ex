defmodule Google.Ads.Googleads.V9.Resources.CampaignExperiment do
  @moduledoc false
  ...
  field :traffic_split_type, 7,
    type:
      Google.Ads.Googleads.V9.Enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType,
  ...
  field :status, 9,
    type: Google.Ads.Googleads.V9.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus,
    enum: true,
    deprecated: false
