defmodule Google.Ads.Googleads.V9.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V9.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
