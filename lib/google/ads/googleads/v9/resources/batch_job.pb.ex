defmodule Google.Ads.Googleads.V9.Resources.BatchJob.BatchJobMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Resources.BatchJob do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :metadata, 4,
    type: Google.Ads.Googleads.V9.Resources.BatchJob.BatchJobMetadata,
    deprecated: false

  field :status, 5,
    type: Google.Ads.Googleads.V9.Enums.BatchJobStatusEnum.BatchJobStatus,
    enum: true,
    deprecated: false
