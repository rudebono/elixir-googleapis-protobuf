defmodule Google.Ads.Googleads.V9.Resources.CampaignSimulation do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          point_list:
            {:cpc_bid_point_list,
             Google.Ads.Googleads.V9.Common.CpcBidSimulationPointList.t() | nil}
            ...
            | {:target_impression_share_point_list,
               Google.Ads.Googleads.V9.Common.TargetImpressionShareSimulationPointList.t() | nil}
            | {:budget_point_list,
               Google.Ads.Googleads.V9.Common.BudgetSimulationPointList.t() | nil},
  ...
  field :cpc_bid_point_list, 7,
    type: Google.Ads.Googleads.V9.Common.CpcBidSimulationPointList,
  ...
  field :target_impression_share_point_list, 10,
    type: Google.Ads.Googleads.V9.Common.TargetImpressionShareSimulationPointList,
    json_name: "targetImpressionSharePointList",
    oneof: 0

  field :budget_point_list, 11,
    type: Google.Ads.Googleads.V9.Common.BudgetSimulationPointList,
