defmodule Google.Ads.Googleads.V9.Resources.AdGroupAd do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V9.Enums.AdGroupAdStatusEnum.AdGroupAdStatus,
    enum: true
  ...
  field :ad, 5, type: Google.Ads.Googleads.V9.Resources.Ad, deprecated: false

  field :policy_summary, 6,
    type: Google.Ads.Googleads.V9.Resources.AdGroupAdPolicySummary,
    json_name: "policySummary",
    deprecated: false

  field :ad_strength, 7,
    type: Google.Ads.Googleads.V9.Enums.AdStrengthEnum.AdStrength,
...
defmodule Google.Ads.Googleads.V9.Resources.AdGroupAdPolicySummary do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
