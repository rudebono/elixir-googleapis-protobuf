defmodule Google.Ads.Googleads.V9.Enums.FlightPlaceholderFieldEnum.FlightPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Enums.FlightPlaceholderFieldEnum do
  @moduledoc false
