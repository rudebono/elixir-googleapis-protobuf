defmodule Google.Ads.Googleads.V9.Enums.JobPlaceholderFieldEnum.JobPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Enums.JobPlaceholderFieldEnum do
  @moduledoc false
