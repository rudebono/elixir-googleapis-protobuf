defmodule Google.Ads.Googleads.V9.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V9.Errors.CampaignDraftErrorEnum do
  @moduledoc false
