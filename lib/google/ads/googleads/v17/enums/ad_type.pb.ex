defmodule Google.Ads.Googleads.V17.Enums.AdTypeEnum.AdType do
  @moduledoc false
  ...
  field :DEMAND_GEN_MULTI_ASSET_AD, 40
  field :DEMAND_GEN_CAROUSEL_AD, 41
  field :TRAVEL_AD, 37
  field :DEMAND_GEN_VIDEO_RESPONSIVE_AD, 42
  field :DEMAND_GEN_PRODUCT_AD, 39
end

defmodule Google.Ads.Googleads.V17.Enums.AdTypeEnum do
  @moduledoc false
