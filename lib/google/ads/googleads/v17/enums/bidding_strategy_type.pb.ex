defmodule Google.Ads.Googleads.V17.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
