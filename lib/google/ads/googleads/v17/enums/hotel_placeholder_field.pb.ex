defmodule Google.Ads.Googleads.V17.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
