defmodule Google.Ads.Googleads.V17.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Errors.CampaignFeedErrorEnum do
  @moduledoc false
