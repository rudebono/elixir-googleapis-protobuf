defmodule Google.Ads.Googleads.V17.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Errors.CampaignDraftErrorEnum do
  @moduledoc false
