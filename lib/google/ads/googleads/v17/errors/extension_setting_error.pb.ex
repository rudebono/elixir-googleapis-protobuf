defmodule Google.Ads.Googleads.V17.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
