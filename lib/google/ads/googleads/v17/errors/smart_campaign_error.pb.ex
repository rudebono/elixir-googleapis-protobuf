defmodule Google.Ads.Googleads.V17.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Errors.SmartCampaignErrorEnum do
  @moduledoc false
