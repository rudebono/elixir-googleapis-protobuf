defmodule Google.Ads.Googleads.V17.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Errors.CustomInterestErrorEnum do
  @moduledoc false
