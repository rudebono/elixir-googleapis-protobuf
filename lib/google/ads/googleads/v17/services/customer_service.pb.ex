...
defmodule Google.Ads.Googleads.V17.Services.CustomerService.Service do
  @moduledoc false
  ...
  rpc :MutateCustomer,
      ...
      Google.Ads.Googleads.V17.Services.MutateCustomerResponse

  rpc :ListAccessibleCustomers,
      Google.Ads.Googleads.V17.Services.ListAccessibleCustomersRequest,
      Google.Ads.Googleads.V17.Services.ListAccessibleCustomersResponse

  rpc :CreateCustomerClient,
      Google.Ads.Googleads.V17.Services.CreateCustomerClientRequest,
      Google.Ads.Googleads.V17.Services.CreateCustomerClientResponse
end

defmodule Google.Ads.Googleads.V17.Services.CustomerService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V17.Services.CustomerService.Service
end
