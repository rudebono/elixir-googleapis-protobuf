...
defmodule Google.Ads.Googleads.V17.Services.KeywordPlanAdGroupKeywordOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V17.Resources.KeywordPlanAdGroupKeyword, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V17.Resources.KeywordPlanAdGroupKeyword, oneof: 0
...
defmodule Google.Ads.Googleads.V17.Services.KeywordPlanAdGroupKeywordService.Service do
  @moduledoc false
  ...
  rpc :MutateKeywordPlanAdGroupKeywords,
      ...
      Google.Ads.Googleads.V17.Services.MutateKeywordPlanAdGroupKeywordsResponse
end

defmodule Google.Ads.Googleads.V17.Services.KeywordPlanAdGroupKeywordService.Stub do
  @moduledoc false

  use GRPC.Stub,
    service: Google.Ads.Googleads.V17.Services.KeywordPlanAdGroupKeywordService.Service
end
