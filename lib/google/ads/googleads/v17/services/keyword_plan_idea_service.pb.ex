defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordIdeasRequest do
  @moduledoc false
  ...
  field :keyword_annotation, 17,
    repeated: true,
    type:
      Google.Ads.Googleads.V17.Enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation,
  ...
  field :keyword_and_url_seed, 2,
    type: Google.Ads.Googleads.V17.Services.KeywordAndUrlSeed,
    json_name: "keywordAndUrlSeed",
    oneof: 0

  field :keyword_seed, 3,
    type: Google.Ads.Googleads.V17.Services.KeywordSeed,
    json_name: "keywordSeed",
    oneof: 0

  field :url_seed, 5,
    type: Google.Ads.Googleads.V17.Services.UrlSeed,
    json_name: "urlSeed",
    oneof: 0

  field :site_seed, 11,
    type: Google.Ads.Googleads.V17.Services.SiteSeed,
    json_name: "siteSeed",
    oneof: 0
end

defmodule Google.Ads.Googleads.V17.Services.KeywordAndUrlSeed do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.KeywordSeed do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.SiteSeed do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.UrlSeed do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordIdeaResponse do
  @moduledoc false
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.GenerateKeywordIdeaResult
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordIdeaResult do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsResponse do
  @moduledoc false
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsResult
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsResult do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateAdGroupThemesRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateAdGroupThemesResponse do
  @moduledoc false
  ...
  field :ad_group_keyword_suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.AdGroupKeywordSuggestion,
    json_name: "adGroupKeywordSuggestions"

  field :unusable_ad_groups, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.UnusableAdGroup,
    json_name: "unusableAdGroups"
end

defmodule Google.Ads.Googleads.V17.Services.AdGroupKeywordSuggestion do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.UnusableAdGroup do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordForecastMetricsRequest do
  @moduledoc false
  ...
  field :campaign, 4,
    type: Google.Ads.Googleads.V17.Services.CampaignToForecast,
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Services.CampaignToForecast.CampaignBiddingStrategy do
  @moduledoc false
  ...
  field :manual_cpc_bidding_strategy, 1,
    type: Google.Ads.Googleads.V17.Services.ManualCpcBiddingStrategy,
    json_name: "manualCpcBiddingStrategy",
    oneof: 0

  field :maximize_clicks_bidding_strategy, 2,
    type: Google.Ads.Googleads.V17.Services.MaximizeClicksBiddingStrategy,
    json_name: "maximizeClicksBiddingStrategy",
    oneof: 0

  field :maximize_conversions_bidding_strategy, 3,
    type: Google.Ads.Googleads.V17.Services.MaximizeConversionsBiddingStrategy,
    json_name: "maximizeConversionsBiddingStrategy",
    oneof: 0
end

defmodule Google.Ads.Googleads.V17.Services.CampaignToForecast do
  @moduledoc false
  ...
  field :geo_modifiers, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.CriterionBidModifier,
  ...
  field :bidding_strategy, 5,
    type: Google.Ads.Googleads.V17.Services.CampaignToForecast.CampaignBiddingStrategy,
  ...
  field :ad_groups, 7,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.ForecastAdGroup,
    json_name: "adGroups"
end

defmodule Google.Ads.Googleads.V17.Services.ForecastAdGroup do
  @moduledoc false
  ...
  field :biddable_keywords, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.BiddableKeyword,
...
defmodule Google.Ads.Googleads.V17.Services.BiddableKeyword do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.CriterionBidModifier do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.ManualCpcBiddingStrategy do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.MaximizeClicksBiddingStrategy do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.MaximizeConversionsBiddingStrategy do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateKeywordForecastMetricsResponse do
  @moduledoc false
  ...
  field :campaign_forecast_metrics, 1,
    proto3_optional: true,
    type: Google.Ads.Googleads.V17.Services.KeywordForecastMetrics,
    json_name: "campaignForecastMetrics"
end

defmodule Google.Ads.Googleads.V17.Services.KeywordForecastMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.KeywordPlanIdeaService.Service do
  @moduledoc false
  ...
  rpc :GenerateKeywordIdeas,
      Google.Ads.Googleads.V17.Services.GenerateKeywordIdeasRequest,
      Google.Ads.Googleads.V17.Services.GenerateKeywordIdeaResponse

  rpc :GenerateKeywordHistoricalMetrics,
      Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsRequest,
      Google.Ads.Googleads.V17.Services.GenerateKeywordHistoricalMetricsResponse

  rpc :GenerateAdGroupThemes,
      Google.Ads.Googleads.V17.Services.GenerateAdGroupThemesRequest,
      Google.Ads.Googleads.V17.Services.GenerateAdGroupThemesResponse

  rpc :GenerateKeywordForecastMetrics,
      Google.Ads.Googleads.V17.Services.GenerateKeywordForecastMetricsRequest,
      Google.Ads.Googleads.V17.Services.GenerateKeywordForecastMetricsResponse
end

defmodule Google.Ads.Googleads.V17.Services.KeywordPlanIdeaService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V17.Services.KeywordPlanIdeaService.Service
end