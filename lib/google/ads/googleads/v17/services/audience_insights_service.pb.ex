defmodule Google.Ads.Googleads.V17.Services.GenerateInsightsFinderReportRequest do
  @moduledoc false
  ...
  field :baseline_audience, 2,
    type: Google.Ads.Googleads.V17.Services.BasicInsightsAudience,
...
defmodule Google.Ads.Googleads.V17.Services.GenerateInsightsFinderReportResponse do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateAudienceCompositionInsightsRequest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :customer_id, 1, type: :string, json_name: "customerId", deprecated: false
  field :audience, 2, type: Google.Ads.Googleads.V17.Services.InsightsAudience, deprecated: false

  field :baseline_audience, 6,
    type: Google.Ads.Googleads.V17.Services.InsightsAudience,
    json_name: "baselineAudience"
...
defmodule Google.Ads.Googleads.V17.Services.GenerateAudienceCompositionInsightsResponse do
  @moduledoc false
  ...
  field :sections, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.AudienceCompositionSection
end

defmodule Google.Ads.Googleads.V17.Services.GenerateSuggestedTargetingInsightsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.GenerateSuggestedTargetingInsightsResponse do
  @moduledoc false
  ...
  field :suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.TargetingSuggestionMetrics
end

defmodule Google.Ads.Googleads.V17.Services.TargetingSuggestionMetrics do
  @moduledoc false
  ...
  field :gender, 3, type: Google.Ads.Googleads.V17.Common.GenderInfo
...
defmodule Google.Ads.Googleads.V17.Services.ListAudienceInsightsAttributesRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.ListInsightsEligibleDatesRequest do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V17.Services.ListInsightsEligibleDatesResponse do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsAttribute do
  ...
  field :gender, 2, type: Google.Ads.Googleads.V17.Common.GenderInfo, oneof: 0
  field :location, 3, type: Google.Ads.Googleads.V17.Common.LocationInfo, oneof: 0
  ...
  field :entity, 5, type: Google.Ads.Googleads.V17.Services.AudienceInsightsEntity, oneof: 0
  field :category, 6, type: Google.Ads.Googleads.V17.Services.AudienceInsightsCategory, oneof: 0

  field :dynamic_lineup, 7,
    type: Google.Ads.Googleads.V17.Services.AudienceInsightsDynamicLineup,
...
defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsTopic do
  @moduledoc false
  ...
  field :entity, 1, type: Google.Ads.Googleads.V17.Services.AudienceInsightsEntity, oneof: 0
  field :category, 2, type: Google.Ads.Googleads.V17.Services.AudienceInsightsCategory, oneof: 0
end

defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsEntity do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsDynamicLineup do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.BasicInsightsAudience do
  @moduledoc false
  ...
  field :topics, 6, repeated: true, type: Google.Ads.Googleads.V17.Services.AudienceInsightsTopic
end

defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsAttributeMetadata do
  @moduledoc false
  ...
  field :dynamic_attribute_metadata, 7,
    type: Google.Ads.Googleads.V17.Services.DynamicLineupAttributeMetadata,
    json_name: "dynamicAttributeMetadata",
    oneof: 0

  field :location_attribute_metadata, 8,
    type: Google.Ads.Googleads.V17.Services.LocationAttributeMetadata,
    json_name: "locationAttributeMetadata",
    oneof: 0
end

defmodule Google.Ads.Googleads.V17.Services.YouTubeChannelAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.DynamicLineupAttributeMetadata.SampleChannel do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.DynamicLineupAttributeMetadata do
  @moduledoc false
  ...
  field :sample_channels, 5,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.DynamicLineupAttributeMetadata.SampleChannel,
    json_name: "sampleChannels"
end

defmodule Google.Ads.Googleads.V17.Services.LocationAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.InsightsAudience do
  @moduledoc false
  ...
  field :topic_audience_combinations, 8,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.InsightsAudienceAttributeGroup,
    json_name: "topicAudienceCombinations"
end

defmodule Google.Ads.Googleads.V17.Services.InsightsAudienceAttributeGroup do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.AudienceCompositionSection do
  @moduledoc false
  ...
  field :top_attributes, 3,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.AudienceCompositionAttribute,
    json_name: "topAttributes"

  field :clustered_attributes, 4,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.AudienceCompositionAttributeCluster,
    json_name: "clusteredAttributes"
end

defmodule Google.Ads.Googleads.V17.Services.AudienceCompositionAttributeCluster do
  @moduledoc false
  ...
  field :cluster_metrics, 3,
    type: Google.Ads.Googleads.V17.Services.AudienceCompositionMetrics,
...
defmodule Google.Ads.Googleads.V17.Services.AudienceCompositionMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Services.AudienceCompositionAttribute do
  @moduledoc false
  ...
  field :metrics, 2, type: Google.Ads.Googleads.V17.Services.AudienceCompositionMetrics
end

defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsService.Service do
  @moduledoc false
  ...
  rpc :GenerateInsightsFinderReport,
      Google.Ads.Googleads.V17.Services.GenerateInsightsFinderReportRequest,
      Google.Ads.Googleads.V17.Services.GenerateInsightsFinderReportResponse

  rpc :ListAudienceInsightsAttributes,
      Google.Ads.Googleads.V17.Services.ListAudienceInsightsAttributesRequest,
      Google.Ads.Googleads.V17.Services.ListAudienceInsightsAttributesResponse

  rpc :ListInsightsEligibleDates,
      Google.Ads.Googleads.V17.Services.ListInsightsEligibleDatesRequest,
      Google.Ads.Googleads.V17.Services.ListInsightsEligibleDatesResponse

  rpc :GenerateAudienceCompositionInsights,
      Google.Ads.Googleads.V17.Services.GenerateAudienceCompositionInsightsRequest,
      Google.Ads.Googleads.V17.Services.GenerateAudienceCompositionInsightsResponse
...
defmodule Google.Ads.Googleads.V17.Services.AudienceInsightsService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V17.Services.AudienceInsightsService.Service
end