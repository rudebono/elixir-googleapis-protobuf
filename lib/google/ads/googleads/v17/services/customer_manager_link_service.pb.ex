defmodule Google.Ads.Googleads.V17.Services.MutateCustomerManagerLinkRequest do
  ...
  field :operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.CustomerManagerLinkOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V17.Services.CustomerManagerLinkOperation do
  ...
  field :update, 2, type: Google.Ads.Googleads.V17.Resources.CustomerManagerLink, oneof: 0
end
...
defmodule Google.Ads.Googleads.V17.Services.MutateCustomerManagerLinkResponse do
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Services.MutateCustomerManagerLinkResult
end
...
defmodule Google.Ads.Googleads.V17.Services.CustomerManagerLinkService.Service do
  @moduledoc false
  ...
  rpc :MutateCustomerManagerLink,
      ...
      Google.Ads.Googleads.V17.Services.MutateCustomerManagerLinkResponse

  rpc :MoveManagerLink,
      Google.Ads.Googleads.V17.Services.MoveManagerLinkRequest,
      Google.Ads.Googleads.V17.Services.MoveManagerLinkResponse
end

defmodule Google.Ads.Googleads.V17.Services.CustomerManagerLinkService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V17.Services.CustomerManagerLinkService.Service
end