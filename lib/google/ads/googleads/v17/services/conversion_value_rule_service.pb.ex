...
defmodule Google.Ads.Googleads.V17.Services.ConversionValueRuleOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V17.Resources.ConversionValueRule, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V17.Resources.ConversionValueRule, oneof: 0
...
defmodule Google.Ads.Googleads.V17.Services.ConversionValueRuleService.Service do
  @moduledoc false
  ...
  rpc :MutateConversionValueRules,
      ...
      Google.Ads.Googleads.V17.Services.MutateConversionValueRulesResponse
end

defmodule Google.Ads.Googleads.V17.Services.ConversionValueRuleService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V17.Services.ConversionValueRuleService.Service
end