defmodule Google.Ads.Googleads.V17.Resources.AccountLink do
  @moduledoc false
  ...
  field :third_party_app_analytics, 5,
    type: Google.Ads.Googleads.V17.Resources.ThirdPartyAppAnalyticsLinkIdentifier,
    json_name: "thirdPartyAppAnalytics",
    oneof: 0,
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.ThirdPartyAppAnalyticsLinkIdentifier do
  @moduledoc false
