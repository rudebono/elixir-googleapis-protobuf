defmodule Google.Ads.Googleads.V17.Resources.LocalServicesEmployee do
  ...
  field :status, 4,
    type:
      Google.Ads.Googleads.V17.Enums.LocalServicesEmployeeStatusEnum.LocalServicesEmployeeStatus,
    enum: true,
    deprecated: false
  ...
  field :university_degrees, 6,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.UniversityDegree,
    json_name: "universityDegrees",
    deprecated: false

  field :residencies, 7,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Residency,
    deprecated: false

  field :fellowships, 8,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Fellowship,
    deprecated: false
