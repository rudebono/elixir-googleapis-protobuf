defmodule Google.Ads.Googleads.V17.Resources.ConversionValueRuleSet do
  @moduledoc false
  ...
  field :status, 8,
    type:
      Google.Ads.Googleads.V17.Enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus,
    enum: true,
    deprecated: false
