defmodule Google.Ads.Googleads.V17.Resources.ProductLinkInvitation do
  @moduledoc false
  ...
  field :hotel_center, 4,
    type: Google.Ads.Googleads.V17.Resources.HotelCenterLinkInvitationIdentifier,
    json_name: "hotelCenter",
    oneof: 0,
    deprecated: false

  field :merchant_center, 5,
    type: Google.Ads.Googleads.V17.Resources.MerchantCenterLinkInvitationIdentifier,
    json_name: "merchantCenter",
    oneof: 0,
    deprecated: false

  field :advertising_partner, 7,
    type: Google.Ads.Googleads.V17.Resources.AdvertisingPartnerLinkInvitationIdentifier,
    json_name: "advertisingPartner",
    oneof: 0,
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.HotelCenterLinkInvitationIdentifier do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.MerchantCenterLinkInvitationIdentifier do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.AdvertisingPartnerLinkInvitationIdentifier do
  @moduledoc false
