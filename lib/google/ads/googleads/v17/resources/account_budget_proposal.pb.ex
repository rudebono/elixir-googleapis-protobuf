defmodule Google.Ads.Googleads.V17.Resources.AccountBudgetProposal do
  @moduledoc false
  ...
  field :status, 15,
    type:
      Google.Ads.Googleads.V17.Enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus,
    enum: true,
    deprecated: false
