defmodule Google.Ads.Googleads.V17.Resources.Campaign.PerformanceMaxUpgrade do
  @moduledoc false
  ...
  field :status, 3,
    type:
      Google.Ads.Googleads.V17.Enums.PerformanceMaxUpgradeStatusEnum.PerformanceMaxUpgradeStatus,
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.Campaign.NetworkSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.HotelSettingInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.DynamicSearchAdsSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.ShoppingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.TrackingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.GeoTargetTypeSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.LocalCampaignSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.AppCampaignSetting do
  @moduledoc false
  ...
  field :bidding_strategy_goal_type, 1,
    type:
      Google.Ads.Googleads.V17.Enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType,
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.VanityPharma do
  @moduledoc false
  ...
  field :vanity_pharma_display_url_mode, 1,
    type:
      Google.Ads.Googleads.V17.Enums.VanityPharmaDisplayUrlModeEnum.VanityPharmaDisplayUrlMode,
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.SelectiveOptimization do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.OptimizationGoalSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.LocalServicesCampaignSettings do
  @moduledoc false
  ...
  field :category_bids, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Campaign.CategoryBid,
    json_name: "categoryBids"
end

defmodule Google.Ads.Googleads.V17.Resources.Campaign.CategoryBid do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.TravelCampaignSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign.DemandGenCampaignSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Campaign do
  @moduledoc false
  ...
  field :primary_status_reasons, 82,
    repeated: true,
    type:
      Google.Ads.Googleads.V17.Enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason,
  ...
  field :bidding_strategy_system_status, 78,
    type:
      Google.Ads.Googleads.V17.Enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus,
  ...
  field :ad_serving_optimization_status, 8,
    type:
      Google.Ads.Googleads.V17.Enums.AdServingOptimizationStatusEnum.AdServingOptimizationStatus,
  ...
  field :local_services_campaign_settings, 75,
    type: Google.Ads.Googleads.V17.Resources.Campaign.LocalServicesCampaignSettings,
    json_name: "localServicesCampaignSettings"

  field :travel_campaign_settings, 85,
    type: Google.Ads.Googleads.V17.Resources.Campaign.TravelCampaignSettings,
  ...
  field :network_settings, 14,
    type: Google.Ads.Googleads.V17.Resources.Campaign.NetworkSettings,
    json_name: "networkSettings"

  field :hotel_setting, 32,
    type: Google.Ads.Googleads.V17.Resources.Campaign.HotelSettingInfo,
    json_name: "hotelSetting",
    deprecated: false

  field :dynamic_search_ads_setting, 33,
    type: Google.Ads.Googleads.V17.Resources.Campaign.DynamicSearchAdsSetting,
    json_name: "dynamicSearchAdsSetting"

  field :shopping_setting, 36,
    type: Google.Ads.Googleads.V17.Resources.Campaign.ShoppingSetting,
  ...
  field :audience_setting, 73,
    proto3_optional: true,
    type: Google.Ads.Googleads.V17.Resources.Campaign.AudienceSetting,
    json_name: "audienceSetting",
    deprecated: false

  field :geo_target_type_setting, 47,
    type: Google.Ads.Googleads.V17.Resources.Campaign.GeoTargetTypeSetting,
    json_name: "geoTargetTypeSetting"

  field :local_campaign_setting, 50,
    type: Google.Ads.Googleads.V17.Resources.Campaign.LocalCampaignSetting,
    json_name: "localCampaignSetting"

  field :app_campaign_setting, 51,
    type: Google.Ads.Googleads.V17.Resources.Campaign.AppCampaignSetting,
  ...
  field :vanity_pharma, 44,
    type: Google.Ads.Googleads.V17.Resources.Campaign.VanityPharma,
    json_name: "vanityPharma"

  field :selective_optimization, 45,
    type: Google.Ads.Googleads.V17.Resources.Campaign.SelectiveOptimization,
    json_name: "selectiveOptimization"

  field :optimization_goal_setting, 54,
    type: Google.Ads.Googleads.V17.Resources.Campaign.OptimizationGoalSetting,
    json_name: "optimizationGoalSetting"

  field :tracking_setting, 46,
    type: Google.Ads.Googleads.V17.Resources.Campaign.TrackingSetting,
  ...
  field :performance_max_upgrade, 77,
    type: Google.Ads.Googleads.V17.Resources.Campaign.PerformanceMaxUpgrade,
  ...
  field :asset_automation_settings, 88,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Campaign.AssetAutomationSetting,
  ...
  field :commission, 49, type: Google.Ads.Googleads.V17.Common.Commission, oneof: 0
