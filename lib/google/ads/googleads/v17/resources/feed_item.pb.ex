defmodule Google.Ads.Googleads.V17.Resources.FeedItem do
  @moduledoc false
  ...
  field :attribute_values, 6,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.FeedItemAttributeValue,
  ...
  field :policy_infos, 10,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.FeedItemPlaceholderPolicyInfo,
    json_name: "policyInfos",
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.FeedItemAttributeValue do
  @moduledoc false
  ...
  field :price_value, 6, type: Google.Ads.Googleads.V17.Common.Money, json_name: "priceValue"
...
defmodule Google.Ads.Googleads.V17.Resources.FeedItemPlaceholderPolicyInfo do
  @moduledoc false
  ...
  field :validation_errors, 7,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.FeedItemValidationError,
    json_name: "validationErrors",
    deprecated: false

  field :quality_approval_status, 8,
    type:
      Google.Ads.Googleads.V17.Enums.FeedItemQualityApprovalStatusEnum.FeedItemQualityApprovalStatus,
  ...
  field :quality_disapproval_reasons, 9,
    repeated: true,
    type:
      Google.Ads.Googleads.V17.Enums.FeedItemQualityDisapprovalReasonEnum.FeedItemQualityDisapprovalReason,
    json_name: "qualityDisapprovalReasons",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.FeedItemValidationError do
  @moduledoc false
