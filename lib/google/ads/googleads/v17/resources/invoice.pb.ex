defmodule Google.Ads.Googleads.V17.Resources.Invoice.AccountSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Invoice.AccountBudgetSummary do
  @moduledoc false
  ...
  field :invalid_activity_summaries, 22,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Invoice.InvalidActivitySummary,
    json_name: "invalidActivitySummaries",
    deprecated: false
end

defmodule Google.Ads.Googleads.V17.Resources.Invoice.InvalidActivitySummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Invoice do
  @moduledoc false
  ...
  field :account_budget_summaries, 18,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Invoice.AccountBudgetSummary,
    json_name: "accountBudgetSummaries",
    deprecated: false

  field :account_summaries, 39,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.Invoice.AccountSummary,
