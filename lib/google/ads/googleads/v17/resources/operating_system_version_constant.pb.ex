defmodule Google.Ads.Googleads.V17.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V17.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
