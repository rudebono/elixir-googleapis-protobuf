defmodule Google.Ads.Googleads.V17.Resources.AssetGroup do
  @moduledoc false
  ...
  field :primary_status_reasons, 12,
    repeated: true,
    type:
      Google.Ads.Googleads.V17.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason,
