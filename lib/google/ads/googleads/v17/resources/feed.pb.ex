defmodule Google.Ads.Googleads.V17.Resources.FeedAttributeOperation.Operator do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Feed.PlacesLocationFeedData.OAuthInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.Feed.PlacesLocationFeedData do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :oauth_info, 1,
    type: Google.Ads.Googleads.V17.Resources.Feed.PlacesLocationFeedData.OAuthInfo,
    json_name: "oauthInfo",
    deprecated: false
...
defmodule Google.Ads.Googleads.V17.Resources.Feed.AffiliateLocationFeedData do
  @moduledoc false
  ...
  field :relationship_type, 2,
    type:
      Google.Ads.Googleads.V17.Enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType,
    json_name: "relationshipType",
    enum: true
end

defmodule Google.Ads.Googleads.V17.Resources.Feed do
  @moduledoc false
  ...
  field :attributes, 4, repeated: true, type: Google.Ads.Googleads.V17.Resources.FeedAttribute

  field :attribute_operations, 9,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.FeedAttributeOperation,
  ...
  field :places_location_feed_data, 6,
    type: Google.Ads.Googleads.V17.Resources.Feed.PlacesLocationFeedData,
    json_name: "placesLocationFeedData",
    oneof: 0

  field :affiliate_location_feed_data, 7,
    type: Google.Ads.Googleads.V17.Resources.Feed.AffiliateLocationFeedData,
    json_name: "affiliateLocationFeedData",
    oneof: 0
end

defmodule Google.Ads.Googleads.V17.Resources.FeedAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.FeedAttributeOperation do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :operator, 1,
    type: Google.Ads.Googleads.V17.Resources.FeedAttributeOperation.Operator,
    enum: true,
    deprecated: false

  field :value, 2, type: Google.Ads.Googleads.V17.Resources.FeedAttribute, deprecated: false
end