defmodule Google.Ads.Googleads.V17.Resources.MediaFile do
  ...
  field :image, 3,
    type: Google.Ads.Googleads.V17.Resources.MediaImage,
    oneof: 0,
    deprecated: false

  field :media_bundle, 4,
    type: Google.Ads.Googleads.V17.Resources.MediaBundle,
    json_name: "mediaBundle",
    oneof: 0,
    deprecated: false

  field :audio, 10,
    type: Google.Ads.Googleads.V17.Resources.MediaAudio,
    oneof: 0,
    deprecated: false

  field :video, 11,
    type: Google.Ads.Googleads.V17.Resources.MediaVideo,
    oneof: 0,
    deprecated: false
end
