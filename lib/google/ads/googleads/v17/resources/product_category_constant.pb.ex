defmodule Google.Ads.Googleads.V17.Resources.ProductCategoryConstant.ProductCategoryLocalization do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Resources.ProductCategoryConstant do
  @moduledoc false
  ...
  field :localizations, 6,
    repeated: true,
    type: Google.Ads.Googleads.V17.Resources.ProductCategoryConstant.ProductCategoryLocalization,
    deprecated: false
end