defmodule Google.Ads.Googleads.V17.Resources.AdGroupCriterionSimulation do
  @moduledoc false
  ...
  field :modification_method, 5,
    type:
      Google.Ads.Googleads.V17.Enums.SimulationModificationMethodEnum.SimulationModificationMethod,
