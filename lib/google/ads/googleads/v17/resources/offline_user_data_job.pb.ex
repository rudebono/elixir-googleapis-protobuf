defmodule Google.Ads.Googleads.V17.Resources.OfflineUserDataJob do
  ...
  field :failure_reason, 6,
    type:
      Google.Ads.Googleads.V17.Enums.OfflineUserDataJobFailureReasonEnum.OfflineUserDataJobFailureReason,
    json_name: "failureReason",
    enum: true,
    deprecated: false

  field :operation_metadata, 11,
    type: Google.Ads.Googleads.V17.Resources.OfflineUserDataJobMetadata,
...
defmodule Google.Ads.Googleads.V17.Resources.OfflineUserDataJobMetadata do
  ...
  field :match_rate_range, 1,
    type:
      Google.Ads.Googleads.V17.Enums.OfflineUserDataJobMatchRateRangeEnum.OfflineUserDataJobMatchRateRange,
