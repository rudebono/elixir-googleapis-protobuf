...
defmodule Google.Ads.Googleads.V17.Common.CrmBasedUserListInfo do
  ...
  field :upload_key_type, 2,
    type:
      Google.Ads.Googleads.V17.Enums.CustomerMatchUploadKeyTypeEnum.CustomerMatchUploadKeyType,
...
defmodule Google.Ads.Googleads.V17.Common.UserListRuleInfo do
  ...
  field :rule_item_groups, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.UserListRuleItemGroupInfo,
...
defmodule Google.Ads.Googleads.V17.Common.UserListRuleItemGroupInfo do
  ...
  field :rule_items, 1,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.UserListRuleItemInfo,
    json_name: "ruleItems"
end
...
defmodule Google.Ads.Googleads.V17.Common.UserListRuleItemInfo do
  ...
  field :number_rule_item, 2,
    type: Google.Ads.Googleads.V17.Common.UserListNumberRuleItemInfo,
    json_name: "numberRuleItem",
    oneof: 0

  field :string_rule_item, 3,
    type: Google.Ads.Googleads.V17.Common.UserListStringRuleItemInfo,
    json_name: "stringRuleItem",
    oneof: 0

  field :date_rule_item, 4,
    type: Google.Ads.Googleads.V17.Common.UserListDateRuleItemInfo,
...
defmodule Google.Ads.Googleads.V17.Common.UserListDateRuleItemInfo do
  ...
  field :operator, 1,
    type:
      Google.Ads.Googleads.V17.Enums.UserListDateRuleItemOperatorEnum.UserListDateRuleItemOperator,
    enum: true
...
defmodule Google.Ads.Googleads.V17.Common.UserListStringRuleItemInfo do
  ...
  field :operator, 1,
    type:
      Google.Ads.Googleads.V17.Enums.UserListStringRuleItemOperatorEnum.UserListStringRuleItemOperator,
    enum: true
...
defmodule Google.Ads.Googleads.V17.Common.FlexibleRuleUserListInfo do
  ...
  field :inclusive_rule_operator, 1,
    type:
      Google.Ads.Googleads.V17.Enums.UserListFlexibleRuleOperatorEnum.UserListFlexibleRuleOperator,
    json_name: "inclusiveRuleOperator",
    enum: true

  field :inclusive_operands, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.FlexibleRuleOperandInfo,
...
defmodule Google.Ads.Googleads.V17.Common.RuleBasedUserListInfo do
  ...
  field :prepopulation_status, 1,
    type:
      Google.Ads.Googleads.V17.Enums.UserListPrepopulationStatusEnum.UserListPrepopulationStatus,
    json_name: "prepopulationStatus",
    enum: true

  field :flexible_rule_user_list, 5,
    type: Google.Ads.Googleads.V17.Common.FlexibleRuleUserListInfo,
...
defmodule Google.Ads.Googleads.V17.Common.UserListLogicalRuleInfo do
  ...
  field :operator, 1,
    type:
      Google.Ads.Googleads.V17.Enums.UserListLogicalRuleOperatorEnum.UserListLogicalRuleOperator,
    enum: true

  field :rule_operands, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.LogicalUserListOperandInfo,
