defmodule Google.Ads.Googleads.V17.Common.MatchingFunction do
  @moduledoc false
  ...
  field :left_operands, 2,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.Operand,
...
defmodule Google.Ads.Googleads.V17.Common.Operand.ConstantOperand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Common.Operand.FeedAttributeOperand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Common.Operand.FunctionOperand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Common.Operand.RequestContextOperand do
  @moduledoc false
  ...
  field :context_type, 1,
    type:
      Google.Ads.Googleads.V17.Enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType,
    json_name: "contextType",
    enum: true
end

defmodule Google.Ads.Googleads.V17.Common.Operand do
  @moduledoc false
  ...
  field :constant_operand, 1,
    type: Google.Ads.Googleads.V17.Common.Operand.ConstantOperand,
    json_name: "constantOperand",
    oneof: 0

  field :feed_attribute_operand, 2,
    type: Google.Ads.Googleads.V17.Common.Operand.FeedAttributeOperand,
    json_name: "feedAttributeOperand",
    oneof: 0

  field :function_operand, 3,
    type: Google.Ads.Googleads.V17.Common.Operand.FunctionOperand,
    json_name: "functionOperand",
    oneof: 0

  field :request_context_operand, 4,
    type: Google.Ads.Googleads.V17.Common.Operand.RequestContextOperand,
