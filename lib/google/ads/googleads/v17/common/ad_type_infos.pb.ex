...
defmodule Google.Ads.Googleads.V17.Common.VideoAdInfo do
  ...
  field :video, 8, type: Google.Ads.Googleads.V17.Common.AdVideoAsset

  field :in_stream, 2,
    type: Google.Ads.Googleads.V17.Common.VideoTrueViewInStreamAdInfo,
    json_name: "inStream",
    oneof: 0

  field :bumper, 3, type: Google.Ads.Googleads.V17.Common.VideoBumperInStreamAdInfo, oneof: 0

  field :out_stream, 4,
    type: Google.Ads.Googleads.V17.Common.VideoOutstreamAdInfo,
    json_name: "outStream",
    oneof: 0

  field :non_skippable, 5,
    type: Google.Ads.Googleads.V17.Common.VideoNonSkippableInStreamAdInfo,
    json_name: "nonSkippable",
    oneof: 0

  field :in_feed, 9,
    type: Google.Ads.Googleads.V17.Common.InFeedVideoAdInfo,
    json_name: "inFeed",
    oneof: 0
end
...
defmodule Google.Ads.Googleads.V17.Common.VideoResponsiveAdInfo do
  ...
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  ...
  field :videos, 5, repeated: true, type: Google.Ads.Googleads.V17.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V17.Common.AppAdInfo do
  ...
  field :headlines, 2, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  field :images, 4, repeated: true, type: Google.Ads.Googleads.V17.Common.AdImageAsset

  field :youtube_videos, 5,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.AdVideoAsset,
    json_name: "youtubeVideos"

  field :html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.AdMediaBundleAsset,
...
defmodule Google.Ads.Googleads.V17.Common.AppEngagementAdInfo do
  ...
  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  field :images, 3, repeated: true, type: Google.Ads.Googleads.V17.Common.AdImageAsset
  field :videos, 4, repeated: true, type: Google.Ads.Googleads.V17.Common.AdVideoAsset
end
...
defmodule Google.Ads.Googleads.V17.Common.LegacyAppInstallAdInfo do
  ...
  field :app_store, 2,
    type:
      Google.Ads.Googleads.V17.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V17.Common.ResponsiveDisplayAdInfo do
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset

  field :long_headline, 6,
    type: Google.Ads.Googleads.V17.Common.AdTextAsset,
    json_name: "longHeadline"

  field :descriptions, 7, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  ...
  field :control_spec, 24,
    type: Google.Ads.Googleads.V17.Common.ResponsiveDisplayAdControlSpec,
...
defmodule Google.Ads.Googleads.V17.Common.LocalAdInfo do
  ...
  field :videos, 6, repeated: true, type: Google.Ads.Googleads.V17.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V17.Common.DemandGenMultiAssetAdInfo do
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
  field :descriptions, 6, repeated: true, type: Google.Ads.Googleads.V17.Common.AdTextAsset
...
defmodule Google.Ads.Googleads.V17.Common.DemandGenCarouselAdInfo do
  ...
  field :headline, 3, type: Google.Ads.Googleads.V17.Common.AdTextAsset, deprecated: false
  field :description, 4, type: Google.Ads.Googleads.V17.Common.AdTextAsset, deprecated: false
  field :call_to_action_text, 5, type: :string, json_name: "callToActionText"

  field :carousel_cards, 6,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.AdDemandGenCarouselCardAsset,
...
defmodule Google.Ads.Googleads.V17.Common.DemandGenVideoResponsiveAdInfo do
  ...
  field :call_to_actions, 9,
    repeated: true,
    type: Google.Ads.Googleads.V17.Common.AdCallToActionAsset,
    json_name: "callToActions"
end
