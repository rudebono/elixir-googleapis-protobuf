defmodule Google.Ads.Googleads.V17.Common.Segments do
  @moduledoc false
  ...
  field :budget_campaign_association_status, 134,
    type: Google.Ads.Googleads.V17.Common.BudgetCampaignAssociationStatus,
  ...
  field :keyword, 61, type: Google.Ads.Googleads.V17.Common.Keyword
  ...
  field :search_engine_results_page_type, 70,
    type:
      Google.Ads.Googleads.V17.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType,
  ...
  field :slot, 23, type: Google.Ads.Googleads.V17.Enums.SlotEnum.Slot, enum: true

  field :conversion_value_rule_primary_dimension, 138,
    type:
      Google.Ads.Googleads.V17.Enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension,
  ...
  field :sk_ad_network_source_app, 143,
    proto3_optional: true,
    type: Google.Ads.Googleads.V17.Common.SkAdNetworkSourceApp,
    json_name: "skAdNetworkSourceApp"

  field :sk_ad_network_attribution_credit, 144,
    type:
      Google.Ads.Googleads.V17.Enums.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit,
  ...
  field :asset_interaction_target, 139,
    proto3_optional: true,
    type: Google.Ads.Googleads.V17.Common.AssetInteractionTarget,
    json_name: "assetInteractionTarget"

  field :new_versus_returning_customers, 160,
    type:
      Google.Ads.Googleads.V17.Enums.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket,
    json_name: "newVersusReturningCustomers",
    enum: true
end

defmodule Google.Ads.Googleads.V17.Common.Keyword do
  @moduledoc false
  ...
  field :info, 2, type: Google.Ads.Googleads.V17.Common.KeywordInfo
end

defmodule Google.Ads.Googleads.V17.Common.BudgetCampaignAssociationStatus do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Common.AssetInteractionTarget do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V17.Common.SkAdNetworkSourceApp do
  @moduledoc false
