defmodule Google.Ads.Googleads.V17.Common.FrequencyCapEntry do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.0", syntax: :proto3

  field :key, 1, type: Google.Ads.Googleads.V17.Common.FrequencyCapKey
  field :cap, 3, proto3_optional: true, type: :int32
end

defmodule Google.Ads.Googleads.V17.Common.FrequencyCapKey do
  @moduledoc false
