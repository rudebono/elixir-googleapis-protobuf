defmodule Google.Ads.Googleads.V10.Resources.CampaignCriterion do
  @moduledoc false
  ...
  field :status, 35,
    type: Google.Ads.Googleads.V10.Enums.CampaignCriterionStatusEnum.CampaignCriterionStatus,
    enum: true
  ...
  field :device, 13, type: Google.Ads.Googleads.V10.Common.DeviceInfo, oneof: 0, deprecated: false
  ...
  field :gender, 17, type: Google.Ads.Googleads.V10.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 24, type: Google.Ads.Googleads.V10.Common.TopicInfo, oneof: 0, deprecated: false

  field :listing_scope, 25,
    type: Google.Ads.Googleads.V10.Common.ListingScopeInfo,
    json_name: "listingScope",
    oneof: 0,
    deprecated: false

  field :language, 26,
    type: Google.Ads.Googleads.V10.Common.LanguageInfo,
    oneof: 0,
    deprecated: false

  field :ip_block, 27,
    type: Google.Ads.Googleads.V10.Common.IpBlockInfo,
    json_name: "ipBlock",
    oneof: 0,
    deprecated: false
  ...
  field :carrier, 29,
    type: Google.Ads.Googleads.V10.Common.CarrierInfo,
    oneof: 0,
    deprecated: false
  ...
  field :operating_system_version, 32,
    type: Google.Ads.Googleads.V10.Common.OperatingSystemVersionInfo,
    json_name: "operatingSystemVersion",
    oneof: 0,
    deprecated: false

  field :mobile_device, 33,
    type: Google.Ads.Googleads.V10.Common.MobileDeviceInfo,
    json_name: "mobileDevice",
    oneof: 0,
    deprecated: false

  field :location_group, 34,
    type: Google.Ads.Googleads.V10.Common.LocationGroupInfo,
