defmodule Google.Ads.Googleads.V10.Resources.ChangeEvent.ChangedResource do
  @moduledoc false
  ...
  field :ad_group, 2,
    type: Google.Ads.Googleads.V10.Resources.AdGroup,
    json_name: "adGroup",
    deprecated: false
  ...
  field :campaign, 4, type: Google.Ads.Googleads.V10.Resources.Campaign, deprecated: false
  ...
  field :feed, 8, type: Google.Ads.Googleads.V10.Resources.Feed, deprecated: false

  field :feed_item, 9,
    type: Google.Ads.Googleads.V10.Resources.FeedItem,
    json_name: "feedItem",
    deprecated: false
  ...
  field :asset, 13, type: Google.Ads.Googleads.V10.Resources.Asset, deprecated: false
...
defmodule Google.Ads.Googleads.V10.Resources.ChangeEvent do
  ...
  @type t :: %__MODULE__{
          ...
          change_resource_type:
            Google.Ads.Googleads.V10.Enums.ChangeEventResourceTypeEnum.ChangeEventResourceType.t(),
          change_resource_name: String.t(),
          client_type: Google.Ads.Googleads.V10.Enums.ChangeClientTypeEnum.ChangeClientType.t(),
          user_email: String.t(),
          old_resource: Google.Ads.Googleads.V10.Resources.ChangeEvent.ChangedResource.t() | nil,
          new_resource: Google.Ads.Googleads.V10.Resources.ChangeEvent.ChangedResource.t() | nil,
          resource_change_operation:
            Google.Ads.Googleads.V10.Enums.ResourceChangeOperationEnum.ResourceChangeOperation.t(),
  ...
  field :change_resource_type, 3,
    type: Google.Ads.Googleads.V10.Enums.ChangeEventResourceTypeEnum.ChangeEventResourceType,
  ...
  field :client_type, 5,
    type: Google.Ads.Googleads.V10.Enums.ChangeClientTypeEnum.ChangeClientType,
  ...
  field :old_resource, 7,
    type: Google.Ads.Googleads.V10.Resources.ChangeEvent.ChangedResource,
  ...
  field :resource_change_operation, 9,
    type: Google.Ads.Googleads.V10.Enums.ResourceChangeOperationEnum.ResourceChangeOperation,
