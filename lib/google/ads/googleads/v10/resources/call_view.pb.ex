defmodule Google.Ads.Googleads.V10.Resources.CallView do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          call_tracking_display_location:
            Google.Ads.Googleads.V10.Enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation.t(),
          type: Google.Ads.Googleads.V10.Enums.CallTypeEnum.CallType.t(),
          call_status:
            Google.Ads.Googleads.V10.Enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus.t()
        }
  ...
  field :call_tracking_display_location, 7,
    type:
      Google.Ads.Googleads.V10.Enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation,
    json_name: "callTrackingDisplayLocation",
    enum: true,
    deprecated: false

  field :type, 8,
    type: Google.Ads.Googleads.V10.Enums.CallTypeEnum.CallType,
    enum: true,
    deprecated: false

  field :call_status, 9,
    type: Google.Ads.Googleads.V10.Enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus,
