defmodule Google.Ads.Googleads.V10.Resources.ProductBiddingCategoryConstant do
  @moduledoc false
  ...
  field :status, 6,
    type:
      Google.Ads.Googleads.V10.Enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus,
    enum: true,
    deprecated: false
