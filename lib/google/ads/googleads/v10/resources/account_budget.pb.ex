defmodule Google.Ads.Googleads.V10.Resources.AccountBudget.PendingAccountBudgetProposal do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Resources.AccountBudget do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V10.Enums.AccountBudgetStatusEnum.AccountBudgetStatus,
    enum: true,
    deprecated: false
  ...
  field :pending_proposal, 22,
    type: Google.Ads.Googleads.V10.Resources.AccountBudget.PendingAccountBudgetProposal,
