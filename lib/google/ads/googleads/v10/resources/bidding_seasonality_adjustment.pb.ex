defmodule Google.Ads.Googleads.V10.Resources.BiddingSeasonalityAdjustment do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          scope:
            Google.Ads.Googleads.V10.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope.t(),
          status:
            Google.Ads.Googleads.V10.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus.t(),
          start_date_time: String.t(),
          end_date_time: String.t(),
          name: String.t(),
          description: String.t(),
          devices: [Google.Ads.Googleads.V10.Enums.DeviceEnum.Device.t()],
  ...
  field :scope, 3,
    type: Google.Ads.Googleads.V10.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope,
    enum: true

  field :status, 4,
    type: Google.Ads.Googleads.V10.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus,
    enum: true,
    deprecated: false
