defmodule Google.Ads.Googleads.V10.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          access_role: Google.Ads.Googleads.V10.Enums.AccessRoleEnum.AccessRole.t(),
          email_address: String.t(),
          creation_date_time: String.t(),
          invitation_status:
            Google.Ads.Googleads.V10.Enums.AccessInvitationStatusEnum.AccessInvitationStatus.t()
        }
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V10.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
