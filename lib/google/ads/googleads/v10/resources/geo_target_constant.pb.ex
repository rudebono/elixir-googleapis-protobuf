defmodule Google.Ads.Googleads.V10.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field :status, 7,
    type: Google.Ads.Googleads.V10.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true,
    deprecated: false
