defmodule Google.Ads.Googleads.V10.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Resources.AdGroup do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V10.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true

  field :type, 12,
    type: Google.Ads.Googleads.V10.Enums.AdGroupTypeEnum.AdGroupType,
    enum: true,
    deprecated: false

  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V10.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :explorer_auto_optimizer_setting, 21,
    type: Google.Ads.Googleads.V10.Common.ExplorerAutoOptimizerSetting,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V10.Resources.AdGroup.AudienceSetting,
