...
defmodule Google.Ads.Googleads.V10.Common.DiscoveryMultiAssetAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V10.Common.AdTextAsset
  field :descriptions, 6, repeated: true, type: Google.Ads.Googleads.V10.Common.AdTextAsset
  field :business_name, 7, proto3_optional: true, type: :string, json_name: "businessName"
...
defmodule Google.Ads.Googleads.V10.Common.DiscoveryCarouselAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headline, 3, type: Google.Ads.Googleads.V10.Common.AdTextAsset, deprecated: false
  field :description, 4, type: Google.Ads.Googleads.V10.Common.AdTextAsset, deprecated: false
  field :call_to_action_text, 5, type: :string, json_name: "callToActionText"

  field :carousel_cards, 6,
    repeated: true,
    type: Google.Ads.Googleads.V10.Common.AdDiscoveryCarouselCardAsset,
