...
defmodule Google.Ads.Googleads.V10.Common.LeadFormAsset do
  ...
  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V10.Common.LeadFormCustomQuestionField,
...
defmodule Google.Ads.Googleads.V10.Common.LeadFormCustomQuestionField do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicRealEstateAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicCustomAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicFlightsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DiscoveryCarouselCardAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicTravelAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicLocalAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Common.DynamicJobsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
