defmodule Google.Ads.Googleads.V10.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.CampaignFeedErrorEnum do
  @moduledoc false
