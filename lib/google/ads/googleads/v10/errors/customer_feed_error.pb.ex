defmodule Google.Ads.Googleads.V10.Errors.CustomerFeedErrorEnum.CustomerFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.CustomerFeedErrorEnum do
  @moduledoc false
