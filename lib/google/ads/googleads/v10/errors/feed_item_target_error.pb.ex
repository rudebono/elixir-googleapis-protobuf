defmodule Google.Ads.Googleads.V10.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
