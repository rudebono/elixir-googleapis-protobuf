defmodule Google.Ads.Googleads.V10.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
