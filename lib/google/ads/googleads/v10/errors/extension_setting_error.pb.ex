defmodule Google.Ads.Googleads.V10.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
