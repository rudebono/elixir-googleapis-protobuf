defmodule Google.Ads.Googleads.V10.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.CustomInterestErrorEnum do
  @moduledoc false
