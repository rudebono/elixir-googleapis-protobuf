defmodule Google.Ads.Googleads.V10.Errors.AdGroupCriterionErrorEnum.AdGroupCriterionError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Errors.AdGroupCriterionErrorEnum do
  @moduledoc false
