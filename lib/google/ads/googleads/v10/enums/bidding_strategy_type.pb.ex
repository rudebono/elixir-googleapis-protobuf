defmodule Google.Ads.Googleads.V10.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V10.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
