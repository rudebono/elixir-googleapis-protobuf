defmodule Google.Ads.Googleads.V10.Services.MutateAccountBudgetProposalRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operation: Google.Ads.Googleads.V10.Services.AccountBudgetProposalOperation.t() | nil,
...
defmodule Google.Ads.Googleads.V10.Services.AccountBudgetProposalOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.AccountBudgetProposal.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V10.Services.MutateAccountBudgetProposalResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Ads.Googleads.V10.Services.MutateAccountBudgetProposalResult.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Services.AccountBudgetProposalService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.AccountBudgetProposalService"
