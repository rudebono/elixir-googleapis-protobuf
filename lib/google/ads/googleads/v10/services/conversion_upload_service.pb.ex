defmodule Google.Ads.Googleads.V10.Services.UploadClickConversionsRequest do
  @moduledoc false
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V10.Services.ClickConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V10.Services.UploadClickConversionsResponse do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :partial_failure_error, 1, type: Google.Rpc.Status, json_name: "partialFailureError"
  field :results, 2, repeated: true, type: Google.Ads.Googleads.V10.Services.ClickConversionResult
end

defmodule Google.Ads.Googleads.V10.Services.UploadCallConversionsRequest do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V10.Services.CallConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V10.Services.UploadCallConversionsResponse do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :partial_failure_error, 1, type: Google.Rpc.Status, json_name: "partialFailureError"
  field :results, 2, repeated: true, type: Google.Ads.Googleads.V10.Services.CallConversionResult
end

defmodule Google.Ads.Googleads.V10.Services.ClickConversion do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :external_attribution_data, 7,
    type: Google.Ads.Googleads.V10.Services.ExternalAttributionData,
    json_name: "externalAttributionData"

  field :custom_variables, 15,
    repeated: true,
    type: Google.Ads.Googleads.V10.Services.CustomVariable,
    json_name: "customVariables"

  field :cart_data, 16, type: Google.Ads.Googleads.V10.Services.CartData, json_name: "cartData"

  field :user_identifiers, 17,
    repeated: true,
    type: Google.Ads.Googleads.V10.Common.UserIdentifier,
    json_name: "userIdentifiers"

  field :conversion_environment, 20,
    type: Google.Ads.Googleads.V10.Enums.ConversionEnvironmentEnum.ConversionEnvironment,
    json_name: "conversionEnvironment",
    enum: true
end

defmodule Google.Ads.Googleads.V10.Services.CallConversion do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.ExternalAttributionData do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.ClickConversionResult do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.CallConversionResult do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.CustomVariable do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.CartData.Item do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.CartData do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :items, 5, repeated: true, type: Google.Ads.Googleads.V10.Services.CartData.Item
end

defmodule Google.Ads.Googleads.V10.Services.ConversionUploadService.Service do
  @moduledoc false
  use GRPC.Service,
  ...
  rpc :UploadClickConversions,
      Google.Ads.Googleads.V10.Services.UploadClickConversionsRequest,
      Google.Ads.Googleads.V10.Services.UploadClickConversionsResponse

  rpc :UploadCallConversions,
      Google.Ads.Googleads.V10.Services.UploadCallConversionsRequest,
      Google.Ads.Googleads.V10.Services.UploadCallConversionsResponse
end

defmodule Google.Ads.Googleads.V10.Services.ConversionUploadService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.ConversionUploadService.Service
end