defmodule Google.Ads.Googleads.V10.Services.MutateCustomerLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.CustomerLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.CustomerLabelOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.CustomerLabel.t() | nil}
            | {:remove, String.t()}
        }
...
defmodule Google.Ads.Googleads.V10.Services.MutateCustomerLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateCustomerLabelResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.CustomerLabelService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.CustomerLabelService"
