defmodule Google.Ads.Googleads.V10.Services.MutateAdGroupsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.AdGroupOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.AdGroupOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.AdGroup.t() | nil}
            | {:update, Google.Ads.Googleads.V10.Resources.AdGroup.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V10.Resources.AdGroup, oneof: 0
...
defmodule Google.Ads.Googleads.V10.Services.MutateAdGroupsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateAdGroupResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.AdGroupService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.AdGroupService"

  rpc :MutateAdGroups,
      Google.Ads.Googleads.V10.Services.MutateAdGroupsRequest,
      Google.Ads.Googleads.V10.Services.MutateAdGroupsResponse
end

defmodule Google.Ads.Googleads.V10.Services.AdGroupService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.AdGroupService.Service
end
