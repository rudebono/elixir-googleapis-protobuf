defmodule Google.Ads.Googleads.V10.Services.UploadConversionAdjustmentsRequest do
  @moduledoc false
  ...
  field :conversion_adjustments, 2,
    repeated: true,
    type: Google.Ads.Googleads.V10.Services.ConversionAdjustment,
...
defmodule Google.Ads.Googleads.V10.Services.UploadConversionAdjustmentsResponse do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :results, 2,
    repeated: true,
    type: Google.Ads.Googleads.V10.Services.ConversionAdjustmentResult
end

defmodule Google.Ads.Googleads.V10.Services.ConversionAdjustment do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :gclid_date_time_pair, 12,
    type: Google.Ads.Googleads.V10.Services.GclidDateTimePair,
  ...
  field :adjustment_type, 5,
    type: Google.Ads.Googleads.V10.Enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType,
    json_name: "adjustmentType",
    enum: true

  field :restatement_value, 6,
    type: Google.Ads.Googleads.V10.Services.RestatementValue,
...
defmodule Google.Ads.Googleads.V10.Services.RestatementValue do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.GclidDateTimePair do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.ConversionAdjustmentResult do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V10.Services.ConversionAdjustmentUploadService.Service do
  @moduledoc false
  use GRPC.Service,
  ...
  rpc :UploadConversionAdjustments,
      Google.Ads.Googleads.V10.Services.UploadConversionAdjustmentsRequest,
      Google.Ads.Googleads.V10.Services.UploadConversionAdjustmentsResponse
end

defmodule Google.Ads.Googleads.V10.Services.ConversionAdjustmentUploadService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Ads.Googleads.V10.Services.ConversionAdjustmentUploadService.Service
end