...
defmodule Google.Ads.Googleads.V10.Services.CustomerNegativeCriterionOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V10.Resources.CustomerNegativeCriterion, oneof: 0
...
defmodule Google.Ads.Googleads.V10.Services.CustomerNegativeCriterionService.Service do
  ...
  rpc :MutateCustomerNegativeCriteria,
      ...
      Google.Ads.Googleads.V10.Services.MutateCustomerNegativeCriteriaResponse
end

defmodule Google.Ads.Googleads.V10.Services.CustomerNegativeCriterionService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Ads.Googleads.V10.Services.CustomerNegativeCriterionService.Service
end