...
defmodule Google.Ads.Googleads.V10.Services.MutateAdsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.AdOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.AdOperation do
  ...
  @type t :: %__MODULE__{
          operation: {:update, Google.Ads.Googleads.V10.Resources.Ad.t() | nil},
...
defmodule Google.Ads.Googleads.V10.Services.MutateAdsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateAdResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.AdService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.AdService"
