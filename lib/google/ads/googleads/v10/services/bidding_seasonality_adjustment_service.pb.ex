...
defmodule Google.Ads.Googleads.V10.Services.BiddingSeasonalityAdjustmentService.Service do
  ...
  rpc :MutateBiddingSeasonalityAdjustments,
      ...
      Google.Ads.Googleads.V10.Services.MutateBiddingSeasonalityAdjustmentsResponse
end

defmodule Google.Ads.Googleads.V10.Services.BiddingSeasonalityAdjustmentService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Ads.Googleads.V10.Services.BiddingSeasonalityAdjustmentService.Service
end