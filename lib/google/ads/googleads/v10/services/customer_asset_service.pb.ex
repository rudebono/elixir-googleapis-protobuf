defmodule Google.Ads.Googleads.V10.Services.MutateCustomerAssetsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.CustomerAssetOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.CustomerAssetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.CustomerAsset.t() | nil}
            | {:update, Google.Ads.Googleads.V10.Resources.CustomerAsset.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V10.Resources.CustomerAsset, oneof: 0
...
defmodule Google.Ads.Googleads.V10.Services.MutateCustomerAssetsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateCustomerAssetResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.CustomerAssetService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.CustomerAssetService"

  rpc :MutateCustomerAssets,
      Google.Ads.Googleads.V10.Services.MutateCustomerAssetsRequest,
      Google.Ads.Googleads.V10.Services.MutateCustomerAssetsResponse
end

defmodule Google.Ads.Googleads.V10.Services.CustomerAssetService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.CustomerAssetService.Service
end
