defmodule Google.Ads.Googleads.V10.Services.MutateConversionCustomVariablesRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.ConversionCustomVariableOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.ConversionCustomVariableOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.ConversionCustomVariable.t() | nil}
            | {:update, Google.Ads.Googleads.V10.Resources.ConversionCustomVariable.t() | nil},
...
defmodule Google.Ads.Googleads.V10.Services.MutateConversionCustomVariablesResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateConversionCustomVariableResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.ConversionCustomVariableService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.ConversionCustomVariableService"
