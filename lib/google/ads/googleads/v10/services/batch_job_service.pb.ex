defmodule Google.Ads.Googleads.V10.Services.MutateBatchJobRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operation: Google.Ads.Googleads.V10.Services.BatchJobOperation.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Services.MutateBatchJobResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Ads.Googleads.V10.Services.MutateBatchJobResult.t() | nil
        }
...
defmodule Google.Ads.Googleads.V10.Services.ListBatchJobResultsResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Ads.Googleads.V10.Services.BatchJobResult.t()],
...
defmodule Google.Ads.Googleads.V10.Services.BatchJobResult do
  ...
  @type t :: %__MODULE__{
          ...
          mutate_operation_response:
            Google.Ads.Googleads.V10.Services.MutateOperationResponse.t() | nil,
...
defmodule Google.Ads.Googleads.V10.Services.BatchJobService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.BatchJobService"

  rpc :MutateBatchJob,
      Google.Ads.Googleads.V10.Services.MutateBatchJobRequest,
      Google.Ads.Googleads.V10.Services.MutateBatchJobResponse

  rpc :ListBatchJobResults,
      Google.Ads.Googleads.V10.Services.ListBatchJobResultsRequest,
      Google.Ads.Googleads.V10.Services.ListBatchJobResultsResponse

  rpc :RunBatchJob,
      Google.Ads.Googleads.V10.Services.RunBatchJobRequest,
      Google.Longrunning.Operation

  rpc :AddBatchJobOperations,
      Google.Ads.Googleads.V10.Services.AddBatchJobOperationsRequest,
      Google.Ads.Googleads.V10.Services.AddBatchJobOperationsResponse
end

defmodule Google.Ads.Googleads.V10.Services.BatchJobService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.BatchJobService.Service
end
