defmodule Google.Ads.Googleads.V10.Services.MutateAdParametersRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V10.Services.AdParameterOperation.t()],
...
defmodule Google.Ads.Googleads.V10.Services.AdParameterOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V10.Resources.AdParameter.t() | nil}
            | {:update, Google.Ads.Googleads.V10.Resources.AdParameter.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V10.Services.MutateAdParametersResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V10.Services.MutateAdParameterResult.t()]
        }
...
defmodule Google.Ads.Googleads.V10.Services.AdParameterService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.AdParameterService"
