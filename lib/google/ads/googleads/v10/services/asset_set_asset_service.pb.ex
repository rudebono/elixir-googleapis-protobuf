...
defmodule Google.Ads.Googleads.V10.Services.AssetSetAssetOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V10.Resources.AssetSetAsset, oneof: 0
...
defmodule Google.Ads.Googleads.V10.Services.AssetSetAssetService.Service do
  ...
  rpc :MutateAssetSetAssets,
      ...
      Google.Ads.Googleads.V10.Services.MutateAssetSetAssetsResponse
end

defmodule Google.Ads.Googleads.V10.Services.AssetSetAssetService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.AssetSetAssetService.Service
end