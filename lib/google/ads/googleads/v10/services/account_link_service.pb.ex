...
defmodule Google.Ads.Googleads.V10.Services.MutateAccountLinkRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          operation: Google.Ads.Googleads.V10.Services.AccountLinkOperation.t() | nil,
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V10.Services.AccountLinkOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V10.Services.AccountLinkOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:update, Google.Ads.Googleads.V10.Resources.AccountLink.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V10.Services.MutateAccountLinkResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Ads.Googleads.V10.Services.MutateAccountLinkResult.t() | nil,
...
defmodule Google.Ads.Googleads.V10.Services.AccountLinkService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v10.services.AccountLinkService"

  rpc :CreateAccountLink,
      Google.Ads.Googleads.V10.Services.CreateAccountLinkRequest,
      Google.Ads.Googleads.V10.Services.CreateAccountLinkResponse

  rpc :MutateAccountLink,
      Google.Ads.Googleads.V10.Services.MutateAccountLinkRequest,
      Google.Ads.Googleads.V10.Services.MutateAccountLinkResponse
end

defmodule Google.Ads.Googleads.V10.Services.AccountLinkService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V10.Services.AccountLinkService.Service
end
