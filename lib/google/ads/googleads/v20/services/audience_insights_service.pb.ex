defmodule Google.Ads.Googleads.V20.Services.GenerateInsightsFinderReportRequest do
  ...
  field :baseline_audience, 2,
    type: Google.Ads.Googleads.V20.Services.BasicInsightsAudience,
...
defmodule Google.Ads.Googleads.V20.Services.GenerateAudienceCompositionInsightsRequest do
  ...
  field :baseline_audience, 6,
    type: Google.Ads.Googleads.V20.Services.InsightsAudience,
    json_name: "baselineAudience"
...
defmodule Google.Ads.Googleads.V20.Services.GenerateAudienceCompositionInsightsResponse do
  ...
  field :sections, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.AudienceCompositionSection
end
...
defmodule Google.Ads.Googleads.V20.Services.GenerateSuggestedTargetingInsightsRequest do
  ...
  field :audience_definition, 6,
    type: Google.Ads.Googleads.V20.Services.InsightsAudienceDefinition,
    json_name: "audienceDefinition",
    oneof: 0

  field :audience_description, 7,
    type: Google.Ads.Googleads.V20.Services.InsightsAudienceDescription,
...
defmodule Google.Ads.Googleads.V20.Services.GenerateSuggestedTargetingInsightsResponse do
  ...
  field :suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.TargetingSuggestionMetrics
end
...
defmodule Google.Ads.Googleads.V20.Services.TargetingSuggestionMetrics do
  ...
  field :gender, 3, type: Google.Ads.Googleads.V20.Common.GenderInfo
...
defmodule Google.Ads.Googleads.V20.Services.GenerateAudienceOverlapInsightsRequest do
  ...
  field :primary_attribute, 6,
    type: Google.Ads.Googleads.V20.Common.AudienceInsightsAttribute,
...
defmodule Google.Ads.Googleads.V20.Services.GenerateAudienceOverlapInsightsResponse do
  ...
  field :dimension_results, 2,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.DimensionOverlapResult,
...
defmodule Google.Ads.Googleads.V20.Services.DimensionOverlapResult do
  ...
  field :items, 2, repeated: true, type: Google.Ads.Googleads.V20.Services.AudienceOverlapItem
end
...
defmodule Google.Ads.Googleads.V20.Services.BasicInsightsAudience do
  ...
  field :topics, 7, repeated: true, type: Google.Ads.Googleads.V20.Common.AudienceInsightsTopic
end
...
defmodule Google.Ads.Googleads.V20.Services.InsightsAudienceDescription do
  ...
  field :marketing_objective, 3,
    type:
      Google.Ads.Googleads.V20.Enums.AudienceInsightsMarketingObjectiveEnum.AudienceInsightsMarketingObjective,
...
defmodule Google.Ads.Googleads.V20.Services.InsightsAudience do
  ...
  field :lineups, 10, repeated: true, type: Google.Ads.Googleads.V20.Common.AudienceInsightsLineup

  field :topic_audience_combinations, 8,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.InsightsAudienceAttributeGroup,
...
defmodule Google.Ads.Googleads.V20.Services.AudienceCompositionSection do
  ...
  field :top_attributes, 3,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.AudienceCompositionAttribute,
    json_name: "topAttributes"

  field :clustered_attributes, 4,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.AudienceCompositionAttributeCluster,
...
defmodule Google.Ads.Googleads.V20.Services.AudienceCompositionAttributeCluster do
  ...
  field :cluster_metrics, 3,
    type: Google.Ads.Googleads.V20.Services.AudienceCompositionMetrics,
...
defmodule Google.Ads.Googleads.V20.Services.AudienceCompositionAttribute do
  ...
  field :metrics, 2, type: Google.Ads.Googleads.V20.Services.AudienceCompositionMetrics
end

defmodule Google.Ads.Googleads.V20.Services.AudienceInsightsService.Service do
  @moduledoc false
  ...
  rpc :GenerateInsightsFinderReport,
      ...
      Google.Ads.Googleads.V20.Services.GenerateInsightsFinderReportResponse

  rpc :ListAudienceInsightsAttributes,
      Google.Ads.Googleads.V20.Services.ListAudienceInsightsAttributesRequest,
      Google.Ads.Googleads.V20.Services.ListAudienceInsightsAttributesResponse

  rpc :ListInsightsEligibleDates,
      Google.Ads.Googleads.V20.Services.ListInsightsEligibleDatesRequest,
      Google.Ads.Googleads.V20.Services.ListInsightsEligibleDatesResponse

  rpc :GenerateAudienceCompositionInsights,
      Google.Ads.Googleads.V20.Services.GenerateAudienceCompositionInsightsRequest,
      Google.Ads.Googleads.V20.Services.GenerateAudienceCompositionInsightsResponse

  rpc :GenerateSuggestedTargetingInsights,
      Google.Ads.Googleads.V20.Services.GenerateSuggestedTargetingInsightsRequest,
      Google.Ads.Googleads.V20.Services.GenerateSuggestedTargetingInsightsResponse

  rpc :GenerateAudienceOverlapInsights,
      Google.Ads.Googleads.V20.Services.GenerateAudienceOverlapInsightsRequest,
      Google.Ads.Googleads.V20.Services.GenerateAudienceOverlapInsightsResponse

  rpc :GenerateTargetingSuggestionMetrics,
      Google.Ads.Googleads.V20.Services.GenerateTargetingSuggestionMetricsRequest,
      Google.Ads.Googleads.V20.Services.GenerateTargetingSuggestionMetricsResponse
end

defmodule Google.Ads.Googleads.V20.Services.AudienceInsightsService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V20.Services.AudienceInsightsService.Service
end
