...
defmodule Google.Ads.Googleads.V20.Services.CampaignOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V20.Resources.Campaign, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V20.Resources.Campaign, oneof: 0
...
defmodule Google.Ads.Googleads.V20.Services.EnablePMaxBrandGuidelinesRequest do
  ...
  field :operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.EnableOperation,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V20.Services.EnableOperation do
  ...
  field :brand_assets, 3,
    type: Google.Ads.Googleads.V20.Services.BrandCampaignAssets,
...
defmodule Google.Ads.Googleads.V20.Services.CampaignService.Service do
  @moduledoc false
  ...
  rpc :MutateCampaigns,
      ...
      Google.Ads.Googleads.V20.Services.MutateCampaignsResponse

  rpc :EnablePMaxBrandGuidelines,
      Google.Ads.Googleads.V20.Services.EnablePMaxBrandGuidelinesRequest,
      Google.Ads.Googleads.V20.Services.EnablePMaxBrandGuidelinesResponse
end

defmodule Google.Ads.Googleads.V20.Services.CampaignService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V20.Services.CampaignService.Service
end
