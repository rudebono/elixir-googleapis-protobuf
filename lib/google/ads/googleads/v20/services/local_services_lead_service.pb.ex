defmodule Google.Ads.Googleads.V20.Services.AppendLeadConversationRequest do
  ...
  field :conversations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.Conversation,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V20.Services.AppendLeadConversationResponse do
  ...
  field :responses, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.ConversationOrError,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V20.Services.SurveySatisfied do
  ...
  field :survey_satisfied_reason, 1,
    type:
      Google.Ads.Googleads.V20.Enums.LocalServicesLeadSurveySatisfiedReasonEnum.SurveySatisfiedReason,
...
defmodule Google.Ads.Googleads.V20.Services.SurveyDissatisfied do
  ...
  field :survey_dissatisfied_reason, 1,
    type:
      Google.Ads.Googleads.V20.Enums.LocalServicesLeadSurveyDissatisfiedReasonEnum.SurveyDissatisfiedReason,
...
defmodule Google.Ads.Googleads.V20.Services.ProvideLeadFeedbackRequest do
  ...
  field :survey_answer, 2,
    type: Google.Ads.Googleads.V20.Enums.LocalServicesLeadSurveyAnswerEnum.SurveyAnswer,
    json_name: "surveyAnswer",
    enum: true,
    deprecated: false

  field :survey_satisfied, 3,
    type: Google.Ads.Googleads.V20.Services.SurveySatisfied,
    json_name: "surveySatisfied",
    oneof: 0

  field :survey_dissatisfied, 4,
    type: Google.Ads.Googleads.V20.Services.SurveyDissatisfied,
...
defmodule Google.Ads.Googleads.V20.Services.ProvideLeadFeedbackResponse do
  ...
  field :credit_issuance_decision, 1,
    type:
      Google.Ads.Googleads.V20.Enums.LocalServicesLeadCreditIssuanceDecisionEnum.CreditIssuanceDecision,
    json_name: "creditIssuanceDecision",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Services.LocalServicesLeadService.Service do
  @moduledoc false
  ...
  rpc :AppendLeadConversation,
      ...
      Google.Ads.Googleads.V20.Services.AppendLeadConversationResponse

  rpc :ProvideLeadFeedback,
      Google.Ads.Googleads.V20.Services.ProvideLeadFeedbackRequest,
      Google.Ads.Googleads.V20.Services.ProvideLeadFeedbackResponse
end

defmodule Google.Ads.Googleads.V20.Services.LocalServicesLeadService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V20.Services.LocalServicesLeadService.Service
end
