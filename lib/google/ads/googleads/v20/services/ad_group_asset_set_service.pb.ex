defmodule Google.Ads.Googleads.V20.Services.MutateAdGroupAssetSetsRequest do
  ...
  field :operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.AdGroupAssetSetOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V20.Services.AdGroupAssetSetOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V20.Resources.AdGroupAssetSet, oneof: 0
...
defmodule Google.Ads.Googleads.V20.Services.MutateAdGroupAssetSetsResponse do
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Services.MutateAdGroupAssetSetResult
...
defmodule Google.Ads.Googleads.V20.Services.AdGroupAssetSetService.Service do
  @moduledoc false
  ...
  rpc :MutateAdGroupAssetSets,
      ...
      Google.Ads.Googleads.V20.Services.MutateAdGroupAssetSetsResponse
end

defmodule Google.Ads.Googleads.V20.Services.AdGroupAssetSetService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V20.Services.AdGroupAssetSetService.Service
end
