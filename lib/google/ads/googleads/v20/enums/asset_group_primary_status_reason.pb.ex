defmodule Google.Ads.Googleads.V20.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
