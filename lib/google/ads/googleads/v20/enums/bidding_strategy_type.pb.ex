defmodule Google.Ads.Googleads.V20.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
