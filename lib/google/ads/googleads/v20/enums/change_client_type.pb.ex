defmodule Google.Ads.Googleads.V20.Enums.ChangeClientTypeEnum.ChangeClientType do
  @moduledoc false
  ...
  field :OTHER, 13
  field :GOOGLE_ADS_RECOMMENDATIONS_SUBSCRIPTION, 14
end

defmodule Google.Ads.Googleads.V20.Enums.ChangeClientTypeEnum do
  @moduledoc false
