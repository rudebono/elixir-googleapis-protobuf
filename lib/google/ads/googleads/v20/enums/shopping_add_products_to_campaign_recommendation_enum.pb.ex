defmodule Google.Ads.Googleads.V20.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
