defmodule Google.Ads.Googleads.V20.Errors.SearchTermInsightErrorEnum.SearchTermInsightError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.SearchTermInsightErrorEnum do
  @moduledoc false
