defmodule Google.Ads.Googleads.V20.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
