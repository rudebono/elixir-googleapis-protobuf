defmodule Google.Ads.Googleads.V20.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.SmartCampaignErrorEnum do
  @moduledoc false
