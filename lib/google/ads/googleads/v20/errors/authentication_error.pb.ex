defmodule Google.Ads.Googleads.V20.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.AuthenticationErrorEnum do
  @moduledoc false
