defmodule Google.Ads.Googleads.V20.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.AuthorizationErrorEnum do
  @moduledoc false
