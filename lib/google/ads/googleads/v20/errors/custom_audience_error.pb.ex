defmodule Google.Ads.Googleads.V20.Errors.CustomAudienceErrorEnum.CustomAudienceError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.CustomAudienceErrorEnum do
  @moduledoc false
