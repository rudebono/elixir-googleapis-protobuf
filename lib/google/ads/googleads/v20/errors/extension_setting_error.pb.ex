defmodule Google.Ads.Googleads.V20.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
