defmodule Google.Ads.Googleads.V20.Errors.OfflineUserDataJobErrorEnum.OfflineUserDataJobError do
  @moduledoc false
  ...
  field :OPERATION_LEVEL_CONSENT_PROVIDED, 48
end

defmodule Google.Ads.Googleads.V20.Errors.OfflineUserDataJobErrorEnum do
  @moduledoc false
