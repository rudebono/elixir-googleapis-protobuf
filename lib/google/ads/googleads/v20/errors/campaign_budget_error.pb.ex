defmodule Google.Ads.Googleads.V20.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
