defmodule Google.Ads.Googleads.V20.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.CustomInterestErrorEnum do
  @moduledoc false
