defmodule Google.Ads.Googleads.V20.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
