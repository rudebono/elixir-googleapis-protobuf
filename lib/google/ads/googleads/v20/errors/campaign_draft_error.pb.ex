defmodule Google.Ads.Googleads.V20.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Errors.CampaignDraftErrorEnum do
  @moduledoc false
