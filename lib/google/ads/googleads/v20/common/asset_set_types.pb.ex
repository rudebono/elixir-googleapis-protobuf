defmodule Google.Ads.Googleads.V20.Common.LocationSet do
  @moduledoc false
  ...
  field :business_profile_location_set, 1,
    type: Google.Ads.Googleads.V20.Common.BusinessProfileLocationSet,
    json_name: "businessProfileLocationSet",
    oneof: 0

  field :chain_location_set, 2,
    type: Google.Ads.Googleads.V20.Common.ChainSet,
    json_name: "chainLocationSet",
    oneof: 0

  field :maps_location_set, 5,
    type: Google.Ads.Googleads.V20.Common.MapsLocationSet,
    json_name: "mapsLocationSet",
    oneof: 0
end

defmodule Google.Ads.Googleads.V20.Common.BusinessProfileLocationSet do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.ChainSet do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :relationship_type, 1,
    type: Google.Ads.Googleads.V20.Enums.ChainRelationshipTypeEnum.ChainRelationshipType,
  ...
  field :chains, 2,
    repeated: true,
    type: Google.Ads.Googleads.V20.Common.ChainFilter,
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Common.ChainFilter do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.MapsLocationSet do
  @moduledoc false
  ...
  field :maps_locations, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Common.MapsLocationInfo,
    json_name: "mapsLocations",
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Common.MapsLocationInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.BusinessProfileLocationGroup do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :dynamic_business_profile_location_group_filter, 1,
    type: Google.Ads.Googleads.V20.Common.DynamicBusinessProfileLocationGroupFilter,
    json_name: "dynamicBusinessProfileLocationGroupFilter"
end

defmodule Google.Ads.Googleads.V20.Common.DynamicBusinessProfileLocationGroupFilter do
  @moduledoc false
  ...
  field :business_name_filter, 2,
    ...
    type: Google.Ads.Googleads.V20.Common.BusinessProfileBusinessNameFilter,
    json_name: "businessNameFilter"

  field :listing_id_filters, 3, repeated: true, type: :int64, json_name: "listingIdFilters"
end

defmodule Google.Ads.Googleads.V20.Common.BusinessProfileBusinessNameFilter do
  @moduledoc false
  ...
  field :filter_type, 2,
    type: Google.Ads.Googleads.V20.Enums.LocationStringFilterTypeEnum.LocationStringFilterType,
    json_name: "filterType",
    enum: true
end

defmodule Google.Ads.Googleads.V20.Common.ChainLocationGroup do
  @moduledoc false
