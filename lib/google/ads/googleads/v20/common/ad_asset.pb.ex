defmodule Google.Ads.Googleads.V20.Common.AdTextAsset do
  @moduledoc false
  ...
  field :policy_summary_info, 6,
    type: Google.Ads.Googleads.V20.Common.AdAssetPolicySummary,
    json_name: "policySummaryInfo"
end

defmodule Google.Ads.Googleads.V20.Common.AdImageAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.AdVideoAsset do
  @moduledoc false
  ...
  field :ad_video_asset_info, 4,
    ...
    type: Google.Ads.Googleads.V20.Common.AdVideoAssetInfo,
    json_name: "adVideoAssetInfo"
end

defmodule Google.Ads.Googleads.V20.Common.AdVideoAssetInfo do
  @moduledoc false
  ...
  field :ad_video_asset_inventory_preferences, 1,
    proto3_optional: true,
    type: Google.Ads.Googleads.V20.Common.AdVideoAssetInventoryPreferences,
    json_name: "adVideoAssetInventoryPreferences"
end

defmodule Google.Ads.Googleads.V20.Common.AdVideoAssetInventoryPreferences do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.AdMediaBundleAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.AdDemandGenCarouselCardAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.AdCallToActionAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Common.AdAppDeepLinkAsset do
  @moduledoc false
