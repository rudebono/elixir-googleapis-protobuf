defmodule Google.Ads.Googleads.V20.Resources.AssetGroupAsset do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V20.Enums.AssetLinkStatusEnum.AssetLinkStatus,
    enum: true
  ...
  field :primary_status_details, 10,
    repeated: true,
    type: Google.Ads.Googleads.V20.Common.AssetLinkPrimaryStatusDetails,
  ...
  field :policy_summary, 7,
    type: Google.Ads.Googleads.V20.Common.PolicySummary,
