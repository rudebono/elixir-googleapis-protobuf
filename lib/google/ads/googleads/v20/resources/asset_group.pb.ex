defmodule Google.Ads.Googleads.V20.Resources.AssetGroup do
  @moduledoc false
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V20.Enums.AssetGroupStatusEnum.AssetGroupStatus,
    enum: true

  field :primary_status, 11,
    type: Google.Ads.Googleads.V20.Enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus,
  ...
  field :primary_status_reasons, 12,
    repeated: true,
    type:
      Google.Ads.Googleads.V20.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason,
  ...
  field :asset_coverage, 13,
    type: Google.Ads.Googleads.V20.Resources.AssetCoverage,
    json_name: "assetCoverage",
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Resources.AssetCoverage do
  @moduledoc false
  ...
  field :ad_strength_action_items, 1,
    repeated: true,
    type: Google.Ads.Googleads.V20.Resources.AdStrengthActionItem,
    json_name: "adStrengthActionItems",
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Resources.AdStrengthActionItem.AddAssetDetails do
  @moduledoc false
  ...
  field :video_aspect_ratio_requirement, 3,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V20.Enums.AssetCoverageVideoAspectRatioRequirementEnum.AssetCoverageVideoAspectRatioRequirement,
    json_name: "videoAspectRatioRequirement",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Resources.AdStrengthActionItem do
  @moduledoc false
  ...
  field :action_item_type, 1,
    type: Google.Ads.Googleads.V20.Enums.AdStrengthActionItemTypeEnum.AdStrengthActionItemType,
    json_name: "actionItemType",
    enum: true,
    deprecated: false

  field :add_asset_details, 2,
    type: Google.Ads.Googleads.V20.Resources.AdStrengthActionItem.AddAssetDetails,
