defmodule Google.Ads.Googleads.V20.Resources.Asset do
  @moduledoc false
  ...
  field :type, 4,
    type: Google.Ads.Googleads.V20.Enums.AssetTypeEnum.AssetType,
    enum: true,
    deprecated: false
  ...
  field :policy_summary, 13,
    type: Google.Ads.Googleads.V20.Resources.AssetPolicySummary,
    json_name: "policySummary",
    deprecated: false

  field :field_type_policy_summaries, 40,
    repeated: true,
    type: Google.Ads.Googleads.V20.Resources.AssetFieldTypePolicySummary,
    json_name: "fieldTypePolicySummaries",
    deprecated: false

  field :youtube_video_asset, 5,
    type: Google.Ads.Googleads.V20.Common.YoutubeVideoAsset,
    json_name: "youtubeVideoAsset",
    oneof: 0,
    deprecated: false

  field :media_bundle_asset, 6,
    type: Google.Ads.Googleads.V20.Common.MediaBundleAsset,
    json_name: "mediaBundleAsset",
    oneof: 0,
    deprecated: false

  field :image_asset, 7,
    type: Google.Ads.Googleads.V20.Common.ImageAsset,
    json_name: "imageAsset",
    oneof: 0,
    deprecated: false

  field :text_asset, 8,
    type: Google.Ads.Googleads.V20.Common.TextAsset,
    json_name: "textAsset",
    oneof: 0,
    deprecated: false

  field :lead_form_asset, 9,
    type: Google.Ads.Googleads.V20.Common.LeadFormAsset,
    json_name: "leadFormAsset",
    oneof: 0

  field :book_on_google_asset, 10,
    type: Google.Ads.Googleads.V20.Common.BookOnGoogleAsset,
    json_name: "bookOnGoogleAsset",
    oneof: 0

  field :promotion_asset, 15,
    type: Google.Ads.Googleads.V20.Common.PromotionAsset,
    json_name: "promotionAsset",
    oneof: 0

  field :callout_asset, 20,
    type: Google.Ads.Googleads.V20.Common.CalloutAsset,
    json_name: "calloutAsset",
    oneof: 0

  field :structured_snippet_asset, 21,
    type: Google.Ads.Googleads.V20.Common.StructuredSnippetAsset,
    json_name: "structuredSnippetAsset",
    oneof: 0

  field :sitelink_asset, 22,
    type: Google.Ads.Googleads.V20.Common.SitelinkAsset,
    json_name: "sitelinkAsset",
    oneof: 0

  field :page_feed_asset, 23,
    type: Google.Ads.Googleads.V20.Common.PageFeedAsset,
    json_name: "pageFeedAsset",
    oneof: 0

  field :dynamic_education_asset, 24,
    type: Google.Ads.Googleads.V20.Common.DynamicEducationAsset,
    json_name: "dynamicEducationAsset",
    oneof: 0

  field :mobile_app_asset, 25,
    type: Google.Ads.Googleads.V20.Common.MobileAppAsset,
    json_name: "mobileAppAsset",
    oneof: 0

  field :hotel_callout_asset, 26,
    type: Google.Ads.Googleads.V20.Common.HotelCalloutAsset,
    json_name: "hotelCalloutAsset",
    oneof: 0

  field :call_asset, 27,
    type: Google.Ads.Googleads.V20.Common.CallAsset,
    json_name: "callAsset",
    oneof: 0

  field :price_asset, 28,
    type: Google.Ads.Googleads.V20.Common.PriceAsset,
    json_name: "priceAsset",
    oneof: 0

  field :call_to_action_asset, 29,
    type: Google.Ads.Googleads.V20.Common.CallToActionAsset,
    json_name: "callToActionAsset",
    oneof: 0,
    deprecated: false

  field :dynamic_real_estate_asset, 30,
    type: Google.Ads.Googleads.V20.Common.DynamicRealEstateAsset,
    json_name: "dynamicRealEstateAsset",
    oneof: 0

  field :dynamic_custom_asset, 31,
    type: Google.Ads.Googleads.V20.Common.DynamicCustomAsset,
    json_name: "dynamicCustomAsset",
    oneof: 0

  field :dynamic_hotels_and_rentals_asset, 32,
    type: Google.Ads.Googleads.V20.Common.DynamicHotelsAndRentalsAsset,
    json_name: "dynamicHotelsAndRentalsAsset",
    oneof: 0

  field :dynamic_flights_asset, 33,
    type: Google.Ads.Googleads.V20.Common.DynamicFlightsAsset,
    json_name: "dynamicFlightsAsset",
    oneof: 0

  field :demand_gen_carousel_card_asset, 50,
    type: Google.Ads.Googleads.V20.Common.DemandGenCarouselCardAsset,
    json_name: "demandGenCarouselCardAsset",
    oneof: 0,
    deprecated: false

  field :dynamic_travel_asset, 35,
    type: Google.Ads.Googleads.V20.Common.DynamicTravelAsset,
    json_name: "dynamicTravelAsset",
    oneof: 0

  field :dynamic_local_asset, 36,
    type: Google.Ads.Googleads.V20.Common.DynamicLocalAsset,
    json_name: "dynamicLocalAsset",
    oneof: 0

  field :dynamic_jobs_asset, 37,
    type: Google.Ads.Googleads.V20.Common.DynamicJobsAsset,
    json_name: "dynamicJobsAsset",
    oneof: 0

  field :location_asset, 39,
    type: Google.Ads.Googleads.V20.Common.LocationAsset,
    json_name: "locationAsset",
    oneof: 0,
    deprecated: false

  field :hotel_property_asset, 41,
    type: Google.Ads.Googleads.V20.Common.HotelPropertyAsset,
    json_name: "hotelPropertyAsset",
    oneof: 0,
    deprecated: false

  field :business_message_asset, 51,
    type: Google.Ads.Googleads.V20.Common.BusinessMessageAsset,
    json_name: "businessMessageAsset",
    oneof: 0

  field :app_deep_link_asset, 52,
    type: Google.Ads.Googleads.V20.Common.AppDeepLinkAsset,
    json_name: "appDeepLinkAsset",
    oneof: 0,
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Resources.AssetFieldTypePolicySummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.AssetPolicySummary do
  @moduledoc false
