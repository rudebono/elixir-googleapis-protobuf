defmodule Google.Ads.Googleads.V20.Resources.ConversionAction.AttributionModelSettings do
  ...
  field :data_driven_model_status, 2,
    type: Google.Ads.Googleads.V20.Enums.DataDrivenModelStatusEnum.DataDrivenModelStatus,
...
defmodule Google.Ads.Googleads.V20.Resources.ConversionAction do
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V20.Enums.ConversionActionStatusEnum.ConversionActionStatus,
    enum: true

  field :type, 5,
    type: Google.Ads.Googleads.V20.Enums.ConversionActionTypeEnum.ConversionActionType,
    enum: true,
    deprecated: false
  ...
  field :value_settings, 11,
    type: Google.Ads.Googleads.V20.Resources.ConversionAction.ValueSettings,
    json_name: "valueSettings"

  field :counting_type, 12,
    type:
      Google.Ads.Googleads.V20.Enums.ConversionActionCountingTypeEnum.ConversionActionCountingType,
    json_name: "countingType",
    enum: true

  field :attribution_model_settings, 13,
    type: Google.Ads.Googleads.V20.Resources.ConversionAction.AttributionModelSettings,
    json_name: "attributionModelSettings"

  field :tag_snippets, 14,
    repeated: true,
    type: Google.Ads.Googleads.V20.Common.TagSnippet,
  ...
  field :firebase_settings, 18,
    type: Google.Ads.Googleads.V20.Resources.ConversionAction.FirebaseSettings,
    json_name: "firebaseSettings",
    deprecated: false

  field :third_party_app_analytics_settings, 19,
    type: Google.Ads.Googleads.V20.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings,
    json_name: "thirdPartyAppAnalyticsSettings",
    deprecated: false

  field :google_analytics_4_settings, 34,
    type: Google.Ads.Googleads.V20.Resources.ConversionAction.GoogleAnalytics4Settings,
