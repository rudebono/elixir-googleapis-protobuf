defmodule Google.Ads.Googleads.V20.Resources.LocalServicesLead do
  @moduledoc false
  ...
  field :contact_details, 5,
    type: Google.Ads.Googleads.V20.Resources.ContactDetails,
    json_name: "contactDetails",
    deprecated: false

  field :lead_type, 6,
    type: Google.Ads.Googleads.V20.Enums.LocalServicesLeadTypeEnum.LeadType,
    json_name: "leadType",
    enum: true,
    deprecated: false

  field :lead_status, 7,
    type: Google.Ads.Googleads.V20.Enums.LocalServicesLeadStatusEnum.LeadStatus,
  ...
  field :note, 10,
    ...
    type: Google.Ads.Googleads.V20.Resources.Note,
    deprecated: false
  ...
  field :credit_details, 12,
    proto3_optional: true,
    type: Google.Ads.Googleads.V20.Resources.CreditDetails,
...
defmodule Google.Ads.Googleads.V20.Resources.ContactDetails do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.Note do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.CreditDetails do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :credit_state, 1,
    type: Google.Ads.Googleads.V20.Enums.LocalServicesCreditStateEnum.CreditState,
