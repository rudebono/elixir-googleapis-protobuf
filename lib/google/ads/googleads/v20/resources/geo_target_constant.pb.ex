defmodule Google.Ads.Googleads.V20.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field :status, 7,
    type: Google.Ads.Googleads.V20.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true,
    deprecated: false
