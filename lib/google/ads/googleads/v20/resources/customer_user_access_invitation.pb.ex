defmodule Google.Ads.Googleads.V20.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V20.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
