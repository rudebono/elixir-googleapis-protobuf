defmodule Google.Ads.Googleads.V20.Resources.BiddingSeasonalityAdjustment do
  @moduledoc false
  ...
  field :scope, 3,
    type: Google.Ads.Googleads.V20.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope,
    enum: true

  field :status, 4,
    type: Google.Ads.Googleads.V20.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus,
    enum: true,
    deprecated: false
