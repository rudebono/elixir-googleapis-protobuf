defmodule Google.Ads.Googleads.V20.Resources.ShoppingProduct.ProductIssue do
  @moduledoc false
  ...
  field :ads_severity, 2,
    type: Google.Ads.Googleads.V20.Enums.ProductIssueSeverityEnum.ProductIssueSeverity,
...
defmodule Google.Ads.Googleads.V20.Resources.ShoppingProduct do
  @moduledoc false
  ...
  field :availability, 14,
    proto3_optional: true,
    type: Google.Ads.Googleads.V20.Enums.ProductAvailabilityEnum.ProductAvailability,
    enum: true,
    deprecated: false
  ...
  field :status, 32,
    type: Google.Ads.Googleads.V20.Enums.ProductStatusEnum.ProductStatus,
    enum: true,
    deprecated: false

  field :issues, 33,
    repeated: true,
    type: Google.Ads.Googleads.V20.Resources.ShoppingProduct.ProductIssue,
    deprecated: false
