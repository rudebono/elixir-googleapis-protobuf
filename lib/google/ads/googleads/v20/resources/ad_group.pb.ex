...
defmodule Google.Ads.Googleads.V20.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls do
  ...
  field :channel_config, 1,
    type: Google.Ads.Googleads.V20.Enums.DemandGenChannelConfigEnum.DemandGenChannelConfig,
    json_name: "channelConfig",
    enum: true,
    deprecated: false

  field :channel_strategy, 2,
    type: Google.Ads.Googleads.V20.Enums.DemandGenChannelStrategyEnum.DemandGenChannelStrategy,
  ...
  field :selected_channels, 3,
    type:
      Google.Ads.Googleads.V20.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels,
...
defmodule Google.Ads.Googleads.V20.Resources.AdGroup.DemandGenAdGroupSettings do
  ...
  field :channel_controls, 1,
    type:
      Google.Ads.Googleads.V20.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls,
...
defmodule Google.Ads.Googleads.V20.Resources.AdGroup do
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V20.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true
  ...
  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V20.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :display_custom_bid_dimension, 23,
    type: Google.Ads.Googleads.V20.Enums.TargetingDimensionEnum.TargetingDimension,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V20.Resources.AdGroup.AudienceSetting,
  ...
  field :primary_status, 62,
    type: Google.Ads.Googleads.V20.Enums.AdGroupPrimaryStatusEnum.AdGroupPrimaryStatus,
  ...
  field :primary_status_reasons, 63,
    repeated: true,
    type:
      Google.Ads.Googleads.V20.Enums.AdGroupPrimaryStatusReasonEnum.AdGroupPrimaryStatusReason,
    json_name: "primaryStatusReasons",
    enum: true,
    deprecated: false

  field :demand_gen_ad_group_settings, 91,
    type: Google.Ads.Googleads.V20.Resources.AdGroup.DemandGenAdGroupSettings,
