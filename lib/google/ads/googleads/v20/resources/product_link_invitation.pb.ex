defmodule Google.Ads.Googleads.V20.Resources.ProductLinkInvitation do
  ...
  field :hotel_center, 4,
    type: Google.Ads.Googleads.V20.Resources.HotelCenterLinkInvitationIdentifier,
    json_name: "hotelCenter",
    oneof: 0,
    deprecated: false

  field :merchant_center, 5,
    type: Google.Ads.Googleads.V20.Resources.MerchantCenterLinkInvitationIdentifier,
    json_name: "merchantCenter",
    oneof: 0,
    deprecated: false

  field :advertising_partner, 7,
    type: Google.Ads.Googleads.V20.Resources.AdvertisingPartnerLinkInvitationIdentifier,
