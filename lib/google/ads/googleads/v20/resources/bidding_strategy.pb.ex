defmodule Google.Ads.Googleads.V20.Resources.BiddingStrategy do
  @moduledoc false
  ...
  field :status, 15,
    type: Google.Ads.Googleads.V20.Enums.BiddingStrategyStatusEnum.BiddingStrategyStatus,
    enum: true,
    deprecated: false
  ...
  field :aligned_campaign_budget_id, 25, type: :int64, json_name: "alignedCampaignBudgetId"
  ...
  field :enhanced_cpc, 7,
    type: Google.Ads.Googleads.V20.Common.EnhancedCpc,
