defmodule Google.Ads.Googleads.V20.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V20.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
