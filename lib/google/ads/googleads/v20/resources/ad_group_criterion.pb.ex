defmodule Google.Ads.Googleads.V20.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
  ...
  field :creative_quality_score, 2,
    type: Google.Ads.Googleads.V20.Enums.QualityScoreBucketEnum.QualityScoreBucket,
...
defmodule Google.Ads.Googleads.V20.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.AdGroupCriterion do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V20.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V20.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :type, 25,
    type: Google.Ads.Googleads.V20.Enums.CriterionTypeEnum.CriterionType,
    enum: true,
    deprecated: false
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V20.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V20.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
  ...
  field :effective_cpc_bid_source, 21,
    type: Google.Ads.Googleads.V20.Enums.BiddingSourceEnum.BiddingSource,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V20.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :primary_status, 85,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V20.Enums.AdGroupCriterionPrimaryStatusEnum.AdGroupCriterionPrimaryStatus,
  ...
  field :primary_status_reasons, 86,
    repeated: true,
    type:
      Google.Ads.Googleads.V20.Enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason,
  ...
  field :placement, 28,
    type: Google.Ads.Googleads.V20.Common.PlacementInfo,
    oneof: 0,
    deprecated: false

  field :mobile_app_category, 29,
    type: Google.Ads.Googleads.V20.Common.MobileAppCategoryInfo,
    json_name: "mobileAppCategory",
    oneof: 0,
    deprecated: false

  field :mobile_application, 30,
    type: Google.Ads.Googleads.V20.Common.MobileApplicationInfo,
    json_name: "mobileApplication",
    oneof: 0,
    deprecated: false

  field :listing_group, 32,
    type: Google.Ads.Googleads.V20.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V20.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 43, type: Google.Ads.Googleads.V20.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :webpage, 46,
    type: Google.Ads.Googleads.V20.Common.WebpageInfo,
    oneof: 0,
    deprecated: false

  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V20.Common.AppPaymentModelInfo,
    json_name: "appPaymentModel",
    oneof: 0,
    deprecated: false

  field :custom_affinity, 48,
    type: Google.Ads.Googleads.V20.Common.CustomAffinityInfo,
    json_name: "customAffinity",
    oneof: 0,
    deprecated: false

  field :custom_intent, 49,
    type: Google.Ads.Googleads.V20.Common.CustomIntentInfo,
    json_name: "customIntent",
    oneof: 0,
    deprecated: false

  field :custom_audience, 74,
    type: Google.Ads.Googleads.V20.Common.CustomAudienceInfo,
    json_name: "customAudience",
    oneof: 0,
    deprecated: false

  field :combined_audience, 75,
    type: Google.Ads.Googleads.V20.Common.CombinedAudienceInfo,
    json_name: "combinedAudience",
    oneof: 0,
    deprecated: false

  field :audience, 79,
    type: Google.Ads.Googleads.V20.Common.AudienceInfo,
    oneof: 0,
    deprecated: false
  ...
  field :language, 83,
    type: Google.Ads.Googleads.V20.Common.LanguageInfo,
    oneof: 0,
    deprecated: false
end
