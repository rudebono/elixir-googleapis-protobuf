defmodule Google.Ads.Googleads.V20.Resources.MediaFile do
  @moduledoc false
  ...
  field :type, 5,
    type: Google.Ads.Googleads.V20.Enums.MediaTypeEnum.MediaType,
    enum: true,
    deprecated: false
  ...
  field :image, 3,
    type: Google.Ads.Googleads.V20.Resources.MediaImage,
    oneof: 0,
    deprecated: false

  field :media_bundle, 4,
    type: Google.Ads.Googleads.V20.Resources.MediaBundle,
    json_name: "mediaBundle",
    oneof: 0,
    deprecated: false

  field :audio, 10,
    type: Google.Ads.Googleads.V20.Resources.MediaAudio,
    oneof: 0,
    deprecated: false

  field :video, 11,
    type: Google.Ads.Googleads.V20.Resources.MediaVideo,
    oneof: 0,
    deprecated: false
end

defmodule Google.Ads.Googleads.V20.Resources.MediaImage do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.MediaBundle do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.MediaAudio do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V20.Resources.MediaVideo do
  @moduledoc false
