...
defmodule Google.Ads.Googleads.V12.Services.AdParameterOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V12.Resources.AdParameter, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V12.Resources.AdParameter, oneof: 0
...
defmodule Google.Ads.Googleads.V12.Services.AdParameterService.Service do
  ...
  rpc :MutateAdParameters,
      ...
      Google.Ads.Googleads.V12.Services.MutateAdParametersResponse
end
