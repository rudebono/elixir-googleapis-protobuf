defmodule Google.Ads.Googleads.V12.Services.MutateCustomerClientLinkRequest do
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V12.Services.CustomerClientLinkOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V12.Services.CustomerClientLinkOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V12.Resources.CustomerClientLink, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V12.Resources.CustomerClientLink, oneof: 0
end
...
defmodule Google.Ads.Googleads.V12.Services.CustomerClientLinkService.Service do
  ...
  rpc :MutateCustomerClientLink,
      ...
      Google.Ads.Googleads.V12.Services.MutateCustomerClientLinkResponse
end
