...
defmodule Google.Ads.Googleads.V12.Services.ListMerchantCenterLinksResponse do
  ...
  field :merchant_center_links, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Resources.MerchantCenterLink,
...
defmodule Google.Ads.Googleads.V12.Services.MutateMerchantCenterLinkRequest do
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V12.Services.MerchantCenterLinkOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V12.Services.MerchantCenterLinkOperation do
  ...
  field :update, 1, type: Google.Ads.Googleads.V12.Resources.MerchantCenterLink, oneof: 0
...
defmodule Google.Ads.Googleads.V12.Services.MerchantCenterLinkService.Service do
  ...
  rpc :ListMerchantCenterLinks,
      ...
      Google.Ads.Googleads.V12.Services.ListMerchantCenterLinksResponse

  rpc :GetMerchantCenterLink,
      Google.Ads.Googleads.V12.Services.GetMerchantCenterLinkRequest,
      Google.Ads.Googleads.V12.Resources.MerchantCenterLink

  rpc :MutateMerchantCenterLink,
      Google.Ads.Googleads.V12.Services.MutateMerchantCenterLinkRequest,
      Google.Ads.Googleads.V12.Services.MutateMerchantCenterLinkResponse
end
