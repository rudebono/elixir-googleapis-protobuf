...
defmodule Google.Ads.Googleads.V12.Services.AudienceOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V12.Resources.Audience, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V12.Resources.Audience, oneof: 0
end
...
defmodule Google.Ads.Googleads.V12.Services.AudienceService.Service do
  ...
  rpc :MutateAudiences,
      ...
      Google.Ads.Googleads.V12.Services.MutateAudiencesResponse
end
