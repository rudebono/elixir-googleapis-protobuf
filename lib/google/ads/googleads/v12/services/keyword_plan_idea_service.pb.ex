defmodule Google.Ads.Googleads.V12.Services.GenerateKeywordIdeasRequest do
  ...
  field :keyword_plan_network, 9,
    type: Google.Ads.Googleads.V12.Enums.KeywordPlanNetworkEnum.KeywordPlanNetwork,
  ...
  field :keyword_annotation, 17,
    repeated: true,
    type:
      Google.Ads.Googleads.V12.Enums.KeywordPlanKeywordAnnotationEnum.KeywordPlanKeywordAnnotation,
  ...
  field :keyword_and_url_seed, 2,
    type: Google.Ads.Googleads.V12.Services.KeywordAndUrlSeed,
    json_name: "keywordAndUrlSeed",
    oneof: 0

  field :keyword_seed, 3,
    type: Google.Ads.Googleads.V12.Services.KeywordSeed,
    json_name: "keywordSeed",
    oneof: 0

  field :url_seed, 5,
    type: Google.Ads.Googleads.V12.Services.UrlSeed,
    json_name: "urlSeed",
    oneof: 0

  field :site_seed, 11,
    type: Google.Ads.Googleads.V12.Services.SiteSeed,
    json_name: "siteSeed",
    oneof: 0
end
...
defmodule Google.Ads.Googleads.V12.Services.GenerateKeywordIdeaResponse do
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.GenerateKeywordIdeaResult
...
defmodule Google.Ads.Googleads.V12.Services.GenerateKeywordIdeaResult do
  ...
  field :keyword_annotations, 6,
    type: Google.Ads.Googleads.V12.Common.KeywordAnnotations,
...
defmodule Google.Ads.Googleads.V12.Services.GenerateKeywordHistoricalMetricsResponse do
  ...
  field :results, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.GenerateKeywordHistoricalMetricsResult
...
defmodule Google.Ads.Googleads.V12.Services.GenerateAdGroupThemesResponse do
  ...
  field :ad_group_keyword_suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.AdGroupKeywordSuggestion,
    json_name: "adGroupKeywordSuggestions"

  field :unusable_ad_groups, 2,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.UnusableAdGroup,
...
defmodule Google.Ads.Googleads.V12.Services.KeywordPlanIdeaService.Service do
  ...
  rpc :GenerateKeywordIdeas,
      ...
      Google.Ads.Googleads.V12.Services.GenerateKeywordIdeaResponse

  rpc :GenerateKeywordHistoricalMetrics,
      Google.Ads.Googleads.V12.Services.GenerateKeywordHistoricalMetricsRequest,
      Google.Ads.Googleads.V12.Services.GenerateKeywordHistoricalMetricsResponse

  rpc :GenerateAdGroupThemes,
      Google.Ads.Googleads.V12.Services.GenerateAdGroupThemesRequest,
      Google.Ads.Googleads.V12.Services.GenerateAdGroupThemesResponse
end
