defmodule Google.Ads.Googleads.V12.Services.MutateBatchJobRequest do
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V12.Services.BatchJobOperation,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V12.Services.BatchJobOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V12.Resources.BatchJob, oneof: 0
...
defmodule Google.Ads.Googleads.V12.Services.BatchJobService.Service do
  ...
  rpc :MutateBatchJob,
      ...
      Google.Ads.Googleads.V12.Services.MutateBatchJobResponse

  rpc :ListBatchJobResults,
      Google.Ads.Googleads.V12.Services.ListBatchJobResultsRequest,
      Google.Ads.Googleads.V12.Services.ListBatchJobResultsResponse

  rpc :RunBatchJob,
      Google.Ads.Googleads.V12.Services.RunBatchJobRequest,
      Google.Longrunning.Operation

  rpc :AddBatchJobOperations,
      Google.Ads.Googleads.V12.Services.AddBatchJobOperationsRequest,
      Google.Ads.Googleads.V12.Services.AddBatchJobOperationsResponse
end
