defmodule Google.Ads.Googleads.V12.Services.UploadClickConversionsRequest do
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.ClickConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V12.Services.UploadCallConversionsRequest do
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.CallConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V12.Services.ClickConversion do
  ...
  field :external_attribution_data, 7,
    type: Google.Ads.Googleads.V12.Services.ExternalAttributionData,
    json_name: "externalAttributionData"

  field :custom_variables, 15,
    repeated: true,
    type: Google.Ads.Googleads.V12.Services.CustomVariable,
    json_name: "customVariables"

  field :cart_data, 16, type: Google.Ads.Googleads.V12.Services.CartData, json_name: "cartData"
  ...
  field :conversion_environment, 20,
    type: Google.Ads.Googleads.V12.Enums.ConversionEnvironmentEnum.ConversionEnvironment,
...
defmodule Google.Ads.Googleads.V12.Services.CartData do
  ...
  field :items, 5, repeated: true, type: Google.Ads.Googleads.V12.Services.CartData.Item
end
...
defmodule Google.Ads.Googleads.V12.Services.ConversionUploadService.Service do
  ...
  rpc :UploadClickConversions,
      ...
      Google.Ads.Googleads.V12.Services.UploadClickConversionsResponse

  rpc :UploadCallConversions,
      Google.Ads.Googleads.V12.Services.UploadCallConversionsRequest,
      Google.Ads.Googleads.V12.Services.UploadCallConversionsResponse
end
