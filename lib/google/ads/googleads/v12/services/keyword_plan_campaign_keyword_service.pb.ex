...
defmodule Google.Ads.Googleads.V12.Services.KeywordPlanCampaignKeywordOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V12.Resources.KeywordPlanCampaignKeyword, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V12.Resources.KeywordPlanCampaignKeyword, oneof: 0
...
defmodule Google.Ads.Googleads.V12.Services.KeywordPlanCampaignKeywordService.Service do
  ...
  rpc :MutateKeywordPlanCampaignKeywords,
      ...
      Google.Ads.Googleads.V12.Services.MutateKeywordPlanCampaignKeywordsResponse
end
