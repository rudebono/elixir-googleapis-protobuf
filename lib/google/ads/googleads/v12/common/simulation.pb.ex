defmodule Google.Ads.Googleads.V12.Common.BidModifierSimulationPointList do
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.BidModifierSimulationPoint
end
...
defmodule Google.Ads.Googleads.V12.Common.TargetRoasSimulationPointList do
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.TargetRoasSimulationPoint
end
...
defmodule Google.Ads.Googleads.V12.Common.PercentCpcBidSimulationPointList do
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.PercentCpcBidSimulationPoint
end
...
defmodule Google.Ads.Googleads.V12.Common.TargetImpressionShareSimulationPointList do
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.TargetImpressionShareSimulationPoint
end
