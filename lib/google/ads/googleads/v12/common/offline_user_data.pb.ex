defmodule Google.Ads.Googleads.V12.Common.OfflineUserAddressInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.UserIdentifier do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :user_identifier_source, 6,
    type: Google.Ads.Googleads.V12.Enums.UserIdentifierSourceEnum.UserIdentifierSource,
  ...
  field :address_info, 5,
    type: Google.Ads.Googleads.V12.Common.OfflineUserAddressInfo,
    json_name: "addressInfo",
    oneof: 0
end

defmodule Google.Ads.Googleads.V12.Common.TransactionAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :store_attribute, 6,
    type: Google.Ads.Googleads.V12.Common.StoreAttribute,
  ...
  field :item_attribute, 14,
    type: Google.Ads.Googleads.V12.Common.ItemAttribute,
    json_name: "itemAttribute"
end

defmodule Google.Ads.Googleads.V12.Common.StoreAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Common.ItemAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Common.UserData do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :user_identifiers, 1,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.UserIdentifier,
    json_name: "userIdentifiers"

  field :transaction_attribute, 2,
    type: Google.Ads.Googleads.V12.Common.TransactionAttribute,
    json_name: "transactionAttribute"

  field :user_attribute, 3,
    type: Google.Ads.Googleads.V12.Common.UserAttribute,
    json_name: "userAttribute"
end

defmodule Google.Ads.Googleads.V12.Common.UserAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :shopping_loyalty, 7,
    proto3_optional: true,
    type: Google.Ads.Googleads.V12.Common.ShoppingLoyalty,
  ...
  field :event_attribute, 10,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.EventAttribute,
    json_name: "eventAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V12.Common.EventAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :item_attribute, 3,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.EventItemAttribute,
    json_name: "itemAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V12.Common.EventItemAttribute do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Common.ShoppingLoyalty do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Common.CustomerMatchUserListMetadata do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Common.StoreSalesMetadata do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :third_party_metadata, 3,
    type: Google.Ads.Googleads.V12.Common.StoreSalesThirdPartyMetadata,
    json_name: "thirdPartyMetadata"
end

defmodule Google.Ads.Googleads.V12.Common.StoreSalesThirdPartyMetadata do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
