defmodule Google.Ads.Googleads.V12.Common.MatchingFunction do
  @moduledoc false
  ...
  field :operator, 4,
    type: Google.Ads.Googleads.V12.Enums.MatchingFunctionOperatorEnum.MatchingFunctionOperator,
    enum: true

  field :left_operands, 2,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.Operand,
...
defmodule Google.Ads.Googleads.V12.Common.Operand.ConstantOperand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.Operand.FeedAttributeOperand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.Operand.FunctionOperand do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :matching_function, 1,
    type: Google.Ads.Googleads.V12.Common.MatchingFunction,
    json_name: "matchingFunction"
end

defmodule Google.Ads.Googleads.V12.Common.Operand.RequestContextOperand do
  @moduledoc false
  ...
  field :context_type, 1,
    type:
      Google.Ads.Googleads.V12.Enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType,
    json_name: "contextType",
    enum: true
end

defmodule Google.Ads.Googleads.V12.Common.Operand do
  @moduledoc false
  ...
  field :constant_operand, 1,
    type: Google.Ads.Googleads.V12.Common.Operand.ConstantOperand,
    json_name: "constantOperand",
    oneof: 0

  field :feed_attribute_operand, 2,
    type: Google.Ads.Googleads.V12.Common.Operand.FeedAttributeOperand,
    json_name: "feedAttributeOperand",
    oneof: 0

  field :function_operand, 3,
    type: Google.Ads.Googleads.V12.Common.Operand.FunctionOperand,
    json_name: "functionOperand",
    oneof: 0

  field :request_context_operand, 4,
    type: Google.Ads.Googleads.V12.Common.Operand.RequestContextOperand,
