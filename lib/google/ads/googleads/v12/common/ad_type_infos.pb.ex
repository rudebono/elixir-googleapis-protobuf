defmodule Google.Ads.Googleads.V12.Common.TextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.ExpandedTextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.ExpandedDynamicSearchAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.HotelAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V12.Common.ShoppingSmartAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V12.Common.ShoppingProductAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V12.Common.ShoppingComparisonListingAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.ImageAdInfo do
  @moduledoc false
  ...
  field :mime_type, 10,
    type: Google.Ads.Googleads.V12.Enums.MimeTypeEnum.MimeType,
    json_name: "mimeType",
    enum: true
...
defmodule Google.Ads.Googleads.V12.Common.VideoBumperInStreamAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :companion_banner, 3,
    type: Google.Ads.Googleads.V12.Common.AdImageAsset,
    json_name: "companionBanner"
end

defmodule Google.Ads.Googleads.V12.Common.VideoNonSkippableInStreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.VideoTrueViewInStreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.VideoOutstreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.InFeedVideoAdInfo do
  @moduledoc false
  ...
  field :thumbnail, 4,
    type: Google.Ads.Googleads.V12.Enums.VideoThumbnailEnum.VideoThumbnail,
    enum: true
end

defmodule Google.Ads.Googleads.V12.Common.VideoAdInfo do
  @moduledoc false
  ...
  field :video, 8, type: Google.Ads.Googleads.V12.Common.AdVideoAsset

  field :in_stream, 2,
    type: Google.Ads.Googleads.V12.Common.VideoTrueViewInStreamAdInfo,
    json_name: "inStream",
    oneof: 0

  field :bumper, 3, type: Google.Ads.Googleads.V12.Common.VideoBumperInStreamAdInfo, oneof: 0

  field :out_stream, 4,
    type: Google.Ads.Googleads.V12.Common.VideoOutstreamAdInfo,
    json_name: "outStream",
    oneof: 0

  field :non_skippable, 5,
    type: Google.Ads.Googleads.V12.Common.VideoNonSkippableInStreamAdInfo,
    json_name: "nonSkippable",
    oneof: 0

  field :in_feed, 9,
    type: Google.Ads.Googleads.V12.Common.InFeedVideoAdInfo,
    json_name: "inFeed",
    oneof: 0
end

defmodule Google.Ads.Googleads.V12.Common.VideoResponsiveAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset

  field :long_headlines, 2,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.AdTextAsset,
    json_name: "longHeadlines"

  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  ...
  field :videos, 5, repeated: true, type: Google.Ads.Googleads.V12.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V12.Common.ResponsiveSearchAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :path1, 5, proto3_optional: true, type: :string
  field :path2, 6, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V12.Common.LegacyResponsiveDisplayAdInfo do
  @moduledoc false
  ...
  field :format_setting, 13,
    type: Google.Ads.Googleads.V12.Enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting,
...
defmodule Google.Ads.Googleads.V12.Common.AppAdInfo do
  @moduledoc false
  ...
  field :headlines, 2, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :images, 4, repeated: true, type: Google.Ads.Googleads.V12.Common.AdImageAsset

  field :youtube_videos, 5,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.AdVideoAsset,
    json_name: "youtubeVideos"

  field :html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.AdMediaBundleAsset,
    json_name: "html5MediaBundles"
end

defmodule Google.Ads.Googleads.V12.Common.AppEngagementAdInfo do
  @moduledoc false
  ...
  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :images, 3, repeated: true, type: Google.Ads.Googleads.V12.Common.AdImageAsset
  field :videos, 4, repeated: true, type: Google.Ads.Googleads.V12.Common.AdVideoAsset
end

defmodule Google.Ads.Googleads.V12.Common.AppPreRegistrationAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.LegacyAppInstallAdInfo do
  @moduledoc false
  ...
  field :app_store, 2,
    type:
      Google.Ads.Googleads.V12.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V12.Common.ResponsiveDisplayAdInfo do
  @moduledoc false
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset

  field :long_headline, 6,
    type: Google.Ads.Googleads.V12.Common.AdTextAsset,
    json_name: "longHeadline"

  field :descriptions, 7, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  ...
  field :control_spec, 24,
    type: Google.Ads.Googleads.V12.Common.ResponsiveDisplayAdControlSpec,
    json_name: "controlSpec"
end

defmodule Google.Ads.Googleads.V12.Common.LocalAdInfo do
  @moduledoc false
  ...
  field :videos, 6, repeated: true, type: Google.Ads.Googleads.V12.Common.AdVideoAsset
  field :path1, 9, proto3_optional: true, type: :string
  field :path2, 10, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V12.Common.DisplayUploadAdInfo do
  @moduledoc false
  ...
  field :display_upload_product_type, 1,
    type: Google.Ads.Googleads.V12.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType,
...
defmodule Google.Ads.Googleads.V12.Common.ResponsiveDisplayAdControlSpec do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.SmartCampaignAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Common.CallAdInfo do
  @moduledoc false
  ...
  field :conversion_reporting_state, 10,
    type:
      Google.Ads.Googleads.V12.Enums.CallConversionReportingStateEnum.CallConversionReportingState,
...
defmodule Google.Ads.Googleads.V12.Common.DiscoveryMultiAssetAdInfo do
  @moduledoc false
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
  field :descriptions, 6, repeated: true, type: Google.Ads.Googleads.V12.Common.AdTextAsset
...
defmodule Google.Ads.Googleads.V12.Common.DiscoveryCarouselAdInfo do
  @moduledoc false
  ...
  field :headline, 3, type: Google.Ads.Googleads.V12.Common.AdTextAsset, deprecated: false
  field :description, 4, type: Google.Ads.Googleads.V12.Common.AdTextAsset, deprecated: false
  field :call_to_action_text, 5, type: :string, json_name: "callToActionText"

  field :carousel_cards, 6,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.AdDiscoveryCarouselCardAsset,
