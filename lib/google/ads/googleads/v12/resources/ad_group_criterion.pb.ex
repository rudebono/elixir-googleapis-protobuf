defmodule Google.Ads.Googleads.V12.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Resources.AdGroupCriterion do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V12.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V12.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V12.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V12.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
  ...
  field :effective_cpc_bid_source, 21,
    type: Google.Ads.Googleads.V12.Enums.BiddingSourceEnum.BiddingSource,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V12.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :listing_group, 32,
    type: Google.Ads.Googleads.V12.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V12.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :user_list, 42,
    type: Google.Ads.Googleads.V12.Common.UserListInfo,
    json_name: "userList",
    oneof: 0,
    deprecated: false
  ...
  field :topic, 43, type: Google.Ads.Googleads.V12.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :webpage, 46,
    type: Google.Ads.Googleads.V12.Common.WebpageInfo,
    oneof: 0,
    deprecated: false

  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V12.Common.AppPaymentModelInfo,
    json_name: "appPaymentModel",
    oneof: 0,
    deprecated: false

  field :custom_affinity, 48,
    type: Google.Ads.Googleads.V12.Common.CustomAffinityInfo,
    json_name: "customAffinity",
    oneof: 0,
    deprecated: false

  field :custom_intent, 49,
    type: Google.Ads.Googleads.V12.Common.CustomIntentInfo,
    json_name: "customIntent",
    oneof: 0,
    deprecated: false

  field :custom_audience, 74,
    type: Google.Ads.Googleads.V12.Common.CustomAudienceInfo,
    json_name: "customAudience",
    oneof: 0,
    deprecated: false

  field :combined_audience, 75,
    type: Google.Ads.Googleads.V12.Common.CombinedAudienceInfo,
    json_name: "combinedAudience",
    oneof: 0,
    deprecated: false

  field :audience, 79,
    type: Google.Ads.Googleads.V12.Common.AudienceInfo,
    oneof: 0,
    deprecated: false
end