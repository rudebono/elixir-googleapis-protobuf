...
defmodule Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy do
  ...
  field :maximize_conversion_value, 7,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.MaximizeConversionValue,
    json_name: "maximizeConversionValue",
    oneof: 0,
    deprecated: false

  field :maximize_conversions, 8,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.MaximizeConversions,
    json_name: "maximizeConversions",
    oneof: 0,
    deprecated: false

  field :target_cpa, 9,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.TargetCpa,
    json_name: "targetCpa",
    oneof: 0,
    deprecated: false

  field :target_impression_share, 10,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.TargetImpressionShare,
    json_name: "targetImpressionShare",
    oneof: 0,
    deprecated: false

  field :target_roas, 11,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.TargetRoas,
    json_name: "targetRoas",
    oneof: 0,
    deprecated: false

  field :target_spend, 12,
    type: Google.Ads.Googleads.V12.Resources.AccessibleBiddingStrategy.TargetSpend,
