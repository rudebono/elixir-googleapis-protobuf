defmodule Google.Ads.Googleads.V12.Resources.MediaFile do
  @moduledoc false
  ...
  field :type, 5,
    type: Google.Ads.Googleads.V12.Enums.MediaTypeEnum.MediaType,
    enum: true,
    deprecated: false
  ...
  field :image, 3,
    type: Google.Ads.Googleads.V12.Resources.MediaImage,
    oneof: 0,
    deprecated: false

  field :media_bundle, 4,
    type: Google.Ads.Googleads.V12.Resources.MediaBundle,
    json_name: "mediaBundle",
    oneof: 0,
    deprecated: false

  field :audio, 10,
    type: Google.Ads.Googleads.V12.Resources.MediaAudio,
    oneof: 0,
    deprecated: false

  field :video, 11,
    type: Google.Ads.Googleads.V12.Resources.MediaVideo,
    oneof: 0,
    deprecated: false
end

defmodule Google.Ads.Googleads.V12.Resources.MediaImage do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Resources.MediaBundle do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Resources.MediaAudio do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V12.Resources.MediaVideo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
