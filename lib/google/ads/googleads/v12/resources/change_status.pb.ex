defmodule Google.Ads.Googleads.V12.Resources.ChangeStatus do
  @moduledoc false
  ...
  field :resource_type, 4,
    type: Google.Ads.Googleads.V12.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType,
  ...
  field :resource_status, 8,
    type: Google.Ads.Googleads.V12.Enums.ChangeStatusOperationEnum.ChangeStatusOperation,
