defmodule Google.Ads.Googleads.V12.Resources.CampaignSimulation do
  @moduledoc false
  ...
  field :cpc_bid_point_list, 7,
    type: Google.Ads.Googleads.V12.Common.CpcBidSimulationPointList,
  ...
  field :target_impression_share_point_list, 10,
    type: Google.Ads.Googleads.V12.Common.TargetImpressionShareSimulationPointList,
    json_name: "targetImpressionSharePointList",
    oneof: 0,
    deprecated: false

  field :budget_point_list, 11,
    type: Google.Ads.Googleads.V12.Common.BudgetSimulationPointList,
