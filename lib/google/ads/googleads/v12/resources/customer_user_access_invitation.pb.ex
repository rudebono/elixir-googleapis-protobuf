defmodule Google.Ads.Googleads.V12.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V12.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
