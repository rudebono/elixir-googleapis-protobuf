defmodule Google.Ads.Googleads.V12.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field :status, 7,
    type: Google.Ads.Googleads.V12.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true,
    deprecated: false
