defmodule Google.Ads.Googleads.V12.Resources.ProductBiddingCategoryConstant do
  @moduledoc false
  ...
  field :status, 6,
    type:
      Google.Ads.Googleads.V12.Enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus,
    enum: true,
    deprecated: false
