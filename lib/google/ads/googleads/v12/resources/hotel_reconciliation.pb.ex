defmodule Google.Ads.Googleads.V12.Resources.HotelReconciliation do
  @moduledoc false
  ...
  field :status, 10,
    type: Google.Ads.Googleads.V12.Enums.HotelReconciliationStatusEnum.HotelReconciliationStatus,
    enum: true,
    deprecated: false
end