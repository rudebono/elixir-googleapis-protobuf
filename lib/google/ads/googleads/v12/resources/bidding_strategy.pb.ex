defmodule Google.Ads.Googleads.V12.Resources.BiddingStrategy do
  @moduledoc false
  ...
  field :status, 15,
    type: Google.Ads.Googleads.V12.Enums.BiddingStrategyStatusEnum.BiddingStrategyStatus,
    enum: true,
    deprecated: false
  ...
  field :enhanced_cpc, 7,
    type: Google.Ads.Googleads.V12.Common.EnhancedCpc,
