defmodule Google.Ads.Googleads.V12.Resources.Invoice.AccountSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Resources.Invoice.AccountBudgetSummary do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :billable_activity_date_range, 9,
    type: Google.Ads.Googleads.V12.Common.DateRange,
...
defmodule Google.Ads.Googleads.V12.Resources.Invoice do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :type, 3,
    type: Google.Ads.Googleads.V12.Enums.InvoiceTypeEnum.InvoiceType,
    enum: true,
    deprecated: false
  ...
  field :account_budget_summaries, 18,
    repeated: true,
    type: Google.Ads.Googleads.V12.Resources.Invoice.AccountBudgetSummary,
    json_name: "accountBudgetSummaries",
    deprecated: false

  field :account_summaries, 39,
    repeated: true,
    type: Google.Ads.Googleads.V12.Resources.Invoice.AccountSummary,
