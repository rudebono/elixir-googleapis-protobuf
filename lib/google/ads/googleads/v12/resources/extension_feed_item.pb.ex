defmodule Google.Ads.Googleads.V12.Resources.ExtensionFeedItem do
  @moduledoc false
  ...
  field :extension_type, 13,
    type: Google.Ads.Googleads.V12.Enums.ExtensionTypeEnum.ExtensionType,
  ...
  field :device, 17,
    type: Google.Ads.Googleads.V12.Enums.FeedItemTargetDeviceEnum.FeedItemTargetDevice,
    enum: true
  ...
  field :structured_snippet_feed_item, 3,
    type: Google.Ads.Googleads.V12.Common.StructuredSnippetFeedItem,
    json_name: "structuredSnippetFeedItem",
    oneof: 0

  field :app_feed_item, 7,
    type: Google.Ads.Googleads.V12.Common.AppFeedItem,
  ...
  field :text_message_feed_item, 10,
    type: Google.Ads.Googleads.V12.Common.TextMessageFeedItem,
    json_name: "textMessageFeedItem",
    oneof: 0

  field :price_feed_item, 11,
    type: Google.Ads.Googleads.V12.Common.PriceFeedItem,
    json_name: "priceFeedItem",
    oneof: 0

  field :promotion_feed_item, 12,
    type: Google.Ads.Googleads.V12.Common.PromotionFeedItem,
    json_name: "promotionFeedItem",
    oneof: 0

  field :location_feed_item, 14,
    type: Google.Ads.Googleads.V12.Common.LocationFeedItem,
    json_name: "locationFeedItem",
    oneof: 0,
    deprecated: false

  field :affiliate_location_feed_item, 15,
    type: Google.Ads.Googleads.V12.Common.AffiliateLocationFeedItem,
    json_name: "affiliateLocationFeedItem",
    oneof: 0,
    deprecated: false

  field :hotel_callout_feed_item, 23,
    type: Google.Ads.Googleads.V12.Common.HotelCalloutFeedItem,
    json_name: "hotelCalloutFeedItem",
    oneof: 0

  field :image_feed_item, 31,
    type: Google.Ads.Googleads.V12.Common.ImageFeedItem,
