defmodule Google.Ads.Googleads.V12.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V12.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
