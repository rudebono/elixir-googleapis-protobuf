defmodule Google.Ads.Googleads.V12.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Resources.AdGroup do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V12.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true

  field :type, 12,
    type: Google.Ads.Googleads.V12.Enums.AdGroupTypeEnum.AdGroupType,
    enum: true,
    deprecated: false

  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V12.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :explorer_auto_optimizer_setting, 21,
    type: Google.Ads.Googleads.V12.Common.ExplorerAutoOptimizerSetting,
    json_name: "explorerAutoOptimizerSetting"

  field :display_custom_bid_dimension, 23,
    type: Google.Ads.Googleads.V12.Enums.TargetingDimensionEnum.TargetingDimension,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V12.Resources.AdGroup.AudienceSetting,
