defmodule Google.Ads.Googleads.V12.Resources.Ad do
  @moduledoc false
  ...
  field :final_app_urls, 35,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.FinalAppUrl,
  ...
  field :type, 5,
    type: Google.Ads.Googleads.V12.Enums.AdTypeEnum.AdType,
    enum: true,
    deprecated: false
  ...
  field :device_preference, 20,
    type: Google.Ads.Googleads.V12.Enums.DeviceEnum.Device,
    json_name: "devicePreference",
    enum: true

  field :url_collections, 26,
    repeated: true,
    type: Google.Ads.Googleads.V12.Common.UrlCollection,
  ...
  field :system_managed_resource_source, 27,
    type:
      Google.Ads.Googleads.V12.Enums.SystemManagedResourceSourceEnum.SystemManagedResourceSource,
    json_name: "systemManagedResourceSource",
    enum: true,
    deprecated: false

  field :text_ad, 6,
    type: Google.Ads.Googleads.V12.Common.TextAdInfo,
    json_name: "textAd",
    oneof: 0,
    deprecated: false

  field :expanded_text_ad, 7,
    type: Google.Ads.Googleads.V12.Common.ExpandedTextAdInfo,
    json_name: "expandedTextAd",
    oneof: 0

  field :call_ad, 49,
    type: Google.Ads.Googleads.V12.Common.CallAdInfo,
    json_name: "callAd",
    oneof: 0

  field :expanded_dynamic_search_ad, 14,
    type: Google.Ads.Googleads.V12.Common.ExpandedDynamicSearchAdInfo,
    json_name: "expandedDynamicSearchAd",
    oneof: 0,
    deprecated: false

  field :hotel_ad, 15,
    type: Google.Ads.Googleads.V12.Common.HotelAdInfo,
    json_name: "hotelAd",
    oneof: 0

  field :shopping_smart_ad, 17,
    type: Google.Ads.Googleads.V12.Common.ShoppingSmartAdInfo,
    json_name: "shoppingSmartAd",
    oneof: 0

  field :shopping_product_ad, 18,
    type: Google.Ads.Googleads.V12.Common.ShoppingProductAdInfo,
    json_name: "shoppingProductAd",
    oneof: 0

  field :image_ad, 22,
    type: Google.Ads.Googleads.V12.Common.ImageAdInfo,
    json_name: "imageAd",
    oneof: 0,
    deprecated: false

  field :video_ad, 24,
    type: Google.Ads.Googleads.V12.Common.VideoAdInfo,
    json_name: "videoAd",
    oneof: 0

  field :video_responsive_ad, 39,
    type: Google.Ads.Googleads.V12.Common.VideoResponsiveAdInfo,
    json_name: "videoResponsiveAd",
    oneof: 0

  field :responsive_search_ad, 25,
    type: Google.Ads.Googleads.V12.Common.ResponsiveSearchAdInfo,
    json_name: "responsiveSearchAd",
    oneof: 0

  field :legacy_responsive_display_ad, 28,
    type: Google.Ads.Googleads.V12.Common.LegacyResponsiveDisplayAdInfo,
    json_name: "legacyResponsiveDisplayAd",
    oneof: 0

  field :app_ad, 29, type: Google.Ads.Googleads.V12.Common.AppAdInfo, json_name: "appAd", oneof: 0

  field :legacy_app_install_ad, 30,
    type: Google.Ads.Googleads.V12.Common.LegacyAppInstallAdInfo,
    json_name: "legacyAppInstallAd",
    oneof: 0,
    deprecated: false

  field :responsive_display_ad, 31,
    type: Google.Ads.Googleads.V12.Common.ResponsiveDisplayAdInfo,
    json_name: "responsiveDisplayAd",
    oneof: 0

  field :local_ad, 32,
    type: Google.Ads.Googleads.V12.Common.LocalAdInfo,
    json_name: "localAd",
    oneof: 0

  field :display_upload_ad, 33,
    type: Google.Ads.Googleads.V12.Common.DisplayUploadAdInfo,
    json_name: "displayUploadAd",
    oneof: 0

  field :app_engagement_ad, 34,
    type: Google.Ads.Googleads.V12.Common.AppEngagementAdInfo,
    json_name: "appEngagementAd",
    oneof: 0

  field :shopping_comparison_listing_ad, 36,
    type: Google.Ads.Googleads.V12.Common.ShoppingComparisonListingAdInfo,
  ...
  field :app_pre_registration_ad, 50,
    type: Google.Ads.Googleads.V12.Common.AppPreRegistrationAdInfo,
    json_name: "appPreRegistrationAd",
    oneof: 0

  field :discovery_multi_asset_ad, 51,
    type: Google.Ads.Googleads.V12.Common.DiscoveryMultiAssetAdInfo,
    json_name: "discoveryMultiAssetAd",
    oneof: 0

  field :discovery_carousel_ad, 52,
    type: Google.Ads.Googleads.V12.Common.DiscoveryCarouselAdInfo,
