...
defmodule Google.Ads.Googleads.V12.Resources.Feed.AffiliateLocationFeedData do
  ...
  field :relationship_type, 2,
    type:
      Google.Ads.Googleads.V12.Enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType,
...
defmodule Google.Ads.Googleads.V12.Resources.Feed do
  ...
  field :attributes, 4, repeated: true, type: Google.Ads.Googleads.V12.Resources.FeedAttribute

  field :attribute_operations, 9,
    repeated: true,
    type: Google.Ads.Googleads.V12.Resources.FeedAttributeOperation,
    json_name: "attributeOperations"

  field :origin, 5,
    type: Google.Ads.Googleads.V12.Enums.FeedOriginEnum.FeedOrigin,
    enum: true,
    deprecated: false

  field :status, 8,
    type: Google.Ads.Googleads.V12.Enums.FeedStatusEnum.FeedStatus,
    enum: true,
    deprecated: false

  field :places_location_feed_data, 6,
    type: Google.Ads.Googleads.V12.Resources.Feed.PlacesLocationFeedData,
    json_name: "placesLocationFeedData",
    oneof: 0

  field :affiliate_location_feed_data, 7,
    type: Google.Ads.Googleads.V12.Resources.Feed.AffiliateLocationFeedData,
...
defmodule Google.Ads.Googleads.V12.Resources.FeedAttribute do
  ...
  field :type, 3,
    type: Google.Ads.Googleads.V12.Enums.FeedAttributeTypeEnum.FeedAttributeType,
    enum: true
...
defmodule Google.Ads.Googleads.V12.Resources.FeedAttributeOperation do
  ...
  field :value, 2, type: Google.Ads.Googleads.V12.Resources.FeedAttribute, deprecated: false
end