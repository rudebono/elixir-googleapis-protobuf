defmodule Google.Ads.Googleads.V12.Enums.RecommendationTypeEnum.RecommendationType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Enums.RecommendationTypeEnum do
  @moduledoc false
