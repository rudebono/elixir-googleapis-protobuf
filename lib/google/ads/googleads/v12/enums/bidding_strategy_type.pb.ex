defmodule Google.Ads.Googleads.V12.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
