defmodule Google.Ads.Googleads.V12.Errors.CustomerFeedErrorEnum.CustomerFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.CustomerFeedErrorEnum do
  @moduledoc false
