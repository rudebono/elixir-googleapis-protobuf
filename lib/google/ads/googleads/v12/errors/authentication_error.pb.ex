defmodule Google.Ads.Googleads.V12.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.AuthenticationErrorEnum do
  @moduledoc false
