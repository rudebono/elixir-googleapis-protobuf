defmodule Google.Ads.Googleads.V12.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
