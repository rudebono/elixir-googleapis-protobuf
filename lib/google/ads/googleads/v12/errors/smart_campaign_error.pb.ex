defmodule Google.Ads.Googleads.V12.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.SmartCampaignErrorEnum do
  @moduledoc false
