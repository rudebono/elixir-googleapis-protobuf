defmodule Google.Ads.Googleads.V12.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
