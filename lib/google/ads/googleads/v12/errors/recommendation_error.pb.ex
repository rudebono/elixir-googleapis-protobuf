defmodule Google.Ads.Googleads.V12.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.RecommendationErrorEnum do
  @moduledoc false
