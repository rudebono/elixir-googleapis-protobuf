defmodule Google.Ads.Googleads.V12.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
