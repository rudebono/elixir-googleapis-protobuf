defmodule Google.Ads.Googleads.V12.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.CampaignFeedErrorEnum do
  @moduledoc false
