defmodule Google.Ads.Googleads.V12.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
