defmodule Google.Ads.Googleads.V12.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.AuthorizationErrorEnum do
  @moduledoc false
