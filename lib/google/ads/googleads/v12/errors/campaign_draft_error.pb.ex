defmodule Google.Ads.Googleads.V12.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V12.Errors.CampaignDraftErrorEnum do
  @moduledoc false
