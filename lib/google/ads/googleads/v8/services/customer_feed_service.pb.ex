...
defmodule Google.Ads.Googleads.V8.Services.CustomerFeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V8.Resources.CustomerFeed.t() | nil}
            | {:update, Google.Ads.Googleads.V8.Resources.CustomerFeed.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V8.Resources.CustomerFeed, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V8.Resources.CustomerFeed, oneof: 0
