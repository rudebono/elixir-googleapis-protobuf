...
defmodule Google.Ads.Googleads.V8.Services.CampaignBudgetOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V8.Resources.CampaignBudget.t() | nil}
            | {:update, Google.Ads.Googleads.V8.Resources.CampaignBudget.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V8.Resources.CampaignBudget, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V8.Resources.CampaignBudget, oneof: 0
