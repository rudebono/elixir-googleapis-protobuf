...
defmodule Google.Ads.Googleads.V8.Services.MutateSharedCriteriaRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8.Services.SharedCriterionOperation.t()],
...
defmodule Google.Ads.Googleads.V8.Services.SharedCriterionOperation do
  ...
  oneof :operation, 0
  field :create, 1, type: Google.Ads.Googleads.V8.Resources.SharedCriterion, oneof: 0
...
defmodule Google.Ads.Googleads.V8.Services.MutateSharedCriteriaResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8.Services.MutateSharedCriterionResult.t()]
        }
...
defmodule Google.Ads.Googleads.V8.Services.MutateSharedCriterionResult do
  ...
  field :resource_name, 1, type: :string
  field :shared_criterion, 2, type: Google.Ads.Googleads.V8.Resources.SharedCriterion
end
