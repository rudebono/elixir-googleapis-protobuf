...
defmodule Google.Ads.Googleads.V8.Services.MutateAdGroupFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8.Services.AdGroupFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V8.Services.AdGroupFeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V8.Resources.AdGroupFeed.t() | nil}
            | {:update, Google.Ads.Googleads.V8.Resources.AdGroupFeed.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V8.Resources.AdGroupFeed, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V8.Resources.AdGroupFeed, oneof: 0
...
defmodule Google.Ads.Googleads.V8.Services.MutateAdGroupFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8.Services.MutateAdGroupFeedResult.t()]
        }
