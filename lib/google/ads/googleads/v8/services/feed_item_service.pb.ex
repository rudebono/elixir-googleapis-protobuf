...
defmodule Google.Ads.Googleads.V8.Services.FeedItemOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V8.Resources.FeedItem.t() | nil}
            | {:update, Google.Ads.Googleads.V8.Resources.FeedItem.t() | nil}
            | {:remove, String.t()},
...
defmodule Google.Ads.Googleads.V8.Services.MutateFeedItemResult do
  ...
  field :feed_item, 2, type: Google.Ads.Googleads.V8.Resources.FeedItem, json_name: "feedItem"
end
