...
defmodule Google.Ads.Googleads.V8.Services.MutateCampaignFeedsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V8.Services.CampaignFeedOperation.t()],
...
defmodule Google.Ads.Googleads.V8.Services.CampaignFeedOperation do
  ...
  @type t :: %__MODULE__{
          operation:
            {:create, Google.Ads.Googleads.V8.Resources.CampaignFeed.t() | nil}
            | {:update, Google.Ads.Googleads.V8.Resources.CampaignFeed.t() | nil}
            | {:remove, String.t()},
  ...
  field :create, 1, type: Google.Ads.Googleads.V8.Resources.CampaignFeed, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V8.Resources.CampaignFeed, oneof: 0
...
defmodule Google.Ads.Googleads.V8.Services.MutateCampaignFeedsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V8.Services.MutateCampaignFeedResult.t()]
        }
