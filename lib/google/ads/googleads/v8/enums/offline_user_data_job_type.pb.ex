defmodule Google.Ads.Googleads.V8.Enums.OfflineUserDataJobTypeEnum.OfflineUserDataJobType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V8.Enums.OfflineUserDataJobTypeEnum do
  @moduledoc false
