defmodule Google.Ads.Googleads.V5.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
