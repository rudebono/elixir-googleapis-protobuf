defmodule Google.Ads.Googleads.V5.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Errors.RecommendationErrorEnum do
  @moduledoc false
