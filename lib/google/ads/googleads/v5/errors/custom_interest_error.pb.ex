defmodule Google.Ads.Googleads.V5.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Errors.CustomInterestErrorEnum do
  @moduledoc false
