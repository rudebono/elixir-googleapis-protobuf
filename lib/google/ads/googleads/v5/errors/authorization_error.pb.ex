defmodule Google.Ads.Googleads.V5.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Errors.AuthorizationErrorEnum do
  @moduledoc false
