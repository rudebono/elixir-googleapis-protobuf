defmodule Google.Ads.Googleads.V5.Resources.BillingSetup.PaymentsAccountInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Resources.BillingSetup do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V5.Enums.BillingSetupStatusEnum.BillingSetupStatus.t(),
          payments_account: Google.Protobuf.StringValue.t() | nil,
          payments_account_info:
            Google.Ads.Googleads.V5.Resources.BillingSetup.PaymentsAccountInfo.t() | nil
        }
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V5.Enums.BillingSetupStatusEnum.BillingSetupStatus,
    enum: true

  field :payments_account, 11, type: Google.Protobuf.StringValue

  field :payments_account_info, 12,
    type: Google.Ads.Googleads.V5.Resources.BillingSetup.PaymentsAccountInfo
