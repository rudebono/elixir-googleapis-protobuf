defmodule Google.Ads.Googleads.V5.Resources.CampaignExperiment do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          traffic_split_type:
            Google.Ads.Googleads.V5.Enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType.t(),
          experiment_campaign: Google.Protobuf.StringValue.t() | nil,
          status:
            Google.Ads.Googleads.V5.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus.t(),
  ...
  field :traffic_split_type, 7,
    type:
      Google.Ads.Googleads.V5.Enums.CampaignExperimentTrafficSplitTypeEnum.CampaignExperimentTrafficSplitType,
    enum: true

  field :experiment_campaign, 8, type: Google.Protobuf.StringValue

  field :status, 9,
    type: Google.Ads.Googleads.V5.Enums.CampaignExperimentStatusEnum.CampaignExperimentStatus,
    enum: true
