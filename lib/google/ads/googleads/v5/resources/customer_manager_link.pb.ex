defmodule Google.Ads.Googleads.V5.Resources.CustomerManagerLink do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V5.Enums.ManagerLinkStatusEnum.ManagerLinkStatus.t()
        }
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V5.Enums.ManagerLinkStatusEnum.ManagerLinkStatus,
    enum: true
end
