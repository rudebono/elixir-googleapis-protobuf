defmodule Google.Ads.Googleads.V5.Resources.UserInterest do
  @moduledoc false
  ...
  @type t :: %__MODULE__{
          ...
          taxonomy_type:
            Google.Ads.Googleads.V5.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType.t(),
          ...
          availabilities: [Google.Ads.Googleads.V5.Common.CriterionCategoryAvailability.t()]
        }
  ...
  field :taxonomy_type, 2,
    type: Google.Ads.Googleads.V5.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
    enum: true
  ...
  field :availabilities, 7,
    repeated: true,
    type: Google.Ads.Googleads.V5.Common.CriterionCategoryAvailability
end
