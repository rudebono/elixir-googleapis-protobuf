...
defmodule Google.Ads.Googleads.V5.Services.FeedItemTargetService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.ads.googleads.v5.services.FeedItemTargetService"

  rpc :GetFeedItemTarget,
      Google.Ads.Googleads.V5.Services.GetFeedItemTargetRequest,
      Google.Ads.Googleads.V5.Resources.FeedItemTarget

  rpc :MutateFeedItemTargets,
      Google.Ads.Googleads.V5.Services.MutateFeedItemTargetsRequest,
      Google.Ads.Googleads.V5.Services.MutateFeedItemTargetsResponse
end

defmodule Google.Ads.Googleads.V5.Services.FeedItemTargetService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V5.Services.FeedItemTargetService.Service
end
