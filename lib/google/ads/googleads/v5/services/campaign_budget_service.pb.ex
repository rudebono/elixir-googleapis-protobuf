defmodule Google.Ads.Googleads.V5.Services.GetCampaignBudgetRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V5.Services.MutateCampaignBudgetsRequest do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          customer_id: String.t(),
          operations: [Google.Ads.Googleads.V5.Services.CampaignBudgetOperation.t()],
...
defmodule Google.Ads.Googleads.V5.Services.CampaignBudgetOperation do
  @moduledoc false
  use Protobuf, syntax: :proto3
  ...
  field :create, 1, type: Google.Ads.Googleads.V5.Resources.CampaignBudget, oneof: 0
  field :update, 2, type: Google.Ads.Googleads.V5.Resources.CampaignBudget, oneof: 0
  field :remove, 3, type: :string, oneof: 0
end

defmodule Google.Ads.Googleads.V5.Services.MutateCampaignBudgetsResponse do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          partial_failure_error: Google.Rpc.Status.t() | nil,
          results: [Google.Ads.Googleads.V5.Services.MutateCampaignBudgetResult.t()]
        }
...
defmodule Google.Ads.Googleads.V5.Services.MutateCampaignBudgetResult do
  @moduledoc false
  use Protobuf, syntax: :proto3
