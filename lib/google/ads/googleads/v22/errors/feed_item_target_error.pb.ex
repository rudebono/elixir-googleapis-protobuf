defmodule Google.Ads.Googleads.V22.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
