defmodule Google.Ads.Googleads.V22.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CampaignDraftErrorEnum do
  @moduledoc false
