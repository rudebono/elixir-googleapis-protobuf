defmodule Google.Ads.Googleads.V22.Errors.ExperimentErrorEnum.ExperimentError do
  @moduledoc false
  ...
  field :DUPLICATE_EXPERIMENT_CAMPAIGN_NAME, 26
  ...
  field :MISSING_EU_POLITICAL_ADVERTISING_SELF_DECLARATION, 31
end

defmodule Google.Ads.Googleads.V22.Errors.ExperimentErrorEnum do
  @moduledoc false
