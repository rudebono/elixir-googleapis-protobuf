defmodule Google.Ads.Googleads.V22.Errors.CampaignLifecycleGoalErrorEnum.CampaignLifecycleGoalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CampaignLifecycleGoalErrorEnum do
  @moduledoc false
