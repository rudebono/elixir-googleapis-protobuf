defmodule Google.Ads.Googleads.V22.Errors.AdGroupCriterionErrorEnum.AdGroupCriterionError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.AdGroupCriterionErrorEnum do
  @moduledoc false
