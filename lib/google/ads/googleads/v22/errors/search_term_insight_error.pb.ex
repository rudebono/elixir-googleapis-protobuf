defmodule Google.Ads.Googleads.V22.Errors.SearchTermInsightErrorEnum.SearchTermInsightError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.SearchTermInsightErrorEnum do
  @moduledoc false
