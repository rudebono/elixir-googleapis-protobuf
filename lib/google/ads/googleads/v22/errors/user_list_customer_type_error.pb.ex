defmodule Google.Ads.Googleads.V22.Errors.UserListCustomerTypeErrorEnum.UserListCustomerTypeError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.UserListCustomerTypeErrorEnum do
  @moduledoc false
