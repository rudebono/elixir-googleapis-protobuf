defmodule Google.Ads.Googleads.V22.Errors.UserListErrorEnum.UserListError do
  @moduledoc false
  ...
  field :PARTNER_AUDIENCE_SOURCE_NOT_SUPPORTED_FOR_USER_LIST_TYPE, 47
  field :COMMERCE_PARTNER_NOT_ALLOWED, 48
  field :PARTNER_AUDIENCE_INFO_NOT_SUPPORTED_FOR_USER_LIST_TYPE, 49
  field :PARTNER_MANAGER_ACCOUNT_DISALLOWED, 50
  field :PARTNER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA, 51
  field :ADVERTISER_TOS_NOT_ACCEPTED, 52
  field :ADVERTISER_PARTNER_LINK_MISSING, 53
  field :ADVERTISER_NOT_ALLOWLISTED_FOR_THIRD_PARTY_PARTNER_DATA, 54
  field :ACCOUNT_SETTING_TYPE_NOT_ALLOWED, 55
end

defmodule Google.Ads.Googleads.V22.Errors.UserListErrorEnum do
  @moduledoc false
