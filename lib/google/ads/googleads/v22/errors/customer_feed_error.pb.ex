defmodule Google.Ads.Googleads.V22.Errors.CustomerFeedErrorEnum.CustomerFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CustomerFeedErrorEnum do
  @moduledoc false
