defmodule Google.Ads.Googleads.V22.Errors.AdErrorEnum.AdError do
  @moduledoc false
  ...
  field :INVALID_YOUTUBE_VIDEO_ASSET_ID_FOR_VIDEO_ADS_SEQUENCING, 157
end

defmodule Google.Ads.Googleads.V22.Errors.AdErrorEnum do
  @moduledoc false
