defmodule Google.Ads.Googleads.V22.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CustomInterestErrorEnum do
  @moduledoc false
