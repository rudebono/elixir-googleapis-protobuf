defmodule Google.Ads.Googleads.V22.Errors.AdCustomizerErrorEnum.AdCustomizerError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.AdCustomizerErrorEnum do
  @moduledoc false
