defmodule Google.Ads.Googleads.V22.Errors.CustomConversionGoalErrorEnum.CustomConversionGoalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CustomConversionGoalErrorEnum do
  @moduledoc false
