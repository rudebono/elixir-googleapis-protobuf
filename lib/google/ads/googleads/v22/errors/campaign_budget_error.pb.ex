defmodule Google.Ads.Googleads.V22.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
  ...
  field :BUDGET_BELOW_PER_DAY_MINIMUM, 22
end

defmodule Google.Ads.Googleads.V22.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
