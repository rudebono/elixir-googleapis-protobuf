defmodule Google.Ads.Googleads.V22.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
