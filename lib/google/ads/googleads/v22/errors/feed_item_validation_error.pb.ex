defmodule Google.Ads.Googleads.V22.Errors.FeedItemValidationErrorEnum.FeedItemValidationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.FeedItemValidationErrorEnum do
  @moduledoc false
