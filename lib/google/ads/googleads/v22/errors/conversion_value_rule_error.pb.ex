defmodule Google.Ads.Googleads.V22.Errors.ConversionValueRuleErrorEnum.ConversionValueRuleError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.ConversionValueRuleErrorEnum do
  @moduledoc false
