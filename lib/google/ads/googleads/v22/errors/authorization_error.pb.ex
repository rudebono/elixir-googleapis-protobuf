defmodule Google.Ads.Googleads.V22.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.AuthorizationErrorEnum do
  @moduledoc false
