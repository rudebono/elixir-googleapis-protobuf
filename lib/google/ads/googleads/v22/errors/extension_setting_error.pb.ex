defmodule Google.Ads.Googleads.V22.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
