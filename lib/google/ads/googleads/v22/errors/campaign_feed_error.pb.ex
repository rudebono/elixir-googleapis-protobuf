defmodule Google.Ads.Googleads.V22.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.CampaignFeedErrorEnum do
  @moduledoc false
