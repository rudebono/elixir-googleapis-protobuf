defmodule Google.Ads.Googleads.V22.Errors.BiddingErrorEnum.BiddingError do
  @moduledoc false
  ...
  field :TARGET_ROAS_TOLERANCE_PERCENT_MILLIS_MUST_BE_INTEGER, 42
end

defmodule Google.Ads.Googleads.V22.Errors.BiddingErrorEnum do
  @moduledoc false
