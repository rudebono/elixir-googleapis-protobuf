defmodule Google.Ads.Googleads.V22.Errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.AccountBudgetProposalErrorEnum do
  @moduledoc false
