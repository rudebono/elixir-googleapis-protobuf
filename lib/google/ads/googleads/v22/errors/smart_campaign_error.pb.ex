defmodule Google.Ads.Googleads.V22.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.SmartCampaignErrorEnum do
  @moduledoc false
