defmodule Google.Ads.Googleads.V22.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Errors.AuthenticationErrorEnum do
  @moduledoc false
