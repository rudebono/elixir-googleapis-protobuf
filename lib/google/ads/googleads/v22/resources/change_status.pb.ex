defmodule Google.Ads.Googleads.V22.Resources.ChangeStatus do
  @moduledoc false
  ...
  field :resource_type, 4,
    type: Google.Ads.Googleads.V22.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType,
  ...
  field :resource_status, 8,
    type: Google.Ads.Googleads.V22.Enums.ChangeStatusOperationEnum.ChangeStatusOperation,
  ...
  field :asset_set, 43, type: :string, json_name: "assetSet", deprecated: false
  field :campaign_budget, 42, type: :string, json_name: "campaignBudget", deprecated: false
  field :campaign_asset_set, 44, type: :string, json_name: "campaignAssetSet", deprecated: false
end
