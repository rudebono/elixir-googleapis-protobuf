defmodule Google.Ads.Googleads.V22.Resources.AccountBudgetProposal do
  @moduledoc false
  ...
  field :status, 15,
    type:
      Google.Ads.Googleads.V22.Enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus,
    enum: true,
    deprecated: false
