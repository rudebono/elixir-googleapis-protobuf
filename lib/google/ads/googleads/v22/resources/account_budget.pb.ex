defmodule Google.Ads.Googleads.V22.Resources.AccountBudget.PendingAccountBudgetProposal do
  @moduledoc false
  ...
  field :proposal_type, 2,
    type: Google.Ads.Googleads.V22.Enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType,
  ...
  field :end_time_type, 6,
    type: Google.Ads.Googleads.V22.Enums.TimeTypeEnum.TimeType,
  ...
  field :spending_limit_type, 8,
    type: Google.Ads.Googleads.V22.Enums.SpendingLimitTypeEnum.SpendingLimitType,
...
defmodule Google.Ads.Googleads.V22.Resources.AccountBudget do
  @moduledoc false
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V22.Enums.AccountBudgetStatusEnum.AccountBudgetStatus,
    enum: true,
    deprecated: false
  ...
  field :pending_proposal, 22,
    type: Google.Ads.Googleads.V22.Resources.AccountBudget.PendingAccountBudgetProposal,
