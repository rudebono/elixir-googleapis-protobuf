defmodule Google.Ads.Googleads.V22.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V22.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
