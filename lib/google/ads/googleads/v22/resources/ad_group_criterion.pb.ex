defmodule Google.Ads.Googleads.V22.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.AdGroupCriterion do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V22.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V22.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V22.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V22.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :primary_status, 85,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V22.Enums.AdGroupCriterionPrimaryStatusEnum.AdGroupCriterionPrimaryStatus,
  ...
  field :primary_status_reasons, 86,
    repeated: true,
    type:
      Google.Ads.Googleads.V22.Enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason,
  ...
  field :listing_group, 32,
    type: Google.Ads.Googleads.V22.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V22.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 43, type: Google.Ads.Googleads.V22.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V22.Common.AppPaymentModelInfo,
    json_name: "appPaymentModel",
    oneof: 0,
    deprecated: false

  field :custom_affinity, 48,
    type: Google.Ads.Googleads.V22.Common.CustomAffinityInfo,
    json_name: "customAffinity",
    oneof: 0,
    deprecated: false

  field :custom_intent, 49,
    type: Google.Ads.Googleads.V22.Common.CustomIntentInfo,
    json_name: "customIntent",
    oneof: 0,
    deprecated: false

  field :custom_audience, 74,
    type: Google.Ads.Googleads.V22.Common.CustomAudienceInfo,
    json_name: "customAudience",
    oneof: 0,
    deprecated: false

  field :combined_audience, 75,
    type: Google.Ads.Googleads.V22.Common.CombinedAudienceInfo,
    json_name: "combinedAudience",
    oneof: 0,
    deprecated: false

  field :audience, 79,
    type: Google.Ads.Googleads.V22.Common.AudienceInfo,
    oneof: 0,
    deprecated: false
  ...
  field :language, 83,
    type: Google.Ads.Googleads.V22.Common.LanguageInfo,
    oneof: 0,
    deprecated: false

  field :life_event, 84,
    type: Google.Ads.Googleads.V22.Common.LifeEventInfo,
    json_name: "lifeEvent",
    oneof: 0,
    deprecated: false

  field :video_lineup, 88,
    type: Google.Ads.Googleads.V22.Common.VideoLineupInfo,
    json_name: "videoLineup",
    oneof: 0,
    deprecated: false

  field :extended_demographic, 90,
    type: Google.Ads.Googleads.V22.Common.ExtendedDemographicInfo,
    json_name: "extendedDemographic",
    oneof: 0,
    deprecated: false

  field :brand_list, 89,
    type: Google.Ads.Googleads.V22.Common.BrandListInfo,
    json_name: "brandList",
    oneof: 0,
    deprecated: false
end
