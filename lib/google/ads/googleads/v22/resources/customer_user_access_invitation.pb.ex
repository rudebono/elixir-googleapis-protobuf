defmodule Google.Ads.Googleads.V22.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V22.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
