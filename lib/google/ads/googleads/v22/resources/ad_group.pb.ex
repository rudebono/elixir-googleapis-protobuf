defmodule Google.Ads.Googleads.V22.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls do
  @moduledoc false
  ...
  field :channel_config, 1,
    type: Google.Ads.Googleads.V22.Enums.DemandGenChannelConfigEnum.DemandGenChannelConfig,
    json_name: "channelConfig",
    enum: true,
    deprecated: false

  field :channel_strategy, 2,
    type: Google.Ads.Googleads.V22.Enums.DemandGenChannelStrategyEnum.DemandGenChannelStrategy,
  ...
  field :selected_channels, 3,
    type:
      Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls.DemandGenSelectedChannels,
    json_name: "selectedChannels",
    oneof: 0
end

defmodule Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings do
  @moduledoc false
  ...
  field :channel_controls, 1,
    type:
      Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings.DemandGenChannelControls,
    json_name: "channelControls"
end

defmodule Google.Ads.Googleads.V22.Resources.AdGroup.VideoAdGroupSettings.VideoAdSequenceStepSetting do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :step_id, 1, type: :int64, json_name: "stepId"
end

defmodule Google.Ads.Googleads.V22.Resources.AdGroup.VideoAdGroupSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :video_ad_sequence, 1,
    type:
      Google.Ads.Googleads.V22.Resources.AdGroup.VideoAdGroupSettings.VideoAdSequenceStepSetting,
    json_name: "videoAdSequence"
end

defmodule Google.Ads.Googleads.V22.Resources.AdGroup.AiMaxAdGroupSetting do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :disable_search_term_matching, 1,
    proto3_optional: true,
    type: :bool,
    json_name: "disableSearchTermMatching"
end

defmodule Google.Ads.Googleads.V22.Resources.AdGroup do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V22.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true
  ...
  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V22.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :target_cpc_micros, 68, proto3_optional: true, type: :int64, json_name: "targetCpcMicros"
  ...
  field :display_custom_bid_dimension, 23,
    type: Google.Ads.Googleads.V22.Enums.TargetingDimensionEnum.TargetingDimension,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V22.Resources.AdGroup.AudienceSetting,
  ...
  field :effective_target_cpa_source, 29,
    type: Google.Ads.Googleads.V22.Enums.BiddingSourceEnum.BiddingSource,
  ...
  field :effective_target_cpc, 69,
    proto3_optional: true,
    type: :int64,
    json_name: "effectiveTargetCpc",
    deprecated: false

  field :effective_target_cpc_source, 70,
    type: Google.Ads.Googleads.V22.Enums.BiddingSourceEnum.BiddingSource,
    json_name: "effectiveTargetCpcSource",
    enum: true,
    deprecated: false
  ...
  field :primary_status, 62,
    type: Google.Ads.Googleads.V22.Enums.AdGroupPrimaryStatusEnum.AdGroupPrimaryStatus,
  ...
  field :primary_status_reasons, 63,
    repeated: true,
    type:
      Google.Ads.Googleads.V22.Enums.AdGroupPrimaryStatusReasonEnum.AdGroupPrimaryStatusReason,
    json_name: "primaryStatusReasons",
    enum: true,
    deprecated: false

  field :demand_gen_ad_group_settings, 91,
    type: Google.Ads.Googleads.V22.Resources.AdGroup.DemandGenAdGroupSettings,
    json_name: "demandGenAdGroupSettings"

  field :video_ad_group_settings, 92,
    type: Google.Ads.Googleads.V22.Resources.AdGroup.VideoAdGroupSettings,
    json_name: "videoAdGroupSettings"

  field :ai_max_ad_group_setting, 71,
    type: Google.Ads.Googleads.V22.Resources.AdGroup.AiMaxAdGroupSetting,
    json_name: "aiMaxAdGroupSetting"
end
