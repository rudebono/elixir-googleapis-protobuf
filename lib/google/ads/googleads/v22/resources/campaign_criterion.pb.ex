defmodule Google.Ads.Googleads.V22.Resources.CampaignCriterion do
  @moduledoc false
  ...
  field :status, 35,
    type: Google.Ads.Googleads.V22.Enums.CampaignCriterionStatusEnum.CampaignCriterionStatus,
    enum: true
  ...
  field :device, 13, type: Google.Ads.Googleads.V22.Common.DeviceInfo, oneof: 0, deprecated: false
  ...
  field :gender, 17, type: Google.Ads.Googleads.V22.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 24, type: Google.Ads.Googleads.V22.Common.TopicInfo, oneof: 0, deprecated: false

  field :listing_scope, 25,
    type: Google.Ads.Googleads.V22.Common.ListingScopeInfo,
  ...
  field :carrier, 29,
    type: Google.Ads.Googleads.V22.Common.CarrierInfo,
    oneof: 0,
    deprecated: false
  ...
  field :operating_system_version, 32,
    type: Google.Ads.Googleads.V22.Common.OperatingSystemVersionInfo,
    json_name: "operatingSystemVersion",
    oneof: 0,
    deprecated: false

  field :mobile_device, 33,
    type: Google.Ads.Googleads.V22.Common.MobileDeviceInfo,
    json_name: "mobileDevice",
    oneof: 0,
    deprecated: false

  field :location_group, 34,
    type: Google.Ads.Googleads.V22.Common.LocationGroupInfo,
  ...
  field :local_service_id, 46,
    type: Google.Ads.Googleads.V22.Common.LocalServiceIdInfo,
  ...
  field :webpage_list, 49,
    type: Google.Ads.Googleads.V22.Common.WebpageListInfo,
