defmodule Google.Ads.Googleads.V22.Resources.LocalServicesLeadConversation do
  @moduledoc false
  ...
  field :conversation_channel, 3,
    type: Google.Ads.Googleads.V22.Enums.LocalServicesLeadConversationTypeEnum.ConversationType,
    json_name: "conversationChannel",
    enum: true,
    deprecated: false

  field :participant_type, 4,
    type: Google.Ads.Googleads.V22.Enums.LocalServicesParticipantTypeEnum.ParticipantType,
  ...
  field :phone_call_details, 7,
    ...
    type: Google.Ads.Googleads.V22.Resources.PhoneCallDetails,
    json_name: "phoneCallDetails",
    deprecated: false

  field :message_details, 8,
    proto3_optional: true,
    type: Google.Ads.Googleads.V22.Resources.MessageDetails,
    json_name: "messageDetails",
    deprecated: false
end

defmodule Google.Ads.Googleads.V22.Resources.PhoneCallDetails do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.MessageDetails do
  @moduledoc false
