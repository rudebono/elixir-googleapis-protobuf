defmodule Google.Ads.Googleads.V22.Resources.BillingSetup.PaymentsAccountInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Resources.BillingSetup do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V22.Enums.BillingSetupStatusEnum.BillingSetupStatus,
    enum: true,
    deprecated: false
  ...
  field :payments_account_info, 12,
    type: Google.Ads.Googleads.V22.Resources.BillingSetup.PaymentsAccountInfo,
