defmodule Google.Ads.Googleads.V22.Resources.Experiment do
  @moduledoc false
  ...
  field :type, 13,
    type: Google.Ads.Googleads.V22.Enums.ExperimentTypeEnum.ExperimentType,
    enum: true,
    deprecated: false

  field :status, 14,
    type: Google.Ads.Googleads.V22.Enums.ExperimentStatusEnum.ExperimentStatus,
    enum: true
  ...
  field :goals, 17, repeated: true, type: Google.Ads.Googleads.V22.Common.MetricGoal
  ...
  field :promote_status, 19,
    type: Google.Ads.Googleads.V22.Enums.AsyncActionStatusEnum.AsyncActionStatus,
