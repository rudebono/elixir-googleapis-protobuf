defmodule Google.Ads.Googleads.V22.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.ChangeStatusResourceTypeEnum do
  @moduledoc false
