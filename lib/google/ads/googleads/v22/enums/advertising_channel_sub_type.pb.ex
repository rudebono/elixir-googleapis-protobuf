defmodule Google.Ads.Googleads.V22.Enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.AdvertisingChannelSubTypeEnum do
  @moduledoc false
