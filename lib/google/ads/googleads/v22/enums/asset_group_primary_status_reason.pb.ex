defmodule Google.Ads.Googleads.V22.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
