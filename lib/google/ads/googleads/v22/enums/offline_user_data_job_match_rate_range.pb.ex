defmodule Google.Ads.Googleads.V22.Enums.OfflineUserDataJobMatchRateRangeEnum.OfflineUserDataJobMatchRateRange do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.OfflineUserDataJobMatchRateRangeEnum do
  @moduledoc false
