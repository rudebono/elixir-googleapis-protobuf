defmodule Google.Ads.Googleads.V22.Enums.ChangeEventResourceTypeEnum.ChangeEventResourceType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.ChangeEventResourceTypeEnum do
  @moduledoc false
