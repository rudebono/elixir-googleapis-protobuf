defmodule Google.Ads.Googleads.V22.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
