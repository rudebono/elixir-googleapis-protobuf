defmodule Google.Ads.Googleads.V22.Enums.AdGroupPrimaryStatusReasonEnum.AdGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.AdGroupPrimaryStatusReasonEnum do
  @moduledoc false
