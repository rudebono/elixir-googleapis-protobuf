defmodule Google.Ads.Googleads.V22.Enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.BiddingStrategySystemStatusEnum do
  @moduledoc false
