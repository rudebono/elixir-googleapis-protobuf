defmodule Google.Ads.Googleads.V22.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.DisplayUploadProductTypeEnum do
  @moduledoc false
