defmodule Google.Ads.Googleads.V22.Enums.ConversionActionCategoryEnum.ConversionActionCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.ConversionActionCategoryEnum do
  @moduledoc false
