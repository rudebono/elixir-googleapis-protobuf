defmodule Google.Ads.Googleads.V22.Enums.ConversionActionTypeEnum.ConversionActionType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.ConversionActionTypeEnum do
  @moduledoc false
