defmodule Google.Ads.Googleads.V22.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
