defmodule Google.Ads.Googleads.V22.Enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType do
  @moduledoc false
  ...
  field :OPTIMIZE_IN_APP_CONVERSIONS_WITHOUT_TARGET_CPA, 8
  field :OPTIMIZE_TOTAL_VALUE_WITHOUT_TARGET_ROAS, 9
end

defmodule Google.Ads.Googleads.V22.Enums.AppCampaignBiddingStrategyGoalTypeEnum do
  @moduledoc false
