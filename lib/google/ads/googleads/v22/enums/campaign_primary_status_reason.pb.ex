defmodule Google.Ads.Googleads.V22.Enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason do
  @moduledoc false
  ...
  field :NO_ASSET_GROUPS, 37
  field :ASSET_GROUPS_PAUSED, 38
  field :MISSING_LOCATION_TARGETING, 39
end

defmodule Google.Ads.Googleads.V22.Enums.CampaignPrimaryStatusReasonEnum do
  @moduledoc false
