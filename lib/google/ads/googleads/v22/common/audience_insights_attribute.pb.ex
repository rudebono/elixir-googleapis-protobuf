defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsAttributeMetadata do
  @moduledoc false
  ...
  field :attribute, 2, type: Google.Ads.Googleads.V22.Common.AudienceInsightsAttribute
  ...
  field :youtube_channel_metadata, 5,
    type: Google.Ads.Googleads.V22.Common.YouTubeChannelAttributeMetadata,
    json_name: "youtubeChannelMetadata",
    oneof: 0

  field :youtube_video_metadata, 10,
    type: Google.Ads.Googleads.V22.Common.YouTubeVideoAttributeMetadata,
    json_name: "youtubeVideoMetadata",
    oneof: 0

  field :lineup_attribute_metadata, 14,
    type: Google.Ads.Googleads.V22.Common.LineupAttributeMetadata,
    json_name: "lineupAttributeMetadata",
    oneof: 0

  field :location_attribute_metadata, 7,
    type: Google.Ads.Googleads.V22.Common.LocationAttributeMetadata,
    json_name: "locationAttributeMetadata",
    oneof: 0

  field :user_interest_attribute_metadata, 11,
    type: Google.Ads.Googleads.V22.Common.UserInterestAttributeMetadata,
    json_name: "userInterestAttributeMetadata",
    oneof: 0

  field :knowledge_graph_attribute_metadata, 12,
    type: Google.Ads.Googleads.V22.Common.KnowledgeGraphAttributeMetadata,
    json_name: "knowledgeGraphAttributeMetadata",
    oneof: 0

  field :user_list_attribute_metadata, 15,
    type: Google.Ads.Googleads.V22.Common.UserListAttributeMetadata,
    json_name: "userListAttributeMetadata",
    oneof: 0
end

defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsAttribute do
  @moduledoc false
  ...
  field :gender, 2, type: Google.Ads.Googleads.V22.Common.GenderInfo, oneof: 0
  field :location, 3, type: Google.Ads.Googleads.V22.Common.LocationInfo, oneof: 0
  ...
  field :entity, 5, type: Google.Ads.Googleads.V22.Common.AudienceInsightsEntity, oneof: 0
  field :category, 6, type: Google.Ads.Googleads.V22.Common.AudienceInsightsCategory, oneof: 0
  field :lineup, 13, type: Google.Ads.Googleads.V22.Common.AudienceInsightsLineup, oneof: 0
  ...
  field :device, 12, type: Google.Ads.Googleads.V22.Common.DeviceInfo, oneof: 0
...
defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsEntity do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsLineup do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.YouTubeChannelAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.YouTubeVideoAttributeMetadata do
  @moduledoc false
  ...
  field :video_properties, 6,
    repeated: true,
    type: Google.Ads.Googleads.V22.Enums.YouTubeVideoPropertyEnum.YouTubeVideoProperty,
    json_name: "videoProperties",
    enum: true

  field :publish_date, 7, type: :string, json_name: "publishDate"
end

defmodule Google.Ads.Googleads.V22.Common.LineupAttributeMetadata.SampleChannel do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.LineupAttributeMetadata do
  @moduledoc false
  ...
  field :sample_channels, 5,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.LineupAttributeMetadata.SampleChannel,
    json_name: "sampleChannels"
end

defmodule Google.Ads.Googleads.V22.Common.LocationAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.UserInterestAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.KnowledgeGraphAttributeMetadata do
  @moduledoc false
  ...
  field :entity_capabilities, 1,
    repeated: true,
    type:
      Google.Ads.Googleads.V22.Enums.InsightsKnowledgeGraphEntityCapabilitiesEnum.InsightsKnowledgeGraphEntityCapabilities,
...
defmodule Google.Ads.Googleads.V22.Common.UserListAttributeMetadata do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.AudienceInsightsAttributeMetadataGroup do
  @moduledoc false
