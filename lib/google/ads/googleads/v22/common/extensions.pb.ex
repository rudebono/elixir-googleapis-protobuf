defmodule Google.Ads.Googleads.V22.Common.CallFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.CalloutFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.SitelinkFeedItem do
  @moduledoc false
