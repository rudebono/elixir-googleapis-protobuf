defmodule Google.Ads.Googleads.V22.Common.Metrics do
  @moduledoc false
  ...
  field :trueview_average_cpv, 405,
    proto3_optional: true,
    type: :double,
    json_name: "trueviewAverageCpv"
  ...
  field :historical_creative_quality_score, 80,
    type: Google.Ads.Googleads.V22.Enums.QualityScoreBucketEnum.QualityScoreBucket,
  ...
  field :interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V22.Enums.InteractionEventTypeEnum.InteractionEventType,
  ...
  field :search_volume, 295,
    proto3_optional: true,
    type: Google.Ads.Googleads.V22.Common.SearchVolumeRange,
  ...
  field :video_trueview_view_rate, 406,
    proto3_optional: true,
    type: :double,
    json_name: "videoTrueviewViewRate"

  field :video_trueview_views, 407,
    proto3_optional: true,
    type: :int64,
    json_name: "videoTrueviewViews"
  ...
  field :store_visits_last_click_model_attributed_conversions, 365,
    proto3_optional: true,
    type: :double,
    json_name: "storeVisitsLastClickModelAttributedConversions"

  field :results_conversions_purchase, 366,
    proto3_optional: true,
    type: :double,
    json_name: "resultsConversionsPurchase"

  field :video_trueview_view_rate_in_feed, 408,
    proto3_optional: true,
    type: :double,
    json_name: "videoTrueviewViewRateInFeed"

  field :video_trueview_view_rate_in_stream, 409,
    proto3_optional: true,
    type: :double,
    json_name: "videoTrueviewViewRateInStream"

  field :video_trueview_view_rate_shorts, 410,
    proto3_optional: true,
    type: :double,
    json_name: "videoTrueviewViewRateShorts"
  ...
  field :platform_comparable_conversions_from_interactions_rate, 382,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsFromInteractionsRate"

  field :platform_comparable_conversions, 383,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversions"

  field :platform_comparable_conversions_value, 384,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsValue"

  field :platform_comparable_conversions_value_per_cost, 385,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsValuePerCost"

  field :platform_comparable_conversions_by_conversion_date, 386,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsByConversionDate"

  field :platform_comparable_conversions_value_by_conversion_date, 387,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsValueByConversionDate"

  field :platform_comparable_conversions_from_interactions_value_per_interaction, 388,
    proto3_optional: true,
    type: :double,
    json_name: "platformComparableConversionsFromInteractionsValuePerInteraction"

  field :cost_per_platform_comparable_conversion, 389,
    proto3_optional: true,
    type: :double,
    json_name: "costPerPlatformComparableConversion"

  field :value_per_platform_comparable_conversion, 390,
    proto3_optional: true,
    type: :double,
    json_name: "valuePerPlatformComparableConversion"

  field :value_per_platform_comparable_conversions_by_conversion_date, 391,
    proto3_optional: true,
    type: :double,
    json_name: "valuePerPlatformComparableConversionsByConversionDate"

  field :cost_converted_currency_per_platform_comparable_conversion, 392,
    proto3_optional: true,
    type: :double,
    json_name: "costConvertedCurrencyPerPlatformComparableConversion"

  field :value_adjustment, 398, proto3_optional: true, type: :double, json_name: "valueAdjustment"

  field :all_value_adjustment, 399,
    proto3_optional: true,
    type: :double,
    json_name: "allValueAdjustment"

  field :clicks_unique_query_clusters, 400,
    proto3_optional: true,
    type: :int64,
    json_name: "clicksUniqueQueryClusters"

  field :conversions_unique_query_clusters, 401,
    proto3_optional: true,
    type: :int64,
    json_name: "conversionsUniqueQueryClusters"

  field :impressions_unique_query_clusters, 402,
    proto3_optional: true,
    type: :int64,
    json_name: "impressionsUniqueQueryClusters"

  field :video_watch_time_duration_millis, 403,
    proto3_optional: true,
    type: :int64,
    json_name: "videoWatchTimeDurationMillis"

  field :average_video_watch_time_duration_millis, 404,
    proto3_optional: true,
    type: :int64,
    json_name: "averageVideoWatchTimeDurationMillis"
end

defmodule Google.Ads.Googleads.V22.Common.SearchVolumeRange do
  @moduledoc false
