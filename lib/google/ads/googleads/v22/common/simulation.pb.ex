defmodule Google.Ads.Googleads.V22.Common.CpcBidSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V22.Common.CpcBidSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.CpvBidSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V22.Common.CpvBidSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.TargetCpaSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V22.Common.TargetCpaSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.TargetRoasSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.TargetRoasSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.PercentCpcBidSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.PercentCpcBidSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.BudgetSimulationPointList do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :points, 1, repeated: true, type: Google.Ads.Googleads.V22.Common.BudgetSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.TargetImpressionShareSimulationPointList do
  @moduledoc false
  ...
  field :points, 1,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.TargetImpressionShareSimulationPoint
end

defmodule Google.Ads.Googleads.V22.Common.CpcBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.CpvBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.TargetCpaSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.TargetRoasSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.PercentCpcBidSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.BudgetSimulationPoint do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.TargetImpressionShareSimulationPoint do
  @moduledoc false
