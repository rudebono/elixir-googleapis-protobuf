defmodule Google.Ads.Googleads.V22.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.MediaBundleAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.ImageAsset do
  @moduledoc false
  ...
  field :full_size, 4, type: Google.Ads.Googleads.V22.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V22.Common.ImageDimension do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.TextAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.LeadFormAsset do
  @moduledoc false
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V22.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V22.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V22.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V22.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V22.Common.LeadFormField do
  @moduledoc false
  ...
  field :input_type, 1,
    type:
      Google.Ads.Googleads.V22.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V22.Common.LeadFormSingleChoiceAnswers,
...
defmodule Google.Ads.Googleads.V22.Common.LeadFormCustomQuestionField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.LeadFormDeliveryMethod do
  @moduledoc false
  ...
  field :webhook, 1, type: Google.Ads.Googleads.V22.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V22.Common.WebhookDelivery do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.BookOnGoogleAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V22.Common.PromotionAsset do
  @moduledoc false
  ...
  field :discount_modifier, 2,
    type:
      Google.Ads.Googleads.V22.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
  ...
  field :occasion, 9,
    type:
      Google.Ads.Googleads.V22.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
  ...
  field :ad_schedule_targets, 13,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.AdScheduleInfo,
    json_name: "adScheduleTargets"

  field :terms_and_conditions_text, 14, type: :string, json_name: "termsAndConditionsText"
  field :terms_and_conditions_uri, 15, type: :string, json_name: "termsAndConditionsUri"
  field :percent_off, 3, type: :int64, json_name: "percentOff", oneof: 0

  field :money_amount_off, 4,
    type: Google.Ads.Googleads.V22.Common.Money,
  ...
  field :promotion_barcode_info, 16,
    type: Google.Ads.Googleads.V22.Common.PromotionBarcodeInfo,
    json_name: "promotionBarcodeInfo",
    oneof: 1

  field :promotion_qr_code_info, 17,
    type: Google.Ads.Googleads.V22.Common.PromotionQrCodeInfo,
    json_name: "promotionQrCodeInfo",
    oneof: 1
end

defmodule Google.Ads.Googleads.V22.Common.PromotionBarcodeInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V22.Enums.PromotionBarcodeTypeEnum.PromotionBarcodeType,
    enum: true

  field :barcode_content, 2, type: :string, json_name: "barcodeContent"
end

defmodule Google.Ads.Googleads.V22.Common.PromotionQrCodeInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :qr_code_content, 1, type: :string, json_name: "qrCodeContent"
end

defmodule Google.Ads.Googleads.V22.Common.CalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.StructuredSnippetAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.SitelinkAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.PageFeedAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicEducationAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.MobileAppAsset do
  @moduledoc false
  ...
  field :app_store, 2,
    type: Google.Ads.Googleads.V22.Enums.MobileAppVendorEnum.MobileAppVendor,
    json_name: "appStore",
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V22.Common.HotelCalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.CallAsset do
  @moduledoc false
  ...
  field :call_conversion_reporting_state, 3,
    type:
      Google.Ads.Googleads.V22.Enums.CallConversionReportingStateEnum.CallConversionReportingState,
...
defmodule Google.Ads.Googleads.V22.Common.PriceAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V22.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false

  field :price_qualifier, 2,
    type:
      Google.Ads.Googleads.V22.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V22.Common.PriceOffering do
  @moduledoc false
  ...
  field :price, 3, type: Google.Ads.Googleads.V22.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V22.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V22.Common.CallToActionAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :call_to_action, 1,
    type: Google.Ads.Googleads.V22.Enums.CallToActionTypeEnum.CallToActionType,
    json_name: "callToAction",
    enum: true
end

defmodule Google.Ads.Googleads.V22.Common.DynamicRealEstateAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicCustomAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicFlightsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DemandGenCarouselCardAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicTravelAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicLocalAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.DynamicJobsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.LocationAsset do
  @moduledoc false
  ...
  field :business_profile_locations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.BusinessProfileLocation,
    json_name: "businessProfileLocations"

  field :location_ownership_type, 3,
    type: Google.Ads.Googleads.V22.Enums.LocationOwnershipTypeEnum.LocationOwnershipType,
    json_name: "locationOwnershipType",
    enum: true
end

defmodule Google.Ads.Googleads.V22.Common.BusinessProfileLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.HotelPropertyAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.BusinessMessageAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  oneof :message_provider_data, 0

  field :message_provider, 1,
    type: Google.Ads.Googleads.V22.Enums.BusinessMessageProviderEnum.BusinessMessageProvider,
    json_name: "messageProvider",
    enum: true,
    deprecated: false

  field :starter_message, 2, type: :string, json_name: "starterMessage", deprecated: false

  field :call_to_action, 3,
    proto3_optional: true,
    type: Google.Ads.Googleads.V22.Common.BusinessMessageCallToActionInfo,
    json_name: "callToAction"

  field :whatsapp_info, 5,
    type: Google.Ads.Googleads.V22.Common.WhatsappBusinessMessageInfo,
    json_name: "whatsappInfo",
    oneof: 0
end

defmodule Google.Ads.Googleads.V22.Common.WhatsappBusinessMessageInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V22.Common.BusinessMessageCallToActionInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :call_to_action_selection, 1,
    type:
      Google.Ads.Googleads.V22.Enums.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType,
    json_name: "callToActionSelection",
    enum: true,
    deprecated: false

  field :call_to_action_description, 2,
    type: :string,
    json_name: "callToActionDescription",
    deprecated: false
end

defmodule Google.Ads.Googleads.V22.Common.AppDeepLinkAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :app_deep_link_uri, 1, type: :string, json_name: "appDeepLinkUri"
end

defmodule Google.Ads.Googleads.V22.Common.YouTubeVideoListAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :youtube_videos, 1,
    repeated: true,
    type: Google.Ads.Googleads.V22.Common.AdVideoAsset,
