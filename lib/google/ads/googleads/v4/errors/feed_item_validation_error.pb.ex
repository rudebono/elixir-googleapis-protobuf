defmodule Google.Ads.Googleads.V4.Errors.FeedItemValidationErrorEnum.FeedItemValidationError do
  @moduledoc false
  ...
  field :CUSTOMER_NOT_WHITELISTED_FOR_CALLTRACKING, 12
...
defmodule Google.Ads.Googleads.V4.Errors.FeedItemValidationErrorEnum do
  @moduledoc false
