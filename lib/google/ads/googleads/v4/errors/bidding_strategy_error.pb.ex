defmodule Google.Ads.Googleads.V4.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
