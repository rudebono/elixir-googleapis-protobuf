defmodule Google.Ads.Googleads.V4.Errors.AdGroupCriterionErrorEnum.AdGroupCriterionError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.AdGroupCriterionErrorEnum do
  @moduledoc false
