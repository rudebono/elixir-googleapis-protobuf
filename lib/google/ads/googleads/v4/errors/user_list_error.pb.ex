defmodule Google.Ads.Googleads.V4.Errors.UserListErrorEnum.UserListError do
  @moduledoc false
  ...
  field :ADVERTISER_NOT_WHITELISTED_FOR_USING_UPLOADED_DATA, 33
...
defmodule Google.Ads.Googleads.V4.Errors.UserListErrorEnum do
  @moduledoc false
