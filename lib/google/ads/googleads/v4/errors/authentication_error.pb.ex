defmodule Google.Ads.Googleads.V4.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.AuthenticationErrorEnum do
  @moduledoc false
