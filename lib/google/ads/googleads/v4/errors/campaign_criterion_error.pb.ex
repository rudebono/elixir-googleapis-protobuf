defmodule Google.Ads.Googleads.V4.Errors.CampaignCriterionErrorEnum.CampaignCriterionError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.CampaignCriterionErrorEnum do
  @moduledoc false
