defmodule Google.Ads.Googleads.V4.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.CampaignDraftErrorEnum do
  @moduledoc false
