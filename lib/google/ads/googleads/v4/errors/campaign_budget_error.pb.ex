defmodule Google.Ads.Googleads.V4.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
