defmodule Google.Ads.Googleads.V4.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.RecommendationErrorEnum do
  @moduledoc false
