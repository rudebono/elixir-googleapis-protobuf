defmodule Google.Ads.Googleads.V4.Errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError do
  @moduledoc false
  ...
  field :CUSTOMER_NOT_WHITELISTED_FOR_CALLTRACKING, 15
...
defmodule Google.Ads.Googleads.V4.Errors.ExtensionFeedItemErrorEnum do
  @moduledoc false
