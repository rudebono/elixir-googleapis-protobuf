defmodule Google.Ads.Googleads.V4.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
