defmodule Google.Ads.Googleads.V4.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
  ...
  field :CUSTOMER_NOT_WHITELISTED_FOR_CALLTRACKING, 29
...
defmodule Google.Ads.Googleads.V4.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
