defmodule Google.Ads.Googleads.V4.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.AuthorizationErrorEnum do
  @moduledoc false
