defmodule Google.Ads.Googleads.V4.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
