...
defmodule Google.Ads.Googleads.V4.Services.MutateCustomerNegativeCriteriaRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V4.Services.CustomerNegativeCriterionOperation.t()],
...
defmodule Google.Ads.Googleads.V4.Services.MutateCustomerNegativeCriteriaResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V4.Services.MutateCustomerNegativeCriteriaResult.t()]
        }
