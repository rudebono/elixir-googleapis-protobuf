...
defmodule Google.Ads.Googleads.V4.Services.MutateKeywordPlanCampaignKeywordsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V4.Services.KeywordPlanCampaignKeywordOperation.t()],
...
defmodule Google.Ads.Googleads.V4.Services.MutateKeywordPlanCampaignKeywordsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V4.Services.MutateKeywordPlanCampaignKeywordResult.t()]
        }
