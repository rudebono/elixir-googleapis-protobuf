...
defmodule Google.Ads.Googleads.V4.Services.MutateAdGroupCriterionLabelsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V4.Services.AdGroupCriterionLabelOperation.t()],
...
defmodule Google.Ads.Googleads.V4.Services.MutateAdGroupCriterionLabelsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V4.Services.MutateAdGroupCriterionLabelResult.t()]
        }
