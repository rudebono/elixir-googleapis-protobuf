...
defmodule Google.Ads.Googleads.V4.Services.ListMerchantCenterLinksResponse do
  ...
  @type t :: %__MODULE__{
          merchant_center_links: [Google.Ads.Googleads.V4.Resources.MerchantCenterLink.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.MutateMerchantCenterLinkRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          operation: Google.Ads.Googleads.V4.Services.MerchantCenterLinkOperation.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Services.MutateMerchantCenterLinkResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Ads.Googleads.V4.Services.MutateMerchantCenterLinkResult.t() | nil
        }
