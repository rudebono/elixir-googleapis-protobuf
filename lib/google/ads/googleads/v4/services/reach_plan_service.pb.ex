...
defmodule Google.Ads.Googleads.V4.Services.ListPlannableLocationsResponse do
  ...
  @type t :: %__MODULE__{
          plannable_locations: [Google.Ads.Googleads.V4.Services.PlannableLocation.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.ListPlannableProductsResponse do
  ...
  @type t :: %__MODULE__{
          product_metadata: [Google.Ads.Googleads.V4.Services.ProductMetadata.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.ProductMetadata do
  ...
  @type t :: %__MODULE__{
          ...
          plannable_targeting: Google.Ads.Googleads.V4.Services.PlannableTargeting.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Services.PlannableTargeting do
  ...
  @type t :: %__MODULE__{
          age_ranges: [
            [Google.Ads.Googleads.V4.Enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange.t()]
          ],
          genders: [Google.Ads.Googleads.V4.Common.GenderInfo.t()],
          devices: [Google.Ads.Googleads.V4.Common.DeviceInfo.t()],
          networks: [[Google.Ads.Googleads.V4.Enums.ReachPlanNetworkEnum.ReachPlanNetwork.t()]]
        }
...
defmodule Google.Ads.Googleads.V4.Services.GenerateProductMixIdeasRequest do
  ...
  @type t :: %__MODULE__{
          ...
          preferences: Google.Ads.Googleads.V4.Services.Preferences.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Services.Preferences do
  ...
  @type t :: %__MODULE__{
          ...
          ad_length: Google.Ads.Googleads.V4.Enums.ReachPlanAdLengthEnum.ReachPlanAdLength.t(),
...
defmodule Google.Ads.Googleads.V4.Services.GenerateProductMixIdeasResponse do
  ...
  @type t :: %__MODULE__{
          product_allocation: [Google.Ads.Googleads.V4.Services.ProductAllocation.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.GenerateReachForecastRequest do
  ...
  @type t :: %__MODULE__{
          customer_id: String.t(),
          currency_code: Google.Protobuf.StringValue.t() | nil,
          campaign_duration: Google.Ads.Googleads.V4.Services.CampaignDuration.t() | nil,
          cookie_frequency_cap: Google.Protobuf.Int32Value.t() | nil,
          cookie_frequency_cap_setting: Google.Ads.Googleads.V4.Services.FrequencyCap.t() | nil,
          min_effective_frequency: Google.Protobuf.Int32Value.t() | nil,
          targeting: Google.Ads.Googleads.V4.Services.Targeting.t() | nil,
          planned_products: [Google.Ads.Googleads.V4.Services.PlannedProduct.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.Targeting do
  ...
  @type t :: %__MODULE__{
          plannable_location_id: Google.Protobuf.StringValue.t() | nil,
          age_range: Google.Ads.Googleads.V4.Enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange.t(),
          genders: [Google.Ads.Googleads.V4.Common.GenderInfo.t()],
          devices: [Google.Ads.Googleads.V4.Common.DeviceInfo.t()],
          network: Google.Ads.Googleads.V4.Enums.ReachPlanNetworkEnum.ReachPlanNetwork.t()
        }
...
defmodule Google.Ads.Googleads.V4.Services.GenerateReachForecastResponse do
  ...
  @type t :: %__MODULE__{
          on_target_audience_metrics:
            Google.Ads.Googleads.V4.Services.OnTargetAudienceMetrics.t() | nil,
          reach_curve: Google.Ads.Googleads.V4.Services.ReachCurve.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Services.ReachCurve do
  ...
  @type t :: %__MODULE__{
          reach_forecasts: [Google.Ads.Googleads.V4.Services.ReachForecast.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Services.ReachForecast do
  ...
  @type t :: %__MODULE__{
          ...
          forecast: Google.Ads.Googleads.V4.Services.Forecast.t() | nil,
          forecasted_product_allocations: [Google.Ads.Googleads.V4.Services.ProductAllocation.t()]
        }
