...
defmodule Google.Ads.Googleads.V4.Services.MutateCampaignExtensionSettingsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          operations: [Google.Ads.Googleads.V4.Services.CampaignExtensionSettingOperation.t()],
...
defmodule Google.Ads.Googleads.V4.Services.MutateCampaignExtensionSettingsResponse do
  ...
  @type t :: %__MODULE__{
          ...
          results: [Google.Ads.Googleads.V4.Services.MutateCampaignExtensionSettingResult.t()]
        }
