defmodule Google.Ads.Googleads.V4.Resources.CustomInterest do
  ...
  @type t :: %__MODULE__{
          ...
          status: Google.Ads.Googleads.V4.Enums.CustomInterestStatusEnum.CustomInterestStatus.t(),
          name: Google.Protobuf.StringValue.t() | nil,
          type: Google.Ads.Googleads.V4.Enums.CustomInterestTypeEnum.CustomInterestType.t(),
          description: Google.Protobuf.StringValue.t() | nil,
          members: [Google.Ads.Googleads.V4.Resources.CustomInterestMember.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Resources.CustomInterestMember do
  ...
  @type t :: %__MODULE__{
          member_type:
            Google.Ads.Googleads.V4.Enums.CustomInterestMemberTypeEnum.CustomInterestMemberType.t(),
