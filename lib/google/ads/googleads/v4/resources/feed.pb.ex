...
defmodule Google.Ads.Googleads.V4.Resources.Feed.PlacesLocationFeedData do
  ...
  @type t :: %__MODULE__{
          oauth_info:
            Google.Ads.Googleads.V4.Resources.Feed.PlacesLocationFeedData.OAuthInfo.t() | nil,
...
defmodule Google.Ads.Googleads.V4.Resources.Feed.AffiliateLocationFeedData do
  ...
  @type t :: %__MODULE__{
          ...
          relationship_type:
            Google.Ads.Googleads.V4.Enums.AffiliateLocationFeedRelationshipTypeEnum.AffiliateLocationFeedRelationshipType.t()
        }
...
defmodule Google.Ads.Googleads.V4.Resources.Feed do
  ...
  @type t :: %__MODULE__{
          ...
          attributes: [Google.Ads.Googleads.V4.Resources.FeedAttribute.t()],
          attribute_operations: [Google.Ads.Googleads.V4.Resources.FeedAttributeOperation.t()],
          origin: Google.Ads.Googleads.V4.Enums.FeedOriginEnum.FeedOrigin.t(),
          status: Google.Ads.Googleads.V4.Enums.FeedStatusEnum.FeedStatus.t()
        }
...
defmodule Google.Ads.Googleads.V4.Resources.FeedAttribute do
  ...
  @type t :: %__MODULE__{
          id: Google.Protobuf.Int64Value.t() | nil,
          name: Google.Protobuf.StringValue.t() | nil,
          type: Google.Ads.Googleads.V4.Enums.FeedAttributeTypeEnum.FeedAttributeType.t(),
...
defmodule Google.Ads.Googleads.V4.Resources.FeedAttributeOperation do
  ...
  @type t :: %__MODULE__{
          operator: Google.Ads.Googleads.V4.Resources.FeedAttributeOperation.Operator.t(),
          value: Google.Ads.Googleads.V4.Resources.FeedAttribute.t() | nil
        }
