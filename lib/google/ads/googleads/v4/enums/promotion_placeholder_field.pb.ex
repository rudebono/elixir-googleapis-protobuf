defmodule Google.Ads.Googleads.V4.Enums.PromotionPlaceholderFieldEnum.PromotionPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Enums.PromotionPlaceholderFieldEnum do
  @moduledoc false
