defmodule Google.Ads.Googleads.V4.Enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Enums.RealEstatePlaceholderFieldEnum do
  @moduledoc false
