defmodule Google.Ads.Googleads.V4.Enums.AppCampaignBiddingStrategyGoalTypeEnum.AppCampaignBiddingStrategyGoalType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Enums.AppCampaignBiddingStrategyGoalTypeEnum do
  @moduledoc false
