defmodule Google.Ads.Googleads.V4.Enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Enums.AdvertisingChannelSubTypeEnum do
  @moduledoc false
