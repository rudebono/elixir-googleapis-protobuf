defmodule Google.Ads.Googleads.V4.Enums.FlightPlaceholderFieldEnum.FlightPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V4.Enums.FlightPlaceholderFieldEnum do
  @moduledoc false
