defmodule Google.Ads.Googleads.V4.Common.AppFeedItem do
  ...
  @type t :: %__MODULE__{
          ...
          app_store: Google.Ads.Googleads.V4.Enums.AppStoreEnum.AppStore.t(),
...
defmodule Google.Ads.Googleads.V4.Common.PriceFeedItem do
  ...
  @type t :: %__MODULE__{
          type: Google.Ads.Googleads.V4.Enums.PriceExtensionTypeEnum.PriceExtensionType.t(),
          price_qualifier:
            Google.Ads.Googleads.V4.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier.t(),
          tracking_url_template: Google.Protobuf.StringValue.t() | nil,
          language_code: Google.Protobuf.StringValue.t() | nil,
          price_offerings: [Google.Ads.Googleads.V4.Common.PriceOffer.t()],
          final_url_suffix: Google.Protobuf.StringValue.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Common.PriceOffer do
  ...
  @type t :: %__MODULE__{
          ...
          price: Google.Ads.Googleads.V4.Common.Money.t() | nil,
          unit:
            Google.Ads.Googleads.V4.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit.t(),
          final_urls: [Google.Protobuf.StringValue.t()],
          final_mobile_urls: [Google.Protobuf.StringValue.t()]
        }
...
defmodule Google.Ads.Googleads.V4.Common.PromotionFeedItem do
  ...
  @type t :: %__MODULE__{
          ...
          discount_modifier:
            Google.Ads.Googleads.V4.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier.t(),
          promotion_start_date: Google.Protobuf.StringValue.t() | nil,
          promotion_end_date: Google.Protobuf.StringValue.t() | nil,
          occasion:
            Google.Ads.Googleads.V4.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion.t(),
          final_urls: [Google.Protobuf.StringValue.t()],
          final_mobile_urls: [Google.Protobuf.StringValue.t()],
          tracking_url_template: Google.Protobuf.StringValue.t() | nil,
          url_custom_parameters: [Google.Ads.Googleads.V4.Common.CustomParameter.t()],
