...
defmodule Google.Ads.Googleads.V4.Common.TransactionAttribute do
  ...
  @type t :: %__MODULE__{
          ...
          store_attribute: Google.Ads.Googleads.V4.Common.StoreAttribute.t() | nil,
...
defmodule Google.Ads.Googleads.V4.Common.UserData do
  ...
  @type t :: %__MODULE__{
          user_identifiers: [Google.Ads.Googleads.V4.Common.UserIdentifier.t()],
          transaction_attribute: Google.Ads.Googleads.V4.Common.TransactionAttribute.t() | nil
        }
...
defmodule Google.Ads.Googleads.V4.Common.StoreSalesMetadata do
  ...
  @type t :: %__MODULE__{
          ...
          third_party_metadata:
            Google.Ads.Googleads.V4.Common.StoreSalesThirdPartyMetadata.t() | nil
        }
