defmodule Google.Ads.Googleads.V4.Common.KeywordPlanHistoricalMetrics do
  ...
  @type t :: %__MODULE__{
          ...
          monthly_search_volumes: [Google.Ads.Googleads.V4.Common.MonthlySearchVolume.t()],
          competition:
            Google.Ads.Googleads.V4.Enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel.t(),
...
defmodule Google.Ads.Googleads.V4.Common.MonthlySearchVolume do
  ...
  @type t :: %__MODULE__{
          ...
          month: Google.Ads.Googleads.V4.Enums.MonthOfYearEnum.MonthOfYear.t(),
