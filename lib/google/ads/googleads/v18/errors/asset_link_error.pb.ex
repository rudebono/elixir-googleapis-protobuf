defmodule Google.Ads.Googleads.V18.Errors.AssetLinkErrorEnum.AssetLinkError do
  @moduledoc false
  ...
  field :BRAND_ASSETS_NOT_LINKED_AT_ASSET_GROUP_LEVEL, 25
  field :BRAND_ASSETS_NOT_LINKED_AT_CAMPAIGN_LEVEL, 26
end

defmodule Google.Ads.Googleads.V18.Errors.AssetLinkErrorEnum do
  @moduledoc false
