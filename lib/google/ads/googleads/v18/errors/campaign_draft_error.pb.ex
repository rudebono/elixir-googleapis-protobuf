defmodule Google.Ads.Googleads.V18.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.CampaignDraftErrorEnum do
  @moduledoc false
