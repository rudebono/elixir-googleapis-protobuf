defmodule Google.Ads.Googleads.V18.Errors.CustomerFeedErrorEnum.CustomerFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.CustomerFeedErrorEnum do
  @moduledoc false
