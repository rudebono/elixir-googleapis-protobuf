defmodule Google.Ads.Googleads.V18.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.SmartCampaignErrorEnum do
  @moduledoc false
