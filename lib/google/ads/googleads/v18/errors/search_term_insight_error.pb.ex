defmodule Google.Ads.Googleads.V18.Errors.SearchTermInsightErrorEnum.SearchTermInsightError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.SearchTermInsightErrorEnum do
  @moduledoc false
