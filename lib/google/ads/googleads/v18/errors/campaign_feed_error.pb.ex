defmodule Google.Ads.Googleads.V18.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.CampaignFeedErrorEnum do
  @moduledoc false
