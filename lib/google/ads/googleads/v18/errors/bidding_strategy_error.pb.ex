defmodule Google.Ads.Googleads.V18.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
