defmodule Google.Ads.Googleads.V18.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.CustomInterestErrorEnum do
  @moduledoc false
