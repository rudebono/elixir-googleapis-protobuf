defmodule Google.Ads.Googleads.V18.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.AuthenticationErrorEnum do
  @moduledoc false
