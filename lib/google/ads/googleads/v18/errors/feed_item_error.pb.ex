defmodule Google.Ads.Googleads.V18.Errors.FeedItemErrorEnum.FeedItemError do
  @moduledoc false
  ...
  field :LEGACY_FEED_TYPE_READ_ONLY, 11
end

defmodule Google.Ads.Googleads.V18.Errors.FeedItemErrorEnum do
  @moduledoc false
