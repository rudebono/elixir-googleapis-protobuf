defmodule Google.Ads.Googleads.V18.Errors.ConversionValueRuleErrorEnum.ConversionValueRuleError do
  @moduledoc false
  ...
  field :NO_DAY_OF_WEEK_SELECTED, 14
end

defmodule Google.Ads.Googleads.V18.Errors.ConversionValueRuleErrorEnum do
  @moduledoc false
