defmodule Google.Ads.Googleads.V18.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
