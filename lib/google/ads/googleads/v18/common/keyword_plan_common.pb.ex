defmodule Google.Ads.Googleads.V18.Common.KeywordPlanHistoricalMetrics do
  ...
  field :monthly_search_volumes, 6,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.MonthlySearchVolume,
    json_name: "monthlySearchVolumes"

  field :competition, 2,
    type:
      Google.Ads.Googleads.V18.Enums.KeywordPlanCompetitionLevelEnum.KeywordPlanCompetitionLevel,
    enum: true
...
defmodule Google.Ads.Googleads.V18.Common.HistoricalMetricsOptions do
  ...
  field :year_month_range, 1,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Common.YearMonthRange,
...
defmodule Google.Ads.Googleads.V18.Common.KeywordPlanAggregateMetrics do
  ...
  field :aggregate_metric_types, 1,
    repeated: true,
    type:
      Google.Ads.Googleads.V18.Enums.KeywordPlanAggregateMetricTypeEnum.KeywordPlanAggregateMetricType,
...
defmodule Google.Ads.Googleads.V18.Common.KeywordPlanAggregateMetricResults do
  ...
  field :device_searches, 1,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.KeywordPlanDeviceSearches,
...
defmodule Google.Ads.Googleads.V18.Common.KeywordConcept do
  ...
  field :concept_group, 2,
    type: Google.Ads.Googleads.V18.Common.ConceptGroup,
...
defmodule Google.Ads.Googleads.V18.Common.ConceptGroup do
  ...
  field :type, 2,
    type:
      Google.Ads.Googleads.V18.Enums.KeywordPlanConceptGroupTypeEnum.KeywordPlanConceptGroupType,
    enum: true
end
