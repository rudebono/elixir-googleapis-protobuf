defmodule Google.Ads.Googleads.V18.Common.AudienceDimension do
  ...
  field :age, 1, type: Google.Ads.Googleads.V18.Common.AgeDimension, oneof: 0
  field :gender, 2, type: Google.Ads.Googleads.V18.Common.GenderDimension, oneof: 0

  field :household_income, 3,
    type: Google.Ads.Googleads.V18.Common.HouseholdIncomeDimension,
    json_name: "householdIncome",
    oneof: 0

  field :parental_status, 4,
    type: Google.Ads.Googleads.V18.Common.ParentalStatusDimension,
    json_name: "parentalStatus",
    oneof: 0

  field :audience_segments, 5,
    type: Google.Ads.Googleads.V18.Common.AudienceSegmentDimension,
...
defmodule Google.Ads.Googleads.V18.Common.ExclusionSegment do
  ...
  field :user_list, 1,
    type: Google.Ads.Googleads.V18.Common.UserListSegment,
    json_name: "userList",
    oneof: 0
end
...
defmodule Google.Ads.Googleads.V18.Common.AgeDimension do
  ...
  field :age_ranges, 1,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.AgeSegment,
    json_name: "ageRanges"
...
defmodule Google.Ads.Googleads.V18.Common.GenderDimension do
  ...
  field :genders, 1,
    repeated: true,
    type: Google.Ads.Googleads.V18.Enums.GenderTypeEnum.GenderType,
    enum: true
...
defmodule Google.Ads.Googleads.V18.Common.AudienceSegment do
  ...
  field :user_interest, 2,
    type: Google.Ads.Googleads.V18.Common.UserInterestSegment,
    json_name: "userInterest",
    oneof: 0

  field :life_event, 3,
    type: Google.Ads.Googleads.V18.Common.LifeEventSegment,
    json_name: "lifeEvent",
    oneof: 0

  field :detailed_demographic, 4,
    type: Google.Ads.Googleads.V18.Common.DetailedDemographicSegment,
    json_name: "detailedDemographic",
    oneof: 0

  field :custom_audience, 5,
    type: Google.Ads.Googleads.V18.Common.CustomAudienceSegment,
