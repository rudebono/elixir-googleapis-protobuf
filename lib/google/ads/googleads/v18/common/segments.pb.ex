defmodule Google.Ads.Googleads.V18.Common.Segments do
  @moduledoc false
  ...
  field :ad_destination_type, 136,
    type: Google.Ads.Googleads.V18.Enums.AdDestinationTypeEnum.AdDestinationType,
    json_name: "adDestinationType",
    enum: true

  field :ad_format_type, 191,
    type: Google.Ads.Googleads.V18.Enums.AdFormatTypeEnum.AdFormatType,
    json_name: "adFormatType",
    enum: true

  field :ad_network_type, 3,
    type: Google.Ads.Googleads.V18.Enums.AdNetworkTypeEnum.AdNetworkType,
  ...
  field :budget_campaign_association_status, 134,
    type: Google.Ads.Googleads.V18.Common.BudgetCampaignAssociationStatus,
    json_name: "budgetCampaignAssociationStatus"

  field :campaign, 157, proto3_optional: true, type: :string

  field :click_type, 26,
    type: Google.Ads.Googleads.V18.Enums.ClickTypeEnum.ClickType,
    json_name: "clickType",
    enum: true
  ...
  field :conversion_attribution_event_type, 2,
    type:
      Google.Ads.Googleads.V18.Enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType,
    json_name: "conversionAttributionEventType",
    enum: true

  field :conversion_lag_bucket, 50,
    type: Google.Ads.Googleads.V18.Enums.ConversionLagBucketEnum.ConversionLagBucket,
    json_name: "conversionLagBucket",
    enum: true

  field :conversion_or_adjustment_lag_bucket, 51,
    type:
      Google.Ads.Googleads.V18.Enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket,
  ...
  field :external_conversion_source, 55,
    type: Google.Ads.Googleads.V18.Enums.ExternalConversionSourceEnum.ExternalConversionSource,
  ...
  field :hotel_rate_type, 74,
    type: Google.Ads.Googleads.V18.Enums.HotelRateTypeEnum.HotelRateType,
    json_name: "hotelRateType",
    enum: true

  field :hotel_price_bucket, 78,
    type: Google.Ads.Googleads.V18.Enums.HotelPriceBucketEnum.HotelPriceBucket,
  ...
  field :keyword, 61, type: Google.Ads.Googleads.V18.Common.Keyword
  field :month, 90, proto3_optional: true, type: :string

  field :month_of_year, 18,
    type: Google.Ads.Googleads.V18.Enums.MonthOfYearEnum.MonthOfYear,
  ...
  field :search_engine_results_page_type, 70,
    type:
      Google.Ads.Googleads.V18.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType,
  ...
  field :search_term_match_type, 22,
    type: Google.Ads.Googleads.V18.Enums.SearchTermMatchTypeEnum.SearchTermMatchType,
    json_name: "searchTermMatchType",
    enum: true

  field :slot, 23, type: Google.Ads.Googleads.V18.Enums.SlotEnum.Slot, enum: true

  field :conversion_value_rule_primary_dimension, 138,
    type:
      Google.Ads.Googleads.V18.Enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension,
  ...
  field :sk_ad_network_user_type, 141,
    type: Google.Ads.Googleads.V18.Enums.SkAdNetworkUserTypeEnum.SkAdNetworkUserType,
    json_name: "skAdNetworkUserType",
    enum: true

  field :sk_ad_network_ad_event_type, 142,
    type: Google.Ads.Googleads.V18.Enums.SkAdNetworkAdEventTypeEnum.SkAdNetworkAdEventType,
    json_name: "skAdNetworkAdEventType",
    enum: true

  field :sk_ad_network_source_app, 143,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Common.SkAdNetworkSourceApp,
    json_name: "skAdNetworkSourceApp"

  field :sk_ad_network_attribution_credit, 144,
    type:
      Google.Ads.Googleads.V18.Enums.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit,
    json_name: "skAdNetworkAttributionCredit",
    enum: true

  field :sk_ad_network_coarse_conversion_value, 151,
    type:
      Google.Ads.Googleads.V18.Enums.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue,
  ...
  field :sk_ad_network_source_type, 153,
    type: Google.Ads.Googleads.V18.Enums.SkAdNetworkSourceTypeEnum.SkAdNetworkSourceType,
  ...
  field :asset_interaction_target, 139,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Common.AssetInteractionTarget,
    json_name: "assetInteractionTarget"

  field :new_versus_returning_customers, 160,
    type:
      Google.Ads.Googleads.V18.Enums.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket,
    json_name: "newVersusReturningCustomers",
    enum: true
end

defmodule Google.Ads.Googleads.V18.Common.Keyword do
  @moduledoc false
  ...
  field :info, 2, type: Google.Ads.Googleads.V18.Common.KeywordInfo
end

defmodule Google.Ads.Googleads.V18.Common.BudgetCampaignAssociationStatus do
  @moduledoc false
  ...
  field :status, 2,
    type:
      Google.Ads.Googleads.V18.Enums.BudgetCampaignAssociationStatusEnum.BudgetCampaignAssociationStatus,
    enum: true
end

defmodule Google.Ads.Googleads.V18.Common.AssetInteractionTarget do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.SkAdNetworkSourceApp do
  @moduledoc false
