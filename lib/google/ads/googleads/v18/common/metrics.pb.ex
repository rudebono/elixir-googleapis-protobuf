defmodule Google.Ads.Googleads.V18.Common.Metrics do
  @moduledoc false
  ...
  field :interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V18.Enums.InteractionEventTypeEnum.InteractionEventType,
  ...
  field :search_volume, 295,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Common.SearchVolumeRange,
...
defmodule Google.Ads.Googleads.V18.Common.SearchVolumeRange do
  @moduledoc false
