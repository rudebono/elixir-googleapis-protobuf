defmodule Google.Ads.Googleads.V18.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.MediaBundleAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.ImageAsset do
  @moduledoc false
  ...
  field :full_size, 4, type: Google.Ads.Googleads.V18.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V18.Common.ImageDimension do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.TextAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.LeadFormAsset do
  @moduledoc false
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V18.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V18.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V18.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V18.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V18.Common.LeadFormField do
  @moduledoc false
  ...
  field :input_type, 1,
    type:
      Google.Ads.Googleads.V18.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V18.Common.LeadFormSingleChoiceAnswers,
...
defmodule Google.Ads.Googleads.V18.Common.LeadFormCustomQuestionField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.LeadFormDeliveryMethod do
  @moduledoc false
  ...
  field :webhook, 1, type: Google.Ads.Googleads.V18.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V18.Common.WebhookDelivery do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.BookOnGoogleAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3
end

defmodule Google.Ads.Googleads.V18.Common.PromotionAsset do
  @moduledoc false
  ...
  field :discount_modifier, 2,
    type:
      Google.Ads.Googleads.V18.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
  ...
  field :money_amount_off, 4,
    type: Google.Ads.Googleads.V18.Common.Money,
...
defmodule Google.Ads.Googleads.V18.Common.CalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.StructuredSnippetAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.SitelinkAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.PageFeedAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicEducationAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.MobileAppAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.HotelCalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.CallAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.PriceAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V18.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false

  field :price_qualifier, 2,
    type:
      Google.Ads.Googleads.V18.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V18.Common.PriceOffering do
  @moduledoc false
  ...
  field :price, 3, type: Google.Ads.Googleads.V18.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V18.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V18.Common.CallToActionAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :call_to_action, 1,
    type: Google.Ads.Googleads.V18.Enums.CallToActionTypeEnum.CallToActionType,
    json_name: "callToAction",
    enum: true
end

defmodule Google.Ads.Googleads.V18.Common.DynamicRealEstateAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicCustomAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicFlightsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DemandGenCarouselCardAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicTravelAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicLocalAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.DynamicJobsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.LocationAsset do
  @moduledoc false
  ...
  field :business_profile_locations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.BusinessProfileLocation,
    json_name: "businessProfileLocations"

  field :location_ownership_type, 3,
    type: Google.Ads.Googleads.V18.Enums.LocationOwnershipTypeEnum.LocationOwnershipType,
    json_name: "locationOwnershipType",
    enum: true
end

defmodule Google.Ads.Googleads.V18.Common.BusinessProfileLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Common.HotelPropertyAsset do
  @moduledoc false
