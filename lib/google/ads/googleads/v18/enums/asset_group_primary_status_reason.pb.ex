defmodule Google.Ads.Googleads.V18.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
