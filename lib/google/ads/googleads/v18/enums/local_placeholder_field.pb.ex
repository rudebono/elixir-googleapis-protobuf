defmodule Google.Ads.Googleads.V18.Enums.LocalPlaceholderFieldEnum.LocalPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.LocalPlaceholderFieldEnum do
  @moduledoc false
