defmodule Google.Ads.Googleads.V18.Enums.ExternalConversionSourceEnum.ExternalConversionSource do
  @moduledoc false
  ...
  field :SEARCH_ADS_360, 25
  field :GOOGLE_HOSTED, 27
  field :FLOODLIGHT, 29
...
defmodule Google.Ads.Googleads.V18.Enums.ExternalConversionSourceEnum do
  @moduledoc false
