defmodule Google.Ads.Googleads.V18.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
