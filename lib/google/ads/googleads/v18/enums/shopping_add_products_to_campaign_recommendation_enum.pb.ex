defmodule Google.Ads.Googleads.V18.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
