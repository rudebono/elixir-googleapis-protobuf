defmodule Google.Ads.Googleads.V18.Enums.ConversionActionTypeEnum.ConversionActionType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.ConversionActionTypeEnum do
  @moduledoc false
