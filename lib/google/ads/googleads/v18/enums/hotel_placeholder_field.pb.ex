defmodule Google.Ads.Googleads.V18.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
