defmodule Google.Ads.Googleads.V18.Services.MutateBillingSetupRequest do
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V18.Services.BillingSetupOperation,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V18.Services.BillingSetupOperation do
  ...
  field :create, 2, type: Google.Ads.Googleads.V18.Resources.BillingSetup, oneof: 0
...
defmodule Google.Ads.Googleads.V18.Services.BillingSetupService.Service do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Services.BillingSetupService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V18.Services.BillingSetupService.Service
end
