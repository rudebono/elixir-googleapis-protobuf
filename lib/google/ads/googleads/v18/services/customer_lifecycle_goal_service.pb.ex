defmodule Google.Ads.Googleads.V18.Services.ConfigureCustomerLifecycleGoalsRequest do
  ...
  field :operation, 2,
    type: Google.Ads.Googleads.V18.Services.CustomerLifecycleGoalOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V18.Services.CustomerLifecycleGoalOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V18.Resources.CustomerLifecycleGoal, oneof: 0
  field :update, 3, type: Google.Ads.Googleads.V18.Resources.CustomerLifecycleGoal, oneof: 0
end
...
defmodule Google.Ads.Googleads.V18.Services.CustomerLifecycleGoalService.Service do
  @moduledoc false
  ...
  rpc :ConfigureCustomerLifecycleGoals,
      ...
      Google.Ads.Googleads.V18.Services.ConfigureCustomerLifecycleGoalsResponse
end

defmodule Google.Ads.Googleads.V18.Services.CustomerLifecycleGoalService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V18.Services.CustomerLifecycleGoalService.Service
end
