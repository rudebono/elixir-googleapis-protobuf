defmodule Google.Ads.Googleads.V18.Services.AppendLeadConversationRequest do
  ...
  field :conversations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V18.Services.Conversation,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V18.Services.AppendLeadConversationResponse do
  ...
  field :responses, 1,
    repeated: true,
    type: Google.Ads.Googleads.V18.Services.ConversationOrError,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V18.Services.LocalServicesLeadService.Service do
  @moduledoc false
  ...
  rpc :AppendLeadConversation,
      ...
      Google.Ads.Googleads.V18.Services.AppendLeadConversationResponse
end

defmodule Google.Ads.Googleads.V18.Services.LocalServicesLeadService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V18.Services.LocalServicesLeadService.Service
end