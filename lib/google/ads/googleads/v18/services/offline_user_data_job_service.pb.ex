...
defmodule Google.Ads.Googleads.V18.Services.AddOfflineUserDataJobOperationsRequest do
  ...
  field :operations, 3,
    repeated: true,
    type: Google.Ads.Googleads.V18.Services.OfflineUserDataJobOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V18.Services.OfflineUserDataJobService.Service do
  @moduledoc false
  ...
  rpc :CreateOfflineUserDataJob,
      ...
      Google.Ads.Googleads.V18.Services.CreateOfflineUserDataJobResponse

  rpc :AddOfflineUserDataJobOperations,
      Google.Ads.Googleads.V18.Services.AddOfflineUserDataJobOperationsRequest,
      Google.Ads.Googleads.V18.Services.AddOfflineUserDataJobOperationsResponse

  rpc :RunOfflineUserDataJob,
      Google.Ads.Googleads.V18.Services.RunOfflineUserDataJobRequest,
      Google.Longrunning.Operation
end

defmodule Google.Ads.Googleads.V18.Services.OfflineUserDataJobService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V18.Services.OfflineUserDataJobService.Service
end
