defmodule Google.Ads.Googleads.V18.Resources.AssetSet.MerchantCenterFeed do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Resources.AssetSet.HotelPropertyData do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Resources.AssetSet do
  @moduledoc false
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V18.Enums.AssetSetStatusEnum.AssetSetStatus,
    enum: true,
    deprecated: false

  field :merchant_center_feed, 5,
    type: Google.Ads.Googleads.V18.Resources.AssetSet.MerchantCenterFeed,
  ...
  field :hotel_property_data, 11,
    type: Google.Ads.Googleads.V18.Resources.AssetSet.HotelPropertyData,
    json_name: "hotelPropertyData",
    deprecated: false

  field :location_set, 7,
    type: Google.Ads.Googleads.V18.Common.LocationSet,
    json_name: "locationSet",
    oneof: 0

  field :business_profile_location_group, 8,
    type: Google.Ads.Googleads.V18.Common.BusinessProfileLocationGroup,
    json_name: "businessProfileLocationGroup",
    oneof: 0

  field :chain_location_group, 9,
    type: Google.Ads.Googleads.V18.Common.ChainLocationGroup,
