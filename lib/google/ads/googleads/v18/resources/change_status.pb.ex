defmodule Google.Ads.Googleads.V18.Resources.ChangeStatus do
  @moduledoc false
  ...
  field :resource_type, 4,
    type: Google.Ads.Googleads.V18.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType,
  ...
  field :resource_status, 8,
    type: Google.Ads.Googleads.V18.Enums.ChangeStatusOperationEnum.ChangeStatusOperation,
