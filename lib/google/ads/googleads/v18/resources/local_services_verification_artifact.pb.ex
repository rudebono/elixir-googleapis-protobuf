defmodule Google.Ads.Googleads.V18.Resources.LocalServicesVerificationArtifact do
  ...
  field :status, 4,
    type:
      Google.Ads.Googleads.V18.Enums.LocalServicesVerificationArtifactStatusEnum.LocalServicesVerificationArtifactStatus,
    enum: true,
    deprecated: false

  field :artifact_type, 5,
    type:
      Google.Ads.Googleads.V18.Enums.LocalServicesVerificationArtifactTypeEnum.LocalServicesVerificationArtifactType,
    json_name: "artifactType",
    enum: true,
    deprecated: false

  field :background_check_verification_artifact, 6,
    type: Google.Ads.Googleads.V18.Resources.BackgroundCheckVerificationArtifact,
    json_name: "backgroundCheckVerificationArtifact",
    oneof: 0,
    deprecated: false

  field :insurance_verification_artifact, 7,
    type: Google.Ads.Googleads.V18.Resources.InsuranceVerificationArtifact,
    json_name: "insuranceVerificationArtifact",
    oneof: 0,
    deprecated: false

  field :license_verification_artifact, 8,
    type: Google.Ads.Googleads.V18.Resources.LicenseVerificationArtifact,
    json_name: "licenseVerificationArtifact",
    oneof: 0,
    deprecated: false

  field :business_registration_check_verification_artifact, 9,
    type: Google.Ads.Googleads.V18.Resources.BusinessRegistrationCheckVerificationArtifact,
...
defmodule Google.Ads.Googleads.V18.Resources.InsuranceVerificationArtifact do
  ...
  field :insurance_document_readonly, 3,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Common.LocalServicesDocumentReadOnly,
...
defmodule Google.Ads.Googleads.V18.Resources.BusinessRegistrationCheckVerificationArtifact do
  ...
  field :registration_type, 3,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V18.Enums.LocalServicesBusinessRegistrationTypeEnum.LocalServicesBusinessRegistrationType,
  ...
  field :registration_number, 1,
    type: Google.Ads.Googleads.V18.Resources.BusinessRegistrationNumber,
    json_name: "registrationNumber",
    oneof: 0,
    deprecated: false

  field :registration_document, 2,
    type: Google.Ads.Googleads.V18.Resources.BusinessRegistrationDocument,
