defmodule Google.Ads.Googleads.V18.Resources.AssetGroup do
  @moduledoc false
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V18.Enums.AssetGroupStatusEnum.AssetGroupStatus,
    enum: true

  field :primary_status, 11,
    type: Google.Ads.Googleads.V18.Enums.AssetGroupPrimaryStatusEnum.AssetGroupPrimaryStatus,
