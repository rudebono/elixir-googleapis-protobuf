defmodule Google.Ads.Googleads.V18.Resources.AdGroup.AudienceSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V18.Resources.AdGroup do
  @moduledoc false
  ...
  field :status, 5,
    type: Google.Ads.Googleads.V18.Enums.AdGroupStatusEnum.AdGroupStatus,
    enum: true
  ...
  field :ad_rotation_mode, 22,
    type: Google.Ads.Googleads.V18.Enums.AdGroupAdRotationModeEnum.AdGroupAdRotationMode,
  ...
  field :audience_setting, 56,
    type: Google.Ads.Googleads.V18.Resources.AdGroup.AudienceSetting,
  ...
  field :primary_status, 62,
    type: Google.Ads.Googleads.V18.Enums.AdGroupPrimaryStatusEnum.AdGroupPrimaryStatus,
