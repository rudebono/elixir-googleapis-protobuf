defmodule Google.Ads.Googleads.V18.Resources.UserInterest do
  @moduledoc false
  ...
  field :taxonomy_type, 2,
    type: Google.Ads.Googleads.V18.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
  ...
  field :availabilities, 7,
    repeated: true,
    type: Google.Ads.Googleads.V18.Common.CriterionCategoryAvailability,
    deprecated: false
end
