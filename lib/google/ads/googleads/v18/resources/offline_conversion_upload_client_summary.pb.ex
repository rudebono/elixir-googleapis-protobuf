defmodule Google.Ads.Googleads.V18.Resources.OfflineConversionUploadClientSummary do
  ...
  field :client, 2,
    type: Google.Ads.Googleads.V18.Enums.OfflineEventUploadClientEnum.OfflineEventUploadClient,
    enum: true,
    deprecated: false

  field :status, 3,
    type:
      Google.Ads.Googleads.V18.Enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus,
    enum: true,
    deprecated: false
  ...
  field :daily_summaries, 8,
    repeated: true,
    type: Google.Ads.Googleads.V18.Resources.OfflineConversionSummary,
  ...
  field :alerts, 10,
    repeated: true,
    type: Google.Ads.Googleads.V18.Resources.OfflineConversionAlert,
    deprecated: false
end
