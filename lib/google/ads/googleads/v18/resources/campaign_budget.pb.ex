defmodule Google.Ads.Googleads.V18.Resources.CampaignBudget do
  @moduledoc false
  ...
  field :status, 6,
    type: Google.Ads.Googleads.V18.Enums.BudgetStatusEnum.BudgetStatus,
    enum: true,
    deprecated: false

  field :delivery_method, 7,
    type: Google.Ads.Googleads.V18.Enums.BudgetDeliveryMethodEnum.BudgetDeliveryMethod,
  ...
  field :period, 13,
    type: Google.Ads.Googleads.V18.Enums.BudgetPeriodEnum.BudgetPeriod,
    enum: true,
    deprecated: false
  ...
  field :type, 18,
    type: Google.Ads.Googleads.V18.Enums.BudgetTypeEnum.BudgetType,
    enum: true,
    deprecated: false
