defmodule Google.Ads.Googleads.V18.Resources.LocalServicesLeadConversation do
  ...
  field :conversation_channel, 3,
    type: Google.Ads.Googleads.V18.Enums.LocalServicesLeadConversationTypeEnum.ConversationType,
    json_name: "conversationChannel",
    enum: true,
    deprecated: false

  field :participant_type, 4,
    type: Google.Ads.Googleads.V18.Enums.LocalServicesParticipantTypeEnum.ParticipantType,
  ...
  field :phone_call_details, 7,
    ...
    type: Google.Ads.Googleads.V18.Resources.PhoneCallDetails,
    json_name: "phoneCallDetails",
    deprecated: false

  field :message_details, 8,
    proto3_optional: true,
    type: Google.Ads.Googleads.V18.Resources.MessageDetails,
