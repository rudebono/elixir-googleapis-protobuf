defmodule Google.Ads.Googleads.V18.Resources.AccountBudget.PendingAccountBudgetProposal do
  ...
  field :proposal_type, 2,
    type: Google.Ads.Googleads.V18.Enums.AccountBudgetProposalTypeEnum.AccountBudgetProposalType,
  ...
  field :end_time_type, 6,
    type: Google.Ads.Googleads.V18.Enums.TimeTypeEnum.TimeType,
  ...
  field :spending_limit_type, 8,
    type: Google.Ads.Googleads.V18.Enums.SpendingLimitTypeEnum.SpendingLimitType,
...
defmodule Google.Ads.Googleads.V18.Resources.AccountBudget do
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V18.Enums.AccountBudgetStatusEnum.AccountBudgetStatus,
    enum: true,
    deprecated: false
  ...
  field :pending_proposal, 22,
    type: Google.Ads.Googleads.V18.Resources.AccountBudget.PendingAccountBudgetProposal,
