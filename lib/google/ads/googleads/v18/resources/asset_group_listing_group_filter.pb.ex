defmodule Google.Ads.Googleads.V18.Resources.AssetGroupListingGroupFilter do
  ...
  field :type, 4,
    type: Google.Ads.Googleads.V18.Enums.ListingGroupFilterTypeEnum.ListingGroupFilterType,
    enum: true,
    deprecated: false

  field :listing_source, 9,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterListingSourceEnum.ListingGroupFilterListingSource,
    json_name: "listingSource",
    enum: true,
    deprecated: false

  field :case_value, 6,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension,
    json_name: "caseValue"
  ...
  field :path, 8,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimensionPath,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCategory do
  ...
  field :level, 2,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterProductCategoryLevelEnum.ListingGroupFilterProductCategoryLevel,
    enum: true
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductChannel do
  ...
  field :channel, 1,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterProductChannelEnum.ListingGroupFilterProductChannel,
    enum: true
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCondition do
  ...
  field :condition, 1,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterProductConditionEnum.ListingGroupFilterProductCondition,
    enum: true
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCustomAttribute do
  ...
  field :index, 2,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterCustomAttributeIndexEnum.ListingGroupFilterCustomAttributeIndex,
    enum: true
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductType do
  ...
  field :level, 2,
    type:
      Google.Ads.Googleads.V18.Enums.ListingGroupFilterProductTypeLevelEnum.ListingGroupFilterProductTypeLevel,
    enum: true
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.Webpage do
  ...
  field :conditions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.WebpageCondition
end
...
defmodule Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension do
  ...
  field :product_category, 10,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCategory,
    json_name: "productCategory",
    oneof: 0

  field :product_brand, 2,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductBrand,
    json_name: "productBrand",
    oneof: 0

  field :product_channel, 3,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductChannel,
    json_name: "productChannel",
    oneof: 0

  field :product_condition, 4,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCondition,
    json_name: "productCondition",
    oneof: 0

  field :product_custom_attribute, 5,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductCustomAttribute,
    json_name: "productCustomAttribute",
    oneof: 0

  field :product_item_id, 6,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductItemId,
    json_name: "productItemId",
    oneof: 0

  field :product_type, 7,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.ProductType,
    json_name: "productType",
    oneof: 0

  field :webpage, 9,
    type: Google.Ads.Googleads.V18.Resources.ListingGroupFilterDimension.Webpage,
    oneof: 0
end
