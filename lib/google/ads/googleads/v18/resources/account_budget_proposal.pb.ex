defmodule Google.Ads.Googleads.V18.Resources.AccountBudgetProposal do
  @moduledoc false
  ...
  field :status, 15,
    type:
      Google.Ads.Googleads.V18.Enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus,
    enum: true,
    deprecated: false
