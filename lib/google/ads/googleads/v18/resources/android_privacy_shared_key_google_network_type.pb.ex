defmodule Google.Ads.Googleads.V18.Resources.AndroidPrivacySharedKeyGoogleNetworkType do
  @moduledoc false
  ...
  field :android_privacy_interaction_type, 3,
    type:
      Google.Ads.Googleads.V18.Enums.AndroidPrivacyInteractionTypeEnum.AndroidPrivacyInteractionType,
  ...
  field :android_privacy_network_type, 5,
    type: Google.Ads.Googleads.V18.Enums.AndroidPrivacyNetworkTypeEnum.AndroidPrivacyNetworkType,
