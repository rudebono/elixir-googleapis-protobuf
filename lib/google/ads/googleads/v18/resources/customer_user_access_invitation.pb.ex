defmodule Google.Ads.Googleads.V18.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V18.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
