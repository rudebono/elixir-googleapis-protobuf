defmodule Google.Ads.Googleads.V21.Services.GenerateConversionRatesRequest do
  @moduledoc false
  ...
  field :reach_application_info, 3,
    type: Google.Ads.Googleads.V21.Common.AdditionalApplicationInfo,
    json_name: "reachApplicationInfo",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Services.GenerateConversionRatesResponse do
  @moduledoc false
  ...
  field :conversion_rate_suggestions, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.ConversionRateSuggestion,
    json_name: "conversionRateSuggestions"
end

defmodule Google.Ads.Googleads.V21.Services.ConversionRateSuggestion do
  @moduledoc false
  ...
  field :conversion_rate_model, 1,
    type:
      Google.Ads.Googleads.V21.Enums.ReachPlanConversionRateModelEnum.ReachPlanConversionRateModel,
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableLocationsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableLocationsResponse do
  @moduledoc false
  ...
  field :plannable_locations, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.PlannableLocation,
    json_name: "plannableLocations"
end

defmodule Google.Ads.Googleads.V21.Services.PlannableLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableProductsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableProductsResponse do
  @moduledoc false
  ...
  field :product_metadata, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.ProductMetadata,
    json_name: "productMetadata"
end

defmodule Google.Ads.Googleads.V21.Services.ProductMetadata do
  @moduledoc false
  ...
  field :plannable_targeting, 2,
    type: Google.Ads.Googleads.V21.Services.PlannableTargeting,
    json_name: "plannableTargeting"
end

defmodule Google.Ads.Googleads.V21.Services.ListPlannableUserListsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableUserListsResponse do
  @moduledoc false
  ...
  field :plannable_user_lists, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.PlannableUserList,
    json_name: "plannableUserLists"
end

defmodule Google.Ads.Googleads.V21.Services.PlannableUserList do
  @moduledoc false
  ...
  field :plannable_status, 4,
    type:
      Google.Ads.Googleads.V21.Enums.ReachPlanPlannableUserListStatusEnum.ReachPlanPlannableUserListStatus,
    json_name: "plannableStatus",
    enum: true
end

defmodule Google.Ads.Googleads.V21.Services.PlannableTargeting do
  @moduledoc false
  ...
  field :age_ranges, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange,
    json_name: "ageRanges",
    enum: true

  field :genders, 2, repeated: true, type: Google.Ads.Googleads.V21.Common.GenderInfo
  field :devices, 3, repeated: true, type: Google.Ads.Googleads.V21.Common.DeviceInfo

  field :networks, 4,
    repeated: true,
    type: Google.Ads.Googleads.V21.Enums.ReachPlanNetworkEnum.ReachPlanNetwork,
    enum: true

  field :youtube_select_lineups, 5,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.YouTubeSelectLineUp,
    json_name: "youtubeSelectLineups"

  field :surface_targeting, 6,
    type: Google.Ads.Googleads.V21.Services.SurfaceTargetingCombinations,
    json_name: "surfaceTargeting"
end

defmodule Google.Ads.Googleads.V21.Services.ListPlannableUserInterestsRequest do
  @moduledoc false
  ...
  field :user_interest_taxonomy_types, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
...
defmodule Google.Ads.Googleads.V21.Services.ListPlannableUserInterestsResponse do
  @moduledoc false
  ...
  field :plannable_user_interests, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.PlannableUserInterest,
    json_name: "plannableUserInterests"
end

defmodule Google.Ads.Googleads.V21.Services.PlannableUserInterest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.GenerateReachForecastRequest do
  @moduledoc false
  ...
  field :campaign_duration, 3,
    type: Google.Ads.Googleads.V21.Services.CampaignDuration,
  ...
  field :cookie_frequency_cap_setting, 8,
    type: Google.Ads.Googleads.V21.Services.FrequencyCap,
  ...
  field :effective_frequency_limit, 12,
    proto3_optional: true,
    type: Google.Ads.Googleads.V21.Services.EffectiveFrequencyLimit,
    json_name: "effectiveFrequencyLimit"

  field :targeting, 6, type: Google.Ads.Googleads.V21.Services.Targeting

  field :planned_products, 7,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.PlannedProduct,
    json_name: "plannedProducts",
    deprecated: false

  field :forecast_metric_options, 13,
    type: Google.Ads.Googleads.V21.Services.ForecastMetricOptions,
...
defmodule Google.Ads.Googleads.V21.Services.EffectiveFrequencyLimit do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.FrequencyCap do
  @moduledoc false
  ...
  field :time_unit, 2,
    type: Google.Ads.Googleads.V21.Enums.FrequencyCapTimeUnitEnum.FrequencyCapTimeUnit,
    json_name: "timeUnit",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Services.Targeting do
  @moduledoc false
  ...
  field :genders, 3, repeated: true, type: Google.Ads.Googleads.V21.Common.GenderInfo
  field :devices, 4, repeated: true, type: Google.Ads.Googleads.V21.Common.DeviceInfo
  ...
  field :audience_targeting, 7,
    type: Google.Ads.Googleads.V21.Services.AudienceTargeting,
    json_name: "audienceTargeting"
end

defmodule Google.Ads.Googleads.V21.Services.CampaignDuration do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :duration_in_days, 2, proto3_optional: true, type: :int32, json_name: "durationInDays"
  field :date_range, 3, type: Google.Ads.Googleads.V21.Common.DateRange, json_name: "dateRange"
end

defmodule Google.Ads.Googleads.V21.Services.PlannedProduct do
  @moduledoc false
  ...
  field :advanced_product_targeting, 5,
    type: Google.Ads.Googleads.V21.Services.AdvancedProductTargeting,
    json_name: "advancedProductTargeting"
end

defmodule Google.Ads.Googleads.V21.Services.GenerateReachForecastResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :on_target_audience_metrics, 1,
    type: Google.Ads.Googleads.V21.Services.OnTargetAudienceMetrics,
    json_name: "onTargetAudienceMetrics"

  field :reach_curve, 2,
    type: Google.Ads.Googleads.V21.Services.ReachCurve,
    json_name: "reachCurve"
end

defmodule Google.Ads.Googleads.V21.Services.ReachCurve do
  @moduledoc false
  ...
  field :reach_forecasts, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.ReachForecast,
    json_name: "reachForecasts"
end

defmodule Google.Ads.Googleads.V21.Services.ReachForecast do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :cost_micros, 5, type: :int64, json_name: "costMicros"
  field :forecast, 2, type: Google.Ads.Googleads.V21.Services.Forecast

  field :planned_product_reach_forecasts, 4,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.PlannedProductReachForecast,
    json_name: "plannedProductReachForecasts"
end

defmodule Google.Ads.Googleads.V21.Services.Forecast do
  @moduledoc false
  ...
  field :effective_frequency_breakdowns, 10,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.EffectiveFrequencyBreakdown,
...
defmodule Google.Ads.Googleads.V21.Services.PlannedProductReachForecast do
  @moduledoc false
  ...
  field :planned_product_forecast, 3,
    type: Google.Ads.Googleads.V21.Services.PlannedProductForecast,
    json_name: "plannedProductForecast"
end

defmodule Google.Ads.Googleads.V21.Services.PlannedProductForecast do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.OnTargetAudienceMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.EffectiveFrequencyBreakdown do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ForecastMetricOptions do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.AudienceTargeting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.AdvancedProductTargeting do
  @moduledoc false
  ...
  field :surface_targeting_settings, 2,
    type: Google.Ads.Googleads.V21.Services.SurfaceTargeting,
    json_name: "surfaceTargetingSettings"

  field :target_frequency_settings, 3,
    type: Google.Ads.Googleads.V21.Services.TargetFrequencySettings,
    json_name: "targetFrequencySettings"

  field :youtube_select_settings, 1,
    type: Google.Ads.Googleads.V21.Services.YouTubeSelectSettings,
    json_name: "youtubeSelectSettings",
    oneof: 0
end

defmodule Google.Ads.Googleads.V21.Services.YouTubeSelectSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.YouTubeSelectLineUp do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.SurfaceTargetingCombinations do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.SurfaceTargeting do
  @moduledoc false
  ...
  field :surfaces, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Enums.ReachPlanSurfaceEnum.ReachPlanSurface,
    enum: true
end

defmodule Google.Ads.Googleads.V21.Services.TargetFrequencySettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ReachPlanService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.ads.googleads.v21.services.ReachPlanService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :GenerateConversionRates,
      Google.Ads.Googleads.V21.Services.GenerateConversionRatesRequest,
      Google.Ads.Googleads.V21.Services.GenerateConversionRatesResponse

  rpc :ListPlannableLocations,
      Google.Ads.Googleads.V21.Services.ListPlannableLocationsRequest,
      Google.Ads.Googleads.V21.Services.ListPlannableLocationsResponse

  rpc :ListPlannableProducts,
      Google.Ads.Googleads.V21.Services.ListPlannableProductsRequest,
      Google.Ads.Googleads.V21.Services.ListPlannableProductsResponse

  rpc :GenerateReachForecast,
      Google.Ads.Googleads.V21.Services.GenerateReachForecastRequest,
      Google.Ads.Googleads.V21.Services.GenerateReachForecastResponse

  rpc :ListPlannableUserLists,
      Google.Ads.Googleads.V21.Services.ListPlannableUserListsRequest,
      Google.Ads.Googleads.V21.Services.ListPlannableUserListsResponse
...
defmodule Google.Ads.Googleads.V21.Services.ReachPlanService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V21.Services.ReachPlanService.Service
end
