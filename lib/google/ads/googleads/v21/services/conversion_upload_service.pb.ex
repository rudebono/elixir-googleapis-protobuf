defmodule Google.Ads.Googleads.V21.Services.UploadClickConversionsRequest do
  @moduledoc false
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.ClickConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V21.Services.UploadClickConversionsResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :partial_failure_error, 1, type: Google.Rpc.Status, json_name: "partialFailureError"
  field :results, 2, repeated: true, type: Google.Ads.Googleads.V21.Services.ClickConversionResult
  field :job_id, 3, type: :int64, json_name: "jobId"
end

defmodule Google.Ads.Googleads.V21.Services.UploadCallConversionsRequest do
  @moduledoc false
  ...
  field :conversions, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.CallConversion,
    deprecated: false
...
defmodule Google.Ads.Googleads.V21.Services.UploadCallConversionsResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :partial_failure_error, 1, type: Google.Rpc.Status, json_name: "partialFailureError"
  field :results, 2, repeated: true, type: Google.Ads.Googleads.V21.Services.CallConversionResult
end

defmodule Google.Ads.Googleads.V21.Services.ClickConversion do
  @moduledoc false
  ...
  field :external_attribution_data, 7,
    type: Google.Ads.Googleads.V21.Services.ExternalAttributionData,
    json_name: "externalAttributionData"

  field :custom_variables, 15,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.CustomVariable,
    json_name: "customVariables"

  field :cart_data, 16, type: Google.Ads.Googleads.V21.Services.CartData, json_name: "cartData"

  field :user_identifiers, 17,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.UserIdentifier,
    json_name: "userIdentifiers"

  field :conversion_environment, 20,
    type: Google.Ads.Googleads.V21.Enums.ConversionEnvironmentEnum.ConversionEnvironment,
    json_name: "conversionEnvironment",
    enum: true

  field :consent, 23, type: Google.Ads.Googleads.V21.Common.Consent

  field :customer_type, 26,
    type: Google.Ads.Googleads.V21.Enums.ConversionCustomerTypeEnum.ConversionCustomerType,
  ...
  field :session_attributes_key_value_pairs, 25,
    type: Google.Ads.Googleads.V21.Services.SessionAttributesKeyValuePairs,
    json_name: "sessionAttributesKeyValuePairs",
    oneof: 0
end

defmodule Google.Ads.Googleads.V21.Services.CallConversion do
  @moduledoc false
  ...
  field :consent, 14, type: Google.Ads.Googleads.V21.Common.Consent
end

defmodule Google.Ads.Googleads.V21.Services.ExternalAttributionData do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ClickConversionResult do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.CallConversionResult do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.CustomVariable do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.CartData.Item do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.CartData do
  @moduledoc false
  ...
  field :items, 5, repeated: true, type: Google.Ads.Googleads.V21.Services.CartData.Item
end

defmodule Google.Ads.Googleads.V21.Services.SessionAttributeKeyValuePair do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.SessionAttributesKeyValuePairs do
  @moduledoc false
  ...
  field :key_value_pairs, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.SessionAttributeKeyValuePair,
    json_name: "keyValuePairs",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Services.ConversionUploadService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.ads.googleads.v21.services.ConversionUploadService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :UploadClickConversions,
      Google.Ads.Googleads.V21.Services.UploadClickConversionsRequest,
      Google.Ads.Googleads.V21.Services.UploadClickConversionsResponse

  rpc :UploadCallConversions,
      Google.Ads.Googleads.V21.Services.UploadCallConversionsRequest,
      Google.Ads.Googleads.V21.Services.UploadCallConversionsResponse
end

defmodule Google.Ads.Googleads.V21.Services.ConversionUploadService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V21.Services.ConversionUploadService.Service
end
