defmodule Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.SearchAttributes do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.SearchBrand do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.YouTubeChannels do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest do
  @moduledoc false
  ...
  field :search_attributes, 3,
    type: Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.SearchAttributes,
    json_name: "searchAttributes",
    oneof: 0

  field :search_brand, 5,
    type: Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.SearchBrand,
    json_name: "searchBrand",
    oneof: 0

  field :search_channels, 4,
    type: Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest.YouTubeChannels,
    json_name: "searchChannels",
    oneof: 0
end

defmodule Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsResponse do
  @moduledoc false
  ...
  field :creator_insights, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.YouTubeCreatorInsights,
    json_name: "creatorInsights"
end

defmodule Google.Ads.Googleads.V21.Services.GenerateTrendingInsightsRequest do
  @moduledoc false
  ...
  field :search_audience, 4,
    type: Google.Ads.Googleads.V21.Services.SearchAudience,
    json_name: "searchAudience",
    oneof: 0

  field :search_topics, 5,
    type: Google.Ads.Googleads.V21.Services.SearchTopics,
    json_name: "searchTopics",
    oneof: 0
end

defmodule Google.Ads.Googleads.V21.Services.GenerateTrendingInsightsResponse do
  @moduledoc false
  ...
  field :trend_insights, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.TrendInsight,
    json_name: "trendInsights"
end

defmodule Google.Ads.Googleads.V21.Services.YouTubeCreatorInsights do
  @moduledoc false
  ...
  field :creator_channels, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Services.YouTubeChannelInsights,
    json_name: "creatorChannels"
end

defmodule Google.Ads.Googleads.V21.Services.YouTubeMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.YouTubeChannelInsights do
  @moduledoc false
  ...
  field :channel_metrics, 3,
    type: Google.Ads.Googleads.V21.Services.YouTubeMetrics,
...
defmodule Google.Ads.Googleads.V21.Services.SearchAudience do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.SearchTopics do
  @moduledoc false
  ...
  field :entities, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.AudienceInsightsEntity,
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Services.TrendInsight do
  @moduledoc false
  ...
  field :trend_metrics, 2,
    type: Google.Ads.Googleads.V21.Services.TrendInsightMetrics,
    json_name: "trendMetrics"

  field :trend, 3,
    type: Google.Ads.Googleads.V21.Enums.InsightsTrendEnum.InsightsTrend,
    enum: true
end

defmodule Google.Ads.Googleads.V21.Services.TrendInsightMetrics do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Services.ContentCreatorInsightsService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.ads.googleads.v21.services.ContentCreatorInsightsService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :GenerateCreatorInsights,
      Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsRequest,
      Google.Ads.Googleads.V21.Services.GenerateCreatorInsightsResponse

  rpc :GenerateTrendingInsights,
      Google.Ads.Googleads.V21.Services.GenerateTrendingInsightsRequest,
      Google.Ads.Googleads.V21.Services.GenerateTrendingInsightsResponse
end

defmodule Google.Ads.Googleads.V21.Services.ContentCreatorInsightsService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V21.Services.ContentCreatorInsightsService.Service
end
