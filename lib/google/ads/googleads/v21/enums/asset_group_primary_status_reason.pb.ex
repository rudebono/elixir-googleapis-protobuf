defmodule Google.Ads.Googleads.V21.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
