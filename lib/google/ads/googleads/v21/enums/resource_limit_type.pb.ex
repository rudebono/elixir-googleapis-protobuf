defmodule Google.Ads.Googleads.V21.Enums.ResourceLimitTypeEnum.ResourceLimitType do
  @moduledoc false
  ...
  field :LOGO_CAMPAIGN_ASSETS_PER_CAMPAIGN, 187
  field :BUSINESS_MESSAGE_ASSET_LINKS_PER_CUSTOMER, 188
  field :WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_CAMPAIGN, 189
  field :WHATSAPP_BUSINESS_MESSAGE_ASSET_LINKS_PER_AD_GROUP, 190
  field :BRAND_LIST_CRITERIA_PER_AD_GROUP, 193
end

defmodule Google.Ads.Googleads.V21.Enums.ResourceLimitTypeEnum do
  @moduledoc false
