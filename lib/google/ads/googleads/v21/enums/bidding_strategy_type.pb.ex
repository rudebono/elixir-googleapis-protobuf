defmodule Google.Ads.Googleads.V21.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
