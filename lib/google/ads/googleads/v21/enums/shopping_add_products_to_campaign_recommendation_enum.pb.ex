defmodule Google.Ads.Googleads.V21.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
