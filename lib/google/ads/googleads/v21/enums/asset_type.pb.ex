defmodule Google.Ads.Googleads.V21.Enums.AssetTypeEnum.AssetType do
  @moduledoc false
  ...
  field :DEMAND_GEN_CAROUSEL_CARD, 29
  field :BUSINESS_MESSAGE, 30
  field :APP_DEEP_LINK, 31
  field :YOUTUBE_VIDEO_LIST, 32
end

defmodule Google.Ads.Googleads.V21.Enums.AssetTypeEnum do
  @moduledoc false
