defmodule Google.Ads.Googleads.V21.Resources.OfflineConversionUploadClientSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.OfflineConversionSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.OfflineConversionAlert do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :error, 1,
    type: Google.Ads.Googleads.V21.Resources.OfflineConversionError,
    deprecated: false

  field :error_percentage, 2, type: :double, json_name: "errorPercentage", deprecated: false
end

defmodule Google.Ads.Googleads.V21.Resources.OfflineConversionError do
  @moduledoc false
