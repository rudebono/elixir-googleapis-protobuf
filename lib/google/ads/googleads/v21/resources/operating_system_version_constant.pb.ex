defmodule Google.Ads.Googleads.V21.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V21.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
