defmodule Google.Ads.Googleads.V21.Resources.Customer do
  @moduledoc false
  ...
  field :call_reporting_setting, 10,
    type: Google.Ads.Googleads.V21.Resources.CallReportingSetting,
    json_name: "callReportingSetting"

  field :conversion_tracking_setting, 14,
    type: Google.Ads.Googleads.V21.Resources.ConversionTrackingSetting,
    json_name: "conversionTrackingSetting"

  field :remarketing_setting, 15,
    type: Google.Ads.Googleads.V21.Resources.RemarketingSetting,
  ...
  field :pay_per_conversion_eligibility_failure_reasons, 16,
    repeated: true,
    type:
      Google.Ads.Googleads.V21.Enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason,
  ...
  field :status, 36,
    type: Google.Ads.Googleads.V21.Enums.CustomerStatusEnum.CustomerStatus,
    enum: true,
    deprecated: false
  ...
  field :customer_agreement_setting, 44,
    type: Google.Ads.Googleads.V21.Resources.CustomerAgreementSetting,
    json_name: "customerAgreementSetting",
    deprecated: false

  field :local_services_settings, 45,
    type: Google.Ads.Googleads.V21.Resources.LocalServicesSettings,
  ...
  field :video_customer, 54,
    type: Google.Ads.Googleads.V21.Resources.VideoCustomer,
    json_name: "videoCustomer"
end

defmodule Google.Ads.Googleads.V21.Resources.CallReportingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.ConversionTrackingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.RemarketingSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.CustomerAgreementSetting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.LocalServicesSettings do
  @moduledoc false
  ...
  field :granular_license_statuses, 1,
    repeated: true,
    type: Google.Ads.Googleads.V21.Resources.GranularLicenseStatus,
    json_name: "granularLicenseStatuses",
    deprecated: false

  field :granular_insurance_statuses, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Resources.GranularInsuranceStatus,
    json_name: "granularInsuranceStatuses",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Resources.GranularLicenseStatus do
  @moduledoc false
  ...
  field :verification_status, 3,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V21.Enums.LocalServicesVerificationStatusEnum.LocalServicesVerificationStatus,
    json_name: "verificationStatus",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Resources.GranularInsuranceStatus do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.VideoCustomer do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :third_party_integration_partners, 1,
    type: Google.Ads.Googleads.V21.Common.CustomerThirdPartyIntegrationPartners,
