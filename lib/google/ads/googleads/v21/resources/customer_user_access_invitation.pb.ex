defmodule Google.Ads.Googleads.V21.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V21.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
