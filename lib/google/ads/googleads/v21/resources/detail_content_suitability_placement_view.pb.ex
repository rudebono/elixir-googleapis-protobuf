defmodule Google.Ads.Googleads.V21.Resources.DetailContentSuitabilityPlacementView do
  @moduledoc false
  ...
  field :placement_type, 4,
    type: Google.Ads.Googleads.V21.Enums.PlacementTypeEnum.PlacementType,
