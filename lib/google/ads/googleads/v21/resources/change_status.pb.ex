defmodule Google.Ads.Googleads.V21.Resources.ChangeStatus do
  @moduledoc false
  ...
  field :resource_type, 4,
    type: Google.Ads.Googleads.V21.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType,
  ...
  field :resource_status, 8,
    type: Google.Ads.Googleads.V21.Enums.ChangeStatusOperationEnum.ChangeStatusOperation,
