defmodule Google.Ads.Googleads.V21.Resources.BiddingSeasonalityAdjustment do
  @moduledoc false
  ...
  field :scope, 3,
    type: Google.Ads.Googleads.V21.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope,
    enum: true

  field :status, 4,
    type: Google.Ads.Googleads.V21.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus,
    enum: true,
    deprecated: false
