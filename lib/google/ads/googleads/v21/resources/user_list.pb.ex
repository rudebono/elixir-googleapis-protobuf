defmodule Google.Ads.Googleads.V21.Resources.UserList do
  @moduledoc false
  ...
  field :membership_status, 6,
    type: Google.Ads.Googleads.V21.Enums.UserListMembershipStatusEnum.UserListMembershipStatus,
  ...
  field :size_range_for_display, 10,
    type: Google.Ads.Googleads.V21.Enums.UserListSizeRangeEnum.UserListSizeRange,
  ...
  field :closing_reason, 14,
    type: Google.Ads.Googleads.V21.Enums.UserListClosingReasonEnum.UserListClosingReason,
    json_name: "closingReason",
    enum: true

  field :access_reason, 15,
    type: Google.Ads.Googleads.V21.Enums.AccessReasonEnum.AccessReason,
    json_name: "accessReason",
    enum: true,
    deprecated: false

  field :account_user_list_status, 16,
    type: Google.Ads.Googleads.V21.Enums.UserListAccessStatusEnum.UserListAccessStatus,
  ...
  field :crm_based_user_list, 19,
    type: Google.Ads.Googleads.V21.Common.CrmBasedUserListInfo,
    json_name: "crmBasedUserList",
    oneof: 0

  field :similar_user_list, 20,
    type: Google.Ads.Googleads.V21.Common.SimilarUserListInfo,
    json_name: "similarUserList",
    oneof: 0,
    deprecated: false

  field :rule_based_user_list, 21,
    type: Google.Ads.Googleads.V21.Common.RuleBasedUserListInfo,
    json_name: "ruleBasedUserList",
    oneof: 0

  field :logical_user_list, 22,
    type: Google.Ads.Googleads.V21.Common.LogicalUserListInfo,
    json_name: "logicalUserList",
    oneof: 0

  field :basic_user_list, 23,
    type: Google.Ads.Googleads.V21.Common.BasicUserListInfo,
    json_name: "basicUserList",
    oneof: 0

  field :lookalike_user_list, 36,
    type: Google.Ads.Googleads.V21.Common.LookalikeUserListInfo,
