defmodule Google.Ads.Googleads.V21.Resources.GeoTargetConstant do
  @moduledoc false
  ...
  field :status, 7,
    type: Google.Ads.Googleads.V21.Enums.GeoTargetConstantStatusEnum.GeoTargetConstantStatus,
    enum: true,
    deprecated: false
