defmodule Google.Ads.Googleads.V21.Resources.Experiment do
  @moduledoc false
  ...
  field :type, 13,
    type: Google.Ads.Googleads.V21.Enums.ExperimentTypeEnum.ExperimentType,
    enum: true,
    deprecated: false

  field :status, 14,
    type: Google.Ads.Googleads.V21.Enums.ExperimentStatusEnum.ExperimentStatus,
    enum: true
  ...
  field :goals, 17, repeated: true, type: Google.Ads.Googleads.V21.Common.MetricGoal
  ...
  field :promote_status, 19,
    type: Google.Ads.Googleads.V21.Enums.AsyncActionStatusEnum.AsyncActionStatus,
