defmodule Google.Ads.Googleads.V21.Resources.ConversionAction.AttributionModelSettings do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :attribution_model, 1,
    type: Google.Ads.Googleads.V21.Enums.AttributionModelEnum.AttributionModel,
    json_name: "attributionModel",
    enum: true

  field :data_driven_model_status, 2,
    type: Google.Ads.Googleads.V21.Enums.DataDrivenModelStatusEnum.DataDrivenModelStatus,
    json_name: "dataDrivenModelStatus",
    enum: true,
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Resources.ConversionAction.ValueSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.ConversionAction.FirebaseSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.ConversionAction.GoogleAnalytics4Settings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Resources.ConversionAction do
  @moduledoc false
  ...
  field :status, 4,
    type: Google.Ads.Googleads.V21.Enums.ConversionActionStatusEnum.ConversionActionStatus,
    enum: true

  field :type, 5,
    type: Google.Ads.Googleads.V21.Enums.ConversionActionTypeEnum.ConversionActionType,
    enum: true,
    deprecated: false

  field :origin, 30,
    type: Google.Ads.Googleads.V21.Enums.ConversionOriginEnum.ConversionOrigin,
    enum: true,
    deprecated: false
  ...
  field :value_settings, 11,
    type: Google.Ads.Googleads.V21.Resources.ConversionAction.ValueSettings,
    json_name: "valueSettings"

  field :counting_type, 12,
    type:
      Google.Ads.Googleads.V21.Enums.ConversionActionCountingTypeEnum.ConversionActionCountingType,
    json_name: "countingType",
    enum: true

  field :attribution_model_settings, 13,
    type: Google.Ads.Googleads.V21.Resources.ConversionAction.AttributionModelSettings,
    json_name: "attributionModelSettings"

  field :tag_snippets, 14,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.TagSnippet,
  ...
  field :firebase_settings, 18,
    type: Google.Ads.Googleads.V21.Resources.ConversionAction.FirebaseSettings,
    json_name: "firebaseSettings",
    deprecated: false

  field :third_party_app_analytics_settings, 19,
    type: Google.Ads.Googleads.V21.Resources.ConversionAction.ThirdPartyAppAnalyticsSettings,
    json_name: "thirdPartyAppAnalyticsSettings",
    deprecated: false

  field :google_analytics_4_settings, 34,
    type: Google.Ads.Googleads.V21.Resources.ConversionAction.GoogleAnalytics4Settings,
