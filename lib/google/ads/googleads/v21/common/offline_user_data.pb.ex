defmodule Google.Ads.Googleads.V21.Common.OfflineUserAddressInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.UserIdentifier do
  @moduledoc false
  ...
  field :user_identifier_source, 6,
    type: Google.Ads.Googleads.V21.Enums.UserIdentifierSourceEnum.UserIdentifierSource,
  ...
  field :address_info, 5,
    type: Google.Ads.Googleads.V21.Common.OfflineUserAddressInfo,
    json_name: "addressInfo",
    oneof: 0
end

defmodule Google.Ads.Googleads.V21.Common.TransactionAttribute do
  @moduledoc false
  ...
  field :store_attribute, 6,
    type: Google.Ads.Googleads.V21.Common.StoreAttribute,
  ...
  field :item_attribute, 14,
    type: Google.Ads.Googleads.V21.Common.ItemAttribute,
    json_name: "itemAttribute"
end

defmodule Google.Ads.Googleads.V21.Common.StoreAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.ItemAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.UserData do
  @moduledoc false
  ...
  field :transaction_attribute, 2,
    type: Google.Ads.Googleads.V21.Common.TransactionAttribute,
    json_name: "transactionAttribute"

  field :user_attribute, 3,
    type: Google.Ads.Googleads.V21.Common.UserAttribute,
    json_name: "userAttribute"

  field :consent, 4, proto3_optional: true, type: Google.Ads.Googleads.V21.Common.Consent
end

defmodule Google.Ads.Googleads.V21.Common.UserAttribute do
  @moduledoc false
  ...
  field :shopping_loyalty, 7,
    proto3_optional: true,
    type: Google.Ads.Googleads.V21.Common.ShoppingLoyalty,
  ...
  field :event_attribute, 10,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.EventAttribute,
    json_name: "eventAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Common.EventAttribute do
  @moduledoc false
  ...
  field :item_attribute, 3,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.EventItemAttribute,
    json_name: "itemAttribute",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Common.EventItemAttribute do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.ShoppingLoyalty do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.CustomerMatchUserListMetadata do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :user_list, 2, proto3_optional: true, type: :string, json_name: "userList"
  field :consent, 3, proto3_optional: true, type: Google.Ads.Googleads.V21.Common.Consent
end

defmodule Google.Ads.Googleads.V21.Common.StoreSalesMetadata do
  @moduledoc false
  ...
  field :third_party_metadata, 3,
    type: Google.Ads.Googleads.V21.Common.StoreSalesThirdPartyMetadata,
    json_name: "thirdPartyMetadata"
end

defmodule Google.Ads.Googleads.V21.Common.StoreSalesThirdPartyMetadata do
  @moduledoc false
