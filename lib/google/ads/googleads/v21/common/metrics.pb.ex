defmodule Google.Ads.Googleads.V21.Common.Metrics do
  @moduledoc false
  ...
  field :historical_creative_quality_score, 80,
    type: Google.Ads.Googleads.V21.Enums.QualityScoreBucketEnum.QualityScoreBucket,
  ...
  field :interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V21.Enums.InteractionEventTypeEnum.InteractionEventType,
  ...
  field :search_volume, 295,
    proto3_optional: true,
    type: Google.Ads.Googleads.V21.Common.SearchVolumeRange,
  ...
  field :video_view_rate_in_feed, 367,
    proto3_optional: true,
    type: :double,
    json_name: "videoViewRateInFeed"

  field :video_view_rate_in_stream, 368,
    proto3_optional: true,
    type: :double,
    json_name: "videoViewRateInStream"

  field :video_view_rate_shorts, 369,
    proto3_optional: true,
    type: :double,
...
defmodule Google.Ads.Googleads.V21.Common.SearchVolumeRange do
  @moduledoc false
