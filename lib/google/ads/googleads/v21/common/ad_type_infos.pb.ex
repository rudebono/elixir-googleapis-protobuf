defmodule Google.Ads.Googleads.V21.Common.TextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.ExpandedTextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.ExpandedDynamicSearchAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.HotelAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V21.Common.TravelAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V21.Common.ShoppingSmartAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V21.Common.ShoppingProductAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V21.Common.ShoppingComparisonListingAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.ImageAdInfo do
  @moduledoc false
  ...
  field :image_asset, 22,
    type: Google.Ads.Googleads.V21.Common.AdImageAsset,
...
defmodule Google.Ads.Googleads.V21.Common.VideoBumperInStreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.VideoNonSkippableInStreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.VideoTrueViewInStreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.VideoOutstreamAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.InFeedVideoAdInfo do
  @moduledoc false
  ...
  field :thumbnail, 4,
    type: Google.Ads.Googleads.V21.Enums.VideoThumbnailEnum.VideoThumbnail,
    enum: true
end

defmodule Google.Ads.Googleads.V21.Common.YouTubeAudioAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V21.Common.VideoAdInfo do
  @moduledoc false
  ...
  field :video, 8, type: Google.Ads.Googleads.V21.Common.AdVideoAsset

  field :in_stream, 2,
    type: Google.Ads.Googleads.V21.Common.VideoTrueViewInStreamAdInfo,
    json_name: "inStream",
    oneof: 0

  field :bumper, 3, type: Google.Ads.Googleads.V21.Common.VideoBumperInStreamAdInfo, oneof: 0

  field :out_stream, 4,
    type: Google.Ads.Googleads.V21.Common.VideoOutstreamAdInfo,
    json_name: "outStream",
    oneof: 0

  field :non_skippable, 5,
    type: Google.Ads.Googleads.V21.Common.VideoNonSkippableInStreamAdInfo,
    json_name: "nonSkippable",
    oneof: 0

  field :in_feed, 9,
    type: Google.Ads.Googleads.V21.Common.InFeedVideoAdInfo,
    json_name: "inFeed",
    oneof: 0

  field :audio, 10, type: Google.Ads.Googleads.V21.Common.YouTubeAudioAdInfo, oneof: 0
end

defmodule Google.Ads.Googleads.V21.Common.VideoResponsiveAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset

  field :long_headlines, 2,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.AdTextAsset,
    json_name: "longHeadlines"

  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  ...
  field :videos, 5, repeated: true, type: Google.Ads.Googleads.V21.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V21.Common.ResponsiveSearchAdInfo do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :path1, 5, proto3_optional: true, type: :string
  field :path2, 6, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V21.Common.LegacyResponsiveDisplayAdInfo do
  @moduledoc false
  ...
  field :format_setting, 13,
    type: Google.Ads.Googleads.V21.Enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting,
...
defmodule Google.Ads.Googleads.V21.Common.AppAdInfo do
  @moduledoc false
  ...
  field :headlines, 2, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :images, 4, repeated: true, type: Google.Ads.Googleads.V21.Common.AdImageAsset
  ...
  field :html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.AdMediaBundleAsset,
    json_name: "html5MediaBundles"

  field :app_deep_link, 7,
    type: Google.Ads.Googleads.V21.Common.AdAppDeepLinkAsset,
    json_name: "appDeepLink"
end

defmodule Google.Ads.Googleads.V21.Common.AppEngagementAdInfo do
  @moduledoc false
  ...
  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :images, 3, repeated: true, type: Google.Ads.Googleads.V21.Common.AdImageAsset
  field :videos, 4, repeated: true, type: Google.Ads.Googleads.V21.Common.AdVideoAsset
end

defmodule Google.Ads.Googleads.V21.Common.AppPreRegistrationAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.LegacyAppInstallAdInfo do
  @moduledoc false
  ...
  field :app_store, 2,
    type:
      Google.Ads.Googleads.V21.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V21.Common.ResponsiveDisplayAdInfo do
  @moduledoc false
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset

  field :long_headline, 6,
    type: Google.Ads.Googleads.V21.Common.AdTextAsset,
    json_name: "longHeadline"

  field :descriptions, 7, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  ...
  field :control_spec, 24,
    type: Google.Ads.Googleads.V21.Common.ResponsiveDisplayAdControlSpec,
    json_name: "controlSpec"
end

defmodule Google.Ads.Googleads.V21.Common.LocalAdInfo do
  @moduledoc false
  ...
  field :videos, 6, repeated: true, type: Google.Ads.Googleads.V21.Common.AdVideoAsset
  field :path1, 9, proto3_optional: true, type: :string
  field :path2, 10, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V21.Common.DisplayUploadAdInfo do
  @moduledoc false
  ...
  field :display_upload_product_type, 1,
    type: Google.Ads.Googleads.V21.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType,
...
defmodule Google.Ads.Googleads.V21.Common.ResponsiveDisplayAdControlSpec do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.SmartCampaignAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.CallAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Common.DemandGenMultiAssetAdInfo do
  @moduledoc false
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
  field :descriptions, 6, repeated: true, type: Google.Ads.Googleads.V21.Common.AdTextAsset
...
defmodule Google.Ads.Googleads.V21.Common.DemandGenCarouselAdInfo do
  @moduledoc false
  ...
  field :headline, 3, type: Google.Ads.Googleads.V21.Common.AdTextAsset, deprecated: false
  field :description, 4, type: Google.Ads.Googleads.V21.Common.AdTextAsset, deprecated: false
  field :call_to_action_text, 5, type: :string, json_name: "callToActionText"

  field :carousel_cards, 6,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.AdDemandGenCarouselCardAsset,
    json_name: "carouselCards",
    deprecated: false
end

defmodule Google.Ads.Googleads.V21.Common.DemandGenVideoResponsiveAdInfo do
  @moduledoc false
  ...
  field :call_to_actions, 9,
    repeated: true,
    type: Google.Ads.Googleads.V21.Common.AdCallToActionAsset,
    json_name: "callToActions"
end

defmodule Google.Ads.Googleads.V21.Common.DemandGenProductAdInfo do
  @moduledoc false
