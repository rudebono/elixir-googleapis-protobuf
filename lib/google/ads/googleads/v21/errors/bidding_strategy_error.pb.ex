defmodule Google.Ads.Googleads.V21.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
