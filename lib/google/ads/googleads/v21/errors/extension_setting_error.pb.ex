defmodule Google.Ads.Googleads.V21.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
