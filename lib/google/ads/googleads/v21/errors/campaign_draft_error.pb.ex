defmodule Google.Ads.Googleads.V21.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.CampaignDraftErrorEnum do
  @moduledoc false
