defmodule Google.Ads.Googleads.V21.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.CampaignFeedErrorEnum do
  @moduledoc false
