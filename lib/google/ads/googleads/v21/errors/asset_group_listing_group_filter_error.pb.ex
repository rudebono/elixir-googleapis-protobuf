defmodule Google.Ads.Googleads.V21.Errors.AssetGroupListingGroupFilterErrorEnum.AssetGroupListingGroupFilterError do
  @moduledoc false
  ...
  field :TREE_WAS_INVALID_BEFORE_MUTATION, 24
end

defmodule Google.Ads.Googleads.V21.Errors.AssetGroupListingGroupFilterErrorEnum do
  @moduledoc false
