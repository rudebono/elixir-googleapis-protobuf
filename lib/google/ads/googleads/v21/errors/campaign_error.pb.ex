defmodule Google.Ads.Googleads.V21.Errors.CampaignErrorEnum.CampaignError do
  @moduledoc false
  ...
  field :THIRD_PARTY_INTEGRATION_PARTNER_NOT_ALLOWED, 105
  field :THIRD_PARTY_INTEGRATION_PARTNER_SHARE_COST_NOT_ALLOWED, 106
  field :DUPLICATE_INTERACTION_TYPE, 107
  field :INVALID_INTERACTION_TYPE, 108
  field :VIDEO_SEQUENCE_ERROR_SEQUENCE_DEFINITION_REQUIRED, 109
  field :AI_MAX_MUST_BE_ENABLED, 110
end

defmodule Google.Ads.Googleads.V21.Errors.CampaignErrorEnum do
  @moduledoc false
