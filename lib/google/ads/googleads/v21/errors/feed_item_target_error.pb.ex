defmodule Google.Ads.Googleads.V21.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
