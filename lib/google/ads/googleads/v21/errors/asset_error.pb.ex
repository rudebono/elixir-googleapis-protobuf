defmodule Google.Ads.Googleads.V21.Errors.AssetErrorEnum.AssetError do
  @moduledoc false
  ...
  field :PROMOTION_BARCODE_CANNOT_CONTAIN_LINKS, 41
  field :PROMOTION_BARCODE_INVALID_FORMAT, 42
  field :UNSUPPORTED_BARCODE_TYPE, 43
  field :PROMOTION_QR_CODE_CANNOT_CONTAIN_LINKS, 44
  field :PROMOTION_QR_CODE_INVALID_FORMAT, 45
end

defmodule Google.Ads.Googleads.V21.Errors.AssetErrorEnum do
  @moduledoc false
