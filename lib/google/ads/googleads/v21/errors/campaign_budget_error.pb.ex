defmodule Google.Ads.Googleads.V21.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V21.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
