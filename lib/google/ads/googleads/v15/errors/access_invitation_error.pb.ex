defmodule Google.Ads.Googleads.V15.Errors.AccessInvitationErrorEnum.AccessInvitationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.AccessInvitationErrorEnum do
  @moduledoc false
