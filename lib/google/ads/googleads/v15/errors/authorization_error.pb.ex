defmodule Google.Ads.Googleads.V15.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.AuthorizationErrorEnum do
  @moduledoc false
