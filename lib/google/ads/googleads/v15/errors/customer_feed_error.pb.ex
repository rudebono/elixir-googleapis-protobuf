defmodule Google.Ads.Googleads.V15.Errors.CustomerFeedErrorEnum.CustomerFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.CustomerFeedErrorEnum do
  @moduledoc false
