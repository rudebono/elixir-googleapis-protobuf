defmodule Google.Ads.Googleads.V15.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.AuthenticationErrorEnum do
  @moduledoc false
