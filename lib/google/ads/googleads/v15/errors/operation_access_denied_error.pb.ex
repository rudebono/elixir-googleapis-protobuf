defmodule Google.Ads.Googleads.V15.Errors.OperationAccessDeniedErrorEnum.OperationAccessDeniedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.OperationAccessDeniedErrorEnum do
  @moduledoc false
