defmodule Google.Ads.Googleads.V15.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.RecommendationErrorEnum do
  @moduledoc false
