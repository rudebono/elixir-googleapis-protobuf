defmodule Google.Ads.Googleads.V15.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
