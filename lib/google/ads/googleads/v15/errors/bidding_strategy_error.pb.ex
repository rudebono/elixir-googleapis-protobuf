defmodule Google.Ads.Googleads.V15.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
