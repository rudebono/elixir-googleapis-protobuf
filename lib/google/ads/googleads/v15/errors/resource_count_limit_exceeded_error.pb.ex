defmodule Google.Ads.Googleads.V15.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
