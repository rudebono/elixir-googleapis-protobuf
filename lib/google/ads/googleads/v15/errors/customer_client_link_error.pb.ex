defmodule Google.Ads.Googleads.V15.Errors.CustomerClientLinkErrorEnum.CustomerClientLinkError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.CustomerClientLinkErrorEnum do
  @moduledoc false
