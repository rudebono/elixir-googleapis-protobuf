defmodule Google.Ads.Googleads.V15.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
