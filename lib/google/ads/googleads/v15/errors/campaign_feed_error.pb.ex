defmodule Google.Ads.Googleads.V15.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.CampaignFeedErrorEnum do
  @moduledoc false
