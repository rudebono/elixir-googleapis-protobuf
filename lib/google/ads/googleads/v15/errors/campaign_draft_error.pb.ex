defmodule Google.Ads.Googleads.V15.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.CampaignDraftErrorEnum do
  @moduledoc false
