defmodule Google.Ads.Googleads.V15.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.SmartCampaignErrorEnum do
  @moduledoc false
