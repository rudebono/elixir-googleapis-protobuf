defmodule Google.Ads.Googleads.V15.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
