defmodule Google.Ads.Googleads.V15.Errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Errors.AccountBudgetProposalErrorEnum do
  @moduledoc false
