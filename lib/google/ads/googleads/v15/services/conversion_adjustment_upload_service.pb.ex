defmodule Google.Ads.Googleads.V15.Services.UploadConversionAdjustmentsRequest do
  @moduledoc false
  ...
  field :conversion_adjustments, 2,
    repeated: true,
    type: Google.Ads.Googleads.V15.Services.ConversionAdjustment,
...
defmodule Google.Ads.Googleads.V15.Services.UploadConversionAdjustmentsResponse do
  @moduledoc false
  ...
  field :results, 2,
    repeated: true,
    type: Google.Ads.Googleads.V15.Services.ConversionAdjustmentResult

  field :job_id, 3, type: :int64, json_name: "jobId"
end

defmodule Google.Ads.Googleads.V15.Services.ConversionAdjustment do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :gclid_date_time_pair, 12,
    type: Google.Ads.Googleads.V15.Services.GclidDateTimePair,
  ...
  field :adjustment_type, 5,
    type: Google.Ads.Googleads.V15.Enums.ConversionAdjustmentTypeEnum.ConversionAdjustmentType,
    json_name: "adjustmentType",
    enum: true

  field :restatement_value, 6,
    type: Google.Ads.Googleads.V15.Services.RestatementValue,
...
defmodule Google.Ads.Googleads.V15.Services.RestatementValue do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Services.GclidDateTimePair do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Services.ConversionAdjustmentResult do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Services.ConversionAdjustmentUploadService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.ads.googleads.v15.services.ConversionAdjustmentUploadService",
    protoc_gen_elixir_version: "0.12.0"

  rpc :UploadConversionAdjustments,
      Google.Ads.Googleads.V15.Services.UploadConversionAdjustmentsRequest,
      Google.Ads.Googleads.V15.Services.UploadConversionAdjustmentsResponse
end

defmodule Google.Ads.Googleads.V15.Services.ConversionAdjustmentUploadService.Stub do
  @moduledoc false

  use GRPC.Stub,
    service: Google.Ads.Googleads.V15.Services.ConversionAdjustmentUploadService.Service
end