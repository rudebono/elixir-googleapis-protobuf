defmodule Google.Ads.Googleads.V15.Common.AppFeedItem do
  @moduledoc false
  ...
  field :app_store, 3,
    type: Google.Ads.Googleads.V15.Enums.AppStoreEnum.AppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V15.Common.CallFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.CalloutFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.LocationFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.AffiliateLocationFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.TextMessageFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.PriceFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.PriceOffer do
  ...
  field :price, 3, type: Google.Ads.Googleads.V15.Common.Money
...
defmodule Google.Ads.Googleads.V15.Common.PromotionFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.StructuredSnippetFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.SitelinkFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.HotelCalloutFeedItem do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.ImageFeedItem do
  @moduledoc false
