defmodule Google.Ads.Googleads.V15.Common.Segments do
  @moduledoc false
  ...
  field :ad_destination_type, 136,
    type: Google.Ads.Googleads.V15.Enums.AdDestinationTypeEnum.AdDestinationType,
    json_name: "adDestinationType",
    enum: true

  field :ad_network_type, 3,
    type: Google.Ads.Googleads.V15.Enums.AdNetworkTypeEnum.AdNetworkType,
  ...
  field :budget_campaign_association_status, 134,
    type: Google.Ads.Googleads.V15.Common.BudgetCampaignAssociationStatus,
    json_name: "budgetCampaignAssociationStatus"

  field :campaign, 157, proto3_optional: true, type: :string

  field :click_type, 26,
    type: Google.Ads.Googleads.V15.Enums.ClickTypeEnum.ClickType,
    json_name: "clickType",
    enum: true
  ...
  field :conversion_attribution_event_type, 2,
    type:
      Google.Ads.Googleads.V15.Enums.ConversionAttributionEventTypeEnum.ConversionAttributionEventType,
    json_name: "conversionAttributionEventType",
    enum: true

  field :conversion_lag_bucket, 50,
    type: Google.Ads.Googleads.V15.Enums.ConversionLagBucketEnum.ConversionLagBucket,
    json_name: "conversionLagBucket",
    enum: true

  field :conversion_or_adjustment_lag_bucket, 51,
    type:
      Google.Ads.Googleads.V15.Enums.ConversionOrAdjustmentLagBucketEnum.ConversionOrAdjustmentLagBucket,
  ...
  field :device, 1, type: Google.Ads.Googleads.V15.Enums.DeviceEnum.Device, enum: true

  field :external_conversion_source, 55,
    type: Google.Ads.Googleads.V15.Enums.ExternalConversionSourceEnum.ExternalConversionSource,
  ...
  field :hotel_rate_type, 74,
    type: Google.Ads.Googleads.V15.Enums.HotelRateTypeEnum.HotelRateType,
    json_name: "hotelRateType",
    enum: true

  field :hotel_price_bucket, 78,
    type: Google.Ads.Googleads.V15.Enums.HotelPriceBucketEnum.HotelPriceBucket,
  ...
  field :keyword, 61, type: Google.Ads.Googleads.V15.Common.Keyword
  field :month, 90, proto3_optional: true, type: :string

  field :month_of_year, 18,
    type: Google.Ads.Googleads.V15.Enums.MonthOfYearEnum.MonthOfYear,
  ...
  field :search_engine_results_page_type, 70,
    type:
      Google.Ads.Googleads.V15.Enums.SearchEngineResultsPageTypeEnum.SearchEngineResultsPageType,
  ...
  field :search_term_match_type, 22,
    type: Google.Ads.Googleads.V15.Enums.SearchTermMatchTypeEnum.SearchTermMatchType,
    json_name: "searchTermMatchType",
    enum: true

  field :slot, 23, type: Google.Ads.Googleads.V15.Enums.SlotEnum.Slot, enum: true

  field :conversion_value_rule_primary_dimension, 138,
    type:
      Google.Ads.Googleads.V15.Enums.ConversionValueRulePrimaryDimensionEnum.ConversionValueRulePrimaryDimension,
  ...
  field :sk_ad_network_user_type, 141,
    type: Google.Ads.Googleads.V15.Enums.SkAdNetworkUserTypeEnum.SkAdNetworkUserType,
    json_name: "skAdNetworkUserType",
    enum: true

  field :sk_ad_network_ad_event_type, 142,
    type: Google.Ads.Googleads.V15.Enums.SkAdNetworkAdEventTypeEnum.SkAdNetworkAdEventType,
    json_name: "skAdNetworkAdEventType",
    enum: true

  field :sk_ad_network_source_app, 143,
    proto3_optional: true,
    type: Google.Ads.Googleads.V15.Common.SkAdNetworkSourceApp,
    json_name: "skAdNetworkSourceApp"

  field :sk_ad_network_attribution_credit, 144,
    type:
      Google.Ads.Googleads.V15.Enums.SkAdNetworkAttributionCreditEnum.SkAdNetworkAttributionCredit,
    json_name: "skAdNetworkAttributionCredit",
    enum: true

  field :sk_ad_network_coarse_conversion_value, 151,
    type:
      Google.Ads.Googleads.V15.Enums.SkAdNetworkCoarseConversionValueEnum.SkAdNetworkCoarseConversionValue,
  ...
  field :sk_ad_network_source_type, 153,
    type: Google.Ads.Googleads.V15.Enums.SkAdNetworkSourceTypeEnum.SkAdNetworkSourceType,
  ...
  field :asset_interaction_target, 139,
    proto3_optional: true,
    type: Google.Ads.Googleads.V15.Common.AssetInteractionTarget,
    json_name: "assetInteractionTarget"

  field :new_versus_returning_customers, 160,
    type:
      Google.Ads.Googleads.V15.Enums.ConvertingUserPriorEngagementTypeAndLtvBucketEnum.ConvertingUserPriorEngagementTypeAndLtvBucket,
    json_name: "newVersusReturningCustomers",
    enum: true
end

defmodule Google.Ads.Googleads.V15.Common.Keyword do
  @moduledoc false
  ...
  field :info, 2, type: Google.Ads.Googleads.V15.Common.KeywordInfo
end

defmodule Google.Ads.Googleads.V15.Common.BudgetCampaignAssociationStatus do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.AssetInteractionTarget do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Common.SkAdNetworkSourceApp do
  @moduledoc false
