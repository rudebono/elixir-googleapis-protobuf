defmodule Google.Ads.Googleads.V15.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
