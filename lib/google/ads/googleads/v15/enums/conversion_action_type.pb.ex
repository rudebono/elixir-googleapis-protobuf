defmodule Google.Ads.Googleads.V15.Enums.ConversionActionTypeEnum.ConversionActionType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.ConversionActionTypeEnum do
  @moduledoc false
