defmodule Google.Ads.Googleads.V15.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
