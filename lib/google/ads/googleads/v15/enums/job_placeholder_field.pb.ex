defmodule Google.Ads.Googleads.V15.Enums.JobPlaceholderFieldEnum.JobPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.JobPlaceholderFieldEnum do
  @moduledoc false
