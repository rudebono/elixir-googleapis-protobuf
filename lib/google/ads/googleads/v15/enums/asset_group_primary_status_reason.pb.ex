defmodule Google.Ads.Googleads.V15.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
