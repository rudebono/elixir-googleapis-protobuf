defmodule Google.Ads.Googleads.V15.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V15.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
