defmodule Google.Ads.Googleads.V15.Resources.AdGroupAd do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V15.Enums.AdGroupAdStatusEnum.AdGroupAdStatus,
    enum: true
  ...
  field :ad, 5, type: Google.Ads.Googleads.V15.Resources.Ad, deprecated: false

  field :policy_summary, 6,
    type: Google.Ads.Googleads.V15.Resources.AdGroupAdPolicySummary,
    json_name: "policySummary",
    deprecated: false

  field :ad_strength, 7,
    type: Google.Ads.Googleads.V15.Enums.AdStrengthEnum.AdStrength,
...
defmodule Google.Ads.Googleads.V15.Resources.AdGroupAdPolicySummary do
  @moduledoc false
