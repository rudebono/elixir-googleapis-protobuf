defmodule Google.Ads.Googleads.V15.Resources.FeedItemSet do
  @moduledoc false
  ...
  field :status, 8,
    type: Google.Ads.Googleads.V15.Enums.FeedItemSetStatusEnum.FeedItemSetStatus,
    enum: true,
    deprecated: false

  field :dynamic_location_set_filter, 5,
    type: Google.Ads.Googleads.V15.Common.DynamicLocationSetFilter,
    json_name: "dynamicLocationSetFilter",
    oneof: 0

  field :dynamic_affiliate_location_set_filter, 6,
    type: Google.Ads.Googleads.V15.Common.DynamicAffiliateLocationSetFilter,
