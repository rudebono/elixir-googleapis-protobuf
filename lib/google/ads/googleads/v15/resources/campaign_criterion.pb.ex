defmodule Google.Ads.Googleads.V15.Resources.CampaignCriterion do
  @moduledoc false
  ...
  field :status, 35,
    type: Google.Ads.Googleads.V15.Enums.CampaignCriterionStatusEnum.CampaignCriterionStatus,
    enum: true
  ...
  field :device, 13, type: Google.Ads.Googleads.V15.Common.DeviceInfo, oneof: 0, deprecated: false
  ...
  field :gender, 17, type: Google.Ads.Googleads.V15.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :user_list, 22,
    type: Google.Ads.Googleads.V15.Common.UserListInfo,
    json_name: "userList",
    oneof: 0,
    deprecated: false
  ...
  field :topic, 24, type: Google.Ads.Googleads.V15.Common.TopicInfo, oneof: 0, deprecated: false

  field :listing_scope, 25,
    type: Google.Ads.Googleads.V15.Common.ListingScopeInfo,
    json_name: "listingScope",
    oneof: 0,
    deprecated: false

  field :language, 26,
    type: Google.Ads.Googleads.V15.Common.LanguageInfo,
    oneof: 0,
    deprecated: false

  field :ip_block, 27,
    type: Google.Ads.Googleads.V15.Common.IpBlockInfo,
    json_name: "ipBlock",
    oneof: 0,
    deprecated: false

  field :content_label, 28,
    type: Google.Ads.Googleads.V15.Common.ContentLabelInfo,
    json_name: "contentLabel",
    oneof: 0,
    deprecated: false

  field :carrier, 29,
    type: Google.Ads.Googleads.V15.Common.CarrierInfo,
    oneof: 0,
    deprecated: false
  ...
  field :webpage, 31,
    type: Google.Ads.Googleads.V15.Common.WebpageInfo,
    oneof: 0,
    deprecated: false

  field :operating_system_version, 32,
    type: Google.Ads.Googleads.V15.Common.OperatingSystemVersionInfo,
    json_name: "operatingSystemVersion",
    oneof: 0,
    deprecated: false

  field :mobile_device, 33,
    type: Google.Ads.Googleads.V15.Common.MobileDeviceInfo,
    json_name: "mobileDevice",
    oneof: 0,
    deprecated: false

  field :location_group, 34,
    type: Google.Ads.Googleads.V15.Common.LocationGroupInfo,
    json_name: "locationGroup",
    oneof: 0,
    deprecated: false

  field :custom_affinity, 36,
    type: Google.Ads.Googleads.V15.Common.CustomAffinityInfo,
  ...
  field :combined_audience, 42,
    type: Google.Ads.Googleads.V15.Common.CombinedAudienceInfo,
  ...
  field :local_service_id, 46,
    type: Google.Ads.Googleads.V15.Common.LocalServiceIdInfo,
    json_name: "localServiceId",
    oneof: 0,
    deprecated: false

  field :brand_list, 47,
    type: Google.Ads.Googleads.V15.Common.BrandListInfo,
    json_name: "brandList",
    oneof: 0,
    deprecated: false
end