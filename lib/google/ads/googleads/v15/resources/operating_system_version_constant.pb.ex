defmodule Google.Ads.Googleads.V15.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V15.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
