defmodule Google.Ads.Googleads.V15.Resources.ConversionValueRuleSet do
  @moduledoc false
  ...
  field :dimensions, 4,
    repeated: true,
    type: Google.Ads.Googleads.V15.Enums.ValueRuleSetDimensionEnum.ValueRuleSetDimension,
    enum: true
  ...
  field :attachment_type, 6,
    type:
      Google.Ads.Googleads.V15.Enums.ValueRuleSetAttachmentTypeEnum.ValueRuleSetAttachmentType,
  ...
  field :status, 8,
    type:
      Google.Ads.Googleads.V15.Enums.ConversionValueRuleSetStatusEnum.ConversionValueRuleSetStatus,
    enum: true,
    deprecated: false
