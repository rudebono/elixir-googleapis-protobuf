defmodule Google.Ads.Googleads.V15.Resources.FeedItemTarget do
  @moduledoc false
  ...
  field :feed_item_target_type, 3,
    type: Google.Ads.Googleads.V15.Enums.FeedItemTargetTypeEnum.FeedItemTargetType,
  ...
  field :status, 11,
    type: Google.Ads.Googleads.V15.Enums.FeedItemTargetStatusEnum.FeedItemTargetStatus,
    enum: true,
    deprecated: false
