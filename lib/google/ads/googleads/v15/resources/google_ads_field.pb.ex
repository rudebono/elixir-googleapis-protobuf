defmodule Google.Ads.Googleads.V15.Resources.GoogleAdsField do
  @moduledoc false
  ...
  field :category, 3,
    type: Google.Ads.Googleads.V15.Enums.GoogleAdsFieldCategoryEnum.GoogleAdsFieldCategory,
    enum: true,
    deprecated: false
  ...
  field :data_type, 12,
    type: Google.Ads.Googleads.V15.Enums.GoogleAdsFieldDataTypeEnum.GoogleAdsFieldDataType,
    json_name: "dataType",
    enum: true,
    deprecated: false
