defmodule Google.Ads.Googleads.V11.Enums.RealEstatePlaceholderFieldEnum.RealEstatePlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.RealEstatePlaceholderFieldEnum do
  @moduledoc false
