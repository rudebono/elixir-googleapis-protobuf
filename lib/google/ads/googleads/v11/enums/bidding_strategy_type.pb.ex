defmodule Google.Ads.Googleads.V11.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
