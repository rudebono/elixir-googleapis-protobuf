defmodule Google.Ads.Googleads.V11.Enums.ConversionActionCategoryEnum.ConversionActionCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.ConversionActionCategoryEnum do
  @moduledoc false
