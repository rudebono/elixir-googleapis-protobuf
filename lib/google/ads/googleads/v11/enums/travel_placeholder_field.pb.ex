defmodule Google.Ads.Googleads.V11.Enums.TravelPlaceholderFieldEnum.TravelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.TravelPlaceholderFieldEnum do
  @moduledoc false
