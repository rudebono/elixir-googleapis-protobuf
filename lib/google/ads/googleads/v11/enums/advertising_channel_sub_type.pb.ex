defmodule Google.Ads.Googleads.V11.Enums.AdvertisingChannelSubTypeEnum.AdvertisingChannelSubType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.AdvertisingChannelSubTypeEnum do
  @moduledoc false
