defmodule Google.Ads.Googleads.V11.Enums.PromotionPlaceholderFieldEnum.PromotionPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.PromotionPlaceholderFieldEnum do
  @moduledoc false
