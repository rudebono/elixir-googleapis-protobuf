defmodule Google.Ads.Googleads.V11.Enums.HotelPlaceholderFieldEnum.HotelPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.HotelPlaceholderFieldEnum do
  @moduledoc false
