defmodule Google.Ads.Googleads.V11.Enums.ChangeStatusResourceTypeEnum.ChangeStatusResourceType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.ChangeStatusResourceTypeEnum do
  @moduledoc false
