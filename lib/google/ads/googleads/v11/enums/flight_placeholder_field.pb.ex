defmodule Google.Ads.Googleads.V11.Enums.FlightPlaceholderFieldEnum.FlightPlaceholderField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Enums.FlightPlaceholderFieldEnum do
  @moduledoc false
