defmodule Google.Ads.Googleads.V11.Resources.Customer do
  ...
  field :conversion_tracking_setting, 14,
    type: Google.Ads.Googleads.V11.Resources.ConversionTrackingSetting,
    json_name: "conversionTrackingSetting",
    deprecated: false

  field :remarketing_setting, 15,
    type: Google.Ads.Googleads.V11.Resources.RemarketingSetting,
  ...
  field :pay_per_conversion_eligibility_failure_reasons, 16,
    repeated: true,
    type:
      Google.Ads.Googleads.V11.Enums.CustomerPayPerConversionEligibilityFailureReasonEnum.CustomerPayPerConversionEligibilityFailureReason,
  ...
  field :status, 36,
    type: Google.Ads.Googleads.V11.Enums.CustomerStatusEnum.CustomerStatus,
    enum: true,
    deprecated: false
end
...
defmodule Google.Ads.Googleads.V11.Resources.ConversionTrackingSetting do
  ...
  field :conversion_tracking_status, 6,
    type: Google.Ads.Googleads.V11.Enums.ConversionTrackingStatusEnum.ConversionTrackingStatus,
