defmodule Google.Ads.Googleads.V11.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Resources.AdGroupCriterion do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V11.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V11.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V11.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V11.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V11.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :listing_group, 32,
    type: Google.Ads.Googleads.V11.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V11.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 43, type: Google.Ads.Googleads.V11.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V11.Common.AppPaymentModelInfo,
  ...
  field :custom_intent, 49,
    type: Google.Ads.Googleads.V11.Common.CustomIntentInfo,
  ...
  field :audience, 79,
    type: Google.Ads.Googleads.V11.Common.AudienceInfo,
    oneof: 0,
    deprecated: false
end