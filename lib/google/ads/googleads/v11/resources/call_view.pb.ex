defmodule Google.Ads.Googleads.V11.Resources.CallView do
  @moduledoc false
  ...
  field :call_tracking_display_location, 7,
    type:
      Google.Ads.Googleads.V11.Enums.CallTrackingDisplayLocationEnum.CallTrackingDisplayLocation,
    json_name: "callTrackingDisplayLocation",
    enum: true,
    deprecated: false

  field :type, 8,
    type: Google.Ads.Googleads.V11.Enums.CallTypeEnum.CallType,
    enum: true,
    deprecated: false

  field :call_status, 9,
    type: Google.Ads.Googleads.V11.Enums.GoogleVoiceCallStatusEnum.GoogleVoiceCallStatus,
