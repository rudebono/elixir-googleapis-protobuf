defmodule Google.Ads.Googleads.V11.Resources.AccountBudgetProposal do
  @moduledoc false
  ...
  field :status, 15,
    type:
      Google.Ads.Googleads.V11.Enums.AccountBudgetProposalStatusEnum.AccountBudgetProposalStatus,
    enum: true,
    deprecated: false
