...
defmodule Google.Ads.Googleads.V11.Resources.SmartCampaignSetting do
  ...
  field :phone_number, 3,
    type: Google.Ads.Googleads.V11.Resources.SmartCampaignSetting.PhoneNumber,
  ...
  field :ad_optimized_business_profile_setting, 9,
    type:
      Google.Ads.Googleads.V11.Resources.SmartCampaignSetting.AdOptimizedBusinessProfileSetting,
