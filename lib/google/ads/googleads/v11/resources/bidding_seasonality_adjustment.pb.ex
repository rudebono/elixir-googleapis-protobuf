defmodule Google.Ads.Googleads.V11.Resources.BiddingSeasonalityAdjustment do
  @moduledoc false
  ...
  field :scope, 3,
    type: Google.Ads.Googleads.V11.Enums.SeasonalityEventScopeEnum.SeasonalityEventScope,
    enum: true

  field :status, 4,
    type: Google.Ads.Googleads.V11.Enums.SeasonalityEventStatusEnum.SeasonalityEventStatus,
    enum: true,
    deprecated: false
