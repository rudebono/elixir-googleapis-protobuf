defmodule Google.Ads.Googleads.V11.Resources.CampaignSimulation do
  @moduledoc false
  ...
  field :cpc_bid_point_list, 7,
    type: Google.Ads.Googleads.V11.Common.CpcBidSimulationPointList,
    json_name: "cpcBidPointList",
    oneof: 0,
    deprecated: false

  field :target_cpa_point_list, 8,
    type: Google.Ads.Googleads.V11.Common.TargetCpaSimulationPointList,
    json_name: "targetCpaPointList",
    oneof: 0,
    deprecated: false

  field :target_roas_point_list, 9,
    type: Google.Ads.Googleads.V11.Common.TargetRoasSimulationPointList,
    json_name: "targetRoasPointList",
    oneof: 0,
    deprecated: false

  field :target_impression_share_point_list, 10,
    type: Google.Ads.Googleads.V11.Common.TargetImpressionShareSimulationPointList,
    json_name: "targetImpressionSharePointList",
    oneof: 0,
    deprecated: false

  field :budget_point_list, 11,
    type: Google.Ads.Googleads.V11.Common.BudgetSimulationPointList,
