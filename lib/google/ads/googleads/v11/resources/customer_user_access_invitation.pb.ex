defmodule Google.Ads.Googleads.V11.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V11.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
