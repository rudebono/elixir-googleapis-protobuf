defmodule Google.Ads.Googleads.V11.Services.MutateCustomerManagerLinkRequest do
  ...
  field :operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V11.Services.CustomerManagerLinkOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V11.Services.CustomerManagerLinkService.Service do
  ...
  rpc :MutateCustomerManagerLink,
      ...
      Google.Ads.Googleads.V11.Services.MutateCustomerManagerLinkResponse

  rpc :MoveManagerLink,
      Google.Ads.Googleads.V11.Services.MoveManagerLinkRequest,
      Google.Ads.Googleads.V11.Services.MoveManagerLinkResponse
end

defmodule Google.Ads.Googleads.V11.Services.CustomerManagerLinkService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.CustomerManagerLinkService.Service
end
