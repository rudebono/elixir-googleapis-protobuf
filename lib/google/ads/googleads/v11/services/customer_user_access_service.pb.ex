...
defmodule Google.Ads.Googleads.V11.Services.CustomerUserAccessService.Service do
  ...
  rpc :MutateCustomerUserAccess,
      ...
      Google.Ads.Googleads.V11.Services.MutateCustomerUserAccessResponse
end

defmodule Google.Ads.Googleads.V11.Services.CustomerUserAccessService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.CustomerUserAccessService.Service
end
