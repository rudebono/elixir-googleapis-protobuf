defmodule Google.Ads.Googleads.V11.Services.MutateCustomAudiencesRequest do
  ...
  field :operations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V11.Services.CustomAudienceOperation,
    deprecated: false
...
defmodule Google.Ads.Googleads.V11.Services.CustomAudienceOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V11.Resources.CustomAudience, oneof: 0
...
defmodule Google.Ads.Googleads.V11.Services.CustomAudienceService.Service do
  ...
  rpc :MutateCustomAudiences,
      ...
      Google.Ads.Googleads.V11.Services.MutateCustomAudiencesResponse
end

defmodule Google.Ads.Googleads.V11.Services.CustomAudienceService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.CustomAudienceService.Service
end
