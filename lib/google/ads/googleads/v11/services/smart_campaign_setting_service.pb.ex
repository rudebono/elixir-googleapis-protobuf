...
defmodule Google.Ads.Googleads.V11.Services.SmartCampaignSettingService.Service do
  ...
  rpc :MutateSmartCampaignSettings,
      ...
      Google.Ads.Googleads.V11.Services.MutateSmartCampaignSettingsResponse
end

defmodule Google.Ads.Googleads.V11.Services.SmartCampaignSettingService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.SmartCampaignSettingService.Service
end
