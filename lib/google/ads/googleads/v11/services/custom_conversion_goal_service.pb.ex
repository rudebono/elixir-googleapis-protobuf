...
defmodule Google.Ads.Googleads.V11.Services.CustomConversionGoalOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V11.Resources.CustomConversionGoal, oneof: 0
...
defmodule Google.Ads.Googleads.V11.Services.CustomConversionGoalService.Service do
  ...
  rpc :MutateCustomConversionGoals,
      ...
      Google.Ads.Googleads.V11.Services.MutateCustomConversionGoalsResponse
end

defmodule Google.Ads.Googleads.V11.Services.CustomConversionGoalService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.CustomConversionGoalService.Service
end
