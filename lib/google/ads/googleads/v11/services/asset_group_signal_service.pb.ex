...
defmodule Google.Ads.Googleads.V11.Services.AssetGroupSignalService.Service do
  ...
  rpc :MutateAssetGroupSignals,
      ...
      Google.Ads.Googleads.V11.Services.MutateAssetGroupSignalsResponse
end

defmodule Google.Ads.Googleads.V11.Services.AssetGroupSignalService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.AssetGroupSignalService.Service
end