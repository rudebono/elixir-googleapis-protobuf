...
defmodule Google.Ads.Googleads.V11.Services.AudienceService.Service do
  ...
  rpc :MutateAudiences,
      ...
      Google.Ads.Googleads.V11.Services.MutateAudiencesResponse
end

defmodule Google.Ads.Googleads.V11.Services.AudienceService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.AudienceService.Service
end
