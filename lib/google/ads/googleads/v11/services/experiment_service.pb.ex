...
defmodule Google.Ads.Googleads.V11.Services.ExperimentOperation do
  ...
  field :create, 1, type: Google.Ads.Googleads.V11.Resources.Experiment, oneof: 0
...
defmodule Google.Ads.Googleads.V11.Services.GraduateExperimentRequest do
  ...
  field :campaign_budget_mappings, 2,
    repeated: true,
    type: Google.Ads.Googleads.V11.Services.CampaignBudgetMapping,
...
defmodule Google.Ads.Googleads.V11.Services.ExperimentService.Service do
  ...
  rpc :MutateExperiments,
      ...
      Google.Ads.Googleads.V11.Services.MutateExperimentsResponse

  rpc :EndExperiment,
      Google.Ads.Googleads.V11.Services.EndExperimentRequest,
      Google.Protobuf.Empty

  rpc :ListExperimentAsyncErrors,
      Google.Ads.Googleads.V11.Services.ListExperimentAsyncErrorsRequest,
      Google.Ads.Googleads.V11.Services.ListExperimentAsyncErrorsResponse

  rpc :GraduateExperiment,
      Google.Ads.Googleads.V11.Services.GraduateExperimentRequest,
      Google.Protobuf.Empty
  ...
  rpc :PromoteExperiment,
      Google.Ads.Googleads.V11.Services.PromoteExperimentRequest,
      Google.Longrunning.Operation
end

defmodule Google.Ads.Googleads.V11.Services.ExperimentService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Ads.Googleads.V11.Services.ExperimentService.Service
end
