...
defmodule Google.Ads.Googleads.V11.Services.ConversionGoalCampaignConfigService.Service do
  ...
  rpc :MutateConversionGoalCampaignConfigs,
      ...
      Google.Ads.Googleads.V11.Services.MutateConversionGoalCampaignConfigsResponse
end

defmodule Google.Ads.Googleads.V11.Services.ConversionGoalCampaignConfigService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Ads.Googleads.V11.Services.ConversionGoalCampaignConfigService.Service
end
