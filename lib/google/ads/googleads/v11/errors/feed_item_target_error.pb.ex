defmodule Google.Ads.Googleads.V11.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
