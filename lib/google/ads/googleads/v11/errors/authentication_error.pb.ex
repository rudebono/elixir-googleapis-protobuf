defmodule Google.Ads.Googleads.V11.Errors.AuthenticationErrorEnum.AuthenticationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.AuthenticationErrorEnum do
  @moduledoc false
