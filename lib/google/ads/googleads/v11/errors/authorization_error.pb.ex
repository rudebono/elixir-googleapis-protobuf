defmodule Google.Ads.Googleads.V11.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.AuthorizationErrorEnum do
  @moduledoc false
