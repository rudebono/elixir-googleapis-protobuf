defmodule Google.Ads.Googleads.V11.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
