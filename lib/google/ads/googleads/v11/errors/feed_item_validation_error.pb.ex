defmodule Google.Ads.Googleads.V11.Errors.FeedItemValidationErrorEnum.FeedItemValidationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.FeedItemValidationErrorEnum do
  @moduledoc false
