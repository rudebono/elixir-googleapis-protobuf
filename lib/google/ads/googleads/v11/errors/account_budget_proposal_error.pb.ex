defmodule Google.Ads.Googleads.V11.Errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.AccountBudgetProposalErrorEnum do
  @moduledoc false
