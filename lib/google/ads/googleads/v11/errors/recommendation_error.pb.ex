defmodule Google.Ads.Googleads.V11.Errors.RecommendationErrorEnum.RecommendationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.RecommendationErrorEnum do
  @moduledoc false
