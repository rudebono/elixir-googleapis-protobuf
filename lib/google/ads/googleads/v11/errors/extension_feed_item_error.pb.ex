defmodule Google.Ads.Googleads.V11.Errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Errors.ExtensionFeedItemErrorEnum do
  @moduledoc false
