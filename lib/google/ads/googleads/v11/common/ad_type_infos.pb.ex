defmodule Google.Ads.Googleads.V11.Common.TextAdInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Common.ExpandedTextAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.ExpandedDynamicSearchAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.HotelAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V11.Common.ShoppingSmartAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V11.Common.ShoppingProductAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V11.Common.ShoppingComparisonListingAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.GmailAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :teaser, 1, type: Google.Ads.Googleads.V11.Common.GmailTeaser
  field :header_image, 10, proto3_optional: true, type: :string, json_name: "headerImage"
  field :marketing_image, 11, proto3_optional: true, type: :string, json_name: "marketingImage"

  field :marketing_image_headline, 12,
    proto3_optional: true,
    type: :string,
    json_name: "marketingImageHeadline"

  field :marketing_image_description, 13,
    proto3_optional: true,
    type: :string,
    json_name: "marketingImageDescription"

  field :marketing_image_display_call_to_action, 6,
    type: Google.Ads.Googleads.V11.Common.DisplayCallToAction,
    json_name: "marketingImageDisplayCallToAction"

  field :product_images, 7,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.ProductImage,
    json_name: "productImages"

  field :product_videos, 8,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.ProductVideo,
    json_name: "productVideos"
end

defmodule Google.Ads.Googleads.V11.Common.GmailTeaser do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :logo_image, 8, proto3_optional: true, type: :string, json_name: "logoImage"
end

defmodule Google.Ads.Googleads.V11.Common.DisplayCallToAction do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :text, 5, proto3_optional: true, type: :string
  field :text_color, 6, proto3_optional: true, type: :string, json_name: "textColor"
  field :url_collection_id, 7, proto3_optional: true, type: :string, json_name: "urlCollectionId"
end

defmodule Google.Ads.Googleads.V11.Common.ProductImage do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :product_image, 4, proto3_optional: true, type: :string, json_name: "productImage"
...
defmodule Google.Ads.Googleads.V11.Common.ProductVideo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :product_video, 2, proto3_optional: true, type: :string, json_name: "productVideo"
end

defmodule Google.Ads.Googleads.V11.Common.ImageAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.VideoBumperInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :companion_banner, 3,
    type: Google.Ads.Googleads.V11.Common.AdImageAsset,
    json_name: "companionBanner"
end

defmodule Google.Ads.Googleads.V11.Common.VideoNonSkippableInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.VideoTrueViewInStreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.VideoOutstreamAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.InFeedVideoAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :thumbnail, 4,
    type: Google.Ads.Googleads.V11.Enums.VideoThumbnailEnum.VideoThumbnail,
    enum: true
end

defmodule Google.Ads.Googleads.V11.Common.VideoAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  oneof :format, 0

  field :video, 8, type: Google.Ads.Googleads.V11.Common.AdVideoAsset

  field :in_stream, 2,
    type: Google.Ads.Googleads.V11.Common.VideoTrueViewInStreamAdInfo,
    json_name: "inStream",
    oneof: 0

  field :bumper, 3, type: Google.Ads.Googleads.V11.Common.VideoBumperInStreamAdInfo, oneof: 0

  field :out_stream, 4,
    type: Google.Ads.Googleads.V11.Common.VideoOutstreamAdInfo,
    json_name: "outStream",
    oneof: 0

  field :non_skippable, 5,
    type: Google.Ads.Googleads.V11.Common.VideoNonSkippableInStreamAdInfo,
    json_name: "nonSkippable",
    oneof: 0

  field :in_feed, 9,
    type: Google.Ads.Googleads.V11.Common.InFeedVideoAdInfo,
    json_name: "inFeed",
    oneof: 0
end

defmodule Google.Ads.Googleads.V11.Common.VideoResponsiveAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset

  field :long_headlines, 2,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.AdTextAsset,
    json_name: "longHeadlines"

  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  ...
  field :videos, 5, repeated: true, type: Google.Ads.Googleads.V11.Common.AdVideoAsset
...
defmodule Google.Ads.Googleads.V11.Common.ResponsiveSearchAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :path1, 5, proto3_optional: true, type: :string
  field :path2, 6, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V11.Common.LegacyResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :format_setting, 13,
    type: Google.Ads.Googleads.V11.Enums.DisplayAdFormatSettingEnum.DisplayAdFormatSetting,
...
defmodule Google.Ads.Googleads.V11.Common.AppAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 2, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :descriptions, 3, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :images, 4, repeated: true, type: Google.Ads.Googleads.V11.Common.AdImageAsset

  field :youtube_videos, 5,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.AdVideoAsset,
    json_name: "youtubeVideos"

  field :html5_media_bundles, 6,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.AdMediaBundleAsset,
    json_name: "html5MediaBundles"
end

defmodule Google.Ads.Googleads.V11.Common.AppEngagementAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :headlines, 1, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :descriptions, 2, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :images, 3, repeated: true, type: Google.Ads.Googleads.V11.Common.AdImageAsset
  field :videos, 4, repeated: true, type: Google.Ads.Googleads.V11.Common.AdVideoAsset
end

defmodule Google.Ads.Googleads.V11.Common.AppPreRegistrationAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.LegacyAppInstallAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :app_store, 2,
    type:
      Google.Ads.Googleads.V11.Enums.LegacyAppInstallAdAppStoreEnum.LegacyAppInstallAdAppStore,
    json_name: "appStore",
    enum: true
...
defmodule Google.Ads.Googleads.V11.Common.ResponsiveDisplayAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset

  field :long_headline, 6,
    type: Google.Ads.Googleads.V11.Common.AdTextAsset,
    json_name: "longHeadline"

  field :descriptions, 7, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  ...
  field :control_spec, 24,
    type: Google.Ads.Googleads.V11.Common.ResponsiveDisplayAdControlSpec,
    json_name: "controlSpec"
end

defmodule Google.Ads.Googleads.V11.Common.LocalAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :videos, 6, repeated: true, type: Google.Ads.Googleads.V11.Common.AdVideoAsset
  field :path1, 9, proto3_optional: true, type: :string
  field :path2, 10, proto3_optional: true, type: :string
end

defmodule Google.Ads.Googleads.V11.Common.DisplayUploadAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :display_upload_product_type, 1,
    type: Google.Ads.Googleads.V11.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType,
...
defmodule Google.Ads.Googleads.V11.Common.ResponsiveDisplayAdControlSpec do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.SmartCampaignAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.CallAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :conversion_reporting_state, 10,
    type:
      Google.Ads.Googleads.V11.Enums.CallConversionReportingStateEnum.CallConversionReportingState,
...
defmodule Google.Ads.Googleads.V11.Common.DiscoveryMultiAssetAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headlines, 5, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :descriptions, 6, repeated: true, type: Google.Ads.Googleads.V11.Common.AdTextAsset
  field :business_name, 7, proto3_optional: true, type: :string, json_name: "businessName"
...
defmodule Google.Ads.Googleads.V11.Common.DiscoveryCarouselAdInfo do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :headline, 3, type: Google.Ads.Googleads.V11.Common.AdTextAsset, deprecated: false
  field :description, 4, type: Google.Ads.Googleads.V11.Common.AdTextAsset, deprecated: false
  field :call_to_action_text, 5, type: :string, json_name: "callToActionText"

  field :carousel_cards, 6,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.AdDiscoveryCarouselCardAsset,
