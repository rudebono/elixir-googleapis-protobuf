...
defmodule Google.Ads.Googleads.V11.Common.Operand.RequestContextOperand do
  ...
  field :context_type, 1,
    type:
      Google.Ads.Googleads.V11.Enums.MatchingFunctionContextTypeEnum.MatchingFunctionContextType,
...
defmodule Google.Ads.Googleads.V11.Common.Operand do
  ...
  field :constant_operand, 1,
    type: Google.Ads.Googleads.V11.Common.Operand.ConstantOperand,
    json_name: "constantOperand",
    oneof: 0

  field :feed_attribute_operand, 2,
    type: Google.Ads.Googleads.V11.Common.Operand.FeedAttributeOperand,
    json_name: "feedAttributeOperand",
    oneof: 0

  field :function_operand, 3,
    type: Google.Ads.Googleads.V11.Common.Operand.FunctionOperand,
    json_name: "functionOperand",
    oneof: 0

  field :request_context_operand, 4,
    type: Google.Ads.Googleads.V11.Common.Operand.RequestContextOperand,
