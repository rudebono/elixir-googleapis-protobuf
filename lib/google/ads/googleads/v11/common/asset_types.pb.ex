defmodule Google.Ads.Googleads.V11.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V11.Common.MediaBundleAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.ImageAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :full_size, 4, type: Google.Ads.Googleads.V11.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V11.Common.ImageDimension do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.TextAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V11.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V11.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V11.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V11.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormField do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :input_type, 1,
    type:
      Google.Ads.Googleads.V11.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V11.Common.LeadFormSingleChoiceAnswers,
    json_name: "singleChoiceAnswers",
    oneof: 0
end

defmodule Google.Ads.Googleads.V11.Common.LeadFormCustomQuestionField do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.LeadFormDeliveryMethod do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  oneof :delivery_details, 0

  field :webhook, 1, type: Google.Ads.Googleads.V11.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V11.Common.WebhookDelivery do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.BookOnGoogleAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V11.Common.PromotionAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :discount_modifier, 2,
    type:
      Google.Ads.Googleads.V11.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
  ...
  field :occasion, 9,
    type:
      Google.Ads.Googleads.V11.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
  ...
  field :money_amount_off, 4,
    type: Google.Ads.Googleads.V11.Common.Money,
...
defmodule Google.Ads.Googleads.V11.Common.CalloutAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.StructuredSnippetAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.SitelinkAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.PageFeedAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicEducationAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.MobileAppAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.HotelCalloutAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.CallAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.PriceAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V11.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false

  field :price_qualifier, 2,
    type:
      Google.Ads.Googleads.V11.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V11.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V11.Common.PriceOffering do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :header, 1, type: :string, deprecated: false
  field :description, 2, type: :string, deprecated: false
  field :price, 3, type: Google.Ads.Googleads.V11.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V11.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V11.Common.CallToActionAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :call_to_action, 1,
    type: Google.Ads.Googleads.V11.Enums.CallToActionTypeEnum.CallToActionType,
    json_name: "callToAction",
    enum: true
end

defmodule Google.Ads.Googleads.V11.Common.DynamicRealEstateAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicCustomAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicFlightsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DiscoveryCarouselCardAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicTravelAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicLocalAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Ads.Googleads.V11.Common.DynamicJobsAsset do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
