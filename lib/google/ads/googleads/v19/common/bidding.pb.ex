defmodule Google.Ads.Googleads.V19.Common.Commission do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.ManualCpa do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V19.Common.ManualCpc do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.ManualCpv do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Ads.Googleads.V19.Common.MaximizeConversions do
  @moduledoc false
