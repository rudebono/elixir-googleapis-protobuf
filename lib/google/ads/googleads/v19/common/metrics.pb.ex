defmodule Google.Ads.Googleads.V19.Common.Metrics do
  @moduledoc false
  ...
  field :interaction_event_types, 100,
    repeated: true,
    type: Google.Ads.Googleads.V19.Enums.InteractionEventTypeEnum.InteractionEventType,
  ...
  field :search_volume, 295,
    proto3_optional: true,
    type: Google.Ads.Googleads.V19.Common.SearchVolumeRange,
