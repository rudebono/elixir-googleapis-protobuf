defmodule Google.Ads.Googleads.V19.Common.YoutubeVideoAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.MediaBundleAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.ImageAsset do
  @moduledoc false
  ...
  field :mime_type, 3,
    type: Google.Ads.Googleads.V19.Enums.MimeTypeEnum.MimeType,
    json_name: "mimeType",
    enum: true

  field :full_size, 4, type: Google.Ads.Googleads.V19.Common.ImageDimension, json_name: "fullSize"
end

defmodule Google.Ads.Googleads.V19.Common.ImageDimension do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.TextAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.LeadFormAsset do
  @moduledoc false
  ...
  field :call_to_action_type, 17,
    type: Google.Ads.Googleads.V19.Enums.LeadFormCallToActionTypeEnum.LeadFormCallToActionType,
  ...
  field :fields, 8, repeated: true, type: Google.Ads.Googleads.V19.Common.LeadFormField

  field :custom_question_fields, 23,
    repeated: true,
    type: Google.Ads.Googleads.V19.Common.LeadFormCustomQuestionField,
    json_name: "customQuestionFields"

  field :delivery_methods, 9,
    repeated: true,
    type: Google.Ads.Googleads.V19.Common.LeadFormDeliveryMethod,
    json_name: "deliveryMethods"

  field :post_submit_call_to_action_type, 19,
    type:
      Google.Ads.Googleads.V19.Enums.LeadFormPostSubmitCallToActionTypeEnum.LeadFormPostSubmitCallToActionType,
  ...
  field :desired_intent, 21,
    type: Google.Ads.Googleads.V19.Enums.LeadFormDesiredIntentEnum.LeadFormDesiredIntent,
...
defmodule Google.Ads.Googleads.V19.Common.LeadFormField do
  @moduledoc false
  ...
  field :input_type, 1,
    type:
      Google.Ads.Googleads.V19.Enums.LeadFormFieldUserInputTypeEnum.LeadFormFieldUserInputType,
    json_name: "inputType",
    enum: true

  field :single_choice_answers, 2,
    type: Google.Ads.Googleads.V19.Common.LeadFormSingleChoiceAnswers,
...
defmodule Google.Ads.Googleads.V19.Common.LeadFormCustomQuestionField do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.LeadFormSingleChoiceAnswers do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.LeadFormDeliveryMethod do
  @moduledoc false
  ...
  field :webhook, 1, type: Google.Ads.Googleads.V19.Common.WebhookDelivery, oneof: 0
end

defmodule Google.Ads.Googleads.V19.Common.WebhookDelivery do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.BookOnGoogleAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3
end

defmodule Google.Ads.Googleads.V19.Common.PromotionAsset do
  @moduledoc false
  ...
  field :discount_modifier, 2,
    type:
      Google.Ads.Googleads.V19.Enums.PromotionExtensionDiscountModifierEnum.PromotionExtensionDiscountModifier,
  ...
  field :occasion, 9,
    type:
      Google.Ads.Googleads.V19.Enums.PromotionExtensionOccasionEnum.PromotionExtensionOccasion,
    enum: true
  ...
  field :money_amount_off, 4,
    type: Google.Ads.Googleads.V19.Common.Money,
...
defmodule Google.Ads.Googleads.V19.Common.CalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.StructuredSnippetAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.SitelinkAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.PageFeedAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicEducationAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.MobileAppAsset do
  @moduledoc false
  ...
  field :app_store, 2,
    type: Google.Ads.Googleads.V19.Enums.MobileAppVendorEnum.MobileAppVendor,
    json_name: "appStore",
    enum: true,
    deprecated: false
...
defmodule Google.Ads.Googleads.V19.Common.HotelCalloutAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.CallAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.PriceAsset do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :type, 1,
    type: Google.Ads.Googleads.V19.Enums.PriceExtensionTypeEnum.PriceExtensionType,
    enum: true,
    deprecated: false

  field :price_qualifier, 2,
    type:
      Google.Ads.Googleads.V19.Enums.PriceExtensionPriceQualifierEnum.PriceExtensionPriceQualifier,
  ...
  field :price_offerings, 4,
    repeated: true,
    type: Google.Ads.Googleads.V19.Common.PriceOffering,
    json_name: "priceOfferings"
end

defmodule Google.Ads.Googleads.V19.Common.PriceOffering do
  @moduledoc false
  ...
  field :price, 3, type: Google.Ads.Googleads.V19.Common.Money, deprecated: false

  field :unit, 4,
    type: Google.Ads.Googleads.V19.Enums.PriceExtensionPriceUnitEnum.PriceExtensionPriceUnit,
    enum: true
...
defmodule Google.Ads.Googleads.V19.Common.CallToActionAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicRealEstateAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicCustomAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicHotelsAndRentalsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicFlightsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DemandGenCarouselCardAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicTravelAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicLocalAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.DynamicJobsAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.LocationAsset do
  @moduledoc false
  ...
  field :business_profile_locations, 2,
    repeated: true,
    type: Google.Ads.Googleads.V19.Common.BusinessProfileLocation,
...
defmodule Google.Ads.Googleads.V19.Common.BusinessProfileLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.HotelPropertyAsset do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.BusinessMessageAsset do
  @moduledoc false
  ...
  field :message_provider, 1,
    type: Google.Ads.Googleads.V19.Enums.BusinessMessageProviderEnum.BusinessMessageProvider,
  ...
  field :call_to_action, 3,
    proto3_optional: true,
    type: Google.Ads.Googleads.V19.Common.BusinessMessageCallToActionInfo,
    json_name: "callToAction"

  field :whatsapp_info, 5,
    type: Google.Ads.Googleads.V19.Common.WhatsappBusinessMessageInfo,
    json_name: "whatsappInfo",
    oneof: 0
end

defmodule Google.Ads.Googleads.V19.Common.WhatsappBusinessMessageInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.BusinessMessageCallToActionInfo do
  @moduledoc false
  ...
  field :call_to_action_selection, 1,
    type:
      Google.Ads.Googleads.V19.Enums.BusinessMessageCallToActionTypeEnum.BusinessMessageCallToActionType,
...
defmodule Google.Ads.Googleads.V19.Common.AppDeepLinkAsset do
  @moduledoc false
