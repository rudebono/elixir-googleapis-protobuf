defmodule Google.Ads.Googleads.V19.Common.AdAssetPolicySummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.AssetLinkPrimaryStatusDetails do
  @moduledoc false
  ...
  field :asset_disapproved, 3,
    type: Google.Ads.Googleads.V19.Common.AssetDisapproved,
    json_name: "assetDisapproved",
    oneof: 0
end

defmodule Google.Ads.Googleads.V19.Common.AssetDisapproved do
  @moduledoc false
  ...
  field :offline_evaluation_error_reasons, 1,
    repeated: true,
    type:
      Google.Ads.Googleads.V19.Enums.AssetOfflineEvaluationErrorReasonsEnum.AssetOfflineEvaluationErrorReasons,
