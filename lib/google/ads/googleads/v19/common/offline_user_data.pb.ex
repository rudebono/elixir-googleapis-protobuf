defmodule Google.Ads.Googleads.V19.Common.OfflineUserAddressInfo do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Common.UserData do
  ...
  field :consent, 4, proto3_optional: true, type: Google.Ads.Googleads.V19.Common.Consent
end
...
defmodule Google.Ads.Googleads.V19.Common.CustomerMatchUserListMetadata do
  ...
  field :consent, 3, proto3_optional: true, type: Google.Ads.Googleads.V19.Common.Consent
end
