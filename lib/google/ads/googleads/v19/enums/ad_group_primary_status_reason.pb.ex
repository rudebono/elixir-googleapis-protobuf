defmodule Google.Ads.Googleads.V19.Enums.AdGroupPrimaryStatusReasonEnum.AdGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.AdGroupPrimaryStatusReasonEnum do
  @moduledoc false
