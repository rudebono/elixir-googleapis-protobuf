defmodule Google.Ads.Googleads.V19.Enums.ConversionLagBucketEnum.ConversionLagBucket do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.ConversionLagBucketEnum do
  @moduledoc false
