defmodule Google.Ads.Googleads.V19.Enums.CampaignPrimaryStatusReasonEnum.CampaignPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.CampaignPrimaryStatusReasonEnum do
  @moduledoc false
