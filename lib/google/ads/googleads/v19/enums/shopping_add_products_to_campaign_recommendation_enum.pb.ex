defmodule Google.Ads.Googleads.V19.Enums.ShoppingAddProductsToCampaignRecommendationEnum.Reason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.ShoppingAddProductsToCampaignRecommendationEnum do
  @moduledoc false
