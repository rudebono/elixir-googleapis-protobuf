defmodule Google.Ads.Googleads.V19.Enums.BiddingStrategyTypeEnum.BiddingStrategyType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.BiddingStrategyTypeEnum do
  @moduledoc false
