defmodule Google.Ads.Googleads.V19.Enums.ChangeEventResourceTypeEnum.ChangeEventResourceType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.ChangeEventResourceTypeEnum do
  @moduledoc false
