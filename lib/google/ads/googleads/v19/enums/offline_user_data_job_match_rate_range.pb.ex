defmodule Google.Ads.Googleads.V19.Enums.OfflineUserDataJobMatchRateRangeEnum.OfflineUserDataJobMatchRateRange do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.OfflineUserDataJobMatchRateRangeEnum do
  @moduledoc false
