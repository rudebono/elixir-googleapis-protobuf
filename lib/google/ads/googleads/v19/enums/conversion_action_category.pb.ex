defmodule Google.Ads.Googleads.V19.Enums.ConversionActionCategoryEnum.ConversionActionCategory do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.ConversionActionCategoryEnum do
  @moduledoc false
