defmodule Google.Ads.Googleads.V19.Enums.BiddingStrategySystemStatusEnum.BiddingStrategySystemStatus do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.BiddingStrategySystemStatusEnum do
  @moduledoc false
