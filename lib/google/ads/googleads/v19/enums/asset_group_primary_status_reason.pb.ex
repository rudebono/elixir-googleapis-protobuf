defmodule Google.Ads.Googleads.V19.Enums.AssetGroupPrimaryStatusReasonEnum.AssetGroupPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.AssetGroupPrimaryStatusReasonEnum do
  @moduledoc false
