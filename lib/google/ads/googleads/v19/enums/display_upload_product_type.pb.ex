defmodule Google.Ads.Googleads.V19.Enums.DisplayUploadProductTypeEnum.DisplayUploadProductType do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.DisplayUploadProductTypeEnum do
  @moduledoc false
