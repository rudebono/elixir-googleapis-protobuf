defmodule Google.Ads.Googleads.V19.Enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Enums.AdGroupCriterionPrimaryStatusReasonEnum do
  @moduledoc false
