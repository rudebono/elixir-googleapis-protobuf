defmodule Google.Ads.Googleads.V19.Resources.OfflineConversionUploadClientSummary do
  @moduledoc false
  ...
  field :client, 2,
    type: Google.Ads.Googleads.V19.Enums.OfflineEventUploadClientEnum.OfflineEventUploadClient,
    enum: true,
    deprecated: false

  field :status, 3,
    type:
      Google.Ads.Googleads.V19.Enums.OfflineConversionDiagnosticStatusEnum.OfflineConversionDiagnosticStatus,
    enum: true,
    deprecated: false
  ...
  field :daily_summaries, 8,
    repeated: true,
    type: Google.Ads.Googleads.V19.Resources.OfflineConversionSummary,
  ...
  field :alerts, 10,
    repeated: true,
    type: Google.Ads.Googleads.V19.Resources.OfflineConversionAlert,
    deprecated: false
end

defmodule Google.Ads.Googleads.V19.Resources.OfflineConversionSummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Resources.OfflineConversionAlert do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :error, 1,
    type: Google.Ads.Googleads.V19.Resources.OfflineConversionError,
    deprecated: false

  field :error_percentage, 2, type: :double, json_name: "errorPercentage", deprecated: false
end

defmodule Google.Ads.Googleads.V19.Resources.OfflineConversionError do
  @moduledoc false
