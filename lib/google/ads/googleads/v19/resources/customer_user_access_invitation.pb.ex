defmodule Google.Ads.Googleads.V19.Resources.CustomerUserAccessInvitation do
  @moduledoc false
  ...
  field :invitation_status, 6,
    type: Google.Ads.Googleads.V19.Enums.AccessInvitationStatusEnum.AccessInvitationStatus,
