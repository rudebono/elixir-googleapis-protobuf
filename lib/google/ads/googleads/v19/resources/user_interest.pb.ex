defmodule Google.Ads.Googleads.V19.Resources.UserInterest do
  @moduledoc false
  ...
  field :taxonomy_type, 2,
    type: Google.Ads.Googleads.V19.Enums.UserInterestTaxonomyTypeEnum.UserInterestTaxonomyType,
  ...
  field :availabilities, 7,
    repeated: true,
    type: Google.Ads.Googleads.V19.Common.CriterionCategoryAvailability,
    deprecated: false
end
