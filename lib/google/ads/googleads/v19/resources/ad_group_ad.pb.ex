defmodule Google.Ads.Googleads.V19.Resources.AdGroupAd do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V19.Enums.AdGroupAdStatusEnum.AdGroupAdStatus,
    enum: true
  ...
  field :ad, 5, type: Google.Ads.Googleads.V19.Resources.Ad, deprecated: false

  field :policy_summary, 6,
    type: Google.Ads.Googleads.V19.Resources.AdGroupAdPolicySummary,
  ...
  field :primary_status, 16,
    type: Google.Ads.Googleads.V19.Enums.AdGroupAdPrimaryStatusEnum.AdGroupAdPrimaryStatus,
  ...
  field :primary_status_reasons, 17,
    repeated: true,
    type:
      Google.Ads.Googleads.V19.Enums.AdGroupAdPrimaryStatusReasonEnum.AdGroupAdPrimaryStatusReason,
  ...
  field :ad_group_ad_asset_automation_settings, 18,
    repeated: true,
    type: Google.Ads.Googleads.V19.Resources.AdGroupAdAssetAutomationSetting,
    json_name: "adGroupAdAssetAutomationSettings"
end

defmodule Google.Ads.Googleads.V19.Resources.AdGroupAdPolicySummary do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Resources.AdGroupAdAssetAutomationSetting do
  @moduledoc false
