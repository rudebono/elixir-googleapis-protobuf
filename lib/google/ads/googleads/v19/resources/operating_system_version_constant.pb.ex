defmodule Google.Ads.Googleads.V19.Resources.OperatingSystemVersionConstant do
  @moduledoc false
  ...
  field :operator_type, 6,
    type:
      Google.Ads.Googleads.V19.Enums.OperatingSystemVersionOperatorTypeEnum.OperatingSystemVersionOperatorType,
