defmodule Google.Ads.Googleads.V19.Resources.LocalServicesLead do
  ...
  field :contact_details, 5,
    type: Google.Ads.Googleads.V19.Resources.ContactDetails,
    json_name: "contactDetails",
    deprecated: false

  field :lead_type, 6,
    type: Google.Ads.Googleads.V19.Enums.LocalServicesLeadTypeEnum.LeadType,
    json_name: "leadType",
    enum: true,
    deprecated: false

  field :lead_status, 7,
    type: Google.Ads.Googleads.V19.Enums.LocalServicesLeadStatusEnum.LeadStatus,
  ...
  field :note, 10,
    ...
    type: Google.Ads.Googleads.V19.Resources.Note,
    deprecated: false
