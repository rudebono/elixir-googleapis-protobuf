defmodule Google.Ads.Googleads.V19.Resources.AdGroupCriterion.QualityInfo do
  @moduledoc false
  ...
  field :creative_quality_score, 2,
    type: Google.Ads.Googleads.V19.Enums.QualityScoreBucketEnum.QualityScoreBucket,
...
defmodule Google.Ads.Googleads.V19.Resources.AdGroupCriterion.PositionEstimates do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Resources.AdGroupCriterion do
  @moduledoc false
  ...
  field :status, 3,
    type: Google.Ads.Googleads.V19.Enums.AdGroupCriterionStatusEnum.AdGroupCriterionStatus,
    enum: true

  field :quality_info, 4,
    type: Google.Ads.Googleads.V19.Resources.AdGroupCriterion.QualityInfo,
  ...
  field :system_serving_status, 52,
    type:
      Google.Ads.Googleads.V19.Enums.CriterionSystemServingStatusEnum.CriterionSystemServingStatus,
  ...
  field :approval_status, 53,
    type:
      Google.Ads.Googleads.V19.Enums.AdGroupCriterionApprovalStatusEnum.AdGroupCriterionApprovalStatus,
  ...
  field :position_estimates, 10,
    type: Google.Ads.Googleads.V19.Resources.AdGroupCriterion.PositionEstimates,
  ...
  field :primary_status, 85,
    proto3_optional: true,
    type:
      Google.Ads.Googleads.V19.Enums.AdGroupCriterionPrimaryStatusEnum.AdGroupCriterionPrimaryStatus,
  ...
  field :primary_status_reasons, 86,
    repeated: true,
    type:
      Google.Ads.Googleads.V19.Enums.AdGroupCriterionPrimaryStatusReasonEnum.AdGroupCriterionPrimaryStatusReason,
  ...
  field :listing_group, 32,
    type: Google.Ads.Googleads.V19.Common.ListingGroupInfo,
  ...
  field :gender, 37, type: Google.Ads.Googleads.V19.Common.GenderInfo, oneof: 0, deprecated: false
  ...
  field :topic, 43, type: Google.Ads.Googleads.V19.Common.TopicInfo, oneof: 0, deprecated: false
  ...
  field :app_payment_model, 47,
    type: Google.Ads.Googleads.V19.Common.AppPaymentModelInfo,
  ...
  field :custom_intent, 49,
    type: Google.Ads.Googleads.V19.Common.CustomIntentInfo,
