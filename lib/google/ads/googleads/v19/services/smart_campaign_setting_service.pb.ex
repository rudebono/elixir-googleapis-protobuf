defmodule Google.Ads.Googleads.V19.Services.GetSmartCampaignStatusRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.SmartCampaignSettingService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.SmartCampaignSettingService.Service
end
