defmodule Google.Ads.Googleads.V19.Services.MutateUserListCustomerTypesRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.UserListCustomerTypeService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.UserListCustomerTypeService.Service
end
