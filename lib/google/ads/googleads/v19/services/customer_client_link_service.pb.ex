defmodule Google.Ads.Googleads.V19.Services.MutateCustomerClientLinkRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.CustomerClientLinkService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.CustomerClientLinkService.Service
end
