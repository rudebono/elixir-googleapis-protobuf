defmodule Google.Ads.Googleads.V19.Services.CreateOfflineUserDataJobRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.OfflineUserDataJobService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.OfflineUserDataJobService.Service
end
