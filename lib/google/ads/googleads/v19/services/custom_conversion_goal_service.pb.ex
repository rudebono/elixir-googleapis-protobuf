defmodule Google.Ads.Googleads.V19.Services.MutateCustomConversionGoalsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.CustomConversionGoalService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.CustomConversionGoalService.Service
end
