defmodule Google.Ads.Googleads.V19.Services.CreateAccountLinkRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AccountLinkService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.AccountLinkService.Service
end
