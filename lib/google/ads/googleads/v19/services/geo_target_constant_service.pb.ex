defmodule Google.Ads.Googleads.V19.Services.SuggestGeoTargetConstantsRequest.LocationNames do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.GeoTargetConstantService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.GeoTargetConstantService.Service
end
