defmodule Google.Ads.Googleads.V19.Services.MutateBillingSetupRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.BillingSetupService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.BillingSetupService.Service
end
