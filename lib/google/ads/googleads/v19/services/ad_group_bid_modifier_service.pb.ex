defmodule Google.Ads.Googleads.V19.Services.MutateAdGroupBidModifiersRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AdGroupBidModifierService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.AdGroupBidModifierService.Service
end
