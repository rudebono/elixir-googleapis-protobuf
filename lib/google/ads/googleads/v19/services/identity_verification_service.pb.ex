defmodule Google.Ads.Googleads.V19.Services.StartIdentityVerificationRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.IdentityVerificationService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.IdentityVerificationService.Service
end
