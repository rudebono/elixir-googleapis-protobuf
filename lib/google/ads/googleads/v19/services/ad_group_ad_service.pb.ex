defmodule Google.Ads.Googleads.V19.Services.MutateAdGroupAdsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AdGroupAdService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.AdGroupAdService.Service
end
