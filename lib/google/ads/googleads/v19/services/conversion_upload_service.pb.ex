defmodule Google.Ads.Googleads.V19.Services.UploadClickConversionsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ConversionUploadService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.ConversionUploadService.Service
end
