defmodule Google.Ads.Googleads.V19.Services.MutateAdGroupAssetSetsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AdGroupAssetSetService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.AdGroupAssetSetService.Service
end
