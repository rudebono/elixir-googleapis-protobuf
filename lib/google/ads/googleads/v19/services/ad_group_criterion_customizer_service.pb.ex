defmodule Google.Ads.Googleads.V19.Services.MutateAdGroupCriterionCustomizersRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AdGroupCriterionCustomizerService.Stub do
  ...
  use GRPC.Stub,
    service: Google.Ads.Googleads.V19.Services.AdGroupCriterionCustomizerService.Service
end
