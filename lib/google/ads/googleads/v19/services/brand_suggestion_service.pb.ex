defmodule Google.Ads.Googleads.V19.Services.SuggestBrandsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.BrandSuggestionService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.BrandSuggestionService.Service
end
