defmodule Google.Ads.Googleads.V19.Services.UploadConversionAdjustmentsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ConversionAdjustmentUploadService.Stub do
  ...
  use GRPC.Stub,
    service: Google.Ads.Googleads.V19.Services.ConversionAdjustmentUploadService.Service
end
