defmodule Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsRequest do
  ...
  field :suggestion_info, 3,
    type: Google.Ads.Googleads.V19.Services.SmartCampaignSuggestionInfo,
...
defmodule Google.Ads.Googleads.V19.Services.SmartCampaignSuggestionInfo do
  ...
  field :business_context, 8,
    type: Google.Ads.Googleads.V19.Services.SmartCampaignSuggestionInfo.BusinessContext,
  ...
  field :location_list, 4,
    type: Google.Ads.Googleads.V19.Services.SmartCampaignSuggestionInfo.LocationList,
...
defmodule Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption do
  ...
  field :metrics, 2,
    type: Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsResponse.Metrics
end
...
defmodule Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsResponse do
  ...
  field :low, 1,
    ...
    type:
      Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsResponse.BudgetOption,
    deprecated: false
...
defmodule Google.Ads.Googleads.V19.Services.SuggestKeywordThemesResponse do
  ...
  field :keyword_themes, 2,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.SuggestKeywordThemesResponse.KeywordTheme,
    json_name: "keywordThemes"
end

defmodule Google.Ads.Googleads.V19.Services.SmartCampaignSuggestService.Service do
  @moduledoc false
  ...
  rpc :SuggestSmartCampaignBudgetOptions,
      ...
      Google.Ads.Googleads.V19.Services.SuggestSmartCampaignBudgetOptionsResponse

  rpc :SuggestSmartCampaignAd,
      Google.Ads.Googleads.V19.Services.SuggestSmartCampaignAdRequest,
      Google.Ads.Googleads.V19.Services.SuggestSmartCampaignAdResponse

  rpc :SuggestKeywordThemes,
      Google.Ads.Googleads.V19.Services.SuggestKeywordThemesRequest,
      Google.Ads.Googleads.V19.Services.SuggestKeywordThemesResponse
end

defmodule Google.Ads.Googleads.V19.Services.SmartCampaignSuggestService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.SmartCampaignSuggestService.Service
end
