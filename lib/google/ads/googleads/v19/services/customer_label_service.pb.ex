defmodule Google.Ads.Googleads.V19.Services.MutateCustomerLabelsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.CustomerLabelService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.CustomerLabelService.Service
end
