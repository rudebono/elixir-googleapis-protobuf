...
defmodule Google.Ads.Googleads.V19.Services.ListPlannableLocationsResponse do
  @moduledoc false
  ...
  field :plannable_locations, 1,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.PlannableLocation,
    json_name: "plannableLocations"
end

defmodule Google.Ads.Googleads.V19.Services.PlannableLocation do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ListPlannableProductsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ListPlannableProductsResponse do
  @moduledoc false
  ...
  field :product_metadata, 1,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.ProductMetadata,
    json_name: "productMetadata"
end

defmodule Google.Ads.Googleads.V19.Services.ProductMetadata do
  @moduledoc false
  ...
  field :plannable_targeting, 2,
    type: Google.Ads.Googleads.V19.Services.PlannableTargeting,
    json_name: "plannableTargeting"
end

defmodule Google.Ads.Googleads.V19.Services.PlannableTargeting do
  @moduledoc false
  ...
  field :age_ranges, 1,
    repeated: true,
    type: Google.Ads.Googleads.V19.Enums.ReachPlanAgeRangeEnum.ReachPlanAgeRange,
    json_name: "ageRanges",
    enum: true

  field :genders, 2, repeated: true, type: Google.Ads.Googleads.V19.Common.GenderInfo
  field :devices, 3, repeated: true, type: Google.Ads.Googleads.V19.Common.DeviceInfo

  field :networks, 4,
    repeated: true,
    type: Google.Ads.Googleads.V19.Enums.ReachPlanNetworkEnum.ReachPlanNetwork,
    enum: true

  field :youtube_select_lineups, 5,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.YouTubeSelectLineUp,
    json_name: "youtubeSelectLineups"

  field :surface_targeting, 6,
    type: Google.Ads.Googleads.V19.Services.SurfaceTargetingCombinations,
    json_name: "surfaceTargeting"
end

defmodule Google.Ads.Googleads.V19.Services.GenerateReachForecastRequest do
  @moduledoc false
  ...
  field :campaign_duration, 3,
    type: Google.Ads.Googleads.V19.Services.CampaignDuration,
  ...
  field :cookie_frequency_cap_setting, 8,
    type: Google.Ads.Googleads.V19.Services.FrequencyCap,
  ...
  field :effective_frequency_limit, 12,
    proto3_optional: true,
    type: Google.Ads.Googleads.V19.Services.EffectiveFrequencyLimit,
    json_name: "effectiveFrequencyLimit"

  field :targeting, 6, type: Google.Ads.Googleads.V19.Services.Targeting

  field :planned_products, 7,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.PlannedProduct,
    json_name: "plannedProducts",
    deprecated: false

  field :forecast_metric_options, 13,
    type: Google.Ads.Googleads.V19.Services.ForecastMetricOptions,
...
defmodule Google.Ads.Googleads.V19.Services.EffectiveFrequencyLimit do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.FrequencyCap do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.Targeting do
  @moduledoc false
  ...
  field :genders, 3, repeated: true, type: Google.Ads.Googleads.V19.Common.GenderInfo
  field :devices, 4, repeated: true, type: Google.Ads.Googleads.V19.Common.DeviceInfo
  ...
  field :audience_targeting, 7,
    type: Google.Ads.Googleads.V19.Services.AudienceTargeting,
    json_name: "audienceTargeting"
end

defmodule Google.Ads.Googleads.V19.Services.CampaignDuration do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :duration_in_days, 2, proto3_optional: true, type: :int32, json_name: "durationInDays"
  field :date_range, 3, type: Google.Ads.Googleads.V19.Common.DateRange, json_name: "dateRange"
end

defmodule Google.Ads.Googleads.V19.Services.PlannedProduct do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.GenerateReachForecastResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :on_target_audience_metrics, 1,
    type: Google.Ads.Googleads.V19.Services.OnTargetAudienceMetrics,
    json_name: "onTargetAudienceMetrics"

  field :reach_curve, 2,
    type: Google.Ads.Googleads.V19.Services.ReachCurve,
    json_name: "reachCurve"
end

defmodule Google.Ads.Googleads.V19.Services.ReachCurve do
  @moduledoc false
  ...
  field :reach_forecasts, 1,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.ReachForecast,
    json_name: "reachForecasts"
end

defmodule Google.Ads.Googleads.V19.Services.ReachForecast do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :cost_micros, 5, type: :int64, json_name: "costMicros"
  field :forecast, 2, type: Google.Ads.Googleads.V19.Services.Forecast

  field :planned_product_reach_forecasts, 4,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.PlannedProductReachForecast,
    json_name: "plannedProductReachForecasts"
end

defmodule Google.Ads.Googleads.V19.Services.Forecast do
  @moduledoc false
  ...
  field :effective_frequency_breakdowns, 10,
    repeated: true,
    type: Google.Ads.Googleads.V19.Services.EffectiveFrequencyBreakdown,
...
defmodule Google.Ads.Googleads.V19.Services.PlannedProductReachForecast do
  ...
  field :planned_product_forecast, 3,
    type: Google.Ads.Googleads.V19.Services.PlannedProductForecast,
    json_name: "plannedProductForecast"
end

defmodule Google.Ads.Googleads.V19.Services.PlannedProductForecast do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.EffectiveFrequencyBreakdown do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ForecastMetricOptions do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AudienceTargeting do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.AdvancedProductTargeting do
  @moduledoc false
  ...
  field :surface_targeting_settings, 2,
    type: Google.Ads.Googleads.V19.Services.SurfaceTargeting,
    json_name: "surfaceTargetingSettings"

  field :target_frequency_settings, 3,
    type: Google.Ads.Googleads.V19.Services.TargetFrequencySettings,
    json_name: "targetFrequencySettings"

  field :youtube_select_settings, 1,
    type: Google.Ads.Googleads.V19.Services.YouTubeSelectSettings,
    json_name: "youtubeSelectSettings",
    oneof: 0
end

defmodule Google.Ads.Googleads.V19.Services.YouTubeSelectSettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.YouTubeSelectLineUp do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.SurfaceTargetingCombinations do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.SurfaceTargeting do
  @moduledoc false
  ...
  field :surfaces, 1,
    repeated: true,
    type: Google.Ads.Googleads.V19.Enums.ReachPlanSurfaceEnum.ReachPlanSurface,
    enum: true
end

defmodule Google.Ads.Googleads.V19.Services.TargetFrequencySettings do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.ReachPlanService.Service do
  @moduledoc false
  ...
  rpc :ListPlannableLocations,
      ...
      Google.Ads.Googleads.V19.Services.ListPlannableLocationsResponse

  rpc :ListPlannableProducts,
      Google.Ads.Googleads.V19.Services.ListPlannableProductsRequest,
      Google.Ads.Googleads.V19.Services.ListPlannableProductsResponse

  rpc :GenerateReachForecast,
      Google.Ads.Googleads.V19.Services.GenerateReachForecastRequest,
      Google.Ads.Googleads.V19.Services.GenerateReachForecastResponse
end

defmodule Google.Ads.Googleads.V19.Services.ReachPlanService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.ReachPlanService.Service
end
