defmodule Google.Ads.Googleads.V19.Services.MutateCampaignDraftsRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.CampaignDraftService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.CampaignDraftService.Service
end
