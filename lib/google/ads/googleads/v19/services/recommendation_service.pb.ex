defmodule Google.Ads.Googleads.V19.Services.ApplyRecommendationOperation.AdAssetApplyParameters.ApplyScope do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.RecommendationService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.RecommendationService.Service
end
