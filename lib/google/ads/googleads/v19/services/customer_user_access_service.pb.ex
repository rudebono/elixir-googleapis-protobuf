defmodule Google.Ads.Googleads.V19.Services.MutateCustomerUserAccessRequest do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Services.CustomerUserAccessService.Stub do
  ...
  use GRPC.Stub, service: Google.Ads.Googleads.V19.Services.CustomerUserAccessService.Service
end
