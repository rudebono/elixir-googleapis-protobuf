defmodule Google.Ads.Googleads.V19.Errors.ExtensionFeedItemErrorEnum.ExtensionFeedItemError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.ExtensionFeedItemErrorEnum do
  @moduledoc false
