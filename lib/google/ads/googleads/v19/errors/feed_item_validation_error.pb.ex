defmodule Google.Ads.Googleads.V19.Errors.FeedItemValidationErrorEnum.FeedItemValidationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.FeedItemValidationErrorEnum do
  @moduledoc false
