defmodule Google.Ads.Googleads.V19.Errors.AssetGroupAssetErrorEnum.AssetGroupAssetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.AssetGroupAssetErrorEnum do
  @moduledoc false
