defmodule Google.Ads.Googleads.V19.Errors.CampaignBudgetErrorEnum.CampaignBudgetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.CampaignBudgetErrorEnum do
  @moduledoc false
