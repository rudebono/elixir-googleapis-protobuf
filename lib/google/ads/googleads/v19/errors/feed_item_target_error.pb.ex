defmodule Google.Ads.Googleads.V19.Errors.FeedItemTargetErrorEnum.FeedItemTargetError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.FeedItemTargetErrorEnum do
  @moduledoc false
