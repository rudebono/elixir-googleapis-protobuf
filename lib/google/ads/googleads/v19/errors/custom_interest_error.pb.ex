defmodule Google.Ads.Googleads.V19.Errors.CustomInterestErrorEnum.CustomInterestError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.CustomInterestErrorEnum do
  @moduledoc false
