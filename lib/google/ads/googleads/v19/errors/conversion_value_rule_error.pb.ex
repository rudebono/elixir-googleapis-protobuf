defmodule Google.Ads.Googleads.V19.Errors.ConversionValueRuleErrorEnum.ConversionValueRuleError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.ConversionValueRuleErrorEnum do
  @moduledoc false
