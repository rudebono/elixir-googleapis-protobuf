defmodule Google.Ads.Googleads.V19.Errors.BiddingStrategyErrorEnum.BiddingStrategyError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.BiddingStrategyErrorEnum do
  @moduledoc false
