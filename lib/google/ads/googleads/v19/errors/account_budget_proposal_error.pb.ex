defmodule Google.Ads.Googleads.V19.Errors.AccountBudgetProposalErrorEnum.AccountBudgetProposalError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.AccountBudgetProposalErrorEnum do
  @moduledoc false
