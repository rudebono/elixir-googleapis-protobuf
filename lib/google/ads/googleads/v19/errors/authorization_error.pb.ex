defmodule Google.Ads.Googleads.V19.Errors.AuthorizationErrorEnum.AuthorizationError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.AuthorizationErrorEnum do
  @moduledoc false
