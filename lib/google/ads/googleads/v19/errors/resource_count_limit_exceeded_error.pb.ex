defmodule Google.Ads.Googleads.V19.Errors.ResourceCountLimitExceededErrorEnum.ResourceCountLimitExceededError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.ResourceCountLimitExceededErrorEnum do
  @moduledoc false
