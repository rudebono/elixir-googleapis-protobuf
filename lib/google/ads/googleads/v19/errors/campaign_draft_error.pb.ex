defmodule Google.Ads.Googleads.V19.Errors.CampaignDraftErrorEnum.CampaignDraftError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.CampaignDraftErrorEnum do
  @moduledoc false
