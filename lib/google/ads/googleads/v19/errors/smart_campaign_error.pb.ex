defmodule Google.Ads.Googleads.V19.Errors.SmartCampaignErrorEnum.SmartCampaignError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.SmartCampaignErrorEnum do
  @moduledoc false
