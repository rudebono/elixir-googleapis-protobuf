defmodule Google.Ads.Googleads.V19.Errors.UserListCustomerTypeErrorEnum.UserListCustomerTypeError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.UserListCustomerTypeErrorEnum do
  @moduledoc false
