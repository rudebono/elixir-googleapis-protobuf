defmodule Google.Ads.Googleads.V19.Errors.ExtensionSettingErrorEnum.ExtensionSettingError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.ExtensionSettingErrorEnum do
  @moduledoc false
