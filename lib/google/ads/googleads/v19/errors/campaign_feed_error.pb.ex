defmodule Google.Ads.Googleads.V19.Errors.CampaignFeedErrorEnum.CampaignFeedError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.CampaignFeedErrorEnum do
  @moduledoc false
