defmodule Google.Ads.Googleads.V19.Errors.AdCustomizerErrorEnum.AdCustomizerError do
  @moduledoc false
...
defmodule Google.Ads.Googleads.V19.Errors.AdCustomizerErrorEnum do
  @moduledoc false
