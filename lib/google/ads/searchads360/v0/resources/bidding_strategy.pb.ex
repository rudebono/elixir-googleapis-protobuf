defmodule Google.Ads.Searchads360.V0.Resources.BiddingStrategy do
  @moduledoc false
  ...
  field :status, 15,
    type: Google.Ads.Searchads360.V0.Enums.BiddingStrategyStatusEnum.BiddingStrategyStatus,
    enum: true,
    deprecated: false
  ...
  field :enhanced_cpc, 7,
    type: Google.Ads.Searchads360.V0.Common.EnhancedCpc,
  ...
  field :target_outrank_share, 10,
    type: Google.Ads.Searchads360.V0.Common.TargetOutrankShare,
    json_name: "targetOutrankShare",
    oneof: 0
