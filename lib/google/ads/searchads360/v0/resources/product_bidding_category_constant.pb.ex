defmodule Google.Ads.Searchads360.V0.Resources.ProductBiddingCategoryConstant do
  @moduledoc false
  ...
  field :level, 5,
    type:
      Google.Ads.Searchads360.V0.Enums.ProductBiddingCategoryLevelEnum.ProductBiddingCategoryLevel,
    enum: true,
    deprecated: false

  field :status, 6,
    type:
      Google.Ads.Searchads360.V0.Enums.ProductBiddingCategoryStatusEnum.ProductBiddingCategoryStatus,
    enum: true,
    deprecated: false
