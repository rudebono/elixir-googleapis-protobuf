defmodule Google.Ads.Searchads360.V0.Enums.ConversionActionCategoryEnum.ConversionActionCategory do
  @moduledoc false
  ...
  field :STORE_SALE, 21
  field :QUALIFIED_LEAD, 22
  field :CONVERTED_LEAD, 23
end

defmodule Google.Ads.Searchads360.V0.Enums.ConversionActionCategoryEnum do
  @moduledoc false
