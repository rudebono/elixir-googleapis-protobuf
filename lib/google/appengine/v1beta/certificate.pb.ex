...
defmodule Google.Appengine.V1beta.AuthorizedCertificate do
  ...
  @type t :: %__MODULE__{
          ...
          certificate_raw_data: Google.Appengine.V1beta.CertificateRawData.t() | nil,
          managed_certificate: Google.Appengine.V1beta.ManagedCertificate.t() | nil,
  ...
  field :certificate_raw_data, 6, type: Google.Appengine.V1beta.CertificateRawData
  field :managed_certificate, 7, type: Google.Appengine.V1beta.ManagedCertificate
