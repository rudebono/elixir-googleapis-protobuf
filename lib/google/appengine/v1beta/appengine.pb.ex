...
defmodule Google.Appengine.V1beta.Services.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1beta.Services", protoc_gen_elixir_version: "0.15.0"
...
defmodule Google.Appengine.V1beta.Versions.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1beta.Versions", protoc_gen_elixir_version: "0.15.0"
...
defmodule Google.Appengine.V1beta.Instances.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1beta.Instances", protoc_gen_elixir_version: "0.15.0"
...
defmodule Google.Appengine.V1beta.Firewall.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1beta.Firewall", protoc_gen_elixir_version: "0.15.0"
