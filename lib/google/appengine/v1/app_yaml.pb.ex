...
defmodule Google.Appengine.V1.ApiConfigHandler do
  ...
  @type t :: %__MODULE__{
          auth_fail_action: Google.Appengine.V1.AuthFailAction.t(),
          login: Google.Appengine.V1.LoginRequirement.t(),
          script: String.t(),
          security_level: Google.Appengine.V1.SecurityLevel.t(),
          url: String.t()
        }

  defstruct [:auth_fail_action, :login, :script, :security_level, :url]

  field :auth_fail_action, 1, type: Google.Appengine.V1.AuthFailAction, enum: true
  field :login, 2, type: Google.Appengine.V1.LoginRequirement, enum: true
  field :script, 3, type: :string
  field :security_level, 4, type: Google.Appengine.V1.SecurityLevel, enum: true
...
defmodule Google.Appengine.V1.ErrorHandler do
  ...
  @type t :: %__MODULE__{
          error_code: Google.Appengine.V1.ErrorHandler.ErrorCode.t(),
  ...
  field :error_code, 1, type: Google.Appengine.V1.ErrorHandler.ErrorCode, enum: true
...
defmodule Google.Appengine.V1.UrlMap do
  ...
  @type t :: %__MODULE__{
          ...
          login: Google.Appengine.V1.LoginRequirement.t(),
          auth_fail_action: Google.Appengine.V1.AuthFailAction.t(),
          redirect_http_response_code: Google.Appengine.V1.UrlMap.RedirectHttpResponseCode.t()
        }
  ...
  field :static_files, 2, type: Google.Appengine.V1.StaticFilesHandler, oneof: 0
  field :script, 3, type: Google.Appengine.V1.ScriptHandler, oneof: 0
  field :api_endpoint, 4, type: Google.Appengine.V1.ApiEndpointHandler, oneof: 0
  field :security_level, 5, type: Google.Appengine.V1.SecurityLevel, enum: true
  field :login, 6, type: Google.Appengine.V1.LoginRequirement, enum: true
  field :auth_fail_action, 7, type: Google.Appengine.V1.AuthFailAction, enum: true
