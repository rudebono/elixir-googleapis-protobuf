...
defmodule Google.Appengine.V1.UrlMap do
  ...
  @type t :: %__MODULE__{
          handler_type:
            {:static_files, Google.Appengine.V1.StaticFilesHandler.t() | nil}
            | {:script, Google.Appengine.V1.ScriptHandler.t() | nil}
            | {:api_endpoint, Google.Appengine.V1.ApiEndpointHandler.t() | nil},
          url_regex: String.t(),
          security_level: Google.Appengine.V1.SecurityLevel.t(),
          login: Google.Appengine.V1.LoginRequirement.t(),
          auth_fail_action: Google.Appengine.V1.AuthFailAction.t(),
