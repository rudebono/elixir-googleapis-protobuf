...
defmodule Google.Appengine.V1.Application do
  ...
  field :dispatch_rules, 3, repeated: true, type: Google.Appengine.V1.UrlDispatchRule
  ...
  field :serving_status, 10, type: Google.Appengine.V1.Application.ServingStatus, enum: true
  ...
  field :database_type, 17, type: Google.Appengine.V1.Application.DatabaseType, enum: true
  field :feature_settings, 18, type: Google.Appengine.V1.Application.FeatureSettings
end
