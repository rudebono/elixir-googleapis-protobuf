...
defmodule Google.Appengine.V1.Applications.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1.Applications", protoc_gen_elixir_version: "0.14.0"
...
defmodule Google.Appengine.V1.Services.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1.Services", protoc_gen_elixir_version: "0.14.0"
...
defmodule Google.Appengine.V1.Versions.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1.Versions", protoc_gen_elixir_version: "0.14.0"
...
defmodule Google.Appengine.V1.Instances.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1.Instances", protoc_gen_elixir_version: "0.14.0"
...
defmodule Google.Appengine.V1.Firewall.Service do
  ...
  use GRPC.Service, name: "google.appengine.v1.Firewall", protoc_gen_elixir_version: "0.14.0"
