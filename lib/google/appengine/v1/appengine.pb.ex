...
defmodule Google.Appengine.V1.Applications.Service do
  @moduledoc false
  use GRPC.Service, name: "google.appengine.v1.Applications", protoc_gen_elixir_version: "0.10.0"
...
defmodule Google.Appengine.V1.Services.Service do
  @moduledoc false
  use GRPC.Service, name: "google.appengine.v1.Services", protoc_gen_elixir_version: "0.10.0"
...
defmodule Google.Appengine.V1.Versions.Service do
  @moduledoc false
  use GRPC.Service, name: "google.appengine.v1.Versions", protoc_gen_elixir_version: "0.10.0"
...
defmodule Google.Appengine.V1.Instances.Service do
  @moduledoc false
  use GRPC.Service, name: "google.appengine.v1.Instances", protoc_gen_elixir_version: "0.10.0"
...
defmodule Google.Appengine.V1.Firewall.Service do
  @moduledoc false
  use GRPC.Service, name: "google.appengine.v1.Firewall", protoc_gen_elixir_version: "0.10.0"
