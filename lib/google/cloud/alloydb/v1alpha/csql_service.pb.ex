defmodule Google.Cloud.Alloydb.V1alpha.RestoreFromCloudSQLRequest do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1alpha.AlloyDBCSQLAdmin.Service do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1alpha.AlloyDBCSQLAdmin.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Alloydb.V1alpha.AlloyDBCSQLAdmin.Service
end
