...
defmodule Google.Cloud.Alloydb.V1beta.Instance.ActivationPolicy do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.SupportedDatabaseFlag.Scope do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.MaintenanceUpdatePolicy.DenyMaintenancePeriod do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.MaintenanceUpdatePolicy do
  ...
  field :deny_maintenance_periods, 2,
    repeated: true,
    type: Google.Cloud.Alloydb.V1beta.MaintenanceUpdatePolicy.DenyMaintenancePeriod,
...
defmodule Google.Cloud.Alloydb.V1beta.Cluster do
  ...
  field :service_account_email, 46,
    type: :string,
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.ObservabilityInstanceConfig do
  ...
  field :assistive_experiences_enabled, 10,
    proto3_optional: true,
    type: :bool,
    json_name: "assistiveExperiencesEnabled"
end
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.PscInterfaceConfig do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.PscAutoConnectionConfig do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.PscInstanceConfig do
  ...
  field :psc_interface_configs, 8,
    repeated: true,
    type: Google.Cloud.Alloydb.V1beta.Instance.PscInterfaceConfig,
    json_name: "pscInterfaceConfigs",
    deprecated: false

  field :psc_auto_connections, 9,
    repeated: true,
    type: Google.Cloud.Alloydb.V1beta.Instance.PscAutoConnectionConfig,
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.ConnectionPoolConfig.FlagsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.Instance.ConnectionPoolConfig do
  @moduledoc false
...
defmodule Google.Cloud.Alloydb.V1beta.Instance do
  ...
  field :activation_policy, 35,
    type: Google.Cloud.Alloydb.V1beta.Instance.ActivationPolicy,
    json_name: "activationPolicy",
    enum: true,
    deprecated: false

  field :connection_pool_config, 37,
    type: Google.Cloud.Alloydb.V1beta.Instance.ConnectionPoolConfig,
    json_name: "connectionPoolConfig",
    deprecated: false

  field :gca_config, 38,
    type: Google.Cloud.Alloydb.V1beta.GCAInstanceConfig,
    json_name: "gcaConfig",
    deprecated: false
end
...
defmodule Google.Cloud.Alloydb.V1beta.SupportedDatabaseFlag do
  ...
  field :scope, 9, type: Google.Cloud.Alloydb.V1beta.SupportedDatabaseFlag.Scope, enum: true
end
