...
defmodule Google.Cloud.Websecurityscanner.V1alpha.Finding do
  ...
  field :outdated_library, 11, type: Google.Cloud.Websecurityscanner.V1alpha.OutdatedLibrary
  field :violating_resource, 12, type: Google.Cloud.Websecurityscanner.V1alpha.ViolatingResource
  field :vulnerable_headers, 15, type: Google.Cloud.Websecurityscanner.V1alpha.VulnerableHeaders
