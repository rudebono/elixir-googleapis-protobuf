...
defmodule Google.Cloud.Websecurityscanner.V1alpha.ScanRun do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          execution_state: Google.Cloud.Websecurityscanner.V1alpha.ScanRun.ExecutionState.t(),
          result_state: Google.Cloud.Websecurityscanner.V1alpha.ScanRun.ResultState.t(),
