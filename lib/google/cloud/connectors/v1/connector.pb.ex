defmodule Google.Cloud.Connectors.V1.Connector.LabelsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Connectors.V1.Connector do
  @moduledoc false
  ...
  field :labels, 4,
    repeated: true,
    type: Google.Cloud.Connectors.V1.Connector.LabelsEntry,
    map: true,
    deprecated: false
...
defmodule Google.Cloud.Connectors.V1.GetConnectorRequest do
  @moduledoc false
...
defmodule Google.Cloud.Connectors.V1.ListConnectorsRequest do
  @moduledoc false
...
defmodule Google.Cloud.Connectors.V1.ListConnectorsResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :connectors, 1, repeated: true, type: Google.Cloud.Connectors.V1.Connector
