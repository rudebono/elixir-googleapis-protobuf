...
defmodule Google.Cloud.Talent.V4.Job.DerivedInfo do
  ...
  field :job_categories, 3, repeated: true, type: Google.Cloud.Talent.V4.JobCategory, enum: true
end
...
defmodule Google.Cloud.Talent.V4.Job.ProcessingOptions do
  ...
  field :html_sanitization, 2, type: Google.Cloud.Talent.V4.HtmlSanitization, enum: true
end
...
defmodule Google.Cloud.Talent.V4.Job do
  ...
  field :application_info, 7, type: Google.Cloud.Talent.V4.Job.ApplicationInfo
  field :job_benefits, 8, repeated: true, type: Google.Cloud.Talent.V4.JobBenefit, enum: true
  field :compensation_info, 9, type: Google.Cloud.Talent.V4.CompensationInfo
  ...
  field :degree_types, 11, repeated: true, type: Google.Cloud.Talent.V4.DegreeType, enum: true
  ...
  field :job_level, 16, type: Google.Cloud.Talent.V4.JobLevel, enum: true
  field :promotion_value, 17, type: :int32
  field :qualifications, 18, type: :string
  field :responsibilities, 19, type: :string
  field :posting_region, 20, type: Google.Cloud.Talent.V4.PostingRegion, enum: true
  ...
  field :derived_info, 29, type: Google.Cloud.Talent.V4.Job.DerivedInfo
  field :processing_options, 30, type: Google.Cloud.Talent.V4.Job.ProcessingOptions
end
