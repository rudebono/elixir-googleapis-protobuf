...
defmodule Google.Cloud.Talent.V4.Job do
  ...
  field :job_level, 16, type: Google.Cloud.Talent.V4.JobLevel, json_name: "jobLevel", enum: true
  ...
  field :visibility, 21, type: Google.Cloud.Talent.V4.Visibility, enum: true, deprecated: true
  ...
  field :derived_info, 29,
    type: Google.Cloud.Talent.V4.Job.DerivedInfo,
