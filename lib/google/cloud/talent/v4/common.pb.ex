...
defmodule Google.Cloud.Talent.V4.Location do
  ...
  field :location_type, 1, type: Google.Cloud.Talent.V4.Location.LocationType, enum: true
...
defmodule Google.Cloud.Talent.V4.RequestMetadata do
  ...
  field :device_info, 5, type: Google.Cloud.Talent.V4.DeviceInfo
end
...
defmodule Google.Cloud.Talent.V4.DeviceInfo do
  ...
  field :device_type, 1, type: Google.Cloud.Talent.V4.DeviceInfo.DeviceType, enum: true
...
defmodule Google.Cloud.Talent.V4.CustomAttribute do
  ...
  field :keyword_searchable, 4, type: :bool
end
