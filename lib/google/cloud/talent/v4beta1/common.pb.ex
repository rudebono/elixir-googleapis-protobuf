...
defmodule Google.Cloud.Talent.V4beta1.Location do
  ...
  field :location_type, 1, type: Google.Cloud.Talent.V4beta1.Location.LocationType, enum: true
  field :postal_address, 2, type: Google.Type.PostalAddress
  field :lat_lng, 3, type: Google.Type.LatLng
  field :radius_miles, 4, type: :double
end
...
defmodule Google.Cloud.Talent.V4beta1.RequestMetadata do
  ...
  field :allow_missing_ids, 4, type: :bool
  field :device_info, 5, type: Google.Cloud.Talent.V4beta1.DeviceInfo
end
...
defmodule Google.Cloud.Talent.V4beta1.DeviceInfo do
  ...
  field :device_type, 1, type: Google.Cloud.Talent.V4beta1.DeviceInfo.DeviceType, enum: true
...
defmodule Google.Cloud.Talent.V4beta1.CustomAttribute do
  ...
  field :long_values, 2, repeated: true, type: :int64
...
defmodule Google.Cloud.Talent.V4beta1.SpellingCorrection do
  ...
  field :corrected_text, 2, type: :string
  field :corrected_html, 3, type: :string
end
...
defmodule Google.Cloud.Talent.V4beta1.CompensationInfo.CompensationEntry do
  ...
  field :expected_units_per_year, 6, type: Google.Protobuf.DoubleValue
end
...
defmodule Google.Cloud.Talent.V4beta1.CompensationInfo.CompensationRange do
  ...
  field :max_compensation, 2, type: Google.Type.Money
  field :min_compensation, 1, type: Google.Type.Money
end
...
defmodule Google.Cloud.Talent.V4beta1.Certification do
  ...
  field :acquire_date, 2, type: Google.Type.Date
  field :expire_date, 3, type: Google.Type.Date
...
defmodule Google.Cloud.Talent.V4beta1.BatchOperationMetadata do
  ...
  field :state_description, 2, type: :string
  field :success_count, 3, type: :int32
  field :failure_count, 4, type: :int32
  field :total_count, 5, type: :int32
