...
defmodule Google.Cloud.Talent.V4beta1.Application do
  ...
  field :external_id, 31, type: :string
  field :profile, 2, type: :string
  field :job, 4, type: :string
  field :company, 5, type: :string
  field :application_date, 7, type: Google.Type.Date
  ...
  field :create_time, 19, type: Google.Protobuf.Timestamp
  field :update_time, 20, type: Google.Protobuf.Timestamp
  field :outcome_notes, 21, type: :string
  field :outcome, 22, type: Google.Cloud.Talent.V4beta1.Outcome, enum: true
  field :is_match, 28, type: Google.Protobuf.BoolValue
  field :job_title_snippet, 29, type: :string
end
