...
defmodule Google.Cloud.Backupdr.Logging.V1.MountedImage do
  ...
  field :source_image_type, 7, type: :string, json_name: "sourceImageType"
  ...
  field :resource_virtual_size_in_gib, 16, type: :double, json_name: "resourceVirtualSizeInGib"
  field :storage_consumed_in_gib, 17, type: :double, json_name: "storageConsumedInGib"
  ...
  field :mounted_image_age_in_days, 20, type: :int32, json_name: "mountedImageAgeInDays"
