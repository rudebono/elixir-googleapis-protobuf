defmodule Google.Cloud.Networkanalyzer.Logging.V1.ReportCauseCode do
  ...
  field :ROUTE_INVALID_NEXT_HOP_ILB_VIP_NOT_ASSIGNED, 7
  field :ROUTE_INVALID_NEXT_HOP_VM_WRONG_NETWORK, 8
  field :ROUTE_INVALID_NEXT_HOP_VM_NON_PRIMARY_IP, 9
  field :ROUTE_INVALID_NEXT_HOP_VPN_TUNNEL_NOT_ESTABLISHED, 10
  field :ROUTE_INVALID_NEXT_HOP_IP_NOT_ASSIGNED, 11
  field :ROUTE_INVALID_NEXT_HOP_FORWARDING_RULE_IP_MISMATCH, 12
  field :ROUTE_INVALID_NEXT_HOP_FORWARDING_RULE_TYPE_INVALID, 13
  field :IP_UTILIZATION_IP_ALLOCATION_RATIO_HIGH, 20
  field :IP_UTILIZATION_IP_ALLOCATION_SUMMARY, 21
  ...
  field :GKE_NODE_SERVICE_ACCOUNT_SERVICE_ACCOUNT_DISABLED, 243
  field :GKE_NODE_SERVICE_ACCOUNT_DEFAULT_SERVICE_ACCOUNT_USED, 244
  field :GKE_NODE_SERVICE_ACCOUNT_BAD_OAUTH_SCOPES, 245
  field :GKE_IP_MASQ_AGENT_CONFIG_MAP_NOT_COVERING_POD_CIDR, 251
  field :GKE_IP_MASQ_AGENT_CUSTOM_CONFIG_NOT_COVERING_POD_CIDR, 252
  ...
  field :DYNAMIC_ROUTE_SHADOWED_FULLY_SHADOWED_BY_NCC_SUBNET_ROUTE, 821
  field :NCC_DYNAMIC_ROUTE_SHADOWED_FULLY_SHADOWED_BY_SUBNET_ROUTE, 822
  field :NCC_DYNAMIC_ROUTE_SHADOWED_FULLY_SHADOWED_BY_PEERING_SUBNET_ROUTE, 823
  field :NCC_DYNAMIC_ROUTE_SHADOWED_FULLY_SHADOWED_BY_STATIC_ROUTE, 824
