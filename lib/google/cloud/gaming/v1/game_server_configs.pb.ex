...
defmodule Google.Cloud.Gaming.V1.ListGameServerConfigsResponse do
  ...
  field :game_server_configs, 1, repeated: true, type: Google.Cloud.Gaming.V1.GameServerConfig
...
defmodule Google.Cloud.Gaming.V1.CreateGameServerConfigRequest do
  ...
  field :game_server_config, 3, type: Google.Cloud.Gaming.V1.GameServerConfig
end
...
defmodule Google.Cloud.Gaming.V1.GameServerConfig do
  ...
  field :fleet_configs, 5, repeated: true, type: Google.Cloud.Gaming.V1.FleetConfig
  field :scaling_configs, 6, repeated: true, type: Google.Cloud.Gaming.V1.ScalingConfig
