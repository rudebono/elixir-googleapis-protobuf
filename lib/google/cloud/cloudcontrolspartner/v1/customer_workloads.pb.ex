...
defmodule Google.Cloud.Cloudcontrolspartner.V1.Workload do
  ...
  field :workload_onboarding_state, 5,
    type: Google.Cloud.Cloudcontrolspartner.V1.WorkloadOnboardingState,
  ...
  field :partner, 9, type: Google.Cloud.Cloudcontrolspartner.V1.Workload.Partner, enum: true
end
...
defmodule Google.Cloud.Cloudcontrolspartner.V1.WorkloadOnboardingState do
  ...
  field :onboarding_steps, 1,
    repeated: true,
    type: Google.Cloud.Cloudcontrolspartner.V1.WorkloadOnboardingStep,
