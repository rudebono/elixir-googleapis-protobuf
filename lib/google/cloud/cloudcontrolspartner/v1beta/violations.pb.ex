...
defmodule Google.Cloud.Cloudcontrolspartner.V1beta.Violation.Remediation.Instructions do
  ...
  field :console_instructions, 2,
    type: Google.Cloud.Cloudcontrolspartner.V1beta.Violation.Remediation.Instructions.Console,
...
defmodule Google.Cloud.Cloudcontrolspartner.V1beta.Violation.Remediation do
  ...
  field :remediation_type, 3,
    type: Google.Cloud.Cloudcontrolspartner.V1beta.Violation.Remediation.RemediationType,
...
defmodule Google.Cloud.Cloudcontrolspartner.V1beta.Violation do
  ...
  field :state, 7,
    type: Google.Cloud.Cloudcontrolspartner.V1beta.Violation.State,
    enum: true,
    deprecated: false
  ...
  field :remediation, 13,
    type: Google.Cloud.Cloudcontrolspartner.V1beta.Violation.Remediation,
    deprecated: false
end
