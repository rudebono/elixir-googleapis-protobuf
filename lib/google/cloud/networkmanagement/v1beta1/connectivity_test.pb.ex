...
defmodule Google.Cloud.Networkmanagement.V1beta1.ConnectivityTest do
  ...
  field :probing_details, 14, type: Google.Cloud.Networkmanagement.V1beta1.ProbingDetails
end
...
defmodule Google.Cloud.Networkmanagement.V1beta1.LatencyPercentile do
  ...
  field :latency_micros, 2, type: :int64
end
...
defmodule Google.Cloud.Networkmanagement.V1beta1.ProbingDetails do
  ...
  field :sent_probe_count, 5, type: :int32
  field :successful_probe_count, 6, type: :int32
  field :endpoint_info, 7, type: Google.Cloud.Networkmanagement.V1beta1.EndpointInfo
  field :probing_latency, 8, type: Google.Cloud.Networkmanagement.V1beta1.LatencyDistribution
end
