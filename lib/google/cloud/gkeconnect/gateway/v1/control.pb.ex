defmodule Google.Cloud.Gkeconnect.Gateway.V1.GenerateCredentialsRequest.OperatingSystem do
  @moduledoc false
...
defmodule Google.Cloud.Gkeconnect.Gateway.V1.GenerateCredentialsRequest do
  @moduledoc false
  ...
  field :operating_system, 5,
    type: Google.Cloud.Gkeconnect.Gateway.V1.GenerateCredentialsRequest.OperatingSystem,
    json_name: "operatingSystem",
    enum: true,
    deprecated: false
end

defmodule Google.Cloud.Gkeconnect.Gateway.V1.GenerateCredentialsResponse do
  @moduledoc false
...
defmodule Google.Cloud.Gkeconnect.Gateway.V1.GatewayControl.Service do
  @moduledoc false
...
defmodule Google.Cloud.Gkeconnect.Gateway.V1.GatewayControl.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Gkeconnect.Gateway.V1.GatewayControl.Service
end
