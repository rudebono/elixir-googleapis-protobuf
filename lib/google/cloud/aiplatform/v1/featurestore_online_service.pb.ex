defmodule Google.Cloud.Aiplatform.V1.ReadFeatureValuesRequest do
  ...
  field :feature_selector, 3, type: Google.Cloud.Aiplatform.V1.FeatureSelector
end
...
defmodule Google.Cloud.Aiplatform.V1.ReadFeatureValuesResponse do
  ...
  field :entity_view, 2, type: Google.Cloud.Aiplatform.V1.ReadFeatureValuesResponse.EntityView
end
...
defmodule Google.Cloud.Aiplatform.V1.FeatureValue do
  ...
  field :bool_array_value, 7, type: Google.Cloud.Aiplatform.V1.BoolArray, oneof: 0
  field :double_array_value, 8, type: Google.Cloud.Aiplatform.V1.DoubleArray, oneof: 0
  field :int64_array_value, 11, type: Google.Cloud.Aiplatform.V1.Int64Array, oneof: 0
  field :string_array_value, 12, type: Google.Cloud.Aiplatform.V1.StringArray, oneof: 0
