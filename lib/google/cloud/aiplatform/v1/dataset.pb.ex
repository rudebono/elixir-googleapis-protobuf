...
defmodule Google.Cloud.Aiplatform.V1.Dataset do
  ...
  field :encryption_spec, 11, type: Google.Cloud.Aiplatform.V1.EncryptionSpec
end
...
defmodule Google.Cloud.Aiplatform.V1.ImportDataConfig do
  ...
  oneof :source, 0
  field :gcs_source, 1, type: Google.Cloud.Aiplatform.V1.GcsSource, oneof: 0
  ...
  field :import_schema_uri, 4, type: :string
end
...
defmodule Google.Cloud.Aiplatform.V1.ExportDataConfig do
  ...
  oneof :destination, 0
  field :gcs_destination, 1, type: Google.Cloud.Aiplatform.V1.GcsDestination, oneof: 0
  field :annotations_filter, 2, type: :string
end
