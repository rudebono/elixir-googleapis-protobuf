defmodule Google.Cloud.Aiplatform.V1.Tensor.DataType do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.Tensor.StructValEntry do
  @moduledoc false

  use Protobuf, map: true, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :key, 1, type: :string
  field :value, 2, type: Google.Cloud.Aiplatform.V1.Tensor
end

defmodule Google.Cloud.Aiplatform.V1.Tensor do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :dtype, 1, type: Google.Cloud.Aiplatform.V1.Tensor.DataType, enum: true
  ...
  field :list_val, 11,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.Tensor,
    json_name: "listVal"

  field :struct_val, 12,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.Tensor.StructValEntry,
    json_name: "structVal",
    map: true
