...
defmodule Google.Cloud.Aiplatform.V1.ScheduleService.Service do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.ScheduleService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Aiplatform.V1.ScheduleService.Service
end
