...
defmodule Google.Cloud.Aiplatform.V1.NotebookExecutionJob.CustomEnvironmentSpec do
  ...
  field :network_spec, 3, type: Google.Cloud.Aiplatform.V1.NetworkSpec, json_name: "networkSpec"
end
...
defmodule Google.Cloud.Aiplatform.V1.NotebookExecutionJob do
  ...
  field :dataform_repository_source, 3,
    type: Google.Cloud.Aiplatform.V1.NotebookExecutionJob.DataformRepositorySource,
    json_name: "dataformRepositorySource",
    oneof: 0

  field :gcs_notebook_source, 4,
    type: Google.Cloud.Aiplatform.V1.NotebookExecutionJob.GcsNotebookSource,
    json_name: "gcsNotebookSource",
    oneof: 0

  field :direct_notebook_source, 17,
    type: Google.Cloud.Aiplatform.V1.NotebookExecutionJob.DirectNotebookSource,
  ...
  field :custom_environment_spec, 16,
    type: Google.Cloud.Aiplatform.V1.NotebookExecutionJob.CustomEnvironmentSpec,
  ...
  field :workbench_runtime, 23,
    type: Google.Cloud.Aiplatform.V1.NotebookExecutionJob.WorkbenchRuntime,
  ...
  field :job_state, 10,
    type: Google.Cloud.Aiplatform.V1.JobState,
    json_name: "jobState",
    enum: true,
    deprecated: false
