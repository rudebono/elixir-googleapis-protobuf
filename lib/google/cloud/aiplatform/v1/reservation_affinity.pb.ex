defmodule Google.Cloud.Aiplatform.V1.ReservationAffinity.Type do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.ReservationAffinity do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :reservation_affinity_type, 1,
    type: Google.Cloud.Aiplatform.V1.ReservationAffinity.Type,
