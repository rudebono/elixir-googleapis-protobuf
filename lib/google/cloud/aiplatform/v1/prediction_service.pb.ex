...
defmodule Google.Cloud.Aiplatform.V1.ExplainRequest do
  ...
  @type t :: %__MODULE__{
          ...
          instances: [Google.Protobuf.Value.t()],
          parameters: Google.Protobuf.Value.t() | nil,
          explanation_spec_override: Google.Cloud.Aiplatform.V1.ExplanationSpecOverride.t() | nil,
          deployed_model_id: String.t()
        }
  ...
  field :explanation_spec_override, 5, type: Google.Cloud.Aiplatform.V1.ExplanationSpecOverride
...
defmodule Google.Cloud.Aiplatform.V1.ExplainResponse do
  ...
  @type t :: %__MODULE__{
          explanations: [Google.Cloud.Aiplatform.V1.Explanation.t()],
          deployed_model_id: String.t(),
          predictions: [Google.Protobuf.Value.t()]
        }
