defmodule Google.Cloud.Aiplatform.V1.EvaluatedAnnotation.EvaluatedAnnotationType do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation.QueryType do
  @moduledoc false
  use Protobuf, enum: true, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Cloud.Aiplatform.V1.EvaluatedAnnotation do
  @moduledoc false
  ...
  field :explanations, 8,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.EvaluatedAnnotationExplanation

  field :error_analysis_annotations, 9,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation,
    json_name: "errorAnalysisAnnotations"
end

defmodule Google.Cloud.Aiplatform.V1.EvaluatedAnnotationExplanation do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :explanation_type, 1, type: :string, json_name: "explanationType"
  field :explanation, 2, type: Google.Cloud.Aiplatform.V1.Explanation
end

defmodule Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation.AttributedItem do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :attributed_items, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation.AttributedItem,
    json_name: "attributedItems"

  field :query_type, 2,
    type: Google.Cloud.Aiplatform.V1.ErrorAnalysisAnnotation.QueryType,
    json_name: "queryType",
    enum: true
