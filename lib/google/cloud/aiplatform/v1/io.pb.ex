...
defmodule Google.Cloud.Aiplatform.V1.GoogleDriveSource do
  ...
  field :resource_ids, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.GoogleDriveSource.ResourceId,
...
defmodule Google.Cloud.Aiplatform.V1.SlackSource.SlackChannels do
  ...
  field :channels, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.SlackSource.SlackChannels.SlackChannel,
    deprecated: false
...
defmodule Google.Cloud.Aiplatform.V1.SlackSource do
  ...
  field :channels, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.SlackSource.SlackChannels,
    deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1.JiraSource do
  ...
  field :jira_queries, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.JiraSource.JiraQueries,
...
defmodule Google.Cloud.Aiplatform.V1.SharePointSources do
  ...
  field :share_point_sources, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.SharePointSources.SharePointSource,
