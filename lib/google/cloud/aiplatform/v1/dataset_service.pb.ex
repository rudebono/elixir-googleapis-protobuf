...
defmodule Google.Cloud.Aiplatform.V1.ImportDataRequest do
  ...
  field :name, 1, type: :string
  field :import_configs, 2, repeated: true, type: Google.Cloud.Aiplatform.V1.ImportDataConfig
end
...
defmodule Google.Cloud.Aiplatform.V1.ExportDataRequest do
  ...
  field :name, 1, type: :string
  field :export_config, 2, type: Google.Cloud.Aiplatform.V1.ExportDataConfig
end
...
defmodule Google.Cloud.Aiplatform.V1.ListDataItemsResponse do
  ...
  field :data_items, 1, repeated: true, type: Google.Cloud.Aiplatform.V1.DataItem
  field :next_page_token, 2, type: :string
end
