...
defmodule Google.Cloud.Aiplatform.V1.PublisherModel.CallToAction.RegionalResourceReferences do
  ...
  field :references, 1,
    repeated: true,
    type:
      Google.Cloud.Aiplatform.V1.PublisherModel.CallToAction.RegionalResourceReferences.ReferencesEntry,
    map: true,
    deprecated: false
...
defmodule Google.Cloud.Aiplatform.V1.PublisherModel.CallToAction.ViewRestApi do
  ...
  field :documentations, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.PublisherModel.Documentation,
    deprecated: false
...
defmodule Google.Cloud.Aiplatform.V1.PublisherModel.CallToAction.Deploy do
  ...
  field :large_model_reference, 2,
    type: Google.Cloud.Aiplatform.V1.LargeModelReference,
...
defmodule Google.Cloud.Aiplatform.V1.PublisherModel do
  ...
  field :open_source_category, 7,
    type: Google.Cloud.Aiplatform.V1.PublisherModel.OpenSourceCategory,
    json_name: "openSourceCategory",
    enum: true,
    deprecated: false

  field :supported_actions, 19,
    type: Google.Cloud.Aiplatform.V1.PublisherModel.CallToAction,
