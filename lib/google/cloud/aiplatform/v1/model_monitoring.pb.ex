...
defmodule Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig do
  ...
  @type t :: %__MODULE__{
          skew_thresholds: %{String.t() => Google.Cloud.Aiplatform.V1.ThresholdConfig.t() | nil},
          attribution_score_skew_thresholds: %{
            String.t() => Google.Cloud.Aiplatform.V1.ThresholdConfig.t() | nil
          }
        }
...
defmodule Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig do
  ...
  @type t :: %__MODULE__{
          drift_thresholds: %{String.t() => Google.Cloud.Aiplatform.V1.ThresholdConfig.t() | nil},
...
defmodule Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.ExplanationConfig do
  ...
  @type t :: %__MODULE__{
          ...
          explanation_baseline:
            Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.ExplanationConfig.ExplanationBaseline.t()
            | nil
        }
...
defmodule Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig do
  ...
  @type t :: %__MODULE__{
          training_dataset:
            Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.TrainingDataset.t() | nil,
          training_prediction_skew_detection_config:
            Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.TrainingPredictionSkewDetectionConfig.t()
            | nil,
          prediction_drift_detection_config:
            Google.Cloud.Aiplatform.V1.ModelMonitoringObjectiveConfig.PredictionDriftDetectionConfig.t()
            | nil,
          explanation_config:
