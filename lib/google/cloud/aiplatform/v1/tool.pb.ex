defmodule Google.Cloud.Aiplatform.V1.Tool.PhishBlockThreshold do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.Tool.ComputerUse.Environment do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.Tool.GoogleSearch do
  ...
  field :blocking_confidence, 4,
    ...
    type: Google.Cloud.Aiplatform.V1.Tool.PhishBlockThreshold,
...
defmodule Google.Cloud.Aiplatform.V1.Tool.ComputerUse do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.Tool do
  ...
  field :url_context, 8,
    type: Google.Cloud.Aiplatform.V1.UrlContext,
    json_name: "urlContext",
    deprecated: false

  field :computer_use, 11,
    type: Google.Cloud.Aiplatform.V1.Tool.ComputerUse,
    json_name: "computerUse",
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1.UrlContext do
  @moduledoc false
