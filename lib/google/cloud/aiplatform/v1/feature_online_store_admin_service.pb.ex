...
defmodule Google.Cloud.Aiplatform.V1.ListFeatureViewSyncsResponse do
  ...
  field :feature_view_syncs, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1.FeatureViewSync,
    json_name: "featureViewSyncs"

  field :next_page_token, 2, type: :string, json_name: "nextPageToken"
end

defmodule Google.Cloud.Aiplatform.V1.FeatureOnlineStoreAdminService.Service do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1.FeatureOnlineStoreAdminService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Aiplatform.V1.FeatureOnlineStoreAdminService.Service
end
