...
defmodule Google.Cloud.Aiplatform.V1.DataLabelingJob do
  ...
  field :encryption_spec, 20, type: Google.Cloud.Aiplatform.V1.EncryptionSpec
  field :active_learning_config, 21, type: Google.Cloud.Aiplatform.V1.ActiveLearningConfig
end
...
defmodule Google.Cloud.Aiplatform.V1.ActiveLearningConfig do
  ...
  field :sample_config, 3, type: Google.Cloud.Aiplatform.V1.SampleConfig
  field :training_config, 4, type: Google.Cloud.Aiplatform.V1.TrainingConfig
end
