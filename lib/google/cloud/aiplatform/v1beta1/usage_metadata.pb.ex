defmodule Google.Cloud.Aiplatform.V1beta1.UsageMetadata.TrafficType do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.UsageMetadata do
  @moduledoc false
  ...
  field :traffic_type, 8,
    type: Google.Cloud.Aiplatform.V1beta1.UsageMetadata.TrafficType,
