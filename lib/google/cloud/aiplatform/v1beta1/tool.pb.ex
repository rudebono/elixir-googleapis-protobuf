...
defmodule Google.Cloud.Aiplatform.V1beta1.FunctionResponsePart do
  ...
  field :inline_data, 1,
    type: Google.Cloud.Aiplatform.V1beta1.FunctionResponseBlob,
    json_name: "inlineData",
    oneof: 0

  field :file_data, 2,
    type: Google.Cloud.Aiplatform.V1beta1.FunctionResponseFileData,
    json_name: "fileData",
    oneof: 0
end

defmodule Google.Cloud.Aiplatform.V1beta1.FunctionResponseBlob do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.FunctionResponseFileData do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.FunctionResponse do
  ...
  field :parts, 4,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.FunctionResponsePart,
    deprecated: false
end
