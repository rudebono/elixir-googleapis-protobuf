...
defmodule Google.Cloud.Aiplatform.V1beta1.ModelDeploymentMonitoringJob do
  ...
  field :state, 4, type: Google.Cloud.Aiplatform.V1beta1.JobState, enum: true
  ...
  field :logging_sampling_strategy, 8, type: Google.Cloud.Aiplatform.V1beta1.SamplingStrategy
...
defmodule Google.Cloud.Aiplatform.V1beta1.ModelDeploymentMonitoringObjectiveConfig do
  ...
  field :objective_config, 2, type: Google.Cloud.Aiplatform.V1beta1.ModelMonitoringObjectiveConfig
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.ModelMonitoringStatsAnomalies.FeatureHistoricStatsAnomalies do
  ...
  field :training_stats, 4, type: Google.Cloud.Aiplatform.V1beta1.FeatureStatsAnomaly
