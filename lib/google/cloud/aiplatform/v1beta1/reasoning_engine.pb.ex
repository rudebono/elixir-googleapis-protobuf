...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec.InlineSource do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec.PythonSpec do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec do
  @moduledoc false
  ...
  field :inline_source, 1,
    type: Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec.InlineSource,
    json_name: "inlineSource",
    oneof: 0

  field :python_spec, 2,
    type: Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec.PythonSpec,
...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec do
  ...
  field :source_code_spec, 11,
    type: Google.Cloud.Aiplatform.V1beta1.ReasoningEngineSpec.SourceCodeSpec,
...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngine.LabelsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.ReasoningEngine do
  ...
  field :labels, 17,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.ReasoningEngine.LabelsEntry,
    map: true
end
