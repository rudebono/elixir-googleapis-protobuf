defmodule Google.Cloud.Aiplatform.V1beta1.Schedule.State do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.Schedule do
  ...
  field :create_pipeline_job_request, 14,
    type: Google.Cloud.Aiplatform.V1beta1.CreatePipelineJobRequest,
  ...
  field :create_notebook_execution_job_request, 20,
    type: Google.Cloud.Aiplatform.V1beta1.CreateNotebookExecutionJobRequest,
  ...
  field :state, 5,
    type: Google.Cloud.Aiplatform.V1beta1.Schedule.State,
    enum: true,
    deprecated: false
