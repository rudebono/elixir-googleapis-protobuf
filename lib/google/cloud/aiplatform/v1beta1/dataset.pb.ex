...
defmodule Google.Cloud.Aiplatform.V1beta1.ImportDataConfig do
  ...
  oneof :source, 0
  field :gcs_source, 1, type: Google.Cloud.Aiplatform.V1beta1.GcsSource, oneof: 0
...
defmodule Google.Cloud.Aiplatform.V1beta1.ExportDataConfig do
  ...
  oneof :destination, 0
  field :gcs_destination, 1, type: Google.Cloud.Aiplatform.V1beta1.GcsDestination, oneof: 0
