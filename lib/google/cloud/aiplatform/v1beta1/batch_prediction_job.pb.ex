defmodule Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.InputConfig do
  ...
  oneof :source, 0
  field :gcs_source, 2, type: Google.Cloud.Aiplatform.V1beta1.GcsSource, oneof: 0
...
defmodule Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.OutputConfig do
  ...
  oneof :destination, 0
  field :gcs_destination, 2, type: Google.Cloud.Aiplatform.V1beta1.GcsDestination, oneof: 0
...
defmodule Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob do
  ...
  @type t :: %__MODULE__{
          ...
          output_info: Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.OutputInfo.t() | nil,
          state: Google.Cloud.Aiplatform.V1beta1.JobState.t(),
          error: Google.Rpc.Status.t() | nil,
          partial_failures: [Google.Rpc.Status.t()],
          resources_consumed: Google.Cloud.Aiplatform.V1beta1.ResourcesConsumed.t() | nil,
          completion_stats: Google.Cloud.Aiplatform.V1beta1.CompletionStats.t() | nil,
  ...
  field :input_config, 4, type: Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.InputConfig
  field :model_parameters, 5, type: Google.Protobuf.Value
  field :output_config, 6, type: Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.OutputConfig
  field :dedicated_resources, 7, type: Google.Cloud.Aiplatform.V1beta1.BatchDedicatedResources
  ...
  field :explanation_spec, 25, type: Google.Cloud.Aiplatform.V1beta1.ExplanationSpec
  field :output_info, 9, type: Google.Cloud.Aiplatform.V1beta1.BatchPredictionJob.OutputInfo
  ...
  field :resources_consumed, 13, type: Google.Cloud.Aiplatform.V1beta1.ResourcesConsumed
  field :completion_stats, 14, type: Google.Cloud.Aiplatform.V1beta1.CompletionStats
  ...
  field :encryption_spec, 24, type: Google.Cloud.Aiplatform.V1beta1.EncryptionSpec
end
