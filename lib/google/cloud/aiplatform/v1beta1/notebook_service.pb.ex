...
defmodule Google.Cloud.Aiplatform.V1beta1.StopNotebookRuntimeRequest do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.StopNotebookRuntimeOperationMetadata do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.StopNotebookRuntimeResponse do
  @moduledoc false
