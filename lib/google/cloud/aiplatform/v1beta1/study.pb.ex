...
defmodule Google.Cloud.Aiplatform.V1beta1.Trial do
  ...
  field :state, 3,
    type: Google.Cloud.Aiplatform.V1beta1.Trial.State,
    enum: true,
    deprecated: false

  field :parameters, 4,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.Trial.Parameter,
    deprecated: false
  ...
  field :web_access_uris, 12,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.Trial.WebAccessUrisEntry,
...
defmodule Google.Cloud.Aiplatform.V1beta1.StudyTimeConstraint do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.StudySpec.ConvexStopConfig do
  ...
  field :autoregressive_order, 3, type: :int64, json_name: "autoregressiveOrder"
  field :learning_rate_parameter_name, 4, type: :string, json_name: "learningRateParameterName"
...
defmodule Google.Cloud.Aiplatform.V1beta1.StudySpec.StudyStoppingConfig do
  @moduledoc false
  ...
  field :minimum_runtime_constraint, 2,
    type: Google.Cloud.Aiplatform.V1beta1.StudyTimeConstraint,
...
defmodule Google.Cloud.Aiplatform.V1beta1.StudySpec do
  ...
  field :convex_stop_config, 8,
    ...
    json_name: "convexStopConfig",
    oneof: 0,
    deprecated: true

  field :convex_automated_stopping_spec, 9,
    type: Google.Cloud.Aiplatform.V1beta1.StudySpec.ConvexAutomatedStoppingSpec,
    json_name: "convexAutomatedStoppingSpec",
    oneof: 0

  field :metrics, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.StudySpec.MetricSpec,
    deprecated: false
  ...
  field :study_stopping_config, 11,
    proto3_optional: true,
    type: Google.Cloud.Aiplatform.V1beta1.StudySpec.StudyStoppingConfig,
...
defmodule Google.Cloud.Aiplatform.V1beta1.Measurement do
  ...
  field :metrics, 3,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.Measurement.Metric,
    deprecated: false
end