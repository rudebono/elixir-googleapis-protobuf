...
defmodule Google.Cloud.Aiplatform.V1beta1.GenerationConfig.ThinkingConfig do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.GenerationConfig do
  ...
  field :thinking_config, 25,
    type: Google.Cloud.Aiplatform.V1beta1.GenerationConfig.ThinkingConfig,
...
defmodule Google.Cloud.Aiplatform.V1beta1.Candidate do
  ...
  field :url_context_metadata, 11,
    type: Google.Cloud.Aiplatform.V1beta1.UrlContextMetadata,
    json_name: "urlContextMetadata",
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1beta1.UrlContextMetadata do
  @moduledoc false
  ...
  field :url_metadata, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.UrlMetadata,
    json_name: "urlMetadata",
    deprecated: false
end

defmodule Google.Cloud.Aiplatform.V1beta1.UrlMetadata do
  @moduledoc false
  ...
  field :url_retrieval_status, 2,
    type: Google.Cloud.Aiplatform.V1beta1.UrlMetadata.UrlRetrievalStatus,
...
defmodule Google.Cloud.Aiplatform.V1beta1.GroundingChunk do
  ...
  field :maps, 3, type: Google.Cloud.Aiplatform.V1beta1.GroundingChunk.Maps, oneof: 0
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.ModalityTokenCount do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :modality, 1, type: Google.Cloud.Aiplatform.V1beta1.Modality, enum: true
