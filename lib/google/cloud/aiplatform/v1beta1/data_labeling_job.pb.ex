...
defmodule Google.Cloud.Aiplatform.V1beta1.DataLabelingJob do
  ...
  field :labeler_count, 4, type: :int32
  field :instruction_uri, 5, type: :string
  field :inputs_schema_uri, 6, type: :string
  field :inputs, 7, type: Google.Protobuf.Value
  field :state, 8, type: Google.Cloud.Aiplatform.V1beta1.JobState, enum: true
  field :labeling_progress, 13, type: :int32
  field :current_spend, 14, type: Google.Type.Money
  ...
  field :specialist_pools, 16, repeated: true, type: :string
  field :encryption_spec, 20, type: Google.Cloud.Aiplatform.V1beta1.EncryptionSpec
  field :active_learning_config, 21, type: Google.Cloud.Aiplatform.V1beta1.ActiveLearningConfig
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.ActiveLearningConfig do
  ...
  @type t :: %__MODULE__{
          human_labeling_budget: {atom, any},
  ...
  field :max_data_item_count, 1, type: :int64, oneof: 0
  field :max_data_item_percentage, 2, type: :int32, oneof: 0
  field :sample_config, 3, type: Google.Cloud.Aiplatform.V1beta1.SampleConfig
  field :training_config, 4, type: Google.Cloud.Aiplatform.V1beta1.TrainingConfig
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.SampleConfig do
  ...
  @type t :: %__MODULE__{
          initial_batch_sample_size: {atom, any},
          following_batch_sample_size: {atom, any},
  ...
  field :initial_batch_sample_percentage, 1, type: :int32, oneof: 0
  field :following_batch_sample_percentage, 3, type: :int32, oneof: 1
...
defmodule Google.Cloud.Aiplatform.V1beta1.TrainingConfig do
  ...
  field :timeout_training_milli_hours, 1, type: :int64
end
