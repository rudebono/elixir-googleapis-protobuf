...
defmodule Google.Cloud.Aiplatform.V1beta1.CustomJob do
  ...
  field :job_spec, 4, type: Google.Cloud.Aiplatform.V1beta1.CustomJobSpec, json_name: "jobSpec"
...
defmodule Google.Cloud.Aiplatform.V1beta1.WorkerPoolSpec do
  ...
  @type t :: %__MODULE__{
          task:
            {:container_spec, Google.Cloud.Aiplatform.V1beta1.ContainerSpec.t() | nil}
