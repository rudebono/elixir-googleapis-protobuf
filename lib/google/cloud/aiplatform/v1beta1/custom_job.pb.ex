...
defmodule Google.Cloud.Aiplatform.V1beta1.CustomJob do
  ...
  @type t :: %__MODULE__{
          ...
          job_spec: Google.Cloud.Aiplatform.V1beta1.CustomJobSpec.t() | nil,
  ...
  field :job_spec, 4, type: Google.Cloud.Aiplatform.V1beta1.CustomJobSpec
  field :state, 5, type: Google.Cloud.Aiplatform.V1beta1.JobState, enum: true
  ...
  field :encryption_spec, 12, type: Google.Cloud.Aiplatform.V1beta1.EncryptionSpec
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.CustomJobSpec do
  ...
  @type t :: %__MODULE__{
          worker_pool_specs: [Google.Cloud.Aiplatform.V1beta1.WorkerPoolSpec.t()],
  ...
  field :base_output_directory, 6, type: Google.Cloud.Aiplatform.V1beta1.GcsDestination
...
defmodule Google.Cloud.Aiplatform.V1beta1.WorkerPoolSpec do
  ...
  oneof :task, 0
  field :container_spec, 6, type: Google.Cloud.Aiplatform.V1beta1.ContainerSpec, oneof: 0
  field :python_package_spec, 7, type: Google.Cloud.Aiplatform.V1beta1.PythonPackageSpec, oneof: 0
  field :machine_spec, 1, type: Google.Cloud.Aiplatform.V1beta1.MachineSpec
  field :replica_count, 2, type: :int64
  field :disk_spec, 5, type: Google.Cloud.Aiplatform.V1beta1.DiskSpec
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.ContainerSpec do
  ...
  defstruct [:image_uri, :command, :args]
...
defmodule Google.Cloud.Aiplatform.V1beta1.PythonPackageSpec do
  ...
  defstruct [:executor_image_uri, :package_uris, :python_module, :args]
