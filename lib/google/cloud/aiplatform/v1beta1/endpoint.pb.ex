...
defmodule Google.Cloud.Aiplatform.V1beta1.Endpoint do
  ...
  field :deployed_models, 4, repeated: true, type: Google.Cloud.Aiplatform.V1beta1.DeployedModel
...
defmodule Google.Cloud.Aiplatform.V1beta1.DeployedModel do
  ...
  field :explanation_spec, 9, type: Google.Cloud.Aiplatform.V1beta1.ExplanationSpec
