...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJob do
  ...
  field :nas_job_spec, 4,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec,
    json_name: "nasJobSpec",
    deprecated: false

  field :nas_job_output, 5,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobOutput,
  ...
  field :labels, 12,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.NasJob.LabelsEntry,
    map: true
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasTrialDetail do
  ...
  field :search_trial, 3, type: Google.Cloud.Aiplatform.V1beta1.NasTrial, json_name: "searchTrial"
  field :train_trial, 4, type: Google.Cloud.Aiplatform.V1beta1.NasTrial, json_name: "trainTrial"
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec do
  ...
  field :goal, 2,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec.GoalType,
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec do
  ...
  field :metric, 2,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec.MetricSpec

  field :search_trial_spec, 3,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec.SearchTrialSpec,
    json_name: "searchTrialSpec",
    deprecated: false

  field :train_trial_spec, 4,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec.TrainTrialSpec,
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJobSpec do
  ...
  field :multi_trial_algorithm_spec, 2,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobSpec.MultiTrialAlgorithmSpec,
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJobOutput.MultiTrialJobOutput do
  ...
  field :search_trials, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.NasTrial,
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasJobOutput do
  ...
  field :multi_trial_job_output, 1,
    type: Google.Cloud.Aiplatform.V1beta1.NasJobOutput.MultiTrialJobOutput,
...
defmodule Google.Cloud.Aiplatform.V1beta1.NasTrial do
  ...
  field :state, 2,
    type: Google.Cloud.Aiplatform.V1beta1.NasTrial.State,
    enum: true,
    deprecated: false
