...
defmodule Google.Cloud.Aiplatform.V1beta1.PipelineJob do
  ...
  field :state, 8, type: Google.Cloud.Aiplatform.V1beta1.PipelineState, enum: true
  field :job_detail, 9, type: Google.Cloud.Aiplatform.V1beta1.PipelineJobDetail
  ...
  field :runtime_config, 12, type: Google.Cloud.Aiplatform.V1beta1.PipelineJob.RuntimeConfig
  field :encryption_spec, 16, type: Google.Cloud.Aiplatform.V1beta1.EncryptionSpec
...
defmodule Google.Cloud.Aiplatform.V1beta1.PipelineJobDetail do
  ...
  field :pipeline_context, 1, type: Google.Cloud.Aiplatform.V1beta1.Context
  field :pipeline_run_context, 2, type: Google.Cloud.Aiplatform.V1beta1.Context
...
defmodule Google.Cloud.Aiplatform.V1beta1.PipelineTaskDetail do
  ...
  field :start_time, 4, type: Google.Protobuf.Timestamp
  field :end_time, 5, type: Google.Protobuf.Timestamp
  field :executor_detail, 6, type: Google.Cloud.Aiplatform.V1beta1.PipelineTaskExecutorDetail
