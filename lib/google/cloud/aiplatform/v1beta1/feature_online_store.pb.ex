defmodule Google.Cloud.Aiplatform.V1beta1.FeatureOnlineStore.State do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.FeatureOnlineStore.Bigtable.AutoScaling do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.FeatureOnlineStore.LabelsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.FeatureOnlineStore do
  @moduledoc false
  ...
  field :labels, 6,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.FeatureOnlineStore.LabelsEntry,
    map: true,
    deprecated: false
