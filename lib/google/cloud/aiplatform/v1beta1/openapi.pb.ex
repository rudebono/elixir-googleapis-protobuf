defmodule Google.Cloud.Aiplatform.V1beta1.Type do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.Schema.PropertiesEntry do
  @moduledoc false

  use Protobuf, map: true, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :key, 1, type: :string
  field :value, 2, type: Google.Cloud.Aiplatform.V1beta1.Schema
end

defmodule Google.Cloud.Aiplatform.V1beta1.Schema.DefsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Aiplatform.V1beta1.Schema do
  @moduledoc false
  ...
  field :properties, 3,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.Schema.PropertiesEntry,
    map: true,
    deprecated: false
  ...
  field :defs, 28,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.Schema.DefsEntry,
    map: true,
    deprecated: false
end
