defmodule Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.SliceConfig do
  ...
  field :value, 1,
    type: Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.Value,
    oneof: 0

  field :range, 2,
    type: Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.Range,
    oneof: 0
...
defmodule Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntry do
  ...
  field :value, 2,
    type: Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.SliceConfig
end
...
defmodule Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec do
  ...
  field :configs, 1,
    repeated: true,
    type: Google.Cloud.Aiplatform.V1beta1.ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntry,
    map: true
end
