defmodule Google.Cloud.Speech.V1.CreatePhraseSetRequest do
  ...
  @type t :: %__MODULE__{
          ...
          phrase_set: Google.Cloud.Speech.V1.PhraseSet.t() | nil
        }
...
defmodule Google.Cloud.Speech.V1.CreateCustomClassRequest do
  ...
  @type t :: %__MODULE__{
          ...
          custom_class: Google.Cloud.Speech.V1.CustomClass.t() | nil
        }
...
defmodule Google.Cloud.Speech.V1.Adaptation.Service do
  @moduledoc false
  use GRPC.Service, name: "google.cloud.speech.v1.Adaptation"
