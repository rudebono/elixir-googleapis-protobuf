...
defmodule Google.Cloud.Texttospeech.V1beta1.MultispeakerPrebuiltVoice do
  @moduledoc false
...
defmodule Google.Cloud.Texttospeech.V1beta1.MultiSpeakerVoiceConfig do
  @moduledoc false
  ...
  field :speaker_voice_configs, 2,
    repeated: true,
    type: Google.Cloud.Texttospeech.V1beta1.MultispeakerPrebuiltVoice,
...
defmodule Google.Cloud.Texttospeech.V1beta1.VoiceSelectionParams do
  ...
  field :multi_speaker_voice_config, 7,
    type: Google.Cloud.Texttospeech.V1beta1.MultiSpeakerVoiceConfig,
