...
defmodule Google.Cloud.Recommender.V1beta1.Recommendation do
  ...
  field :primary_impact, 5, type: Google.Cloud.Recommender.V1beta1.Impact
  field :additional_impact, 6, repeated: true, type: Google.Cloud.Recommender.V1beta1.Impact
  field :content, 7, type: Google.Cloud.Recommender.V1beta1.RecommendationContent
  field :state_info, 10, type: Google.Cloud.Recommender.V1beta1.RecommendationStateInfo
...
defmodule Google.Cloud.Recommender.V1beta1.Operation do
  ...
  field :value_matcher, 10, type: Google.Cloud.Recommender.V1beta1.ValueMatcher, oneof: 0
...
defmodule Google.Cloud.Recommender.V1beta1.Impact do
  ...
  field :cost_projection, 100, type: Google.Cloud.Recommender.V1beta1.CostProjection, oneof: 0
end
