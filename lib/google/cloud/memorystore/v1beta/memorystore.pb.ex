...
defmodule Google.Cloud.Memorystore.V1beta.Instance.StateInfo do
  ...
  field :update_info, 1,
    type: Google.Cloud.Memorystore.V1beta.Instance.StateInfo.UpdateInfo,
...
defmodule Google.Cloud.Memorystore.V1beta.Instance.InstanceEndpoint do
  ...
  field :connections, 1,
    repeated: true,
    type: Google.Cloud.Memorystore.V1beta.Instance.ConnectionDetail,
    deprecated: false
end
...
defmodule Google.Cloud.Memorystore.V1beta.Instance.ConnectionDetail do
  ...
  field :psc_auto_connection, 1,
    type: Google.Cloud.Memorystore.V1beta.PscAutoConnection,
    json_name: "pscAutoConnection",
    oneof: 0

  field :psc_connection, 2,
    type: Google.Cloud.Memorystore.V1beta.PscConnection,
...
defmodule Google.Cloud.Memorystore.V1beta.Instance do
  ...
  field :labels, 4,
    repeated: true,
    type: Google.Cloud.Memorystore.V1beta.Instance.LabelsEntry,
    map: true,
    deprecated: false

  field :state, 5,
    type: Google.Cloud.Memorystore.V1beta.Instance.State,
    enum: true,
    deprecated: false

  field :state_info, 6,
    type: Google.Cloud.Memorystore.V1beta.Instance.StateInfo,
    json_name: "stateInfo",
    deprecated: false
  ...
  field :authorization_mode, 9,
    type: Google.Cloud.Memorystore.V1beta.Instance.AuthorizationMode,
    json_name: "authorizationMode",
    enum: true,
    deprecated: false

  field :transit_encryption_mode, 10,
    type: Google.Cloud.Memorystore.V1beta.Instance.TransitEncryptionMode,
  ...
  field :discovery_endpoints, 12,
    repeated: true,
    type: Google.Cloud.Memorystore.V1beta.DiscoveryEndpoint,
    json_name: "discoveryEndpoints",
    deprecated: false

  field :node_type, 13,
    type: Google.Cloud.Memorystore.V1beta.Instance.NodeType,
    json_name: "nodeType",
    enum: true,
    deprecated: false

  field :persistence_config, 14,
    type: Google.Cloud.Memorystore.V1beta.PersistenceConfig,
  ...
  field :engine_configs, 16,
    repeated: true,
    type: Google.Cloud.Memorystore.V1beta.Instance.EngineConfigsEntry,
    json_name: "engineConfigs",
    map: true,
    deprecated: false

  field :node_config, 17,
    type: Google.Cloud.Memorystore.V1beta.NodeConfig,
    json_name: "nodeConfig",
    deprecated: false

  field :zone_distribution_config, 18,
    type: Google.Cloud.Memorystore.V1beta.ZoneDistributionConfig,
  ...
  field :endpoints, 25,
    repeated: true,
    type: Google.Cloud.Memorystore.V1beta.Instance.InstanceEndpoint,
    deprecated: false

  field :mode, 26,
    type: Google.Cloud.Memorystore.V1beta.Instance.Mode,
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Memorystore.V1beta.PscAutoConnection do
  ...
  field :psc_connection_status, 7,
    type: Google.Cloud.Memorystore.V1beta.PscConnectionStatus,
    json_name: "pscConnectionStatus",
    enum: true,
    deprecated: false

  field :connection_type, 8,
    type: Google.Cloud.Memorystore.V1beta.ConnectionType,
...
defmodule Google.Cloud.Memorystore.V1beta.PersistenceConfig do
  ...
  field :rdb_config, 2,
    type: Google.Cloud.Memorystore.V1beta.PersistenceConfig.RDBConfig,
    json_name: "rdbConfig",
    deprecated: false

  field :aof_config, 3,
    type: Google.Cloud.Memorystore.V1beta.PersistenceConfig.AOFConfig,
    json_name: "aofConfig",
    deprecated: false
end
...
defmodule Google.Cloud.Memorystore.V1beta.ZoneDistributionConfig do
  ...
  field :mode, 1,
    type: Google.Cloud.Memorystore.V1beta.ZoneDistributionConfig.ZoneDistributionMode,
    enum: true,
    deprecated: false
end
...
defmodule Google.Cloud.Memorystore.V1beta.CreateInstanceRequest do
  ...
  field :instance, 3, type: Google.Cloud.Memorystore.V1beta.Instance, deprecated: false
...
defmodule Google.Cloud.Memorystore.V1beta.UpdateInstanceRequest do
  ...
  field :instance, 2, type: Google.Cloud.Memorystore.V1beta.Instance, deprecated: false
...
defmodule Google.Cloud.Memorystore.V1beta.CertificateAuthority do
  ...
  field :managed_server_ca, 2,
    type: Google.Cloud.Memorystore.V1beta.CertificateAuthority.ManagedCertificateAuthority,
...
defmodule Google.Cloud.Memorystore.V1beta.Memorystore.Service do
  @moduledoc false
...
defmodule Google.Cloud.Memorystore.V1beta.Memorystore.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Memorystore.V1beta.Memorystore.Service
end
