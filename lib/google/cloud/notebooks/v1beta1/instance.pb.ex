...
defmodule Google.Cloud.Notebooks.V1beta1.Instance do
  ...
  field :vm_image, 2, type: Google.Cloud.Notebooks.V1beta1.VmImage, oneof: 0
  field :container_image, 3, type: Google.Cloud.Notebooks.V1beta1.ContainerImage, oneof: 0
  ...
  field :accelerator_config, 9, type: Google.Cloud.Notebooks.V1beta1.Instance.AcceleratorConfig
  ...
  field :boot_disk_type, 13, type: Google.Cloud.Notebooks.V1beta1.Instance.DiskType, enum: true
  field :boot_disk_size_gb, 14, type: :int64
  field :data_disk_type, 25, type: Google.Cloud.Notebooks.V1beta1.Instance.DiskType, enum: true
