...
defmodule Google.Cloud.Notebooks.V1.Schedule do
  ...
  field :cron_schedule, 5, type: :string
  ...
  field :execution_template, 9, type: Google.Cloud.Notebooks.V1.ExecutionTemplate
  field :recent_executions, 10, repeated: true, type: Google.Cloud.Notebooks.V1.Execution
end
