...
defmodule Google.Cloud.Scheduler.V1.HttpTarget do
  ...
  @type t :: %__MODULE__{
          ...
          uri: String.t(),
          http_method: Google.Cloud.Scheduler.V1.HttpMethod.t(),
  ...
  field :http_method, 2, type: Google.Cloud.Scheduler.V1.HttpMethod, enum: true
  ...
  field :oauth_token, 5, type: Google.Cloud.Scheduler.V1.OAuthToken, oneof: 0
  field :oidc_token, 6, type: Google.Cloud.Scheduler.V1.OidcToken, oneof: 0
end
...
defmodule Google.Cloud.Scheduler.V1.AppEngineHttpTarget do
  ...
  @type t :: %__MODULE__{
          http_method: Google.Cloud.Scheduler.V1.HttpMethod.t(),
          app_engine_routing: Google.Cloud.Scheduler.V1.AppEngineRouting.t() | nil,
  ...
  field :http_method, 1, type: Google.Cloud.Scheduler.V1.HttpMethod, enum: true
  field :app_engine_routing, 2, type: Google.Cloud.Scheduler.V1.AppEngineRouting
