...
defmodule Google.Cloud.Scheduler.V1.Job do
  ...
  field :pubsub_target, 4, type: Google.Cloud.Scheduler.V1.PubsubTarget, oneof: 0
  field :app_engine_http_target, 5, type: Google.Cloud.Scheduler.V1.AppEngineHttpTarget, oneof: 0
  field :http_target, 6, type: Google.Cloud.Scheduler.V1.HttpTarget, oneof: 0
  ...
  field :retry_config, 19, type: Google.Cloud.Scheduler.V1.RetryConfig
