...
defmodule Google.Cloud.Documentai.V1beta3.BatchDocumentsInputConfig do
  ...
  oneof :source, 0
  field :gcs_prefix, 1, type: Google.Cloud.Documentai.V1beta3.GcsPrefix, oneof: 0
  field :gcs_documents, 2, type: Google.Cloud.Documentai.V1beta3.GcsDocuments, oneof: 0
end
