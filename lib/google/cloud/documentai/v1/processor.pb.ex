...
defmodule Google.Cloud.Documentai.V1.ProcessorVersion do
  ...
  field :kms_key_name, 9, type: :string, json_name: "kmsKeyName", deprecated: false

  field :kms_key_version_name, 10,
    type: :string,
...
defmodule Google.Cloud.Documentai.V1.Processor do
  ...
  field :state, 4, type: Google.Cloud.Documentai.V1.Processor.State, enum: true, deprecated: false
