...
defmodule Google.Cloud.Documentai.V1beta2.Document.Provenance.OperationType do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Image do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Matrix do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Block do
  ...
  field :provenance, 3,
    type: Google.Cloud.Documentai.V1beta2.Document.Provenance,
    deprecated: true
end
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Token.StyleInfo do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Token do
  ...
  field :style_info, 5,
    type: Google.Cloud.Documentai.V1beta2.Document.Page.Token.StyleInfo,
    json_name: "styleInfo"
end

defmodule Google.Cloud.Documentai.V1beta2.Document.Page.Symbol do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.FormField do
  ...
  field :provenance, 8, type: Google.Cloud.Documentai.V1beta2.Document.Provenance
end

defmodule Google.Cloud.Documentai.V1beta2.Document.Page.DetectedBarcode do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.12.0", syntax: :proto3

  field :layout, 1, type: Google.Cloud.Documentai.V1beta2.Document.Page.Layout
  field :barcode, 2, type: Google.Cloud.Documentai.V1beta2.Barcode
end
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.ImageQualityScores.DetectedDefect do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page.ImageQualityScores do
  @moduledoc false
  ...
  field :detected_defects, 2,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.Page.ImageQualityScores.DetectedDefect,
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Page do
  ...
  field :image, 13, type: Google.Cloud.Documentai.V1beta2.Document.Page.Image

  field :transforms, 14,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.Page.Matrix
  ...
  field :symbols, 12, repeated: true, type: Google.Cloud.Documentai.V1beta2.Document.Page.Symbol

  field :detected_barcodes, 15,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.Page.DetectedBarcode,
    json_name: "detectedBarcodes"

  field :image_quality_scores, 17,
    type: Google.Cloud.Documentai.V1beta2.Document.Page.ImageQualityScores,
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Entity.NormalizedValue do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Entity do
  ...
  field :normalized_value, 9,
    type: Google.Cloud.Documentai.V1beta2.Document.Entity.NormalizedValue,
    json_name: "normalizedValue",
    deprecated: false

  field :properties, 10,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.Entity,
    deprecated: false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Provenance.Parent do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Provenance do
  @moduledoc false
  ...
  field :parents, 3,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.Provenance.Parent

  field :type, 4,
    type: Google.Cloud.Documentai.V1beta2.Document.Provenance.OperationType,
    enum: true
end

defmodule Google.Cloud.Documentai.V1beta2.Document.Revision.HumanReview do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document.Revision do
  @moduledoc false
  ...
  field :human_review, 6,
    type: Google.Cloud.Documentai.V1beta2.Document.Revision.HumanReview,
    json_name: "humanReview"
end

defmodule Google.Cloud.Documentai.V1beta2.Document.TextChange do
  @moduledoc false
...
defmodule Google.Cloud.Documentai.V1beta2.Document do
  ...
  field :text_changes, 14,
    repeated: true,
    type: Google.Cloud.Documentai.V1beta2.Document.TextChange,
  ...
  field :revisions, 13, repeated: true, type: Google.Cloud.Documentai.V1beta2.Document.Revision
end