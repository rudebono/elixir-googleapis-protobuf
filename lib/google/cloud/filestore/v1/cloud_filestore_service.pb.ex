...
defmodule Google.Cloud.Filestore.V1.NetworkConfig do
  ...
  @type t :: %__MODULE__{
          network: String.t(),
          modes: [[Google.Cloud.Filestore.V1.NetworkConfig.AddressMode.t()]],
...
defmodule Google.Cloud.Filestore.V1.FileShareConfig do
  ...
  field :source_backup, 8, type: :string, oneof: 0
  field :nfs_export_options, 7, repeated: true, type: Google.Cloud.Filestore.V1.NfsExportOptions
end
...
defmodule Google.Cloud.Filestore.V1.NfsExportOptions do
  ...
  @type t :: %__MODULE__{
          ip_ranges: [String.t()],
          access_mode: Google.Cloud.Filestore.V1.NfsExportOptions.AccessMode.t(),
          squash_mode: Google.Cloud.Filestore.V1.NfsExportOptions.SquashMode.t(),
          anon_uid: integer,
          anon_gid: integer
        }
  ...
  field :access_mode, 2, type: Google.Cloud.Filestore.V1.NfsExportOptions.AccessMode, enum: true
  field :squash_mode, 3, type: Google.Cloud.Filestore.V1.NfsExportOptions.SquashMode, enum: true
...
defmodule Google.Cloud.Filestore.V1.Instance do
  ...
  @type t :: %__MODULE__{
          ...
          state: Google.Cloud.Filestore.V1.Instance.State.t(),
          status_message: String.t(),
          create_time: Google.Protobuf.Timestamp.t() | nil,
          tier: Google.Cloud.Filestore.V1.Instance.Tier.t(),
          labels: %{String.t() => String.t()},
          file_shares: [Google.Cloud.Filestore.V1.FileShareConfig.t()],
          networks: [Google.Cloud.Filestore.V1.NetworkConfig.t()],
          etag: String.t(),
  ...
  field :file_shares, 10, repeated: true, type: Google.Cloud.Filestore.V1.FileShareConfig
...
defmodule Google.Cloud.Filestore.V1.RestoreInstanceRequest do
  ...
  field :source_backup, 3, type: :string, oneof: 0
end
...
defmodule Google.Cloud.Filestore.V1.ListInstancesResponse do
  ...
  @type t :: %__MODULE__{
          instances: [Google.Cloud.Filestore.V1.Instance.t()],
...
defmodule Google.Cloud.Filestore.V1.Backup do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          description: String.t(),
          state: Google.Cloud.Filestore.V1.Backup.State.t(),
          create_time: Google.Protobuf.Timestamp.t() | nil,
          labels: %{String.t() => String.t()},
          capacity_gb: integer,
          ...
          source_instance_tier: Google.Cloud.Filestore.V1.Instance.Tier.t(),
  ...
  field :source_instance_tier, 10, type: Google.Cloud.Filestore.V1.Instance.Tier, enum: true
...
defmodule Google.Cloud.Filestore.V1.CreateBackupRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          backup: Google.Cloud.Filestore.V1.Backup.t() | nil,
          backup_id: String.t()
        }
...
defmodule Google.Cloud.Filestore.V1.ListBackupsResponse do
  ...
  @type t :: %__MODULE__{
          backups: [Google.Cloud.Filestore.V1.Backup.t()],
          next_page_token: String.t(),
          unreachable: [String.t()]
        }
