...
defmodule Google.Cloud.Automl.V1.Document.Layout do
  ...
  field :text_segment, 1, type: Google.Cloud.Automl.V1.TextSegment
  field :page_number, 2, type: :int32
  field :bounding_poly, 3, type: Google.Cloud.Automl.V1.BoundingPoly
...
defmodule Google.Cloud.Automl.V1.Document do
  ...
  field :input_config, 1, type: Google.Cloud.Automl.V1.DocumentInputConfig
  field :document_text, 2, type: Google.Cloud.Automl.V1.TextSnippet
  field :layout, 3, repeated: true, type: Google.Cloud.Automl.V1.Document.Layout
  field :document_dimensions, 4, type: Google.Cloud.Automl.V1.DocumentDimensions
...
defmodule Google.Cloud.Automl.V1.ExamplePayload do
  ...
  field :text_snippet, 2, type: Google.Cloud.Automl.V1.TextSnippet, oneof: 0
