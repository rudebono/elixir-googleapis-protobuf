defmodule Google.Cloud.Automl.V1.OperationMetadata do
  ...
  oneof :details, 0
  field :delete_details, 8, type: Google.Cloud.Automl.V1.DeleteOperationMetadata, oneof: 0
...
defmodule Google.Cloud.Automl.V1.BatchPredictOperationMetadata do
  ...
  field :input_config, 1, type: Google.Cloud.Automl.V1.BatchPredictInputConfig
