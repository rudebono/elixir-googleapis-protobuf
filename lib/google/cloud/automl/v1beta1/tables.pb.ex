...
defmodule Google.Cloud.Automl.V1beta1.TablesDatasetMetadata do
  ...
  field :primary_table_spec_id, 1, type: :string
  field :target_column_spec_id, 2, type: :string
  field :weight_column_spec_id, 3, type: :string
  field :ml_use_column_spec_id, 4, type: :string
  ...
  field :stats_update_time, 7, type: Google.Protobuf.Timestamp
end
...
defmodule Google.Cloud.Automl.V1beta1.TablesModelMetadata do
  ...
  field :optimization_objective_recall_value, 17, type: :float, oneof: 0
  field :optimization_objective_precision_value, 18, type: :float, oneof: 0
  field :target_column_spec, 2, type: Google.Cloud.Automl.V1beta1.ColumnSpec
  ...
  field :disable_early_stopping, 12, type: :bool
end
...
defmodule Google.Cloud.Automl.V1beta1.TablesAnnotation do
  ...
  field :prediction_interval, 4, type: Google.Cloud.Automl.V1beta1.DoubleRange
  ...
  field :baseline_score, 5, type: :float
end
...
defmodule Google.Cloud.Automl.V1beta1.TablesModelColumnInfo do
  ...
  field :column_spec_name, 1, type: :string
  field :column_display_name, 2, type: :string
  field :feature_importance, 3, type: :float
end
