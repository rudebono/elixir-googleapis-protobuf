defmodule Google.Cloud.Automl.V1beta1.RegressionEvaluationMetrics do
  ...
  field :root_mean_squared_error, 1, type: :float
  field :mean_absolute_error, 2, type: :float
  field :mean_absolute_percentage_error, 3, type: :float
  field :r_squared, 4, type: :float
  field :root_mean_squared_log_error, 5, type: :float
end
