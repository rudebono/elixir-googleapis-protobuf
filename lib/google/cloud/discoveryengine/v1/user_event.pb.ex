...
defmodule Google.Cloud.Discoveryengine.V1.UserEvent do
  ...
  field :page_info, 7, type: Google.Cloud.Discoveryengine.V1.PageInfo, json_name: "pageInfo"
  field :attribution_token, 8, type: :string, json_name: "attributionToken"
  field :filter, 9, type: :string
  field :documents, 10, repeated: true, type: Google.Cloud.Discoveryengine.V1.DocumentInfo
  field :panel, 11, type: Google.Cloud.Discoveryengine.V1.PanelInfo

  field :search_info, 12,
    type: Google.Cloud.Discoveryengine.V1.SearchInfo,
    json_name: "searchInfo"

  field :completion_info, 13,
    type: Google.Cloud.Discoveryengine.V1.CompletionInfo,
    json_name: "completionInfo"

  field :transaction_info, 14,
    type: Google.Cloud.Discoveryengine.V1.TransactionInfo,
  ...
  field :attributes, 17,
    repeated: true,
    type: Google.Cloud.Discoveryengine.V1.UserEvent.AttributesEntry,
    map: true
