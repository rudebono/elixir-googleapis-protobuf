...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Citation do
  ...
  field :sources, 3,
    repeated: true,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.CitationSource
end
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Reference.ChunkInfo do
  ...
  field :document_metadata, 4,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Reference.ChunkInfo.DocumentMetadata,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Reference do
  ...
  field :unstructured_document_info, 1,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Reference.UnstructuredDocumentInfo,
    json_name: "unstructuredDocumentInfo",
    oneof: 0

  field :chunk_info, 2,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Reference.ChunkInfo,
    json_name: "chunkInfo",
    oneof: 0

  field :structured_document_info, 3,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Reference.StructuredDocumentInfo,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation.SearchResult do
  ...
  field :snippet_info, 4,
    repeated: true,
    type:
      Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation.SearchResult.SnippetInfo,
    json_name: "snippetInfo"

  field :chunk_info, 5,
    repeated: true,
    type:
      Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation.SearchResult.ChunkInfo,
    json_name: "chunkInfo"
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation do
  ...
  field :search_results, 2,
    repeated: true,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation.SearchResult,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action do
  ...
  field :search_action, 2,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.SearchAction,
    json_name: "searchAction",
    oneof: 0

  field :observation, 3, type: Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action.Observation
end
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.Step do
  ...
  field :actions, 4, repeated: true, type: Google.Cloud.Discoveryengine.V1alpha.Answer.Step.Action
end
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.QueryUnderstandingInfo.QueryClassificationInfo do
  ...
  field :type, 1,
    type:
      Google.Cloud.Discoveryengine.V1alpha.Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type,
    enum: true
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer.QueryUnderstandingInfo do
  ...
  field :query_classification_info, 1,
    repeated: true,
    type:
      Google.Cloud.Discoveryengine.V1alpha.Answer.QueryUnderstandingInfo.QueryClassificationInfo,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.Answer do
  ...
  field :citations, 4, repeated: true, type: Google.Cloud.Discoveryengine.V1alpha.Answer.Citation

  field :references, 5,
    repeated: true,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.Reference

  field :related_questions, 6, repeated: true, type: :string, json_name: "relatedQuestions"
  field :steps, 7, repeated: true, type: Google.Cloud.Discoveryengine.V1alpha.Answer.Step

  field :query_understanding_info, 10,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.QueryUnderstandingInfo,
    json_name: "queryUnderstandingInfo"

  field :answer_skipped_reasons, 11,
    repeated: true,
    type: Google.Cloud.Discoveryengine.V1alpha.Answer.AnswerSkippedReason,
