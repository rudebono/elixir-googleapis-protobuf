...
defmodule Google.Cloud.Discoveryengine.V1alpha.SearchRequest.RankingExpressionBackend do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1alpha.SearchRequest do
  ...
  field :ranking_expression_backend, 53,
    type: Google.Cloud.Discoveryengine.V1alpha.SearchRequest.RankingExpressionBackend,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.SearchResponse.SearchResult.RankSignals.CustomSignal do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1alpha.SearchResponse.SearchResult.RankSignals do
  @moduledoc false
  ...
  field :custom_signals, 33,
    repeated: true,
    type:
      Google.Cloud.Discoveryengine.V1alpha.SearchResponse.SearchResult.RankSignals.CustomSignal,
...
defmodule Google.Cloud.Discoveryengine.V1alpha.SearchResponse.SearchResult do
  ...
  field :rank_signals, 7,
    type: Google.Cloud.Discoveryengine.V1alpha.SearchResponse.SearchResult.RankSignals,
