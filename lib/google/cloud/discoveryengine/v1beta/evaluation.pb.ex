...
defmodule Google.Cloud.Discoveryengine.V1beta.Evaluation.EvaluationSpec do
  ...
  field :search_request, 2,
    type: Google.Cloud.Discoveryengine.V1beta.SearchRequest,
    json_name: "searchRequest",
    oneof: 0,
    deprecated: false

  field :query_set_spec, 1,
    type: Google.Cloud.Discoveryengine.V1beta.Evaluation.EvaluationSpec.QuerySetSpec,
...
defmodule Google.Cloud.Discoveryengine.V1beta.Evaluation do
  ...
  field :evaluation_spec, 2,
    type: Google.Cloud.Discoveryengine.V1beta.Evaluation.EvaluationSpec,
  ...
  field :state, 4,
    type: Google.Cloud.Discoveryengine.V1beta.Evaluation.State,
    enum: true,
    deprecated: false
