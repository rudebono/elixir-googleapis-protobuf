...
defmodule Google.Cloud.Discoveryengine.V1beta.TargetSite.FailureReason do
  ...
  field :quota_failure, 1,
    type: Google.Cloud.Discoveryengine.V1beta.TargetSite.FailureReason.QuotaFailure,
...
defmodule Google.Cloud.Discoveryengine.V1beta.TargetSite do
  ...
  field :type, 3, type: Google.Cloud.Discoveryengine.V1beta.TargetSite.Type, enum: true
  ...
  field :site_verification_info, 7,
    type: Google.Cloud.Discoveryengine.V1beta.SiteVerificationInfo,
    json_name: "siteVerificationInfo",
    deprecated: false

  field :indexing_status, 8,
    type: Google.Cloud.Discoveryengine.V1beta.TargetSite.IndexingStatus,
  ...
  field :failure_reason, 9,
    type: Google.Cloud.Discoveryengine.V1beta.TargetSite.FailureReason,
