defmodule Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig.ChunkingConfig.LayoutBasedChunkingConfig do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig.ChunkingConfig do
  @moduledoc false
  ...
  field :layout_based_chunking_config, 1,
    type:
      Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig.ChunkingConfig.LayoutBasedChunkingConfig,
...
defmodule Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig.ParsingConfig.LayoutParsingConfig do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig do
  ...
  field :chunking_config, 3,
    type: Google.Cloud.Discoveryengine.V1beta.DocumentProcessingConfig.ChunkingConfig,
