defmodule Google.Cloud.Discoveryengine.V1beta.ServingConfig.MediaConfig do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1beta.ServingConfig.GenericConfig do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1beta.ServingConfig do
  @moduledoc false
  ...
  field :media_config, 7,
    type: Google.Cloud.Discoveryengine.V1beta.ServingConfig.MediaConfig,
    json_name: "mediaConfig",
    oneof: 0

  field :generic_config, 10,
    type: Google.Cloud.Discoveryengine.V1beta.ServingConfig.GenericConfig,
  ...
  field :embedding_config, 20,
    type: Google.Cloud.Discoveryengine.V1beta.EmbeddingConfig,
