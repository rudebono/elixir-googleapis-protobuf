defmodule Google.Cloud.Discoveryengine.V1beta.SuggestionDenyListEntry.MatchOperator do
  @moduledoc false
...
defmodule Google.Cloud.Discoveryengine.V1beta.SuggestionDenyListEntry do
  @moduledoc false
  ...
  field :match_operator, 2,
    type: Google.Cloud.Discoveryengine.V1beta.SuggestionDenyListEntry.MatchOperator,
    json_name: "matchOperator",
    enum: true,
    deprecated: false
end

defmodule Google.Cloud.Discoveryengine.V1beta.CompletionSuggestion do
  @moduledoc false
