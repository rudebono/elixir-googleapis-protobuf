...
defmodule Google.Cloud.Webrisk.V1.ComputeThreatListDiffRequest do
  ...
  field :threat_type, 1, type: Google.Cloud.Webrisk.V1.ThreatType, enum: true
...
defmodule Google.Cloud.Webrisk.V1.SearchUrisRequest do
  ...
  field :threat_types, 2, repeated: true, type: Google.Cloud.Webrisk.V1.ThreatType, enum: true
end
...
defmodule Google.Cloud.Webrisk.V1.SearchUrisResponse.ThreatUri do
  ...
  field :threat_types, 1, repeated: true, type: Google.Cloud.Webrisk.V1.ThreatType, enum: true
...
defmodule Google.Cloud.Webrisk.V1.ThreatEntryAdditions do
  ...
  field :raw_hashes, 1, repeated: true, type: Google.Cloud.Webrisk.V1.RawHashes
  field :rice_hashes, 2, type: Google.Cloud.Webrisk.V1.RiceDeltaEncoding
end
...
defmodule Google.Cloud.Webrisk.V1.ThreatEntryRemovals do
  ...
  field :raw_indices, 1, type: Google.Cloud.Webrisk.V1.RawIndices
  field :rice_indices, 2, type: Google.Cloud.Webrisk.V1.RiceDeltaEncoding
end
