...
defmodule Google.Cloud.Dataqna.V1alpha.Question do
  ...
  field :data_source_annotations, 4, repeated: true, type: :string
  field :interpret_error, 5, type: Google.Cloud.Dataqna.V1alpha.InterpretError
  ...
  field :user_email, 8, type: :string
  field :debug_flags, 9, type: Google.Cloud.Dataqna.V1alpha.DebugFlags
  field :debug_info, 10, type: Google.Protobuf.Any
end
...
defmodule Google.Cloud.Dataqna.V1alpha.ExecutionInfo do
  ...
  field :job_creation_status, 1, type: Google.Rpc.Status
  ...
  field :bigquery_job, 4, type: Google.Cloud.Dataqna.V1alpha.BigQueryJob
end
...
defmodule Google.Cloud.Dataqna.V1alpha.Interpretation do
  ...
  field :data_sources, 1, repeated: true, type: :string
  field :confidence, 2, type: :double
  field :unused_phrases, 3, repeated: true, type: :string
  field :human_readable, 4, type: Google.Cloud.Dataqna.V1alpha.HumanReadable
  field :interpretation_structure, 5, type: Google.Cloud.Dataqna.V1alpha.InterpretationStructure
  field :data_query, 6, type: Google.Cloud.Dataqna.V1alpha.DataQuery
  field :execution_info, 7, type: Google.Cloud.Dataqna.V1alpha.ExecutionInfo
end
...
defmodule Google.Cloud.Dataqna.V1alpha.HumanReadable do
  ...
  field :generated_interpretation, 1, type: Google.Cloud.Dataqna.V1alpha.AnnotatedString
  field :original_question, 2, type: Google.Cloud.Dataqna.V1alpha.AnnotatedString
end
...
defmodule Google.Cloud.Dataqna.V1alpha.InterpretationStructure.ColumnInfo do
  ...
  field :output_alias, 1, type: :string
...
defmodule Google.Cloud.Dataqna.V1alpha.DebugFlags do
  ...
  field :include_va_query, 1, type: :bool
  field :include_nested_va_query, 2, type: :bool
  field :include_human_interpretation, 3, type: :bool
  field :include_aqua_debug_response, 4, type: :bool
  field :time_override, 5, type: :int64
  field :is_internal_google_user, 6, type: :bool
  field :ignore_cache, 7, type: :bool
  field :include_search_entities_rpc, 8, type: :bool
  field :include_list_column_annotations_rpc, 9, type: :bool
  field :include_virtual_analyst_entities, 10, type: :bool
  field :include_table_list, 11, type: :bool
  field :include_domain_list, 12, type: :bool
end
