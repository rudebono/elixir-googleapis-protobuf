...
defmodule Google.Cloud.Channel.V1.CustomerEvent do
  ...
  field :event_type, 2, type: Google.Cloud.Channel.V1.CustomerEvent.Type, enum: true
end
...
defmodule Google.Cloud.Channel.V1.EntitlementEvent do
  ...
  field :event_type, 2, type: Google.Cloud.Channel.V1.EntitlementEvent.Type, enum: true
end
...
defmodule Google.Cloud.Channel.V1.SubscriberEvent do
  ...
  oneof :event, 0
  field :customer_event, 1, type: Google.Cloud.Channel.V1.CustomerEvent, oneof: 0
  field :entitlement_event, 2, type: Google.Cloud.Channel.V1.EntitlementEvent, oneof: 0
end
