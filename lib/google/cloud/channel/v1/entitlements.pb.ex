...
defmodule Google.Cloud.Channel.V1.Entitlement do
  ...
  field :commitment_settings, 12, type: Google.Cloud.Channel.V1.CommitmentSettings

  field :provisioning_state, 13,
    type: Google.Cloud.Channel.V1.Entitlement.ProvisioningState,
    enum: true

  field :provisioned_service, 16, type: Google.Cloud.Channel.V1.ProvisionedService
  ...
  field :purchase_order_id, 19, type: :string
  field :trial_settings, 21, type: Google.Cloud.Channel.V1.TrialSettings
  field :association_info, 23, type: Google.Cloud.Channel.V1.AssociationInfo
...
defmodule Google.Cloud.Channel.V1.AssociationInfo do
  ...
  field :base_entitlement, 1, type: :string
end
...
defmodule Google.Cloud.Channel.V1.ProvisionedService do
  ...
  field :provisioning_id, 1, type: :string
...
defmodule Google.Cloud.Channel.V1.RenewalSettings do
  ...
  field :enable_renewal, 1, type: :bool
  field :resize_unit_count, 2, type: :bool
  field :payment_plan, 5, type: Google.Cloud.Channel.V1.PaymentPlan, enum: true
  field :payment_cycle, 6, type: Google.Cloud.Channel.V1.Period
end
...
defmodule Google.Cloud.Channel.V1.TransferableSku do
  ...
  field :transfer_eligibility, 9, type: Google.Cloud.Channel.V1.TransferEligibility
  field :sku, 11, type: Google.Cloud.Channel.V1.Sku
  field :legacy_sku, 12, type: Google.Cloud.Channel.V1.Sku
end
