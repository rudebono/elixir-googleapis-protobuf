...
defmodule Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy.Option.AggregateMethod do
  @moduledoc false
  use Protobuf, enum: true, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Cloud.Visionai.V1alpha1.SearchAssetsRequest do
  ...
  field :schema_key_sorting_strategy, 9,
    type: Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy,
...
defmodule Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy.Option do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
  ...
  field :aggregate_method, 3,
    proto3_optional: true,
    type: Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy.Option.AggregateMethod,
    json_name: "aggregateMethod",
    enum: true
end

defmodule Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :options, 1,
    repeated: true,
    type: Google.Cloud.Visionai.V1alpha1.SchemaKeySortingStrategy.Option
end
