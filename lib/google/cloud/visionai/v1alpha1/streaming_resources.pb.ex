...
defmodule Google.Cloud.Visionai.V1alpha1.PacketType.TypeDescriptor do
  ...
  field :gstreamer_buffer_descriptor, 2,
    type: Google.Cloud.Visionai.V1alpha1.GstreamerBufferDescriptor,
    json_name: "gstreamerBufferDescriptor",
    oneof: 0

  field :raw_image_descriptor, 3,
    type: Google.Cloud.Visionai.V1alpha1.RawImageDescriptor,
...
defmodule Google.Cloud.Visionai.V1alpha1.PacketType do
  ...
  field :type_descriptor, 2,
    type: Google.Cloud.Visionai.V1alpha1.PacketType.TypeDescriptor,
...
defmodule Google.Cloud.Visionai.V1alpha1.PacketHeader do
  ...
  field :type, 2, type: Google.Cloud.Visionai.V1alpha1.PacketType, deprecated: false
  field :metadata, 3, type: Google.Protobuf.Struct, deprecated: false

  field :server_metadata, 4,
    type: Google.Cloud.Visionai.V1alpha1.ServerMetadata,
