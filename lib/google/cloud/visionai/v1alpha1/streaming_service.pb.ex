...
defmodule Google.Cloud.Visionai.V1alpha1.OffsetConfig.SpecialOffset do
  @moduledoc false
  use Protobuf, enum: true, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :SPECIAL_OFFSET_UNSPECIFIED, 0
  field :OFFSET_BEGINNING, 1
  field :OFFSET_END, 2
end
...
defmodule Google.Cloud.Visionai.V1alpha1.ReceivePacketsRequest do
  ...
  field :series_metadata, 1,
    type: Google.Cloud.Visionai.V1alpha1.SeriesMetadata,
    json_name: "seriesMetadata"

  field :consumer, 2, type: :string

  field :offset_config, 3,
    type: Google.Cloud.Visionai.V1alpha1.OffsetConfig,
    json_name: "offsetConfig"

  field :timeout, 4, type: Google.Protobuf.Duration
  field :metadata, 5, type: Google.Cloud.Visionai.V1alpha1.RequestMetadata
end

defmodule Google.Cloud.Visionai.V1alpha1.ResponseMetadata do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  field :end_of_stream, 1, type: :bool, json_name: "endOfStream"
end
...
defmodule Google.Cloud.Visionai.V1alpha1.ReceivePacketsResponse do
  ...
  field :metadata, 2, type: Google.Cloud.Visionai.V1alpha1.ResponseMetadata, oneof: 0
end

defmodule Google.Cloud.Visionai.V1alpha1.OffsetConfig do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3

  oneof :config, 0

  field :special_offset, 1,
    type: Google.Cloud.Visionai.V1alpha1.OffsetConfig.SpecialOffset,
    json_name: "specialOffset",
    enum: true,
    oneof: 0

  field :seek_position, 2, type: :int64, json_name: "seekPosition", oneof: 0
  field :seek_time, 3, type: Google.Protobuf.Timestamp, json_name: "seekTime", oneof: 0
end
