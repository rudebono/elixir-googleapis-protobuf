...
defmodule Google.Cloud.Visionai.V1alpha1.ApplicationConfigs.MonitoringConfig do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.11.0", syntax: :proto3
...
defmodule Google.Cloud.Visionai.V1alpha1.ApplicationConfigs do
  ...
  field :monitoring_config, 2,
    type: Google.Cloud.Visionai.V1alpha1.ApplicationConfigs.MonitoringConfig,
