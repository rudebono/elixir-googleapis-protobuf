...
defmodule Google.Cloud.Assuredworkloads.V1.CreateWorkloadRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          workload: Google.Cloud.Assuredworkloads.V1.Workload.t() | nil,
  ...
  field :workload, 2, type: Google.Cloud.Assuredworkloads.V1.Workload
...
defmodule Google.Cloud.Assuredworkloads.V1.UpdateWorkloadRequest do
  ...
  field :workload, 1, type: Google.Cloud.Assuredworkloads.V1.Workload
...
defmodule Google.Cloud.Assuredworkloads.V1.ListWorkloadsResponse do
  ...
  @type t :: %__MODULE__{
          workloads: [Google.Cloud.Assuredworkloads.V1.Workload.t()],
...
defmodule Google.Cloud.Assuredworkloads.V1.Workload.ResourceInfo do
  ...
  @type t :: %__MODULE__{
          resource_id: integer,
          resource_type: Google.Cloud.Assuredworkloads.V1.Workload.ResourceInfo.ResourceType.t()
        }
...
defmodule Google.Cloud.Assuredworkloads.V1.Workload do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          display_name: String.t(),
          resources: [Google.Cloud.Assuredworkloads.V1.Workload.ResourceInfo.t()],
          compliance_regime: Google.Cloud.Assuredworkloads.V1.Workload.ComplianceRegime.t(),
          create_time: Google.Protobuf.Timestamp.t() | nil,
          billing_account: String.t(),
          etag: String.t(),
          labels: %{String.t() => String.t()},
          provisioned_resources_parent: String.t(),
          kms_settings: Google.Cloud.Assuredworkloads.V1.Workload.KMSSettings.t() | nil,
          resource_settings: [Google.Cloud.Assuredworkloads.V1.Workload.ResourceSettings.t()]
        }
  ...
  field :kms_settings, 14, type: Google.Cloud.Assuredworkloads.V1.Workload.KMSSettings
...
defmodule Google.Cloud.Assuredworkloads.V1.AssuredWorkloadsService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.cloud.assuredworkloads.v1.AssuredWorkloadsService"
