...
defmodule Google.Cloud.Managedidentities.V1.Domain do
  ...
  field :state, 13, type: Google.Cloud.Managedidentities.V1.Domain.State, enum: true
  field :status_message, 14, type: :string
  field :trusts, 15, repeated: true, type: Google.Cloud.Managedidentities.V1.Trust
end
...
defmodule Google.Cloud.Managedidentities.V1.Trust do
  ...
  field :trust_type, 2, type: Google.Cloud.Managedidentities.V1.Trust.TrustType, enum: true
  ...
  field :state, 9, type: Google.Cloud.Managedidentities.V1.Trust.State, enum: true
