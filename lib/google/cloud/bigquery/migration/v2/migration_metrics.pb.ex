defmodule Google.Cloud.Bigquery.Migration.V2.TimeSeries do
  ...
  @type t :: %__MODULE__{
          ...
          points: [Google.Cloud.Bigquery.Migration.V2.Point.t()]
        }
...
defmodule Google.Cloud.Bigquery.Migration.V2.Point do
  ...
  @type t :: %__MODULE__{
          interval: Google.Cloud.Bigquery.Migration.V2.TimeInterval.t() | nil,
          value: Google.Cloud.Bigquery.Migration.V2.TypedValue.t() | nil
        }
