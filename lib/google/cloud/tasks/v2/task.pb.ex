...
defmodule Google.Cloud.Tasks.V2.Task do
  ...
  field :app_engine_http_request, 2, type: Google.Cloud.Tasks.V2.AppEngineHttpRequest, oneof: 0
  field :http_request, 3, type: Google.Cloud.Tasks.V2.HttpRequest, oneof: 0
  field :schedule_time, 4, type: Google.Protobuf.Timestamp
  field :create_time, 5, type: Google.Protobuf.Timestamp
  field :dispatch_deadline, 6, type: Google.Protobuf.Duration
  field :dispatch_count, 7, type: :int32
  field :response_count, 8, type: :int32
  field :first_attempt, 9, type: Google.Cloud.Tasks.V2.Attempt
  field :last_attempt, 10, type: Google.Cloud.Tasks.V2.Attempt
