defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Page do
  ...
  @type t :: %__MODULE__{
          ...
          entry_fulfillment: Google.Cloud.Dialogflow.Cx.V3beta1.Fulfillment.t() | nil,
          form: Google.Cloud.Dialogflow.Cx.V3beta1.Form.t() | nil,
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Form.Parameter.FillBehavior do
  ...
  @type t :: %__MODULE__{
          initial_prompt_fulfillment: Google.Cloud.Dialogflow.Cx.V3beta1.Fulfillment.t() | nil,
          reprompt_event_handlers: [Google.Cloud.Dialogflow.Cx.V3beta1.EventHandler.t()]
        }
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Form.Parameter do
  ...
  @type t :: %__MODULE__{
          ...
          is_list: boolean,
          fill_behavior: Google.Cloud.Dialogflow.Cx.V3beta1.Form.Parameter.FillBehavior.t() | nil,
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Form do
  ...
  @type t :: %__MODULE__{
          parameters: [Google.Cloud.Dialogflow.Cx.V3beta1.Form.Parameter.t()]
        }
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.ListPagesResponse do
  ...
  @type t :: %__MODULE__{
          pages: [Google.Cloud.Dialogflow.Cx.V3beta1.Page.t()],
