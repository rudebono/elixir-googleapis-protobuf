...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Environment.WebhookConfig do
  @moduledoc false
  use Protobuf, protoc_gen_elixir_version: "0.10.0", syntax: :proto3

  field :webhook_overrides, 1,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3beta1.Webhook,
...
defmodule Google.Cloud.Dialogflow.Cx.V3beta1.Environment do
  ...
  field :webhook_config, 10,
    type: Google.Cloud.Dialogflow.Cx.V3beta1.Environment.WebhookConfig,
