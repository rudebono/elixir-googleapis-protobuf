...
defmodule Google.Cloud.Dialogflow.Cx.V3.InputAudioConfig do
  ...
  field :audio_encoding, 1, type: Google.Cloud.Dialogflow.Cx.V3.AudioEncoding, enum: true
  ...
  field :model_variant, 10, type: Google.Cloud.Dialogflow.Cx.V3.SpeechModelVariant, enum: true
...
defmodule Google.Cloud.Dialogflow.Cx.V3.VoiceSelectionParams do
  ...
  field :ssml_gender, 2, type: Google.Cloud.Dialogflow.Cx.V3.SsmlVoiceGender, enum: true
end
...
defmodule Google.Cloud.Dialogflow.Cx.V3.OutputAudioConfig do
  ...
  field :audio_encoding, 1, type: Google.Cloud.Dialogflow.Cx.V3.OutputAudioEncoding, enum: true
  field :sample_rate_hertz, 2, type: :int32
  field :synthesize_speech_config, 3, type: Google.Cloud.Dialogflow.Cx.V3.SynthesizeSpeechConfig
end
