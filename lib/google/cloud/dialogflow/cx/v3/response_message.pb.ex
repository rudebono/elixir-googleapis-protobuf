...
defmodule Google.Cloud.Dialogflow.Cx.V3.ResponseMessage do
  ...
  field :play_audio, 12, type: Google.Cloud.Dialogflow.Cx.V3.ResponseMessage.PlayAudio, oneof: 0
  field :mixed_audio, 13, type: Google.Cloud.Dialogflow.Cx.V3.ResponseMessage.MixedAudio, oneof: 0
end
