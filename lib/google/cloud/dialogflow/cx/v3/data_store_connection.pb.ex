...
defmodule Google.Cloud.Dialogflow.Cx.V3.DocumentProcessingMode do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.GroundingSignals.GroundingDecision do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.GroundingSignals.GroundingScoreBucket do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SafetySignals.SafetyDecision do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SafetySignals.BannedPhraseMatch do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnection do
  ...
  field :document_processing_mode, 4,
    type: Google.Cloud.Dialogflow.Cx.V3.DocumentProcessingMode,
    json_name: "documentProcessingMode",
    enum: true
end

defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.RewriterModelCallSignals do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SearchSnippet do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.AnswerGenerationModelCallSignals do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.AnswerPart do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.CitedSnippet do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :search_snippet, 1,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SearchSnippet,
    json_name: "searchSnippet"

  field :snippet_index, 2, type: :int32, json_name: "snippetIndex"
end

defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.GroundingSignals do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SafetySignals do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :decision, 1,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SafetySignals.SafetyDecision,
    enum: true
...
defmodule Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :rewriter_model_call_signals, 1,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.RewriterModelCallSignals,
  ...
  field :answer_parts, 6,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.AnswerPart,
    json_name: "answerParts",
    deprecated: false

  field :cited_snippets, 7,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.CitedSnippet,
    json_name: "citedSnippets",
    deprecated: false

  field :grounding_signals, 8,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.GroundingSignals,
    json_name: "groundingSignals",
    deprecated: false

  field :safety_signals, 9,
    type: Google.Cloud.Dialogflow.Cx.V3.DataStoreConnectionSignals.SafetySignals,
