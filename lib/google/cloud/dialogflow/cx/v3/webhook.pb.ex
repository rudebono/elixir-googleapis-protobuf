...
defmodule Google.Cloud.Dialogflow.Cx.V3.Webhook.GenericWebService do
  ...
  field :webhook_type, 6,
    type: Google.Cloud.Dialogflow.Cx.V3.Webhook.GenericWebService.WebhookType,
    json_name: "webhookType",
    enum: true,
    deprecated: false

  field :http_method, 7,
    type: Google.Cloud.Dialogflow.Cx.V3.Webhook.GenericWebService.HttpMethod,
  ...
  field :parameter_mapping, 9,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3.Webhook.GenericWebService.ParameterMappingEntry,
