...
defmodule Google.Cloud.Dialogflow.Cx.V3.Fulfillment.GeneratorSettings.InputParametersEntry do
  @moduledoc false
...
defmodule Google.Cloud.Dialogflow.Cx.V3.Fulfillment.GeneratorSettings do
  @moduledoc false
  ...
  field :input_parameters, 2,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3.Fulfillment.GeneratorSettings.InputParametersEntry,
...
defmodule Google.Cloud.Dialogflow.Cx.V3.Fulfillment do
  ...
  field :generators, 13,
    repeated: true,
    type: Google.Cloud.Dialogflow.Cx.V3.Fulfillment.GeneratorSettings
end
