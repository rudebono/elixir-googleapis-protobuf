...
defmodule Google.Cloud.Dialogflow.V2beta1.CreateEntityTypeRequest do
  ...
  field :parent, 1, type: :string
  field :entity_type, 2, type: Google.Cloud.Dialogflow.V2beta1.EntityType, json_name: "entityType"
...
defmodule Google.Cloud.Dialogflow.V2beta1.UpdateEntityTypeRequest do
  ...
  field :entity_type, 1, type: Google.Cloud.Dialogflow.V2beta1.EntityType, json_name: "entityType"
  field :language_code, 2, type: :string, json_name: "languageCode"
