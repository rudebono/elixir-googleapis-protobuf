...
defmodule Google.Cloud.Dialogflow.V2beta1.SessionEntityType do
  ...
  @type t :: %__MODULE__{
          ...
          entity_override_mode:
            Google.Cloud.Dialogflow.V2beta1.SessionEntityType.EntityOverrideMode.t(),
...
defmodule Google.Cloud.Dialogflow.V2beta1.CreateSessionEntityTypeRequest do
  ...
  field :parent, 1, type: :string
  field :session_entity_type, 2, type: Google.Cloud.Dialogflow.V2beta1.SessionEntityType
end
...
defmodule Google.Cloud.Dialogflow.V2beta1.UpdateSessionEntityTypeRequest do
  ...
  field :session_entity_type, 1, type: Google.Cloud.Dialogflow.V2beta1.SessionEntityType
