...
defmodule Google.Cloud.Dialogflow.V2beta1.ConversationProfile do
  ...
  @type t :: %__MODULE__{
          ...
          automated_agent_config: Google.Cloud.Dialogflow.V2beta1.AutomatedAgentConfig.t() | nil,
          human_agent_assistant_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.t() | nil,
          human_agent_handoff_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentHandoffConfig.t() | nil,
          notification_config: Google.Cloud.Dialogflow.V2beta1.NotificationConfig.t() | nil,
          logging_config: Google.Cloud.Dialogflow.V2beta1.LoggingConfig.t() | nil,
...
defmodule Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionFeatureConfig do
  ...
  @type t :: %__MODULE__{
          suggestion_feature: Google.Cloud.Dialogflow.V2beta1.SuggestionFeature.t() | nil,
          enable_event_based_suggestion: boolean,
          suggestion_trigger_settings:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionTriggerSettings.t()
            | nil,
          query_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.t()
            | nil,
...
defmodule Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig do
  ...
  @type t :: %__MODULE__{
          ...
          context_filter_settings:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionQueryConfig.ContextFilterSettings.t()
            | nil
        }
...
defmodule Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig do
  ...
  @type t :: %__MODULE__{
          ...
          human_agent_suggestion_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionConfig.t() | nil,
          end_user_suggestion_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.SuggestionConfig.t() | nil,
          message_analysis_config:
            Google.Cloud.Dialogflow.V2beta1.HumanAgentAssistantConfig.MessageAnalysisConfig.t()
            | nil
        }
...
defmodule Google.Cloud.Dialogflow.V2beta1.NotificationConfig do
  ...
  @type t :: %__MODULE__{
          topic: String.t(),
          message_format: Google.Cloud.Dialogflow.V2beta1.NotificationConfig.MessageFormat.t()
        }
...
defmodule Google.Cloud.Dialogflow.V2beta1.ListConversationProfilesResponse do
  ...
  @type t :: %__MODULE__{
          conversation_profiles: [Google.Cloud.Dialogflow.V2beta1.ConversationProfile.t()],
...
defmodule Google.Cloud.Dialogflow.V2beta1.CreateConversationProfileRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          conversation_profile: Google.Cloud.Dialogflow.V2beta1.ConversationProfile.t() | nil
        }
