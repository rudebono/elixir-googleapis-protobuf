...
defmodule Google.Cloud.Dialogflow.V2.ValidationError do
  ...
  @type t :: %__MODULE__{
          severity: Google.Cloud.Dialogflow.V2.ValidationError.Severity.t(),
          entries: [String.t()],
...
defmodule Google.Cloud.Dialogflow.V2.ValidationResult do
  ...
  @type t :: %__MODULE__{
          validation_errors: [Google.Cloud.Dialogflow.V2.ValidationError.t()]
        }

  defstruct [:validation_errors]

  field :validation_errors, 1, repeated: true, type: Google.Cloud.Dialogflow.V2.ValidationError
end
