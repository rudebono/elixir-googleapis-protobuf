...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.IgnoredFacetValues do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.MergedFacetValue do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.MergedFacet do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.RerankConfig do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig do
  @moduledoc false
  ...
  field :facet_intervals, 1,
    repeated: true,
    type: Google.Cloud.Retail.V2beta.Interval,
    json_name: "facetIntervals"

  field :ignored_facet_values, 2,
    repeated: true,
    type: Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.IgnoredFacetValues,
    json_name: "ignoredFacetValues"

  field :merged_facet_values, 3,
    repeated: true,
    type: Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.MergedFacetValue,
    json_name: "mergedFacetValues"

  field :merged_facet, 4,
    type: Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.MergedFacet,
    json_name: "mergedFacet"

  field :rerank_config, 5,
    type: Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig.RerankConfig,
...
defmodule Google.Cloud.Retail.V2beta.CatalogAttribute do
  ...
  field :facet_config, 13,
    type: Google.Cloud.Retail.V2beta.CatalogAttribute.FacetConfig,
