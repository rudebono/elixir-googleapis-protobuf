...
defmodule Google.Cloud.Retail.V2beta.Model.ContextProductsType do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.Model.FrequentlyBoughtTogetherFeaturesConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.13.0", syntax: :proto3

  field :context_products_type, 2,
    type: Google.Cloud.Retail.V2beta.Model.ContextProductsType,
    json_name: "contextProductsType",
    enum: true,
    deprecated: false
end

defmodule Google.Cloud.Retail.V2beta.Model.ModelFeaturesConfig do
  @moduledoc false
  ...
  field :frequently_bought_together_config, 1,
    type: Google.Cloud.Retail.V2beta.Model.FrequentlyBoughtTogetherFeaturesConfig,
...
defmodule Google.Cloud.Retail.V2beta.Model do
  ...
  field :model_features_config, 22,
    type: Google.Cloud.Retail.V2beta.Model.ModelFeaturesConfig,
