defmodule Google.Cloud.Retail.V2beta.SearchRequest.SearchMode do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.DynamicFacetSpec.Mode do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.QueryExpansionSpec.Condition do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.FacetSpec.FacetKey do
  ...
  @type t :: %__MODULE__{
          key: String.t(),
          intervals: [Google.Cloud.Retail.V2beta.Interval.t()],
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.FacetSpec do
  ...
  @type t :: %__MODULE__{
          facet_key: Google.Cloud.Retail.V2beta.SearchRequest.FacetSpec.FacetKey.t() | nil,
          limit: integer,
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.DynamicFacetSpec do
  ...
  @type t :: %__MODULE__{
          mode: Google.Cloud.Retail.V2beta.SearchRequest.DynamicFacetSpec.Mode.t()
        }
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.BoostSpec do
  ...
  @type t :: %__MODULE__{
          condition_boost_specs: [
            Google.Cloud.Retail.V2beta.SearchRequest.BoostSpec.ConditionBoostSpec.t()
          ]
        }
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest.QueryExpansionSpec do
  ...
  @type t :: %__MODULE__{
          condition: Google.Cloud.Retail.V2beta.SearchRequest.QueryExpansionSpec.Condition.t(),
...
defmodule Google.Cloud.Retail.V2beta.SearchRequest do
  ...
  @type t :: %__MODULE__{
          ...
          order_by: String.t(),
          facet_specs: [Google.Cloud.Retail.V2beta.SearchRequest.FacetSpec.t()],
          dynamic_facet_spec: Google.Cloud.Retail.V2beta.SearchRequest.DynamicFacetSpec.t() | nil,
          boost_spec: Google.Cloud.Retail.V2beta.SearchRequest.BoostSpec.t() | nil,
          query_expansion_spec:
            Google.Cloud.Retail.V2beta.SearchRequest.QueryExpansionSpec.t() | nil,
          variant_rollup_keys: [String.t()],
          page_categories: [String.t()],
          search_mode: Google.Cloud.Retail.V2beta.SearchRequest.SearchMode.t()
        }
...
defmodule Google.Cloud.Retail.V2beta.SearchResponse.Facet do
  ...
  @type t :: %__MODULE__{
          key: String.t(),
          values: [Google.Cloud.Retail.V2beta.SearchResponse.Facet.FacetValue.t()],
...
defmodule Google.Cloud.Retail.V2beta.SearchResponse do
  ...
  @type t :: %__MODULE__{
          results: [Google.Cloud.Retail.V2beta.SearchResponse.SearchResult.t()],
          facets: [Google.Cloud.Retail.V2beta.SearchResponse.Facet.t()],
          total_size: integer,
...
defmodule Google.Cloud.Retail.V2beta.SearchService.Service do
  @moduledoc false
  use GRPC.Service, name: "google.cloud.retail.v2beta.SearchService"

  rpc :Search, Google.Cloud.Retail.V2beta.SearchRequest, Google.Cloud.Retail.V2beta.SearchResponse
end

defmodule Google.Cloud.Retail.V2beta.SearchService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Cloud.Retail.V2beta.SearchService.Service
end
