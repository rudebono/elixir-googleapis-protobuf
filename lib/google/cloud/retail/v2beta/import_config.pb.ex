...
defmodule Google.Cloud.Retail.V2beta.ImportCompletionDataRequest do
  ...
  field :parent, 1, type: :string
  field :input_config, 2, type: Google.Cloud.Retail.V2beta.CompletionDataInputConfig
...
defmodule Google.Cloud.Retail.V2beta.CompletionDataInputConfig do
  ...
  oneof :source, 0
  field :big_query_source, 1, type: Google.Cloud.Retail.V2beta.BigQuerySource, oneof: 0
end
