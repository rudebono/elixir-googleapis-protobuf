...
defmodule Google.Cloud.Retail.V2alpha.Product do
  ...
  field :fulfillment_info, 21, repeated: true, type: Google.Cloud.Retail.V2alpha.FulfillmentInfo
  ...
  field :color_info, 25, type: Google.Cloud.Retail.V2alpha.ColorInfo
  ...
  field :variants, 31, repeated: true, type: Google.Cloud.Retail.V2alpha.Product
end
