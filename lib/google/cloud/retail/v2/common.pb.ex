...
defmodule Google.Cloud.Retail.V2.Rule.ForceReturnFacetAction.FacetPositionAdjustment do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.Rule.ForceReturnFacetAction do
  @moduledoc false
  ...
  field :facet_position_adjustments, 1,
    repeated: true,
    type: Google.Cloud.Retail.V2.Rule.ForceReturnFacetAction.FacetPositionAdjustment,
    json_name: "facetPositionAdjustments"
end

defmodule Google.Cloud.Retail.V2.Rule.RemoveFacetAction do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.Rule.PinAction.PinMapEntry do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.Rule.PinAction do
  @moduledoc false
  ...
  field :pin_map, 1,
    repeated: true,
    type: Google.Cloud.Retail.V2.Rule.PinAction.PinMapEntry,
    json_name: "pinMap",
    map: true,
    deprecated: false
end
...
defmodule Google.Cloud.Retail.V2.Rule do
  ...
  field :force_return_facet_action, 12,
    type: Google.Cloud.Retail.V2.Rule.ForceReturnFacetAction,
    json_name: "forceReturnFacetAction",
    oneof: 0

  field :remove_facet_action, 13,
    type: Google.Cloud.Retail.V2.Rule.RemoveFacetAction,
    json_name: "removeFacetAction",
    oneof: 0

  field :pin_action, 14,
    type: Google.Cloud.Retail.V2.Rule.PinAction,
    json_name: "pinAction",
    oneof: 0
...
defmodule Google.Cloud.Retail.V2.LocalInventory do
  ...
  field :price_info, 2,
    type: Google.Cloud.Retail.V2.PriceInfo,
    json_name: "priceInfo",
    deprecated: false
...
defmodule Google.Cloud.Retail.V2.PinControlMetadata.ProductPins do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.PinControlMetadata.AllMatchedPinsEntry do
  @moduledoc false

  use Protobuf, map: true, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :key, 1, type: :int64
  field :value, 2, type: Google.Cloud.Retail.V2.PinControlMetadata.ProductPins
end

defmodule Google.Cloud.Retail.V2.PinControlMetadata.DroppedPinsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.PinControlMetadata do
  @moduledoc false
  ...
  field :all_matched_pins, 1,
    repeated: true,
    type: Google.Cloud.Retail.V2.PinControlMetadata.AllMatchedPinsEntry,
    json_name: "allMatchedPins",
    map: true

  field :dropped_pins, 2,
    repeated: true,
    type: Google.Cloud.Retail.V2.PinControlMetadata.DroppedPinsEntry,
