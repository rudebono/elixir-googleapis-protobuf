defmodule Google.Cloud.Retail.V2.CreateServingConfigRequest do
  @moduledoc false
  ...
  field :serving_config, 2,
    type: Google.Cloud.Retail.V2.ServingConfig,
...
defmodule Google.Cloud.Retail.V2.UpdateServingConfigRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.DeleteServingConfigRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.GetServingConfigRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.ListServingConfigsRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.ListServingConfigsResponse do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.AddControlRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.RemoveControlRequest do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.ServingConfigService.Service do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.ServingConfigService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Retail.V2.ServingConfigService.Service
end
