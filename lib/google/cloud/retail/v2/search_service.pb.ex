...
defmodule Google.Cloud.Retail.V2.SearchRequest.FacetSpec do
  ...
  field :facet_key, 1, type: Google.Cloud.Retail.V2.SearchRequest.FacetSpec.FacetKey
...
defmodule Google.Cloud.Retail.V2.SearchRequest do
  ...
  field :user_info, 5, type: Google.Cloud.Retail.V2.UserInfo
  ...
  field :facet_specs, 12, repeated: true, type: Google.Cloud.Retail.V2.SearchRequest.FacetSpec
  field :dynamic_facet_spec, 21, type: Google.Cloud.Retail.V2.SearchRequest.DynamicFacetSpec
  field :boost_spec, 13, type: Google.Cloud.Retail.V2.SearchRequest.BoostSpec
...
defmodule Google.Cloud.Retail.V2.SearchResponse do
  ...
  field :query_expansion_info, 7, type: Google.Cloud.Retail.V2.SearchResponse.QueryExpansionInfo
