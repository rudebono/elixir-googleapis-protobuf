...
defmodule Google.Cloud.Retail.V2.Product do
  ...
  field :attributes, 12,
    repeated: true,
    type: Google.Cloud.Retail.V2.Product.AttributesEntry,
    map: true

  field :tags, 13, repeated: true, type: :string
  field :price_info, 14, type: Google.Cloud.Retail.V2.PriceInfo, json_name: "priceInfo"
  ...
  field :fulfillment_info, 21,
    repeated: true,
    type: Google.Cloud.Retail.V2.FulfillmentInfo,
  ...
  field :color_info, 25, type: Google.Cloud.Retail.V2.ColorInfo, json_name: "colorInfo"
