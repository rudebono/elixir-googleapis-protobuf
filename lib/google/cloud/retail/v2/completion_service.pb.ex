...
defmodule Google.Cloud.Retail.V2.CompleteQueryResponse.AttributeResult do
  @moduledoc false
...
defmodule Google.Cloud.Retail.V2.CompleteQueryResponse.AttributeResultsEntry do
  @moduledoc false

  use Protobuf, map: true, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :key, 1, type: :string
  field :value, 2, type: Google.Cloud.Retail.V2.CompleteQueryResponse.AttributeResult
end
...
defmodule Google.Cloud.Retail.V2.CompleteQueryResponse do
  ...
  field :attribute_results, 4,
    repeated: true,
    type: Google.Cloud.Retail.V2.CompleteQueryResponse.AttributeResultsEntry,
