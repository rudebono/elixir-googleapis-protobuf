defmodule Google.Cloud.Security.Publicca.V1beta1.CreateExternalAccountKeyRequest do
  ...
  field :external_account_key, 2,
    type: Google.Cloud.Security.Publicca.V1beta1.ExternalAccountKey,
...
defmodule Google.Cloud.Security.Publicca.V1beta1.PublicCertificateAuthorityService.Stub do
  @moduledoc false
  use GRPC.Stub,
    service: Google.Cloud.Security.Publicca.V1beta1.PublicCertificateAuthorityService.Service
end
