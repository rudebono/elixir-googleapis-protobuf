...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.File do
  ...
  @type t :: %__MODULE__{
          type:
            {:remote, Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.Remote.t() | nil}
            | {:gcs, Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.Gcs.t() | nil}
            | {:local_path, String.t()},
  ...
  field :remote, 1, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.Remote, oneof: 0
  field :gcs, 2, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.Gcs, oneof: 0
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.Deb do
  ...
  @type t :: %__MODULE__{
          source: Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.t() | nil,
          pull_deps: boolean
        }

  defstruct [:source, :pull_deps]

  field :source, 1, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.File
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource do
  ...
  @type t :: %__MODULE__{
          system_package:
            {:apt, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.APT.t() | nil}
            | {:deb, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.Deb.t() | nil}
            | {:yum, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.YUM.t() | nil}
            | {:zypper,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.Zypper.t() | nil}
            | {:rpm, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.RPM.t() | nil}
            | {:googet,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.GooGet.t() | nil}
            | {:msi, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.MSI.t() | nil},
          desired_state:
            Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.DesiredState.t()
        }
  ...
  field :desired_state, 1,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.DesiredState,
    enum: true,
    json_name: "desiredState"

  field :apt, 2, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.APT, oneof: 0
  field :deb, 3, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.Deb, oneof: 0
  field :yum, 4, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.YUM, oneof: 0

  field :zypper, 5,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.Zypper,
    oneof: 0

  field :rpm, 6, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.RPM, oneof: 0

  field :googet, 7,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.GooGet,
    oneof: 0

  field :msi, 8, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.MSI, oneof: 0
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.AptRepository do
  ...
  @type t :: %__MODULE__{
          archive_type:
            Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.AptRepository.ArchiveType.t(),
          uri: String.t(),
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource do
  ...
  @type t :: %__MODULE__{
          repository:
            {:apt,
             Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.AptRepository.t() | nil}
            | {:yum,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.YumRepository.t()
               | nil}
            | {:zypper,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.ZypperRepository.t()
               | nil}
            | {:goo,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.GooRepository.t()
               | nil}
        }
  ...
  field :apt, 1,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.AptRepository,
    oneof: 0

  field :yum, 2,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.YumRepository,
    oneof: 0

  field :zypper, 3,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.ZypperRepository,
    oneof: 0

  field :goo, 4,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.GooRepository,
    oneof: 0
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec do
  ...
  @type t :: %__MODULE__{
          source:
            {:file, Google.Cloud.Osconfig.V1.OSPolicy.Resource.File.t() | nil}
            | {:script, String.t()},
          args: [String.t()],
          interpreter:
            Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec.Interpreter.t(),
  ...
  field :file, 1, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.File, oneof: 0
  field :script, 2, type: :string, oneof: 0
  field :args, 3, repeated: true, type: :string

  field :interpreter, 4,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec.Interpreter,
    enum: true
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource do
  ...
  @type t :: %__MODULE__{
          validate: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec.t() | nil,
          enforce: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec.t() | nil
        }

  defstruct [:validate, :enforce]

  field :validate, 1, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec
  field :enforce, 2, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.Exec
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource.FileResource do
  ...
  @type t :: %__MODULE__{
          source:
            ...
            | {:content, String.t()},
          path: String.t(),
          state: Google.Cloud.Osconfig.V1.OSPolicy.Resource.FileResource.DesiredState.t(),
  ...
  field :state, 4,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.FileResource.DesiredState,
    enum: true
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.Resource do
  ...
  @type t :: %__MODULE__{
          resource_type:
            {:pkg, Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource.t() | nil}
            | {:repository,
               Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource.t() | nil}
            | {:exec, Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource.t() | nil}
            | {:file, Google.Cloud.Osconfig.V1.OSPolicy.Resource.FileResource.t() | nil},
          id: String.t()
        }
  ...
  field :id, 1, type: :string
  field :pkg, 2, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.PackageResource, oneof: 0

  field :repository, 3,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.RepositoryResource,
    oneof: 0

  field :exec, 4, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.ExecResource, oneof: 0
  field :file, 5, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource.FileResource, oneof: 0
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.ResourceGroup do
  ...
  @type t :: %__MODULE__{
          inventory_filters: [Google.Cloud.Osconfig.V1.OSPolicy.InventoryFilter.t()],
          resources: [Google.Cloud.Osconfig.V1.OSPolicy.Resource.t()]
        }

  defstruct [:inventory_filters, :resources]

  field :inventory_filters, 1,
    repeated: true,
    type: Google.Cloud.Osconfig.V1.OSPolicy.InventoryFilter,
    json_name: "inventoryFilters"

  field :resources, 2, repeated: true, type: Google.Cloud.Osconfig.V1.OSPolicy.Resource
...
defmodule Google.Cloud.Osconfig.V1.OSPolicy do
  ...
  @type t :: %__MODULE__{
          ...
          mode: Google.Cloud.Osconfig.V1.OSPolicy.Mode.t(),
          resource_groups: [Google.Cloud.Osconfig.V1.OSPolicy.ResourceGroup.t()],
  ...
  field :mode, 3, type: Google.Cloud.Osconfig.V1.OSPolicy.Mode, enum: true

  field :resource_groups, 4,
    repeated: true,
    type: Google.Cloud.Osconfig.V1.OSPolicy.ResourceGroup,
