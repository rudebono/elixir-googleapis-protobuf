...
defmodule Google.Cloud.Osconfig.V1.OSPolicy.ResourceGroup do
  ...
  field :resources, 2,
    repeated: true,
    type: Google.Cloud.Osconfig.V1.OSPolicy.Resource,
    deprecated: false
end
defmodule Google.Cloud.Osconfig.V1.OSPolicy do
  ...
  field :mode, 3, type: Google.Cloud.Osconfig.V1.OSPolicy.Mode, enum: true, deprecated: false
