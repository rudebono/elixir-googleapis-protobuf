...
defmodule Google.Cloud.Osconfig.V1beta.Assignment.OsType do
  ...
  field :os_architecture, 3, type: :string
end
...
defmodule Google.Cloud.Osconfig.V1beta.Assignment do
  ...
  field :group_labels, 1, repeated: true, type: Google.Cloud.Osconfig.V1beta.Assignment.GroupLabel
  field :zones, 2, repeated: true, type: :string
  field :instances, 3, repeated: true, type: :string
  field :instance_name_prefixes, 4, repeated: true, type: :string
  field :os_types, 5, repeated: true, type: Google.Cloud.Osconfig.V1beta.Assignment.OsType
end
...
defmodule Google.Cloud.Osconfig.V1beta.Package do
  ...
  field :name, 1, type: :string
  field :desired_state, 2, type: Google.Cloud.Osconfig.V1beta.DesiredState, enum: true
...
defmodule Google.Cloud.Osconfig.V1beta.AptRepository do
  ...
  field :archive_type, 1, type: Google.Cloud.Osconfig.V1beta.AptRepository.ArchiveType, enum: true
...
defmodule Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step do
  ...
  oneof :step, 0
  field :file_copy, 1, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step.CopyFile, oneof: 0
  ...
  field :file_exec, 6, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step.ExecFile, oneof: 0
  field :script_run, 7, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step.RunScript, oneof: 0
end
...
defmodule Google.Cloud.Osconfig.V1beta.SoftwareRecipe do
  ...
  field :install_steps, 4, repeated: true, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step
  field :update_steps, 5, repeated: true, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe.Step
  field :desired_state, 6, type: Google.Cloud.Osconfig.V1beta.DesiredState, enum: true
end
...
defmodule Google.Cloud.Osconfig.V1beta.CreateGuestPolicyRequest do
  ...
  field :guest_policy_id, 2, type: :string
  field :guest_policy, 3, type: Google.Cloud.Osconfig.V1beta.GuestPolicy
end
...
defmodule Google.Cloud.Osconfig.V1beta.ListGuestPoliciesResponse do
  ...
  field :guest_policies, 1, repeated: true, type: Google.Cloud.Osconfig.V1beta.GuestPolicy
...
defmodule Google.Cloud.Osconfig.V1beta.UpdateGuestPolicyRequest do
  ...
  field :guest_policy, 1, type: Google.Cloud.Osconfig.V1beta.GuestPolicy
...
defmodule Google.Cloud.Osconfig.V1beta.EffectiveGuestPolicy.SourcedPackageRepository do
  ...
  field :source, 1, type: :string
  field :package_repository, 2, type: Google.Cloud.Osconfig.V1beta.PackageRepository
end
...
defmodule Google.Cloud.Osconfig.V1beta.EffectiveGuestPolicy.SourcedSoftwareRecipe do
  ...
  field :source, 1, type: :string
  field :software_recipe, 2, type: Google.Cloud.Osconfig.V1beta.SoftwareRecipe
end
