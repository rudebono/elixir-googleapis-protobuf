...
defmodule Google.Cloud.Orchestration.Airflow.Service.V1beta1.ListImageVersionsResponse do
  ...
  @type t :: %__MODULE__{
          image_versions: [Google.Cloud.Orchestration.Airflow.Service.V1beta1.ImageVersion.t()],
...
defmodule Google.Cloud.Orchestration.Airflow.Service.V1beta1.ImageVersions.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Cloud.Orchestration.Airflow.Service.V1beta1.ImageVersions.Service
end
