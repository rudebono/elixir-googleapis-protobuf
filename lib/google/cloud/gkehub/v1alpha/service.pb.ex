...
defmodule Google.Cloud.Gkehub.V1alpha.ListFeaturesResponse do
  ...
  @type t :: %__MODULE__{
          resources: [Google.Cloud.Gkehub.V1alpha.Feature.t()],
...
defmodule Google.Cloud.Gkehub.V1alpha.CreateFeatureRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          feature_id: String.t(),
          resource: Google.Cloud.Gkehub.V1alpha.Feature.t() | nil,
          request_id: String.t()
        }
...
defmodule Google.Cloud.Gkehub.V1alpha.GkeHub.Service do
  @moduledoc false
  use GRPC.Service, name: "google.cloud.gkehub.v1alpha.GkeHub"
