...
defmodule Google.Cloud.Vision.V1p1beta1.WebDetection.WebPage do
  ...
  @type t :: %__MODULE__{
          ...
          score: float | :infinity | :negative_infinity | :nan,
          page_title: String.t(),
          full_matching_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebImage.t()],
          partial_matching_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebImage.t()]
        }
...
defmodule Google.Cloud.Vision.V1p1beta1.WebDetection do
  ...
  @type t :: %__MODULE__{
          web_entities: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebEntity.t()],
          full_matching_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebImage.t()],
          partial_matching_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebImage.t()],
          pages_with_matching_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebPage.t()],
          visually_similar_images: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebImage.t()],
          best_guess_labels: [Google.Cloud.Vision.V1p1beta1.WebDetection.WebLabel.t()]
        }
