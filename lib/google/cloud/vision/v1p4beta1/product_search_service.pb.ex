...
defmodule Google.Cloud.Vision.V1p4beta1.Product do
  ...
  @type t :: %__MODULE__{
          ...
          product_labels: [Google.Cloud.Vision.V1p4beta1.Product.KeyValue.t()]
        }
  ...
  field :product_labels, 5, repeated: true, type: Google.Cloud.Vision.V1p4beta1.Product.KeyValue
end
...
defmodule Google.Cloud.Vision.V1p4beta1.ReferenceImage do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          uri: String.t(),
          bounding_polys: [Google.Cloud.Vision.V1p4beta1.BoundingPoly.t()]
        }
  ...
  field :bounding_polys, 3, repeated: true, type: Google.Cloud.Vision.V1p4beta1.BoundingPoly
end
...
defmodule Google.Cloud.Vision.V1p4beta1.CreateProductRequest do
  ...
  field :product, 2, type: Google.Cloud.Vision.V1p4beta1.Product
...
defmodule Google.Cloud.Vision.V1p4beta1.ListProductsResponse do
  ...
  @type t :: %__MODULE__{
          products: [Google.Cloud.Vision.V1p4beta1.Product.t()],
...
defmodule Google.Cloud.Vision.V1p4beta1.CreateProductSetRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          product_set: Google.Cloud.Vision.V1p4beta1.ProductSet.t() | nil,
  ...
  field :parent, 1, type: :string
  field :product_set, 2, type: Google.Cloud.Vision.V1p4beta1.ProductSet
...
defmodule Google.Cloud.Vision.V1p4beta1.ListProductSetsResponse do
  ...
  @type t :: %__MODULE__{
          product_sets: [Google.Cloud.Vision.V1p4beta1.ProductSet.t()],
          next_page_token: String.t()
        }

  defstruct [:product_sets, :next_page_token]

  field :product_sets, 1, repeated: true, type: Google.Cloud.Vision.V1p4beta1.ProductSet
  field :next_page_token, 2, type: :string
end
...
defmodule Google.Cloud.Vision.V1p4beta1.UpdateProductSetRequest do
  ...
  field :product_set, 1, type: Google.Cloud.Vision.V1p4beta1.ProductSet
  field :update_mask, 2, type: Google.Protobuf.FieldMask
end
...
defmodule Google.Cloud.Vision.V1p4beta1.CreateReferenceImageRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          reference_image: Google.Cloud.Vision.V1p4beta1.ReferenceImage.t() | nil,
  ...
  field :parent, 1, type: :string
  field :reference_image, 2, type: Google.Cloud.Vision.V1p4beta1.ReferenceImage
...
defmodule Google.Cloud.Vision.V1p4beta1.ListReferenceImagesResponse do
  ...
  @type t :: %__MODULE__{
          reference_images: [Google.Cloud.Vision.V1p4beta1.ReferenceImage.t()],
          page_size: integer,
          next_page_token: String.t()
        }
  ...
  field :reference_images, 1, repeated: true, type: Google.Cloud.Vision.V1p4beta1.ReferenceImage
  field :page_size, 2, type: :int32
...
defmodule Google.Cloud.Vision.V1p4beta1.ImportProductSetsInputConfig do
  ...
  oneof :source, 0
  field :gcs_source, 1, type: Google.Cloud.Vision.V1p4beta1.ImportProductSetsGcsSource, oneof: 0
end
...
defmodule Google.Cloud.Vision.V1p4beta1.ImportProductSetsRequest do
  ...
  @type t :: %__MODULE__{
          parent: String.t(),
          input_config: Google.Cloud.Vision.V1p4beta1.ImportProductSetsInputConfig.t() | nil
        }

  defstruct [:parent, :input_config]

  field :parent, 1, type: :string
  field :input_config, 2, type: Google.Cloud.Vision.V1p4beta1.ImportProductSetsInputConfig
end
...
defmodule Google.Cloud.Vision.V1p4beta1.BatchOperationMetadata do
  ...
  @type t :: %__MODULE__{
          state: Google.Cloud.Vision.V1p4beta1.BatchOperationMetadata.State.t(),
...
defmodule Google.Cloud.Vision.V1p4beta1.PurgeProductsRequest do
  ...
  field :product_set_purge_config, 2,
    type: Google.Cloud.Vision.V1p4beta1.ProductSetPurgeConfig,
    oneof: 0
...
defmodule Google.Cloud.Vision.V1p4beta1.ProductSearch.Service do
  @moduledoc false
  use GRPC.Service, name: "google.cloud.vision.v1p4beta1.ProductSearch"
