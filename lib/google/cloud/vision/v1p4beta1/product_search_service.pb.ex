...
defmodule Google.Cloud.Vision.V1p4beta1.Product do
  ...
  field :product_labels, 5,
    repeated: true,
    type: Google.Cloud.Vision.V1p4beta1.Product.KeyValue,
...
defmodule Google.Cloud.Vision.V1p4beta1.CreateProductSetRequest do
  ...
  field :parent, 1, type: :string
  field :product_set, 2, type: Google.Cloud.Vision.V1p4beta1.ProductSet, json_name: "productSet"
...
defmodule Google.Cloud.Vision.V1p4beta1.UpdateProductSetRequest do
  ...
  field :product_set, 1, type: Google.Cloud.Vision.V1p4beta1.ProductSet, json_name: "productSet"
  field :update_mask, 2, type: Google.Protobuf.FieldMask, json_name: "updateMask"
...
defmodule Google.Cloud.Vision.V1p4beta1.CreateReferenceImageRequest do
  ...
  field :reference_image, 2,
    type: Google.Cloud.Vision.V1p4beta1.ReferenceImage,
...
defmodule Google.Cloud.Vision.V1p4beta1.ImportProductSetsInputConfig do
  ...
  @type t :: %__MODULE__{
          source:
            {:gcs_source, Google.Cloud.Vision.V1p4beta1.ImportProductSetsGcsSource.t() | nil}
        }
  ...
  field :gcs_source, 1,
    type: Google.Cloud.Vision.V1p4beta1.ImportProductSetsGcsSource,
    json_name: "gcsSource",
    oneof: 0
...
defmodule Google.Cloud.Vision.V1p4beta1.ImportProductSetsRequest do
  ...
  field :input_config, 2,
    type: Google.Cloud.Vision.V1p4beta1.ImportProductSetsInputConfig,
  ...
  @type t :: %__MODULE__{
          target:
            {:product_set_purge_config,
             Google.Cloud.Vision.V1p4beta1.ProductSetPurgeConfig.t() | nil}
