...
defmodule Google.Cloud.Vision.V1p4beta1.WebDetection.WebPage do
  ...
  field :full_matching_images, 4,
    repeated: true,
    type: Google.Cloud.Vision.V1p4beta1.WebDetection.WebImage,
...
defmodule Google.Cloud.Vision.V1p4beta1.WebDetection do
  ...
  field :web_entities, 1,
    repeated: true,
    type: Google.Cloud.Vision.V1p4beta1.WebDetection.WebEntity,
  ...
  field :pages_with_matching_images, 4,
    repeated: true,
    type: Google.Cloud.Vision.V1p4beta1.WebDetection.WebPage,
  ...
  field :best_guess_labels, 8,
    repeated: true,
    type: Google.Cloud.Vision.V1p4beta1.WebDetection.WebLabel,
