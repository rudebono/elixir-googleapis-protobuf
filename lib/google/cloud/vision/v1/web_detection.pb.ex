...
defmodule Google.Cloud.Vision.V1.WebDetection.WebPage do
  ...
  @type t :: %__MODULE__{
          ...
          score: float | :infinity | :negative_infinity | :nan,
          page_title: String.t(),
          full_matching_images: [Google.Cloud.Vision.V1.WebDetection.WebImage.t()],
...
defmodule Google.Cloud.Vision.V1.WebDetection do
  ...
  @type t :: %__MODULE__{
          web_entities: [Google.Cloud.Vision.V1.WebDetection.WebEntity.t()],
          full_matching_images: [Google.Cloud.Vision.V1.WebDetection.WebImage.t()],
          partial_matching_images: [Google.Cloud.Vision.V1.WebDetection.WebImage.t()],
          pages_with_matching_images: [Google.Cloud.Vision.V1.WebDetection.WebPage.t()],
          visually_similar_images: [Google.Cloud.Vision.V1.WebDetection.WebImage.t()],
  ...
  field :web_entities, 1, repeated: true, type: Google.Cloud.Vision.V1.WebDetection.WebEntity
  ...
  field :pages_with_matching_images, 4,
    repeated: true,
    type: Google.Cloud.Vision.V1.WebDetection.WebPage

  field :visually_similar_images, 6,
    repeated: true,
    type: Google.Cloud.Vision.V1.WebDetection.WebImage

  field :best_guess_labels, 8, repeated: true, type: Google.Cloud.Vision.V1.WebDetection.WebLabel
end
