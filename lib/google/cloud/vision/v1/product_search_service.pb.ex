...
defmodule Google.Cloud.Vision.V1.CreateProductSetRequest do
  ...
  field :parent, 1, type: :string
  field :product_set, 2, type: Google.Cloud.Vision.V1.ProductSet, json_name: "productSet"
...
defmodule Google.Cloud.Vision.V1.UpdateProductSetRequest do
  ...
  field :product_set, 1, type: Google.Cloud.Vision.V1.ProductSet, json_name: "productSet"
  field :update_mask, 2, type: Google.Protobuf.FieldMask, json_name: "updateMask"
