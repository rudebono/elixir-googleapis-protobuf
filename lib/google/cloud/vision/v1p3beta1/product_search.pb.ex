...
defmodule Google.Cloud.Vision.V1p3beta1.ProductSearchResults.GroupedResult do
  ...
  @type t :: %__MODULE__{
          ...
          object_annotations: [
            Google.Cloud.Vision.V1p3beta1.ProductSearchResults.ObjectAnnotation.t()
          ]
        }
...
defmodule Google.Cloud.Vision.V1p3beta1.ProductSearchResults do
  ...
  @type t :: %__MODULE__{
          ...
          product_grouped_results: [
            Google.Cloud.Vision.V1p3beta1.ProductSearchResults.GroupedResult.t()
          ]
        }
  ...
  field :product_grouped_results, 6,
    repeated: true,
    type: Google.Cloud.Vision.V1p3beta1.ProductSearchResults.GroupedResult,
