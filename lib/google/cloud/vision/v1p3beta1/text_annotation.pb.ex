...
defmodule Google.Cloud.Vision.V1p3beta1.TextAnnotation.TextProperty do
  ...
  field :detected_languages, 1,
    repeated: true,
    type: Google.Cloud.Vision.V1p3beta1.TextAnnotation.DetectedLanguage

  field :detected_break, 2, type: Google.Cloud.Vision.V1p3beta1.TextAnnotation.DetectedBreak
end
...
defmodule Google.Cloud.Vision.V1p3beta1.Page do
  ...
  field :blocks, 4, repeated: true, type: Google.Cloud.Vision.V1p3beta1.Block
...
defmodule Google.Cloud.Vision.V1p3beta1.Block do
  ...
  field :property, 1, type: Google.Cloud.Vision.V1p3beta1.TextAnnotation.TextProperty
  field :bounding_box, 2, type: Google.Cloud.Vision.V1p3beta1.BoundingPoly
  field :paragraphs, 3, repeated: true, type: Google.Cloud.Vision.V1p3beta1.Paragraph
  field :block_type, 4, type: Google.Cloud.Vision.V1p3beta1.Block.BlockType, enum: true
  field :confidence, 5, type: :float
end
...
defmodule Google.Cloud.Vision.V1p3beta1.Paragraph do
  ...
  field :property, 1, type: Google.Cloud.Vision.V1p3beta1.TextAnnotation.TextProperty
  field :bounding_box, 2, type: Google.Cloud.Vision.V1p3beta1.BoundingPoly
  field :words, 3, repeated: true, type: Google.Cloud.Vision.V1p3beta1.Word
...
defmodule Google.Cloud.Vision.V1p3beta1.Word do
  ...
  field :property, 1, type: Google.Cloud.Vision.V1p3beta1.TextAnnotation.TextProperty
  field :bounding_box, 2, type: Google.Cloud.Vision.V1p3beta1.BoundingPoly
  field :symbols, 3, repeated: true, type: Google.Cloud.Vision.V1p3beta1.Symbol
  field :confidence, 4, type: :float
end
