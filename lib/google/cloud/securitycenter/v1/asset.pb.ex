defmodule Google.Cloud.Securitycenter.V1.Asset.SecurityCenterProperties do
  ...
  field :resource_display_name, 6, type: :string
  field :resource_parent_display_name, 7, type: :string
  field :resource_project_display_name, 8, type: :string
...
defmodule Google.Cloud.Securitycenter.V1.Asset.IamPolicy do
  ...
  field :policy_blob, 1, type: :string
end
...
defmodule Google.Cloud.Securitycenter.V1.Asset do
  ...
  @type t :: %__MODULE__{
          ...
          security_center_properties:
            Google.Cloud.Securitycenter.V1.Asset.SecurityCenterProperties.t() | nil,
          ...
          iam_policy: Google.Cloud.Securitycenter.V1.Asset.IamPolicy.t() | nil,
  ...
  field :security_center_properties, 2,
    type: Google.Cloud.Securitycenter.V1.Asset.SecurityCenterProperties

  field :resource_properties, 7,
    repeated: true,
    type: Google.Cloud.Securitycenter.V1.Asset.ResourcePropertiesEntry,
    map: true
  ...
  field :iam_policy, 11, type: Google.Cloud.Securitycenter.V1.Asset.IamPolicy
  field :canonical_name, 13, type: :string
end
