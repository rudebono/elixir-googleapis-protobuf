...
defmodule Google.Cloud.Securitycenter.V1.CreateNotificationConfigRequest do
  ...
  field :notification_config, 3, type: Google.Cloud.Securitycenter.V1.NotificationConfig
end
...
defmodule Google.Cloud.Securitycenter.V1.GroupAssetsResponse do
  ...
  field :group_by_results, 1, repeated: true, type: Google.Cloud.Securitycenter.V1.GroupResult
...
defmodule Google.Cloud.Securitycenter.V1.UpdateNotificationConfigRequest do
  ...
  field :notification_config, 1, type: Google.Cloud.Securitycenter.V1.NotificationConfig
  field :update_mask, 2, type: Google.Protobuf.FieldMask
end
...
defmodule Google.Cloud.Securitycenter.V1.UpdateOrganizationSettingsRequest do
  ...
  field :organization_settings, 1, type: Google.Cloud.Securitycenter.V1.OrganizationSettings
  field :update_mask, 2, type: Google.Protobuf.FieldMask
end
...
defmodule Google.Cloud.Securitycenter.V1.UpdateSecurityMarksRequest do
  ...
  field :security_marks, 1, type: Google.Cloud.Securitycenter.V1.SecurityMarks
  field :update_mask, 2, type: Google.Protobuf.FieldMask
  field :start_time, 3, type: Google.Protobuf.Timestamp
end
