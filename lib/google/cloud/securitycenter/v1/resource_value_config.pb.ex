...
defmodule Google.Cloud.Securitycenter.V1.ResourceValueConfig do
  ...
  field :resource_labels_selector, 6,
    repeated: true,
    type: Google.Cloud.Securitycenter.V1.ResourceValueConfig.ResourceLabelsSelectorEntry,
  ...
  field :sensitive_data_protection_mapping, 11,
    type: Google.Cloud.Securitycenter.V1.ResourceValueConfig.SensitiveDataProtectionMapping,
