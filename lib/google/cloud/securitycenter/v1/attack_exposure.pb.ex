defmodule Google.Cloud.Securitycenter.V1.AttackExposure.State do
  @moduledoc false
...
defmodule Google.Cloud.Securitycenter.V1.AttackExposure do
  @moduledoc false
  ...
  field :state, 4, type: Google.Cloud.Securitycenter.V1.AttackExposure.State, enum: true
