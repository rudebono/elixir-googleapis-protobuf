...
defmodule Google.Cloud.Securitycenter.V1p1beta1.Asset do
  ...
  field :security_marks, 8, type: Google.Cloud.Securitycenter.V1p1beta1.SecurityMarks
  field :create_time, 9, type: Google.Protobuf.Timestamp
  field :update_time, 10, type: Google.Protobuf.Timestamp
  field :iam_policy, 11, type: Google.Cloud.Securitycenter.V1p1beta1.Asset.IamPolicy
