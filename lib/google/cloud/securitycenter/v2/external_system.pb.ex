defmodule Google.Cloud.Securitycenter.V2.ExternalSystem.TicketInfo do
  @moduledoc false
...
defmodule Google.Cloud.Securitycenter.V2.ExternalSystem do
  @moduledoc false
  ...
  field :ticket_info, 8,
    type: Google.Cloud.Securitycenter.V2.ExternalSystem.TicketInfo,
