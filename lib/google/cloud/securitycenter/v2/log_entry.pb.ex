defmodule Google.Cloud.Securitycenter.V2.LogEntry do
  @moduledoc false
  ...
  field :cloud_logging_entry, 1,
    type: Google.Cloud.Securitycenter.V2.CloudLoggingEntry,
    json_name: "cloudLoggingEntry",
    oneof: 0
end

defmodule Google.Cloud.Securitycenter.V2.CloudLoggingEntry do
  @moduledoc false
