defmodule Google.Cloud.Securitycenter.V2.SecurityPosture.PolicyDriftDetails do
  @moduledoc false
...
defmodule Google.Cloud.Securitycenter.V2.SecurityPosture do
  @moduledoc false
  ...
  field :policy_drift_details, 8,
    repeated: true,
    type: Google.Cloud.Securitycenter.V2.SecurityPosture.PolicyDriftDetails,
