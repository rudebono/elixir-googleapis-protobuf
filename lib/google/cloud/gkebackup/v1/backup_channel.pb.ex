defmodule Google.Cloud.Gkebackup.V1.BackupChannel.LabelsEntry do
  @moduledoc false
...
defmodule Google.Cloud.Gkebackup.V1.BackupChannel do
  @moduledoc false
  ...
  field :labels, 6,
    repeated: true,
    type: Google.Cloud.Gkebackup.V1.BackupChannel.LabelsEntry,
    map: true,
    deprecated: false
