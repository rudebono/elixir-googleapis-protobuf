...
defmodule Google.Cloud.Gkebackup.Logging.V1.LoggedRestorePlan do
  ...
  field :backup_plan, 2, type: :string
  field :cluster, 3, type: :string
  field :restore_config, 4, type: Google.Cloud.Gkebackup.Logging.V1.RestoreConfig
...
defmodule Google.Cloud.Gkebackup.Logging.V1.RestoreConfig.GroupKind do
  ...
  field :resource_group, 1, type: :string
  field :resource_kind, 2, type: :string
end
...
defmodule Google.Cloud.Gkebackup.Logging.V1.RestoreConfig.SubstitutionRule do
  ...
  field :target_namespaces, 1, repeated: true, type: :string

  field :target_group_kinds, 2,
    repeated: true,
    type: Google.Cloud.Gkebackup.Logging.V1.RestoreConfig.GroupKind

  field :target_json_path, 3, type: :string
  field :original_value_pattern, 4, type: :string
  field :new_value, 5, type: :string
end
...
defmodule Google.Cloud.Gkebackup.Logging.V1.RestoreConfig do
  ...
  @type t :: %__MODULE__{
          namespaced_resource_restore_scope: {atom, any},
  ...
  field :all_namespaces, 5, type: :bool, oneof: 0
  field :selected_namespaces, 6, type: Google.Cloud.Gkebackup.Logging.V1.Namespaces, oneof: 0
