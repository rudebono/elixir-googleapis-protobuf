...
defmodule Google.Cloud.Gkebackup.Logging.V1.BackupPlanChange do
  ...
  field :backup_plan, 1, type: :string
  field :change_type, 2, type: Google.Cloud.Gkebackup.Logging.V1.ChangeType, enum: true
  field :update_mask, 3, type: Google.Protobuf.FieldMask
  field :input_backup_plan, 4, type: Google.Cloud.Gkebackup.Logging.V1.LoggedBackupPlan
...
defmodule Google.Cloud.Gkebackup.Logging.V1.BackupChange do
  ...
  field :input_backup, 5, type: Google.Cloud.Gkebackup.Logging.V1.LoggedBackup
...
defmodule Google.Cloud.Gkebackup.Logging.V1.RestorePlanChange do
  ...
  field :restore_plan, 1, type: :string
  field :change_type, 2, type: Google.Cloud.Gkebackup.Logging.V1.ChangeType, enum: true
  field :update_mask, 3, type: Google.Protobuf.FieldMask
  field :input_restore_plan, 4, type: Google.Cloud.Gkebackup.Logging.V1.LoggedRestorePlan
  field :error, 5, type: Google.Rpc.Status
end
...
defmodule Google.Cloud.Gkebackup.Logging.V1.RestoreChange do
  ...
  field :change_type, 2, type: Google.Cloud.Gkebackup.Logging.V1.ChangeType, enum: true
  field :update_mask, 3, type: Google.Protobuf.FieldMask
  field :input_restore, 4, type: Google.Cloud.Gkebackup.Logging.V1.LoggedRestore
  field :error, 5, type: Google.Rpc.Status
end
