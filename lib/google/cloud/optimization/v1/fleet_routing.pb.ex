...
defmodule Google.Cloud.Optimization.V1.OptimizeToursRequest do
  ...
  field :model, 3, type: Google.Cloud.Optimization.V1.ShipmentModel
  ...
  field :injected_first_solution_routes, 7,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute,
  ...
  field :populate_travel_step_polylines, 20,
    type: :bool,
    json_name: "populateTravelStepPolylines",
    deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.OptimizeToursResponse.Metrics do
  ...
  field :costs, 10,
    repeated: true,
    type: Google.Cloud.Optimization.V1.OptimizeToursResponse.Metrics.CostsEntry,
    map: true
...
defmodule Google.Cloud.Optimization.V1.OptimizeToursResponse do
  ...
  field :skipped_shipments, 4,
    repeated: true,
    type: Google.Cloud.Optimization.V1.SkippedShipment,
    json_name: "skippedShipments"

  field :validation_errors, 5,
    repeated: true,
    type: Google.Cloud.Optimization.V1.OptimizeToursValidationError,
    json_name: "validationErrors"

  field :metrics, 6, type: Google.Cloud.Optimization.V1.OptimizeToursResponse.Metrics
  field :total_cost, 2, type: :double, json_name: "totalCost", deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.BatchOptimizeToursRequest.AsyncModelConfig do
  ...
  field :input_config, 2,
    type: Google.Cloud.Optimization.V1.InputConfig,
    json_name: "inputConfig",
    deprecated: false

  field :output_config, 3,
    type: Google.Cloud.Optimization.V1.OutputConfig,
    json_name: "outputConfig",
    deprecated: false

  field :enable_checkpoints, 4, type: :bool, json_name: "enableCheckpoints"
end
...
defmodule Google.Cloud.Optimization.V1.BatchOptimizeToursRequest do
  ...
  field :model_configs, 2,
    repeated: true,
    type: Google.Cloud.Optimization.V1.BatchOptimizeToursRequest.AsyncModelConfig,
...
defmodule Google.Cloud.Optimization.V1.ShipmentModel.DurationDistanceMatrix do
  ...
  field :rows, 1,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.DurationDistanceMatrix.Row
...
defmodule Google.Cloud.Optimization.V1.ShipmentModel.BreakRule do
  ...
  field :break_requests, 1,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.BreakRule.BreakRequest,
    json_name: "breakRequests"

  field :frequency_constraints, 2,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.BreakRule.FrequencyConstraint,
...
defmodule Google.Cloud.Optimization.V1.ShipmentModel do
  ...
  field :duration_distance_matrices, 8,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.DurationDistanceMatrix,
  ...
  field :transition_attributes, 11,
    repeated: true,
    type: Google.Cloud.Optimization.V1.TransitionAttributes,
    json_name: "transitionAttributes"

  field :shipment_type_incompatibilities, 12,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentTypeIncompatibility,
    json_name: "shipmentTypeIncompatibilities"

  field :shipment_type_requirements, 13,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentTypeRequirement,
    json_name: "shipmentTypeRequirements"

  field :precedence_rules, 14,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.PrecedenceRule,
    json_name: "precedenceRules"

  field :break_rules, 15,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentModel.BreakRule,
    json_name: "breakRules",
    deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.Shipment.VisitRequest do
  ...
  field :arrival_waypoint, 2,
    type: Google.Cloud.Optimization.V1.Waypoint,
  ...
  field :time_windows, 6,
    repeated: true,
    type: Google.Cloud.Optimization.V1.TimeWindow,
  ...
  field :load_demands, 12,
    repeated: true,
    type: Google.Cloud.Optimization.V1.Shipment.VisitRequest.LoadDemandsEntry,
  ...
  field :demands, 9,
    repeated: true,
    type: Google.Cloud.Optimization.V1.CapacityQuantity,
    deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.Shipment do
  ...
  field :load_demands, 14,
    repeated: true,
    type: Google.Cloud.Optimization.V1.Shipment.LoadDemandsEntry,
    json_name: "loadDemands",
    map: true
...
defmodule Google.Cloud.Optimization.V1.ShipmentTypeIncompatibility do
  ...
  field :incompatibility_mode, 2,
    type: Google.Cloud.Optimization.V1.ShipmentTypeIncompatibility.IncompatibilityMode,
...
defmodule Google.Cloud.Optimization.V1.ShipmentTypeRequirement do
  ...
  field :requirement_mode, 3,
    type: Google.Cloud.Optimization.V1.ShipmentTypeRequirement.RequirementMode,
...
defmodule Google.Cloud.Optimization.V1.Vehicle.LoadLimit do
  ...
  field :start_load_interval, 4,
    type: Google.Cloud.Optimization.V1.Vehicle.LoadLimit.Interval,
...
defmodule Google.Cloud.Optimization.V1.Vehicle do
  ...
  field :end_waypoint, 6, type: Google.Cloud.Optimization.V1.Waypoint, json_name: "endWaypoint"
  ...
  field :unloading_policy, 12,
    type: Google.Cloud.Optimization.V1.Vehicle.UnloadingPolicy,
    json_name: "unloadingPolicy",
    enum: true

  field :load_limits, 30,
    repeated: true,
    type: Google.Cloud.Optimization.V1.Vehicle.LoadLimitsEntry,
  ...
  field :route_duration_limit, 21,
    type: Google.Cloud.Optimization.V1.Vehicle.DurationLimit,
  ...
  field :route_distance_limit, 23,
    type: Google.Cloud.Optimization.V1.DistanceLimit,
    json_name: "routeDistanceLimit"

  field :extra_visit_duration_for_visit_type, 24,
    repeated: true,
    type: Google.Cloud.Optimization.V1.Vehicle.ExtraVisitDurationForVisitTypeEntry,
    json_name: "extraVisitDurationForVisitType",
    map: true

  field :break_rule, 25, type: Google.Cloud.Optimization.V1.BreakRule, json_name: "breakRule"
  field :label, 27, type: :string
  field :ignore, 28, type: :bool

  field :break_rule_indices, 29,
    repeated: true,
    type: :int32,
    json_name: "breakRuleIndices",
    deprecated: true
  ...
  field :start_load_intervals, 14,
    repeated: true,
    type: Google.Cloud.Optimization.V1.CapacityQuantityInterval,
    json_name: "startLoadIntervals",
    deprecated: true

  field :end_load_intervals, 15,
    repeated: true,
    type: Google.Cloud.Optimization.V1.CapacityQuantityInterval,
    json_name: "endLoadIntervals",
    deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.CapacityQuantityInterval do
  ...
  field :max_value, 3, proto3_optional: true, type: :int64, json_name: "maxValue"
end
...
defmodule Google.Cloud.Optimization.V1.Waypoint do
  ...
  field :location, 1, type: Google.Cloud.Optimization.V1.Location, oneof: 0
  field :place_id, 2, type: :string, json_name: "placeId", oneof: 0
  field :side_of_road, 3, type: :bool, json_name: "sideOfRoad"
end
...
defmodule Google.Cloud.Optimization.V1.BreakRule do
  ...
  field :break_requests, 1,
    repeated: true,
    type: Google.Cloud.Optimization.V1.BreakRule.BreakRequest,
    json_name: "breakRequests"

  field :frequency_constraints, 2,
    repeated: true,
    type: Google.Cloud.Optimization.V1.BreakRule.FrequencyConstraint,
    json_name: "frequencyConstraints"
end
...
defmodule Google.Cloud.Optimization.V1.ShipmentRoute.Visit do
  ...
  field :load_demands, 11,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.Visit.LoadDemandsEntry,
    json_name: "loadDemands",
    map: true
  ...
  field :arrival_loads, 9,
    repeated: true,
    type: Google.Cloud.Optimization.V1.CapacityQuantity,
    json_name: "arrivalLoads",
    deprecated: true

  field :delay_before_start, 10,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.Delay,
    json_name: "delayBeforeStart",
    deprecated: true
...
defmodule Google.Cloud.Optimization.V1.ShipmentRoute.Transition do
  ...
  field :route_polyline, 9,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.EncodedPolyline,
    json_name: "routePolyline"

  field :vehicle_loads, 11,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.Transition.VehicleLoadsEntry,
...
defmodule Google.Cloud.Optimization.V1.ShipmentRoute do
  ...
  field :visits, 7, repeated: true, type: Google.Cloud.Optimization.V1.ShipmentRoute.Visit

  field :transitions, 8,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.Transition
  ...
  field :breaks, 11, repeated: true, type: Google.Cloud.Optimization.V1.ShipmentRoute.Break
  field :metrics, 12, type: Google.Cloud.Optimization.V1.AggregatedMetrics

  field :route_costs, 17,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.RouteCostsEntry,
  ...
  field :travel_steps, 14,
    repeated: true,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.TravelStep,
    json_name: "travelSteps",
    deprecated: true

  field :vehicle_detour, 15,
    type: Google.Protobuf.Duration,
    json_name: "vehicleDetour",
    deprecated: true

  field :delay_before_vehicle_end, 16,
    type: Google.Cloud.Optimization.V1.ShipmentRoute.Delay,
    json_name: "delayBeforeVehicleEnd",
    deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.SkippedShipment do
  ...
  field :reasons, 3, repeated: true, type: Google.Cloud.Optimization.V1.SkippedShipment.Reason
end
...
defmodule Google.Cloud.Optimization.V1.AggregatedMetrics do
  ...
  field :max_loads, 9,
    repeated: true,
    type: Google.Cloud.Optimization.V1.AggregatedMetrics.MaxLoadsEntry,
    json_name: "maxLoads",
    map: true

  field :costs, 10,
    repeated: true,
    type: Google.Cloud.Optimization.V1.AggregatedMetrics.CostsEntry,
    map: true,
    deprecated: true

  field :total_cost, 11, type: :double, json_name: "totalCost", deprecated: true
end
...
defmodule Google.Cloud.Optimization.V1.InjectedSolutionConstraint.ConstraintRelaxation do
  ...
  field :relaxations, 1,
    repeated: true,
    type: Google.Cloud.Optimization.V1.InjectedSolutionConstraint.ConstraintRelaxation.Relaxation
...
defmodule Google.Cloud.Optimization.V1.InjectedSolutionConstraint do
  ...
  field :constraint_relaxations, 3,
    repeated: true,
    type: Google.Cloud.Optimization.V1.InjectedSolutionConstraint.ConstraintRelaxation,
...
defmodule Google.Cloud.Optimization.V1.OptimizeToursValidationError.FieldReference do
  ...
  field :sub_field, 3,
    type: Google.Cloud.Optimization.V1.OptimizeToursValidationError.FieldReference,
    json_name: "subField"
end
...
defmodule Google.Cloud.Optimization.V1.FleetRouting.Service do
  @moduledoc false
...
defmodule Google.Cloud.Optimization.V1.FleetRouting.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Cloud.Optimization.V1.FleetRouting.Service
end
