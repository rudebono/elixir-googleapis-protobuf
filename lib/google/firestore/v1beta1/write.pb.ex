...
defmodule Google.Firestore.V1beta1.Write do
  ...
  field :update_mask, 3, type: Google.Firestore.V1beta1.DocumentMask
...
defmodule Google.Firestore.V1beta1.DocumentTransform.FieldTransform do
  ...
  field :append_missing_elements, 6, type: Google.Firestore.V1beta1.ArrayValue, oneof: 0
  field :remove_all_from_array, 7, type: Google.Firestore.V1beta1.ArrayValue, oneof: 0
end
...
defmodule Google.Firestore.V1beta1.WriteResult do
  ...
  field :transform_results, 2, repeated: true, type: Google.Firestore.V1beta1.Value
end
