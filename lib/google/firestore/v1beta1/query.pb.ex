...
defmodule Google.Firestore.V1beta1.StructuredQuery.Filter do
  ...
  field :field_filter, 2, type: Google.Firestore.V1beta1.StructuredQuery.FieldFilter, oneof: 0
  field :unary_filter, 3, type: Google.Firestore.V1beta1.StructuredQuery.UnaryFilter, oneof: 0
end
...
defmodule Google.Firestore.V1beta1.StructuredQuery do
  ...
  field :order_by, 4, repeated: true, type: Google.Firestore.V1beta1.StructuredQuery.Order
  field :start_at, 7, type: Google.Firestore.V1beta1.Cursor
  field :end_at, 8, type: Google.Firestore.V1beta1.Cursor
