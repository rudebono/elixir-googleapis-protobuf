...
defmodule Google.Firestore.V1.BatchGetDocumentsRequest do
  ...
  @type t :: %__MODULE__{
          consistency_selector:
            {:transaction, binary}
            | {:new_transaction, Google.Firestore.V1.TransactionOptions.t() | nil}
...
defmodule Google.Firestore.V1.BatchGetDocumentsResponse do
  ...
  @type t :: %__MODULE__{
          result: {:found, Google.Firestore.V1.Document.t() | nil} | {:missing, String.t()},
          transaction: binary,
          read_time: Google.Protobuf.Timestamp.t() | nil
        }
...
defmodule Google.Firestore.V1.PartitionQueryResponse do
  ...
  @type t :: %__MODULE__{
          partitions: [Google.Firestore.V1.Cursor.t()],
          next_page_token: String.t()
        }
...
defmodule Google.Firestore.V1.ListenRequest do
  ...
  @type t :: %__MODULE__{
          target_change:
            {:add_target, Google.Firestore.V1.Target.t() | nil} | {:remove_target, integer},
          database: String.t(),
          labels: %{String.t() => String.t()}
        }
...
defmodule Google.Firestore.V1.ListenResponse do
  ...
  @type t :: %__MODULE__{
          response_type:
            {:target_change, Google.Firestore.V1.TargetChange.t() | nil}
            | {:document_change, Google.Firestore.V1.DocumentChange.t() | nil}
            | {:document_delete, Google.Firestore.V1.DocumentDelete.t() | nil}
            | {:document_remove, Google.Firestore.V1.DocumentRemove.t() | nil}
            | {:filter, Google.Firestore.V1.ExistenceFilter.t() | nil}
        }
...
defmodule Google.Firestore.V1.Target do
  ...
  @type t :: %__MODULE__{
          target_type:
            {:query, Google.Firestore.V1.Target.QueryTarget.t() | nil}
            | {:documents, Google.Firestore.V1.Target.DocumentsTarget.t() | nil},
          resume_type:
...
defmodule Google.Firestore.V1.BatchWriteRequest do
  ...
  defstruct [:database, :writes, :labels]
