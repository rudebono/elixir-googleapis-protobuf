defmodule Google.Firestore.V1.ExplainOptions do
  @moduledoc false
...
defmodule Google.Firestore.V1.ExplainMetrics do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.14.1", syntax: :proto3

  field :plan_summary, 1, type: Google.Firestore.V1.PlanSummary, json_name: "planSummary"
  field :execution_stats, 2, type: Google.Firestore.V1.ExecutionStats, json_name: "executionStats"
end

defmodule Google.Firestore.V1.PlanSummary do
  @moduledoc false
...
defmodule Google.Firestore.V1.ExecutionStats do
  @moduledoc false
