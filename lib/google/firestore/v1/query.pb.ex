...
defmodule Google.Firestore.V1.StructuredQuery.Filter do
  ...
  @type t :: %__MODULE__{
          filter_type:
            {:composite_filter, Google.Firestore.V1.StructuredQuery.CompositeFilter.t() | nil}
            | {:field_filter, Google.Firestore.V1.StructuredQuery.FieldFilter.t() | nil}
            | {:unary_filter, Google.Firestore.V1.StructuredQuery.UnaryFilter.t() | nil}
        }
...
defmodule Google.Firestore.V1.StructuredQuery.UnaryFilter do
  ...
  @type t :: %__MODULE__{
          operand_type: {:field, Google.Firestore.V1.StructuredQuery.FieldReference.t() | nil},
