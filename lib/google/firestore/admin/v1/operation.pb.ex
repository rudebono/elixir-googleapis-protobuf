...
defmodule Google.Firestore.Admin.V1.IndexOperationMetadata do
  ...
  field :progress_documents, 5, type: Google.Firestore.Admin.V1.Progress
  field :progress_bytes, 6, type: Google.Firestore.Admin.V1.Progress
end
...
defmodule Google.Firestore.Admin.V1.FieldOperationMetadata do
  ...
  field :progress_documents, 6, type: Google.Firestore.Admin.V1.Progress
  field :progress_bytes, 7, type: Google.Firestore.Admin.V1.Progress
end
...
defmodule Google.Firestore.Admin.V1.ExportDocumentsMetadata do
  ...
  field :start_time, 1, type: Google.Protobuf.Timestamp
  field :end_time, 2, type: Google.Protobuf.Timestamp
  field :operation_state, 3, type: Google.Firestore.Admin.V1.OperationState, enum: true
  field :progress_documents, 4, type: Google.Firestore.Admin.V1.Progress
  field :progress_bytes, 5, type: Google.Firestore.Admin.V1.Progress
