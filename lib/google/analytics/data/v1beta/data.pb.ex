...
defmodule Google.Analytics.Data.V1beta.Dimension do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          dimension_expression: Google.Analytics.Data.V1beta.DimensionExpression.t() | nil
        }

  defstruct [:name, :dimension_expression]

  field :name, 1, type: :string
  field :dimension_expression, 2, type: Google.Analytics.Data.V1beta.DimensionExpression
end
...
defmodule Google.Analytics.Data.V1beta.FilterExpression do
  ...
  oneof :expr, 0
  field :and_group, 1, type: Google.Analytics.Data.V1beta.FilterExpressionList, oneof: 0
  field :or_group, 2, type: Google.Analytics.Data.V1beta.FilterExpressionList, oneof: 0
  field :not_expression, 3, type: Google.Analytics.Data.V1beta.FilterExpression, oneof: 0
...
defmodule Google.Analytics.Data.V1beta.FilterExpressionList do
  ...
  @type t :: %__MODULE__{
          expressions: [Google.Analytics.Data.V1beta.FilterExpression.t()]
        }
...
defmodule Google.Analytics.Data.V1beta.Filter.StringFilter do
  ...
  @type t :: %__MODULE__{
          match_type: Google.Analytics.Data.V1beta.Filter.StringFilter.MatchType.t(),
          value: String.t(),
...
defmodule Google.Analytics.Data.V1beta.Filter.NumericFilter do
  ...
  @type t :: %__MODULE__{
          operation: Google.Analytics.Data.V1beta.Filter.NumericFilter.Operation.t(),
          value: Google.Analytics.Data.V1beta.NumericValue.t() | nil
        }
...
defmodule Google.Analytics.Data.V1beta.Filter.BetweenFilter do
  ...
  @type t :: %__MODULE__{
          from_value: Google.Analytics.Data.V1beta.NumericValue.t() | nil,
          to_value: Google.Analytics.Data.V1beta.NumericValue.t() | nil
        }

  defstruct [:from_value, :to_value]

  field :from_value, 1, type: Google.Analytics.Data.V1beta.NumericValue
  field :to_value, 2, type: Google.Analytics.Data.V1beta.NumericValue
end
...
defmodule Google.Analytics.Data.V1beta.Filter do
  ...
  field :string_filter, 3, type: Google.Analytics.Data.V1beta.Filter.StringFilter, oneof: 0
  field :in_list_filter, 4, type: Google.Analytics.Data.V1beta.Filter.InListFilter, oneof: 0
  field :numeric_filter, 5, type: Google.Analytics.Data.V1beta.Filter.NumericFilter, oneof: 0
  field :between_filter, 6, type: Google.Analytics.Data.V1beta.Filter.BetweenFilter, oneof: 0
end
...
defmodule Google.Analytics.Data.V1beta.OrderBy.DimensionOrderBy do
  ...
  @type t :: %__MODULE__{
          dimension_name: String.t(),
          order_type: Google.Analytics.Data.V1beta.OrderBy.DimensionOrderBy.OrderType.t()
        }
...
defmodule Google.Analytics.Data.V1beta.OrderBy.PivotOrderBy do
  ...
  @type t :: %__MODULE__{
          metric_name: String.t(),
          pivot_selections: [Google.Analytics.Data.V1beta.OrderBy.PivotOrderBy.PivotSelection.t()]
        }
...
defmodule Google.Analytics.Data.V1beta.Pivot do
  ...
  field :order_bys, 2, repeated: true, type: Google.Analytics.Data.V1beta.OrderBy
...
defmodule Google.Analytics.Data.V1beta.CohortSpec do
  ...
  @type t :: %__MODULE__{
          cohorts: [Google.Analytics.Data.V1beta.Cohort.t()],
          cohorts_range: Google.Analytics.Data.V1beta.CohortsRange.t() | nil,
          cohort_report_settings: Google.Analytics.Data.V1beta.CohortReportSettings.t() | nil
        }
  ...
  field :cohorts_range, 2, type: Google.Analytics.Data.V1beta.CohortsRange
  field :cohort_report_settings, 3, type: Google.Analytics.Data.V1beta.CohortReportSettings
end
...
defmodule Google.Analytics.Data.V1beta.Cohort do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          dimension: String.t(),
          date_range: Google.Analytics.Data.V1beta.DateRange.t() | nil
        }
  ...
  field :date_range, 3, type: Google.Analytics.Data.V1beta.DateRange
end
...
defmodule Google.Analytics.Data.V1beta.CohortsRange do
  ...
  @type t :: %__MODULE__{
          granularity: Google.Analytics.Data.V1beta.CohortsRange.Granularity.t(),
...
defmodule Google.Analytics.Data.V1beta.MetricHeader do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          type: Google.Analytics.Data.V1beta.MetricType.t()
        }
...
defmodule Google.Analytics.Data.V1beta.PivotHeader do
  ...
  @type t :: %__MODULE__{
          pivot_dimension_headers: [Google.Analytics.Data.V1beta.PivotDimensionHeader.t()],
          row_count: integer
        }
...
defmodule Google.Analytics.Data.V1beta.PivotDimensionHeader do
  ...
  @type t :: %__MODULE__{
          dimension_values: [Google.Analytics.Data.V1beta.DimensionValue.t()]
        }

  defstruct [:dimension_values]

  field :dimension_values, 1, repeated: true, type: Google.Analytics.Data.V1beta.DimensionValue
end
...
defmodule Google.Analytics.Data.V1beta.Row do
  ...
  @type t :: %__MODULE__{
          dimension_values: [Google.Analytics.Data.V1beta.DimensionValue.t()],
          metric_values: [Google.Analytics.Data.V1beta.MetricValue.t()]
        }

  defstruct [:dimension_values, :metric_values]

  field :dimension_values, 1, repeated: true, type: Google.Analytics.Data.V1beta.DimensionValue
  field :metric_values, 2, repeated: true, type: Google.Analytics.Data.V1beta.MetricValue
end
...
defmodule Google.Analytics.Data.V1beta.PropertyQuota do
  ...
  @type t :: %__MODULE__{
          tokens_per_day: Google.Analytics.Data.V1beta.QuotaStatus.t() | nil,
          tokens_per_hour: Google.Analytics.Data.V1beta.QuotaStatus.t() | nil,
          concurrent_requests: Google.Analytics.Data.V1beta.QuotaStatus.t() | nil,
          server_errors_per_project_per_hour: Google.Analytics.Data.V1beta.QuotaStatus.t() | nil,
          potentially_thresholded_requests_per_hour:
            Google.Analytics.Data.V1beta.QuotaStatus.t() | nil
        }
  ...
  field :tokens_per_day, 1, type: Google.Analytics.Data.V1beta.QuotaStatus
  field :tokens_per_hour, 2, type: Google.Analytics.Data.V1beta.QuotaStatus
  field :concurrent_requests, 3, type: Google.Analytics.Data.V1beta.QuotaStatus
  field :server_errors_per_project_per_hour, 4, type: Google.Analytics.Data.V1beta.QuotaStatus
