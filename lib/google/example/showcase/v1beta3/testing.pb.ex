defmodule Google.Example.Showcase.V1beta3.Session.Version do
  @moduledoc false
...
defmodule Google.Example.Showcase.V1beta3.ReportSessionResponse.Result do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Example.Showcase.V1beta3.Test.ExpectationLevel do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Example.Showcase.V1beta3.Issue.Type do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Example.Showcase.V1beta3.Issue.Severity do
  @moduledoc false
  use Protobuf, enum: true, syntax: :proto3
...
defmodule Google.Example.Showcase.V1beta3.Session do
  @moduledoc false
  use Protobuf, syntax: :proto3

  @type t :: %__MODULE__{
          name: String.t(),
          version: Google.Example.Showcase.V1beta3.Session.Version.t()
        }
...
defmodule Google.Example.Showcase.V1beta3.CreateSessionRequest do
  ...
  @type t :: %__MODULE__{
          session: Google.Example.Showcase.V1beta3.Session.t() | nil
        }
...
defmodule Google.Example.Showcase.V1beta3.ListSessionsResponse do
  ...
  @type t :: %__MODULE__{
          sessions: [Google.Example.Showcase.V1beta3.Session.t()],
...
defmodule Google.Example.Showcase.V1beta3.ReportSessionResponse do
  ...
  @type t :: %__MODULE__{
          result: Google.Example.Showcase.V1beta3.ReportSessionResponse.Result.t(),
          test_runs: [Google.Example.Showcase.V1beta3.TestRun.t()]
        }
...
defmodule Google.Example.Showcase.V1beta3.Test.Blueprint do
  ...
  @type t :: %__MODULE__{
          ...
          request: Google.Example.Showcase.V1beta3.Test.Blueprint.Invocation.t() | nil,
          additional_requests: [Google.Example.Showcase.V1beta3.Test.Blueprint.Invocation.t()]
        }
  ...
  field :request, 3, type: Google.Example.Showcase.V1beta3.Test.Blueprint.Invocation
...
defmodule Google.Example.Showcase.V1beta3.Test do
  ...
  @type t :: %__MODULE__{
          name: String.t(),
          expectation_level: Google.Example.Showcase.V1beta3.Test.ExpectationLevel.t(),
          description: String.t(),
          blueprints: [Google.Example.Showcase.V1beta3.Test.Blueprint.t()]
        }
...
defmodule Google.Example.Showcase.V1beta3.Issue do
  ...
  @type t :: %__MODULE__{
          type: Google.Example.Showcase.V1beta3.Issue.Type.t(),
          severity: Google.Example.Showcase.V1beta3.Issue.Severity.t(),
          description: String.t()
        }
...
defmodule Google.Example.Showcase.V1beta3.ListTestsResponse do
  ...
  @type t :: %__MODULE__{
          tests: [Google.Example.Showcase.V1beta3.Test.t()],
          next_page_token: String.t()
        }
...
defmodule Google.Example.Showcase.V1beta3.TestRun do
  ...
  @type t :: %__MODULE__{
          test: String.t(),
          issue: Google.Example.Showcase.V1beta3.Issue.t() | nil
        }
...
defmodule Google.Example.Showcase.V1beta3.Testing.Service do
  @moduledoc false
  use GRPC.Service, name: "google.example.showcase.v1beta3.Testing"

  rpc :CreateSession,
      Google.Example.Showcase.V1beta3.CreateSessionRequest,
      Google.Example.Showcase.V1beta3.Session

  rpc :GetSession,
      Google.Example.Showcase.V1beta3.GetSessionRequest,
      Google.Example.Showcase.V1beta3.Session

  rpc :ListSessions,
      Google.Example.Showcase.V1beta3.ListSessionsRequest,
      Google.Example.Showcase.V1beta3.ListSessionsResponse

  rpc :DeleteSession, Google.Example.Showcase.V1beta3.DeleteSessionRequest, Google.Protobuf.Empty

  rpc :ReportSession,
      Google.Example.Showcase.V1beta3.ReportSessionRequest,
      Google.Example.Showcase.V1beta3.ReportSessionResponse

  rpc :ListTests,
      Google.Example.Showcase.V1beta3.ListTestsRequest,
      Google.Example.Showcase.V1beta3.ListTestsResponse

  rpc :DeleteTest, Google.Example.Showcase.V1beta3.DeleteTestRequest, Google.Protobuf.Empty

  rpc :VerifyTest,
      Google.Example.Showcase.V1beta3.VerifyTestRequest,
      Google.Example.Showcase.V1beta3.VerifyTestResponse
end

defmodule Google.Example.Showcase.V1beta3.Testing.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Example.Showcase.V1beta3.Testing.Service
end
