defmodule Google.Example.Showcase.V1.Sequence.Response do
  @moduledoc false
...
defmodule Google.Example.Showcase.V1.SequenceService.Service do
  ...
  rpc :CreateSequence,
      Google.Example.Showcase.V1.CreateSequenceRequest,
      Google.Example.Showcase.V1.Sequence

  rpc :GetSequenceReport,
      Google.Example.Showcase.V1.GetSequenceReportRequest,
      Google.Example.Showcase.V1.SequenceReport

  rpc :AttemptSequence, Google.Example.Showcase.V1.AttemptSequenceRequest, Google.Protobuf.Empty
end

defmodule Google.Example.Showcase.V1.SequenceService.Stub do
  @moduledoc false
  use GRPC.Stub, service: Google.Example.Showcase.V1.SequenceService.Service
end
