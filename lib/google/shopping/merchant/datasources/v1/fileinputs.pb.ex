defmodule Google.Shopping.Merchant.Datasources.V1.FileInput.FileInputType do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Datasources.V1.FileInput.FetchSettings.Frequency do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Datasources.V1.FileInput.FetchSettings do
  @moduledoc false
  ...
  field :frequency, 6,
    type: Google.Shopping.Merchant.Datasources.V1.FileInput.FetchSettings.Frequency,
    enum: true,
    deprecated: false
...
defmodule Google.Shopping.Merchant.Datasources.V1.FileInput do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :fetch_settings, 1,
    type: Google.Shopping.Merchant.Datasources.V1.FileInput.FetchSettings,
  ...
  field :file_input_type, 3,
    type: Google.Shopping.Merchant.Datasources.V1.FileInput.FileInputType,
