defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.ShippingInfo.ShippingState do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.CreateOrderTrackingSignalRequest do
  @moduledoc false
  ...
  field :order_tracking_signal, 3,
    type: Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal,
    json_name: "orderTrackingSignal",
    deprecated: false
end

defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.ShippingInfo do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.LineItemDetails do
  @moduledoc false
  ...
  field :gtins, 8, repeated: true, type: :string, deprecated: false
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.ShipmentLineItemMapping do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal do
  @moduledoc false
  ...
  field :shipping_info, 3,
    repeated: true,
    type: Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.ShippingInfo,
    json_name: "shippingInfo",
    deprecated: false

  field :line_items, 4,
    repeated: true,
    type: Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.LineItemDetails,
    json_name: "lineItems",
    deprecated: false

  field :shipment_line_item_mapping, 5,
    repeated: true,
    type: Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignal.ShipmentLineItemMapping,
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignalsService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.shopping.merchant.ordertracking.v1.OrderTrackingSignalsService",
...
defmodule Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignalsService.Stub do
  @moduledoc false

  use GRPC.Stub,
    service: Google.Shopping.Merchant.Ordertracking.V1.OrderTrackingSignalsService.Service
end
