defmodule Google.Shopping.Merchant.Quota.V1.QuotaGroup do
  @moduledoc false
  ...
  field :method_details, 4,
    repeated: true,
    type: Google.Shopping.Merchant.Quota.V1.MethodDetails,
    json_name: "methodDetails",
    deprecated: false
end

defmodule Google.Shopping.Merchant.Quota.V1.MethodDetails do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Quota.V1.ListQuotaGroupsRequest do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Quota.V1.ListQuotaGroupsResponse do
  @moduledoc false
  ...
  field :quota_groups, 1,
    repeated: true,
    type: Google.Shopping.Merchant.Quota.V1.QuotaGroup,
    json_name: "quotaGroups"

  field :next_page_token, 2, type: :string, json_name: "nextPageToken"
end

defmodule Google.Shopping.Merchant.Quota.V1.QuotaService.Service do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Quota.V1.QuotaService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Shopping.Merchant.Quota.V1.QuotaService.Service
end
