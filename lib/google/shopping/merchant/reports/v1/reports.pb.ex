defmodule Google.Shopping.Merchant.Reports.V1.ProductView.AggregatedReportingContextStatus do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ClickPotential do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueResolution do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueSeverity.AggregatedIssueSeverity do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.PriceInsightsProductView.Effectiveness do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.BestSellersProductClusterView.InventoryStatus do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.MarketingMethod.MarketingMethodEnum do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ReportGranularity.ReportGranularityEnum do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.RelativeDemand.RelativeDemandEnum do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.RelativeDemandChangeType.RelativeDemandChangeTypeEnum do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.TrafficSource.TrafficSourceEnum do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.SearchRequest do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.SearchResponse do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :results, 1, repeated: true, type: Google.Shopping.Merchant.Reports.V1.ReportRow
  field :next_page_token, 2, type: :string, json_name: "nextPageToken"
end

defmodule Google.Shopping.Merchant.Reports.V1.ReportRow do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :product_performance_view, 1,
    type: Google.Shopping.Merchant.Reports.V1.ProductPerformanceView,
    json_name: "productPerformanceView"

  field :non_product_performance_view, 7,
    type: Google.Shopping.Merchant.Reports.V1.NonProductPerformanceView,
    json_name: "nonProductPerformanceView"

  field :product_view, 2,
    type: Google.Shopping.Merchant.Reports.V1.ProductView,
    json_name: "productView"

  field :price_competitiveness_product_view, 3,
    type: Google.Shopping.Merchant.Reports.V1.PriceCompetitivenessProductView,
    json_name: "priceCompetitivenessProductView"

  field :price_insights_product_view, 4,
    type: Google.Shopping.Merchant.Reports.V1.PriceInsightsProductView,
    json_name: "priceInsightsProductView"

  field :best_sellers_product_cluster_view, 5,
    type: Google.Shopping.Merchant.Reports.V1.BestSellersProductClusterView,
    json_name: "bestSellersProductClusterView"

  field :best_sellers_brand_view, 6,
    type: Google.Shopping.Merchant.Reports.V1.BestSellersBrandView,
    json_name: "bestSellersBrandView"

  field :competitive_visibility_competitor_view, 8,
    type: Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityCompetitorView,
    json_name: "competitiveVisibilityCompetitorView"

  field :competitive_visibility_top_merchant_view, 9,
    type: Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityTopMerchantView,
    json_name: "competitiveVisibilityTopMerchantView"

  field :competitive_visibility_benchmark_view, 10,
    type: Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityBenchmarkView,
    json_name: "competitiveVisibilityBenchmarkView"
end

defmodule Google.Shopping.Merchant.Reports.V1.ProductPerformanceView do
  @moduledoc false
  ...
  field :marketing_method, 1,
    ...
    type: Google.Shopping.Merchant.Reports.V1.MarketingMethod.MarketingMethodEnum,
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueType do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueSeverity.IssueSeverityPerReportingContext do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueSeverity do
  @moduledoc false
  ...
  field :severity_per_reporting_context, 1,
    repeated: true,
    type:
      Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueSeverity.IssueSeverityPerReportingContext,
...
defmodule Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :type, 1, type: Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueType

  field :severity, 2,
    type: Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueSeverity

  field :resolution, 3,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue.ItemIssueResolution,
    enum: true
end

defmodule Google.Shopping.Merchant.Reports.V1.ProductView do
  @moduledoc false
  ...
  field :aggregated_reporting_context_status, 26,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.ProductView.AggregatedReportingContextStatus,
    json_name: "aggregatedReportingContextStatus",
    enum: true

  field :item_issues, 27,
    repeated: true,
    type: Google.Shopping.Merchant.Reports.V1.ProductView.ItemIssue,
    json_name: "itemIssues"

  field :click_potential, 29,
    type: Google.Shopping.Merchant.Reports.V1.ProductView.ClickPotential,
...
defmodule Google.Shopping.Merchant.Reports.V1.PriceCompetitivenessProductView do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.PriceInsightsProductView do
  @moduledoc false
  ...
  field :effectiveness, 22,
    type: Google.Shopping.Merchant.Reports.V1.PriceInsightsProductView.Effectiveness,
    enum: true
end

defmodule Google.Shopping.Merchant.Reports.V1.BestSellersProductClusterView do
  @moduledoc false
  ...
  field :report_granularity, 2,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.ReportGranularity.ReportGranularityEnum,
  ...
  field :inventory_status, 14,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.BestSellersProductClusterView.InventoryStatus,
  ...
  field :relative_demand, 18,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.RelativeDemand.RelativeDemandEnum,
...
defmodule Google.Shopping.Merchant.Reports.V1.BestSellersBrandView do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.NonProductPerformanceView do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityCompetitorView do
  @moduledoc false
  ...
  field :traffic_source, 6,
    proto3_optional: true,
    type: Google.Shopping.Merchant.Reports.V1.TrafficSource.TrafficSourceEnum,
...
defmodule Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityTopMerchantView do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.CompetitiveVisibilityBenchmarkView do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Reports.V1.MarketingMethod do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Shopping.Merchant.Reports.V1.ReportGranularity do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Shopping.Merchant.Reports.V1.RelativeDemand do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Shopping.Merchant.Reports.V1.RelativeDemandChangeType do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Shopping.Merchant.Reports.V1.TrafficSource do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3
end

defmodule Google.Shopping.Merchant.Reports.V1.ReportService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.shopping.merchant.reports.v1.ReportService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :Search,
      Google.Shopping.Merchant.Reports.V1.SearchRequest,
      Google.Shopping.Merchant.Reports.V1.SearchResponse
end

defmodule Google.Shopping.Merchant.Reports.V1.ReportService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Shopping.Merchant.Reports.V1.ReportService.Service
end
