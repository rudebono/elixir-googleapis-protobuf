defmodule Google.Shopping.Merchant.Lfp.V1.LfpSale do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.InsertLfpSaleRequest do
  @moduledoc false
  ...
  field :lfp_sale, 2,
    type: Google.Shopping.Merchant.Lfp.V1.LfpSale,
    json_name: "lfpSale",
    deprecated: false
end

defmodule Google.Shopping.Merchant.Lfp.V1.LfpSaleService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.shopping.merchant.lfp.v1.LfpSaleService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :InsertLfpSale,
      Google.Shopping.Merchant.Lfp.V1.InsertLfpSaleRequest,
      Google.Shopping.Merchant.Lfp.V1.LfpSale
end

defmodule Google.Shopping.Merchant.Lfp.V1.LfpSaleService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Shopping.Merchant.Lfp.V1.LfpSaleService.Service
end
