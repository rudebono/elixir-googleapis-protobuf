defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.LfpStoreState.StoreMatchingState do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings.VerificationState do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings.ProductPageType do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.LfpStoreState do
  @moduledoc false
  ...
  field :matching_state, 2,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.LfpStoreState.StoreMatchingState,
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.InventoryStats do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings do
  @moduledoc false
  ...
  field :inventory_verification_state, 4,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings.VerificationState,
    json_name: "inventoryVerificationState",
    enum: true,
    deprecated: false

  field :product_page_type, 5,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings.ProductPageType,
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantState do
  @moduledoc false
  ...
  field :store_states, 3,
    repeated: true,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.LfpStoreState,
    json_name: "storeStates",
    deprecated: false

  field :inventory_stats, 4,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.InventoryStats,
    json_name: "inventoryStats"

  field :country_settings, 5,
    repeated: true,
    type: Google.Shopping.Merchant.Lfp.V1.LfpMerchantState.CountrySettings,
    json_name: "countrySettings"
end

defmodule Google.Shopping.Merchant.Lfp.V1.GetLfpMerchantStateRequest do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantStateService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.shopping.merchant.lfp.v1.LfpMerchantStateService",
    protoc_gen_elixir_version: "0.15.0"

  rpc :GetLfpMerchantState,
      Google.Shopping.Merchant.Lfp.V1.GetLfpMerchantStateRequest,
      Google.Shopping.Merchant.Lfp.V1.LfpMerchantState
end

defmodule Google.Shopping.Merchant.Lfp.V1.LfpMerchantStateService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Shopping.Merchant.Lfp.V1.LfpMerchantStateService.Service
end
