defmodule Google.Shopping.Merchant.Lfp.V1.LfpInventory do
  @moduledoc false
...
defmodule Google.Shopping.Merchant.Lfp.V1.InsertLfpInventoryRequest do
  @moduledoc false
  ...
  field :lfp_inventory, 2,
    type: Google.Shopping.Merchant.Lfp.V1.LfpInventory,
    json_name: "lfpInventory",
    deprecated: false
end

defmodule Google.Shopping.Merchant.Lfp.V1.LfpInventoryService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "google.shopping.merchant.lfp.v1.LfpInventoryService",
...
defmodule Google.Shopping.Merchant.Lfp.V1.LfpInventoryService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Shopping.Merchant.Lfp.V1.LfpInventoryService.Service
end
