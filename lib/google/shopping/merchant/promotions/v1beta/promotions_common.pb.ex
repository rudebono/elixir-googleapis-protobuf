...
defmodule Google.Shopping.Merchant.Promotions.V1beta.Attributes do
  ...
  field :offer_type, 2,
    type: Google.Shopping.Merchant.Promotions.V1beta.OfferType,
    json_name: "offerType",
    enum: true,
    deprecated: false
  ...
  field :coupon_value_type, 5,
    type: Google.Shopping.Merchant.Promotions.V1beta.CouponValueType,
  ...
  field :store_applicability, 28,
    type: Google.Shopping.Merchant.Promotions.V1beta.StoreApplicability,
...
defmodule Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.DestinationStatus do
  ...
  field :status, 2,
    type: Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.DestinationStatus.State,
    enum: true,
    deprecated: false
end
...
defmodule Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.ItemLevelIssue do
  ...
  field :severity, 2,
    type: Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.ItemLevelIssue.Severity,
    enum: true,
    deprecated: false
...
defmodule Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus do
  ...
  field :destination_statuses, 1,
    repeated: true,
    type: Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.DestinationStatus,
    json_name: "destinationStatuses",
    deprecated: false

  field :item_level_issues, 2,
    repeated: true,
    type: Google.Shopping.Merchant.Promotions.V1beta.PromotionStatus.ItemLevelIssue,
