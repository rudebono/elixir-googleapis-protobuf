...
defmodule Google.Container.V1.LinuxNodeConfig.TransparentHugepageEnabled do
  @moduledoc false
...
defmodule Google.Container.V1.LinuxNodeConfig.TransparentHugepageDefrag do
  @moduledoc false
...
defmodule Google.Container.V1.LinuxNodeConfig.NodeKernelModuleLoading.Policy do
  @moduledoc false
...
defmodule Google.Container.V1.AdvancedMachineFeatures.PerformanceMonitoringUnit do
  @moduledoc false
...
defmodule Google.Container.V1.AnonymousAuthenticationConfig.Mode do
  @moduledoc false
...
defmodule Google.Container.V1.MaintenanceExclusionOptions.EndTimeBehavior do
  @moduledoc false
...
defmodule Google.Container.V1.ConfidentialNodes.ConfidentialInstanceType do
  @moduledoc false
...
defmodule Google.Container.V1.UpgradeInfoEvent.EventType do
  @moduledoc false
...
defmodule Google.Container.V1.AutoMonitoringConfig.Scope do
  @moduledoc false
...
defmodule Google.Container.V1.PodAutoscaling.HPAProfile do
  @moduledoc false
...
defmodule Google.Container.V1.Fleet.MembershipType do
  @moduledoc false
...
defmodule Google.Container.V1.ClusterUpgradeInfo.AutoUpgradeStatus do
  @moduledoc false
...
defmodule Google.Container.V1.ClusterUpgradeInfo.AutoUpgradePausedReason do
  @moduledoc false
...
defmodule Google.Container.V1.UpgradeDetails.State do
  @moduledoc false
...
defmodule Google.Container.V1.UpgradeDetails.StartType do
  @moduledoc false
...
defmodule Google.Container.V1.NodePoolUpgradeInfo.AutoUpgradeStatus do
  @moduledoc false
...
defmodule Google.Container.V1.NodePoolUpgradeInfo.AutoUpgradePausedReason do
  @moduledoc false
...
defmodule Google.Container.V1.GkeAutoUpgradeConfig.PatchMode do
  @moduledoc false
...
defmodule Google.Container.V1.NetworkTierConfig.NetworkTier do
  @moduledoc false
...
defmodule Google.Container.V1.LinuxNodeConfig.NodeKernelModuleLoading do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :policy, 1,
    type: Google.Container.V1.LinuxNodeConfig.NodeKernelModuleLoading.Policy,
    enum: true
end
...
defmodule Google.Container.V1.LinuxNodeConfig do
  ...
  field :transparent_hugepage_enabled, 4,
    type: Google.Container.V1.LinuxNodeConfig.TransparentHugepageEnabled,
    json_name: "transparentHugepageEnabled",
    enum: true,
    deprecated: false

  field :transparent_hugepage_defrag, 5,
    type: Google.Container.V1.LinuxNodeConfig.TransparentHugepageDefrag,
    json_name: "transparentHugepageDefrag",
    enum: true,
    deprecated: false

  field :node_kernel_module_loading, 13,
    type: Google.Container.V1.LinuxNodeConfig.NodeKernelModuleLoading,
...
defmodule Google.Container.V1.NodeKubeletConfig do
  ...
  field :topology_manager, 8,
    type: Google.Container.V1.TopologyManager,
    json_name: "topologyManager",
    deprecated: false

  field :memory_manager, 9,
    type: Google.Container.V1.MemoryManager,
  ...
  field :eviction_soft, 17,
    type: Google.Container.V1.EvictionSignals,
    json_name: "evictionSoft",
    deprecated: false

  field :eviction_soft_grace_period, 18,
    type: Google.Container.V1.EvictionGracePeriod,
    json_name: "evictionSoftGracePeriod",
    deprecated: false

  field :eviction_minimum_reclaim, 19,
    type: Google.Container.V1.EvictionMinimumReclaim,
...
defmodule Google.Container.V1.TopologyManager do
  @moduledoc false
...
defmodule Google.Container.V1.MemoryManager do
  @moduledoc false
...
defmodule Google.Container.V1.EvictionSignals do
  @moduledoc false
...
defmodule Google.Container.V1.EvictionGracePeriod do
  @moduledoc false
...
defmodule Google.Container.V1.EvictionMinimumReclaim do
  @moduledoc false
...
defmodule Google.Container.V1.NodeConfig do
  ...
  field :local_nvme_ssd_block_config, 40,
    type: Google.Container.V1.LocalNvmeSsdBlockConfig,
    json_name: "localNvmeSsdBlockConfig"

  field :ephemeral_storage_local_ssd_config, 41,
    type: Google.Container.V1.EphemeralStorageLocalSsdConfig,
  ...
  field :boot_disk, 57, type: Google.Container.V1.BootDisk, json_name: "bootDisk"
end
...
defmodule Google.Container.V1.AdvancedMachineFeatures do
  ...
  field :performance_monitoring_unit, 3,
    proto3_optional: true,
    type: Google.Container.V1.AdvancedMachineFeatures.PerformanceMonitoringUnit,
...
defmodule Google.Container.V1.NodeNetworkConfig do
  ...
  field :network_tier_config, 20,
    type: Google.Container.V1.NetworkTierConfig,
...
defmodule Google.Container.V1.ContainerdConfig.WritableCgroups do
  @moduledoc false
...
defmodule Google.Container.V1.ContainerdConfig do
  ...
  field :writable_cgroups, 2,
    type: Google.Container.V1.ContainerdConfig.WritableCgroups,
...
defmodule Google.Container.V1.AddonsConfig do
  ...
  field :high_scale_checkpointing_config, 22,
    type: Google.Container.V1.HighScaleCheckpointingConfig,
    json_name: "highScaleCheckpointingConfig"

  field :lustre_csi_driver_config, 23,
    type: Google.Container.V1.LustreCsiDriverConfig,
...
defmodule Google.Container.V1.HighScaleCheckpointingConfig do
  @moduledoc false
...
defmodule Google.Container.V1.LustreCsiDriverConfig do
  @moduledoc false
...
defmodule Google.Container.V1.IPAllocationPolicy do
  ...
  field :additional_ip_ranges_configs, 29,
    repeated: true,
    type: Google.Container.V1.AdditionalIPRangesConfig,
    json_name: "additionalIpRangesConfigs",
    deprecated: false

  field :auto_ipam_config, 30,
    type: Google.Container.V1.AutoIpamConfig,
...
defmodule Google.Container.V1.Cluster do
  ...
  field :status, 107, type: Google.Container.V1.Cluster.Status, enum: true, deprecated: false
  ...
  field :pod_autoscaling, 138,
    type: Google.Container.V1.PodAutoscaling,
  ...
  field :gke_auto_upgrade_config, 163,
    type: Google.Container.V1.GkeAutoUpgradeConfig,
    json_name: "gkeAutoUpgradeConfig"

  field :anonymous_authentication_config, 164,
    type: Google.Container.V1.AnonymousAuthenticationConfig,
...
defmodule Google.Container.V1.AnonymousAuthenticationConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :mode, 1, type: Google.Container.V1.AnonymousAuthenticationConfig.Mode, enum: true
end
...
defmodule Google.Container.V1.ClusterUpdate do
  ...
  field :desired_additional_ip_ranges_config, 145,
    type: Google.Container.V1.DesiredAdditionalIPRangesConfig,
...
defmodule Google.Container.V1.AdditionalIPRangesConfig do
  @moduledoc false
...
defmodule Google.Container.V1.DesiredAdditionalIPRangesConfig do
  @moduledoc false
...
defmodule Google.Container.V1.AutoIpamConfig do
  @moduledoc false
...
defmodule Google.Container.V1.Operation do
  ...
  field :status, 4, type: Google.Container.V1.Operation.Status, enum: true, deprecated: false
...
defmodule Google.Container.V1.UpdateNodePoolRequest do
  ...
  field :boot_disk, 47, type: Google.Container.V1.BootDisk, json_name: "bootDisk"
end
...
defmodule Google.Container.V1.BlueGreenSettings.AutoscaledRolloutPolicy do
  @moduledoc false
...
defmodule Google.Container.V1.BlueGreenSettings do
  ...
  field :autoscaled_rollout_policy, 3,
    type: Google.Container.V1.BlueGreenSettings.AutoscaledRolloutPolicy,
...
defmodule Google.Container.V1.NodePool do
  ...
  field :status, 103, type: Google.Container.V1.NodePool.Status, enum: true, deprecated: false
...
defmodule Google.Container.V1.MaintenanceExclusionOptions do
  ...
  field :end_time_behavior, 2,
    type: Google.Container.V1.MaintenanceExclusionOptions.EndTimeBehavior,
...
defmodule Google.Container.V1.ClusterAutoscaling do
  ...
  field :default_compute_class_config, 9,
    type: Google.Container.V1.DefaultComputeClassConfig,
...
defmodule Google.Container.V1.DefaultComputeClassConfig do
  @moduledoc false
...
defmodule Google.Container.V1.NetworkConfig.ClusterNetworkPerformanceConfig do
  ...
  field :total_egress_bandwidth_tier, 1,
    proto3_optional: true,
    type: Google.Container.V1.NetworkConfig.ClusterNetworkPerformanceConfig.Tier,
    json_name: "totalEgressBandwidthTier",
    enum: true
end
...
defmodule Google.Container.V1.AutopilotCompatibilityIssue do
  ...
  field :incompatibility_type, 3,
    type: Google.Container.V1.AutopilotCompatibilityIssue.IssueType,
...
defmodule Google.Container.V1.ConfidentialNodes do
  ...
  field :confidential_instance_type, 2,
    type: Google.Container.V1.ConfidentialNodes.ConfidentialInstanceType,
...
defmodule Google.Container.V1.UpgradeInfoEvent do
  ...
  field :event_type, 12,
    type: Google.Container.V1.UpgradeInfoEvent.EventType,
    json_name: "eventType",
    enum: true
end
...
defmodule Google.Container.V1.Autopilot do
  ...
  field :privileged_admission_config, 4,
    type: Google.Container.V1.PrivilegedAdmissionConfig,
    json_name: "privilegedAdmissionConfig"
end

defmodule Google.Container.V1.PrivilegedAdmissionConfig do
  @moduledoc false
...
defmodule Google.Container.V1.ManagedPrometheusConfig do
  ...
  field :auto_monitoring_config, 2,
    type: Google.Container.V1.AutoMonitoringConfig,
    json_name: "autoMonitoringConfig"
end

defmodule Google.Container.V1.AutoMonitoringConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :scope, 1, type: Google.Container.V1.AutoMonitoringConfig.Scope, enum: true
end

defmodule Google.Container.V1.PodAutoscaling do
  @moduledoc false
  ...
  field :hpa_profile, 2,
    proto3_optional: true,
    type: Google.Container.V1.PodAutoscaling.HPAProfile,
...
defmodule Google.Container.V1.Fleet do
  ...
  field :membership_type, 4,
    type: Google.Container.V1.Fleet.MembershipType,
...
defmodule Google.Container.V1.SecretManagerConfig.RotationConfig do
  @moduledoc false
...
defmodule Google.Container.V1.SecretManagerConfig do
  ...
  field :rotation_config, 2,
    proto3_optional: true,
    type: Google.Container.V1.SecretManagerConfig.RotationConfig,
    json_name: "rotationConfig"
end

defmodule Google.Container.V1.BootDisk do
  @moduledoc false
...
defmodule Google.Container.V1.FetchClusterUpgradeInfoRequest do
  @moduledoc false
...
defmodule Google.Container.V1.ClusterUpgradeInfo do
  @moduledoc false
  ...
  field :auto_upgrade_status, 2,
    repeated: true,
    type: Google.Container.V1.ClusterUpgradeInfo.AutoUpgradeStatus,
    json_name: "autoUpgradeStatus",
    enum: true

  field :paused_reason, 3,
    repeated: true,
    type: Google.Container.V1.ClusterUpgradeInfo.AutoUpgradePausedReason,
    json_name: "pausedReason",
    enum: true

  field :upgrade_details, 4,
    repeated: true,
    type: Google.Container.V1.UpgradeDetails,
...
defmodule Google.Container.V1.UpgradeDetails do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :state, 1, type: Google.Container.V1.UpgradeDetails.State, enum: true, deprecated: false
  ...
  field :start_type, 6,
    type: Google.Container.V1.UpgradeDetails.StartType,
    json_name: "startType",
    enum: true
end

defmodule Google.Container.V1.FetchNodePoolUpgradeInfoRequest do
  @moduledoc false
...
defmodule Google.Container.V1.NodePoolUpgradeInfo do
  @moduledoc false
  ...
  field :auto_upgrade_status, 3,
    repeated: true,
    type: Google.Container.V1.NodePoolUpgradeInfo.AutoUpgradeStatus,
    json_name: "autoUpgradeStatus",
    enum: true

  field :paused_reason, 4,
    repeated: true,
    type: Google.Container.V1.NodePoolUpgradeInfo.AutoUpgradePausedReason,
    json_name: "pausedReason",
    enum: true
...
defmodule Google.Container.V1.GkeAutoUpgradeConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :patch_mode, 1,
    type: Google.Container.V1.GkeAutoUpgradeConfig.PatchMode,
    json_name: "patchMode",
    enum: true
end

defmodule Google.Container.V1.NetworkTierConfig do
  @moduledoc false

  use Protobuf, protoc_gen_elixir_version: "0.15.0", syntax: :proto3

  field :network_tier, 1,
    type: Google.Container.V1.NetworkTierConfig.NetworkTier,
...
defmodule Google.Container.V1.ClusterManager.Service do
  ...
  rpc :FetchClusterUpgradeInfo,
      Google.Container.V1.FetchClusterUpgradeInfoRequest,
      Google.Container.V1.ClusterUpgradeInfo

  rpc :FetchNodePoolUpgradeInfo,
      Google.Container.V1.FetchNodePoolUpgradeInfoRequest,
      Google.Container.V1.NodePoolUpgradeInfo
end
