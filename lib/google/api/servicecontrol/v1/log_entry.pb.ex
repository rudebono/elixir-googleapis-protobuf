...
defmodule Google.Api.Servicecontrol.V1.LogEntry do
  ...
  field :http_request, 14, type: Google.Api.Servicecontrol.V1.HttpRequest
  ...
  field :struct_payload, 6, type: Google.Protobuf.Struct, oneof: 0
  field :operation, 16, type: Google.Api.Servicecontrol.V1.LogEntryOperation
  field :source_location, 17, type: Google.Api.Servicecontrol.V1.LogEntrySourceLocation
end
