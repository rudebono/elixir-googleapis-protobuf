defmodule Google.Api.Cloudquotas.V1beta.QuotaSafetyCheck do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaInfo.ContainerType do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaIncreaseEligibility.IneligibilityReason do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaConfig.Origin do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaInfo do
  @moduledoc false
  ...
  field :container_type, 7,
    type: Google.Api.Cloudquotas.V1beta.QuotaInfo.ContainerType,
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaIncreaseEligibility do
  @moduledoc false
  ...
  field :ineligibility_reason, 2,
    type: Google.Api.Cloudquotas.V1beta.QuotaIncreaseEligibility.IneligibilityReason,
    json_name: "ineligibilityReason",
    enum: true
end

defmodule Google.Api.Cloudquotas.V1beta.QuotaPreference.DimensionsEntry do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaPreference do
  @moduledoc false
  ...
  field :dimensions, 2,
    repeated: true,
    type: Google.Api.Cloudquotas.V1beta.QuotaPreference.DimensionsEntry,
    map: true,
    deprecated: false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaConfig.AnnotationsEntry do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.QuotaConfig do
  @moduledoc false
  ...
  field :annotations, 5,
    repeated: true,
    type: Google.Api.Cloudquotas.V1beta.QuotaConfig.AnnotationsEntry,
    map: true,
    deprecated: false

  field :request_origin, 6,
    type: Google.Api.Cloudquotas.V1beta.QuotaConfig.Origin,
    json_name: "requestOrigin",
    enum: true,
    deprecated: false
end

defmodule Google.Api.Cloudquotas.V1beta.DimensionsInfo.DimensionsEntry do
  @moduledoc false
...
defmodule Google.Api.Cloudquotas.V1beta.DimensionsInfo do
  @moduledoc false
  ...
  field :dimensions, 1,
    repeated: true,
    type: Google.Api.Cloudquotas.V1beta.DimensionsInfo.DimensionsEntry,
    map: true

  field :details, 2, type: Google.Api.Cloudquotas.V1beta.QuotaDetails
  field :applicable_locations, 3, repeated: true, type: :string, json_name: "applicableLocations"
end

defmodule Google.Api.Cloudquotas.V1beta.QuotaDetails do
  @moduledoc false
  ...
  field :rollout_info, 3,
    type: Google.Api.Cloudquotas.V1beta.RolloutInfo,
    json_name: "rolloutInfo"
end

defmodule Google.Api.Cloudquotas.V1beta.RolloutInfo do
  @moduledoc false
