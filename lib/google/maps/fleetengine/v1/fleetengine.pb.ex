...
defmodule Maps.Fleetengine.V1.TerminalPointId do
  ...
  oneof :Id, 0
  field :place_id, 2, type: :string, deprecated: true, oneof: 0
  field :generated_id, 3, type: :string, deprecated: true, oneof: 0
...
defmodule Maps.Fleetengine.V1.TerminalLocation do
  ...
  field :terminal_point_id, 2, type: Maps.Fleetengine.V1.TerminalPointId
  field :access_point_id, 3, type: :string, deprecated: true
  field :trip_id, 4, type: :string, deprecated: true
...
defmodule Maps.Fleetengine.V1.TripWaypoint do
  ...
  field :trip_id, 2, type: :string
  field :waypoint_type, 3, type: Maps.Fleetengine.V1.WaypointType, enum: true
  field :path_to_waypoint, 4, repeated: true, type: Google.Type.LatLng
  field :distance_meters, 6, type: Google.Protobuf.Int32Value
...
defmodule Maps.Fleetengine.V1.Address do
  ...
  field :formatted_address, 1, type: Maps.Fleetengine.V1.FormattedAddress
end
...
defmodule Maps.Fleetengine.V1.VehicleLocation do
  ...
  field :horizontal_accuracy, 8, type: Google.Protobuf.DoubleValue, deprecated: true
  field :latlng_accuracy, 22, type: Google.Protobuf.DoubleValue
  field :heading, 2, type: Google.Protobuf.Int32Value
  field :bearing_accuracy, 10, type: Google.Protobuf.DoubleValue, deprecated: true
  field :heading_accuracy, 23, type: Google.Protobuf.DoubleValue
  field :altitude, 5, type: Google.Protobuf.DoubleValue
  field :vertical_accuracy, 9, type: Google.Protobuf.DoubleValue, deprecated: true
  field :altitude_accuracy, 24, type: Google.Protobuf.DoubleValue
  field :speed_kmph, 3, type: Google.Protobuf.Int32Value, deprecated: true
  field :speed, 6, type: Google.Protobuf.DoubleValue
  field :speed_accuracy, 7, type: Google.Protobuf.DoubleValue
  field :update_time, 4, type: Google.Protobuf.Timestamp
  field :server_time, 13, type: Google.Protobuf.Timestamp
  field :location_sensor, 11, type: Maps.Fleetengine.V1.LocationSensor, enum: true
  field :is_road_snapped, 27, type: Google.Protobuf.BoolValue
  field :is_gps_sensor_enabled, 12, type: Google.Protobuf.BoolValue
  field :time_since_update, 14, type: Google.Protobuf.Int32Value
  field :num_stale_updates, 15, type: Google.Protobuf.Int32Value
  field :raw_location, 16, type: Google.Type.LatLng
  field :raw_location_time, 17, type: Google.Protobuf.Timestamp
  field :raw_location_sensor, 28, type: Maps.Fleetengine.V1.LocationSensor, enum: true
  field :raw_location_accuracy, 25, type: Google.Protobuf.DoubleValue
  field :supplemental_location, 18, type: Google.Type.LatLng
  field :supplemental_location_time, 19, type: Google.Protobuf.Timestamp
  field :supplemental_location_sensor, 20, type: Maps.Fleetengine.V1.LocationSensor, enum: true
  field :supplemental_location_accuracy, 21, type: Google.Protobuf.DoubleValue
  field :road_snapped, 26, type: :bool, deprecated: true
end
