...
defmodule Maps.Fleetengine.V1.Vehicle do
  ...
  field :vehicle_state, 2, type: Maps.Fleetengine.V1.VehicleState, enum: true
  field :supported_trip_types, 3, repeated: true, type: Maps.Fleetengine.V1.TripType, enum: true
  field :current_trips, 4, repeated: true, type: :string
  field :last_location, 5, type: Maps.Fleetengine.V1.VehicleLocation
  field :maximum_capacity, 6, type: :int32
  field :available_capacity, 7, type: :int32
  field :attributes, 8, repeated: true, type: Maps.Fleetengine.V1.VehicleAttribute
  field :vehicle_type, 9, type: Maps.Fleetengine.V1.Vehicle.VehicleType
  field :license_plate, 10, type: Maps.Fleetengine.V1.LicensePlate
  field :route, 12, repeated: true, type: Maps.Fleetengine.V1.TerminalLocation, deprecated: true
  field :current_route_segment, 20, type: :string
  field :current_route_segment_version, 15, type: Google.Protobuf.Timestamp
  field :current_route_segment_end_point, 24, type: Maps.Fleetengine.V1.TripWaypoint
  field :remaining_distance_meters, 18, type: Google.Protobuf.Int32Value
  field :eta_to_first_waypoint, 19, type: Google.Protobuf.Timestamp
  field :remaining_time_seconds, 25, type: Google.Protobuf.Int32Value
  field :waypoints, 22, repeated: true, type: Maps.Fleetengine.V1.TripWaypoint
  field :waypoints_version, 16, type: Google.Protobuf.Timestamp
  field :back_to_back_enabled, 23, type: :bool
  field :navigation_status, 26, type: Maps.Fleetengine.V1.NavigationStatus, enum: true
  field :device_settings, 27, type: Maps.Fleetengine.V1.DeviceSettings
end
...
defmodule Maps.Fleetengine.V1.BatteryInfo do
  ...
  field :battery_status, 1, type: Maps.Fleetengine.V1.BatteryStatus, enum: true
  field :power_source, 2, type: Maps.Fleetengine.V1.PowerSource, enum: true
  field :battery_percentage, 3, type: :float
end
...
defmodule Maps.Fleetengine.V1.DeviceSettings do
  ...
  field :location_power_save_mode, 1, type: Maps.Fleetengine.V1.LocationPowerSaveMode, enum: true
  field :is_power_save_mode, 2, type: :bool
  field :is_interactive, 3, type: :bool
  field :battery_info, 4, type: Maps.Fleetengine.V1.BatteryInfo
end
...
defmodule Maps.Fleetengine.V1.LicensePlate do
  ...
  field :last_character, 2, type: :string
end
