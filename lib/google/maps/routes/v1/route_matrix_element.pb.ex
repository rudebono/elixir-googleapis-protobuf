...
defmodule Google.Maps.Routes.V1.RouteMatrixElement do
  ...
  field :origin_index, 1, type: :int32
  field :destination_index, 2, type: :int32
  field :status, 3, type: Google.Rpc.Status
  field :condition, 9, type: Google.Maps.Routes.V1.RouteMatrixElementCondition, enum: true
  field :distance_meters, 4, type: :int32
  field :duration, 5, type: Google.Protobuf.Duration
  field :static_duration, 6, type: Google.Protobuf.Duration
  field :travel_advisory, 7, type: Google.Maps.Routes.V1.RouteTravelAdvisory
  field :fallback_info, 8, type: Google.Maps.Routes.V1.FallbackInfo
end
