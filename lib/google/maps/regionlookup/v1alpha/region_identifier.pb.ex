...
defmodule Google.Maps.Regionlookup.V1alpha.RegionIdentifier do
  ...
  field :place, 4, type: :string, oneof: 0
  field :unit_code, 5, type: :string, json_name: "unitCode", oneof: 0

  field :place_type, 6,
    type: Google.Maps.Regionlookup.V1alpha.RegionIdentifier.PlaceType,
    json_name: "placeType",
    enum: true,
    deprecated: false
