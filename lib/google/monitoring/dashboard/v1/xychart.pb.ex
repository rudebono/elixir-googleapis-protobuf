...
defmodule Google.Monitoring.Dashboard.V1.XyChart.DataSet do
  ...
  field :plot_type, 2, type: Google.Monitoring.Dashboard.V1.XyChart.DataSet.PlotType, enum: true
  field :legend_template, 3, type: :string
  field :min_alignment_period, 4, type: Google.Protobuf.Duration
end
...
defmodule Google.Monitoring.Dashboard.V1.XyChart do
  ...
  field :data_sets, 1, repeated: true, type: Google.Monitoring.Dashboard.V1.XyChart.DataSet
  field :timeshift_duration, 4, type: Google.Protobuf.Duration
  field :thresholds, 5, repeated: true, type: Google.Monitoring.Dashboard.V1.Threshold
  field :x_axis, 6, type: Google.Monitoring.Dashboard.V1.XyChart.Axis
  field :y_axis, 7, type: Google.Monitoring.Dashboard.V1.XyChart.Axis
  field :chart_options, 8, type: Google.Monitoring.Dashboard.V1.ChartOptions
end
