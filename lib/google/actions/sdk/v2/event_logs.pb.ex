defmodule Google.Actions.Sdk.V2.ExecutionEvent do
  ...
  field :execution_state, 2, type: Google.Actions.Sdk.V2.ExecutionState
  field :status, 3, type: Google.Rpc.Status
  field :user_input, 4, type: Google.Actions.Sdk.V2.UserConversationInput, oneof: 0
  field :intent_match, 5, type: Google.Actions.Sdk.V2.IntentMatch, oneof: 0
  field :conditions_evaluated, 6, type: Google.Actions.Sdk.V2.ConditionsEvaluated, oneof: 0
  field :on_scene_enter, 7, type: Google.Actions.Sdk.V2.OnSceneEnter, oneof: 0
  field :webhook_request, 8, type: Google.Actions.Sdk.V2.WebhookRequest, oneof: 0
  field :webhook_response, 9, type: Google.Actions.Sdk.V2.WebhookResponse, oneof: 0

  field :webhook_initiated_transition, 10,
    type: Google.Actions.Sdk.V2.WebhookInitiatedTransition,
    oneof: 0

  field :slot_match, 11, type: Google.Actions.Sdk.V2.SlotMatch, oneof: 0
  field :slot_requested, 12, type: Google.Actions.Sdk.V2.SlotRequested, oneof: 0
  field :slot_validated, 13, type: Google.Actions.Sdk.V2.SlotValidated, oneof: 0
  field :form_filled, 14, type: Google.Actions.Sdk.V2.FormFilled, oneof: 0
  field :waiting_user_input, 15, type: Google.Actions.Sdk.V2.WaitingForUserInput, oneof: 0
  field :end_conversation, 16, type: Google.Actions.Sdk.V2.EndConversation, oneof: 0
  field :warning_messages, 17, repeated: true, type: :string
end
...
defmodule Google.Actions.Sdk.V2.ExecutionState do
  ...
  field :current_scene_id, 1, type: :string
  field :session_storage, 2, type: Google.Protobuf.Struct
  field :slots, 5, type: Google.Actions.Sdk.V2.Slots
  field :prompt_queue, 7, repeated: true, type: Google.Actions.Sdk.V2.Conversation.Prompt
  field :user_storage, 6, type: Google.Protobuf.Struct
  field :household_storage, 8, type: Google.Protobuf.Struct
end
...
defmodule Google.Actions.Sdk.V2.UserConversationInput do
  ...
  field :original_query, 2, type: :string
end
...
defmodule Google.Actions.Sdk.V2.IntentMatch do
  ...
  field :next_scene_id, 4, type: :string
end
...
defmodule Google.Actions.Sdk.V2.ConditionsEvaluated do
  ...
  field :failed_conditions, 1, repeated: true, type: Google.Actions.Sdk.V2.Condition
  field :success_condition, 2, type: Google.Actions.Sdk.V2.Condition
end
...
defmodule Google.Actions.Sdk.V2.Condition do
  ...
  field :next_scene_id, 3, type: :string
end
...
defmodule Google.Actions.Sdk.V2.WebhookInitiatedTransition do
  ...
  field :next_scene_id, 1, type: :string
end
...
defmodule Google.Actions.Sdk.V2.WebhookRequest do
  ...
  field :request_json, 1, type: :string
end
...
defmodule Google.Actions.Sdk.V2.WebhookResponse do
  ...
  field :response_json, 1, type: :string
end
