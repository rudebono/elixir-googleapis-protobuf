defmodule Google.Actions.Sdk.V2.Interactionmodel.Scene do
  ...
  field :on_enter, 1, type: Google.Actions.Sdk.V2.Interactionmodel.EventHandler
  ...
  field :on_slot_updated, 5, type: Google.Actions.Sdk.V2.Interactionmodel.EventHandler
end
