defmodule Google.Ai.Generativelanguage.V1.CitationMetadata do
  @moduledoc false
  ...
  field :citation_sources, 1,
    repeated: true,
    type: Google.Ai.Generativelanguage.V1.CitationSource,
    json_name: "citationSources"
end

defmodule Google.Ai.Generativelanguage.V1.CitationSource do
  @moduledoc false
