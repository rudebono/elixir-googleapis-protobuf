...
defmodule Google.Ai.Generativelanguage.V1alpha.Document do
  ...
  field :custom_metadata, 3,
    repeated: true,
    type: Google.Ai.Generativelanguage.V1alpha.CustomMetadata,
...
defmodule Google.Ai.Generativelanguage.V1alpha.CustomMetadata do
  ...
  field :string_list_value, 6,
    type: Google.Ai.Generativelanguage.V1alpha.StringList,
...
defmodule Google.Ai.Generativelanguage.V1alpha.MetadataFilter do
  ...
  field :conditions, 2,
    repeated: true,
    type: Google.Ai.Generativelanguage.V1alpha.Condition,
    deprecated: false
end
...
defmodule Google.Ai.Generativelanguage.V1alpha.Condition do
  ...
  field :operation, 5,
    type: Google.Ai.Generativelanguage.V1alpha.Condition.Operator,
    enum: true,
    deprecated: false
end
...
defmodule Google.Ai.Generativelanguage.V1alpha.Chunk do
  ...
  field :state, 6,
    type: Google.Ai.Generativelanguage.V1alpha.Chunk.State,
    enum: true,
    deprecated: false
end
