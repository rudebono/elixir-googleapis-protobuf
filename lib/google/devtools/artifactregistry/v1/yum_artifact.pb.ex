...
defmodule Google.Devtools.Artifactregistry.V1.YumArtifact do
  ...
  field :package_type, 3,
    type: Google.Devtools.Artifactregistry.V1.YumArtifact.PackageType,
...
defmodule Google.Devtools.Artifactregistry.V1.ImportYumArtifactsRequest do
  ...
  field :gcs_source, 2,
    type: Google.Devtools.Artifactregistry.V1.ImportYumArtifactsGcsSource,
    json_name: "gcsSource",
    oneof: 0
...
defmodule Google.Devtools.Artifactregistry.V1.ImportYumArtifactsResponse do
  ...
  field :yum_artifacts, 1,
    repeated: true,
    type: Google.Devtools.Artifactregistry.V1.YumArtifact,
