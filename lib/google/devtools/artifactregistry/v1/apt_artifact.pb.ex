...
defmodule Google.Devtools.Artifactregistry.V1.AptArtifact do
  ...
  field :package_type, 3,
    type: Google.Devtools.Artifactregistry.V1.AptArtifact.PackageType,
...
defmodule Google.Devtools.Artifactregistry.V1.ImportAptArtifactsRequest do
  ...
  field :gcs_source, 2,
    type: Google.Devtools.Artifactregistry.V1.ImportAptArtifactsGcsSource,
    json_name: "gcsSource",
    oneof: 0
...
defmodule Google.Devtools.Artifactregistry.V1.ImportAptArtifactsResponse do
  ...
  field :apt_artifacts, 1,
    repeated: true,
    type: Google.Devtools.Artifactregistry.V1.AptArtifact,
    json_name: "aptArtifacts"

  field :errors, 2,
    repeated: true,
    type: Google.Devtools.Artifactregistry.V1.ImportAptArtifactsErrorInfo
end
