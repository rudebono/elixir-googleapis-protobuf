...
defmodule Google.Devtools.Artifactregistry.V1.Version do
  ...
  @type t :: %__MODULE__{
          ...
          related_tags: [Google.Devtools.Artifactregistry.V1.Tag.t()],
...
defmodule Google.Devtools.Artifactregistry.V1.ListVersionsRequest do
  ...
  @type t :: %__MODULE__{
          ...
          page_size: integer,
          page_token: String.t(),
          view: Google.Devtools.Artifactregistry.V1.VersionView.t(),
          order_by: String.t()
        }
...
defmodule Google.Devtools.Artifactregistry.V1.ListVersionsResponse do
  ...
  @type t :: %__MODULE__{
          versions: [Google.Devtools.Artifactregistry.V1.Version.t()],
