...
defmodule Grafeas.V1beta1.Provenance.BuildProvenance do
  ...
  field :built_artifacts, 4, repeated: true, type: Grafeas.V1beta1.Provenance.Artifact
  ...
  field :source_provenance, 10, type: Grafeas.V1beta1.Provenance.Source
...
defmodule Grafeas.V1beta1.Provenance.Source do
  ...
  field :additional_contexts, 4, repeated: true, type: Grafeas.V1beta1.Source.SourceContext
end
...
defmodule Grafeas.V1beta1.Provenance.FileHashes do
  ...
  field :file_hash, 1, repeated: true, type: Grafeas.V1beta1.Provenance.Hash
end
