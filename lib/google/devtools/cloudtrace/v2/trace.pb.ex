...
defmodule Google.Devtools.Cloudtrace.V2.Span.TimeEvent.MessageEvent do
  ...
  field :uncompressed_size_bytes, 3, type: :int64
  field :compressed_size_bytes, 4, type: :int64
end
...
defmodule Google.Devtools.Cloudtrace.V2.Span.TimeEvents do
  ...
  field :time_event, 1, repeated: true, type: Google.Devtools.Cloudtrace.V2.Span.TimeEvent
...
defmodule Google.Devtools.Cloudtrace.V2.Span.Link do
  ...
  field :trace_id, 1, type: :string
  field :span_id, 2, type: :string
...
defmodule Google.Devtools.Cloudtrace.V2.Span do
  ...
  field :span_id, 2, type: :string
  field :parent_span_id, 3, type: :string
  field :display_name, 4, type: Google.Devtools.Cloudtrace.V2.TruncatableString
  ...
  field :stack_trace, 8, type: Google.Devtools.Cloudtrace.V2.StackTrace
  field :time_events, 9, type: Google.Devtools.Cloudtrace.V2.Span.TimeEvents
  ...
  field :child_span_count, 13, type: Google.Protobuf.Int32Value
  field :span_kind, 14, type: Google.Devtools.Cloudtrace.V2.Span.SpanKind, enum: true
end
...
defmodule Google.Devtools.Cloudtrace.V2.AttributeValue do
  ...
  oneof :value, 0
  field :string_value, 1, type: Google.Devtools.Cloudtrace.V2.TruncatableString, oneof: 0
...
defmodule Google.Devtools.Cloudtrace.V2.StackTrace.StackFrame do
  ...
  field :function_name, 1, type: Google.Devtools.Cloudtrace.V2.TruncatableString
  field :original_function_name, 2, type: Google.Devtools.Cloudtrace.V2.TruncatableString
  field :file_name, 3, type: Google.Devtools.Cloudtrace.V2.TruncatableString
  field :line_number, 4, type: :int64
  field :column_number, 5, type: :int64
  field :load_module, 6, type: Google.Devtools.Cloudtrace.V2.Module
  field :source_version, 7, type: Google.Devtools.Cloudtrace.V2.TruncatableString
end
...
defmodule Google.Devtools.Cloudtrace.V2.StackTrace do
  ...
  field :stack_frames, 1, type: Google.Devtools.Cloudtrace.V2.StackTrace.StackFrames
  field :stack_trace_hash_id, 2, type: :int64
end
...
defmodule Google.Devtools.Cloudtrace.V2.Module do
  ...
  field :build_id, 2, type: Google.Devtools.Cloudtrace.V2.TruncatableString
end
