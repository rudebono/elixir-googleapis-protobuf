...
defmodule Google.Security.Safebrowsing.V5alpha1.SearchHashesResponse do
  ...
  field :full_hashes, 1,
    repeated: true,
    type: Google.Security.Safebrowsing.V5alpha1.FullHash,
...
defmodule Google.Security.Safebrowsing.V5alpha1.FullHash.FullHashDetail do
  ...
  field :attributes, 2,
    repeated: true,
    type: Google.Security.Safebrowsing.V5alpha1.ThreatAttribute,
    enum: true,
    deprecated: false
end
...
defmodule Google.Security.Safebrowsing.V5alpha1.FullHash do
  ...
  field :full_hash_details, 2,
    repeated: true,
    type: Google.Security.Safebrowsing.V5alpha1.FullHash.FullHashDetail,
...
defmodule Google.Security.Safebrowsing.V5alpha1.GetHashListRequest do
  ...
  field :size_constraints, 4,
    type: Google.Security.Safebrowsing.V5alpha1.SizeConstraints,
...
defmodule Google.Security.Safebrowsing.V5alpha1.HashListMetadata do
  ...
  field :likely_safe_types, 2,
    repeated: true,
    type: Google.Security.Safebrowsing.V5alpha1.LikelySafeType,
  ...
  field :hash_length, 6,
    type: Google.Security.Safebrowsing.V5alpha1.HashListMetadata.HashLength,
...
defmodule Google.Security.Safebrowsing.V5alpha1.HashList do
  ...
  field :additions_four_bytes, 4,
    type: Google.Security.Safebrowsing.V5alpha1.RiceDeltaEncoded32Bit,
    json_name: "additionsFourBytes",
    oneof: 0

  field :additions_eight_bytes, 9,
    type: Google.Security.Safebrowsing.V5alpha1.RiceDeltaEncoded64Bit,
    json_name: "additionsEightBytes",
    oneof: 0

  field :additions_sixteen_bytes, 10,
    type: Google.Security.Safebrowsing.V5alpha1.RiceDeltaEncoded128Bit,
    json_name: "additionsSixteenBytes",
    oneof: 0

  field :additions_thirty_two_bytes, 11,
    type: Google.Security.Safebrowsing.V5alpha1.RiceDeltaEncoded256Bit,
  ...
  field :metadata, 8, type: Google.Security.Safebrowsing.V5alpha1.HashListMetadata
end
...
defmodule Google.Security.Safebrowsing.V5alpha1.BatchGetHashListsResponse do
  ...
  field :hash_lists, 1,
    repeated: true,
    type: Google.Security.Safebrowsing.V5alpha1.HashList,
    json_name: "hashLists"
end
...
defmodule Google.Security.Safebrowsing.V5alpha1.SafeBrowsing.Service do
  @moduledoc false
  ...
  rpc :SearchHashes,
      ...
      Google.Security.Safebrowsing.V5alpha1.SearchHashesResponse

  rpc :GetHashList,
      Google.Security.Safebrowsing.V5alpha1.GetHashListRequest,
      Google.Security.Safebrowsing.V5alpha1.HashList

  rpc :ListHashLists,
      Google.Security.Safebrowsing.V5alpha1.ListHashListsRequest,
      Google.Security.Safebrowsing.V5alpha1.ListHashListsResponse

  rpc :BatchGetHashLists,
      Google.Security.Safebrowsing.V5alpha1.BatchGetHashListsRequest,
      Google.Security.Safebrowsing.V5alpha1.BatchGetHashListsResponse
end

defmodule Google.Security.Safebrowsing.V5alpha1.SafeBrowsing.Stub do
  @moduledoc false

  use GRPC.Stub, service: Google.Security.Safebrowsing.V5alpha1.SafeBrowsing.Service
end
