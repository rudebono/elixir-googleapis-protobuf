...
defmodule Google.Dataflow.V1beta3.JobMessage do
  ...
  field :message_importance, 4, type: Google.Dataflow.V1beta3.JobMessageImportance, enum: true
end
...
defmodule Google.Dataflow.V1beta3.StructuredMessage do
  ...
  field :message_key, 2, type: :string
...
defmodule Google.Dataflow.V1beta3.AutoscalingEvent do
  ...
  field :current_num_workers, 1, type: :int64
  field :target_num_workers, 2, type: :int64
...
defmodule Google.Dataflow.V1beta3.ListJobMessagesRequest do
  ...
  field :minimum_importance, 3, type: Google.Dataflow.V1beta3.JobMessageImportance, enum: true
...
defmodule Google.Dataflow.V1beta3.ListJobMessagesResponse do
  ...
  field :job_messages, 1, repeated: true, type: Google.Dataflow.V1beta3.JobMessage
  field :next_page_token, 2, type: :string
  field :autoscaling_events, 3, repeated: true, type: Google.Dataflow.V1beta3.AutoscalingEvent
end
