defmodule Google.Iam.V3beta.PolicyBinding.PolicyKind do
  @moduledoc false
...
defmodule Google.Iam.V3beta.PolicyBinding.Target do
  @moduledoc false
...
defmodule Google.Iam.V3beta.PolicyBinding.AnnotationsEntry do
  @moduledoc false
...
defmodule Google.Iam.V3beta.PolicyBinding do
  @moduledoc false
  ...
  field :annotations, 5,
    repeated: true,
    type: Google.Iam.V3beta.PolicyBinding.AnnotationsEntry,
    map: true,
    deprecated: false

  field :target, 6, type: Google.Iam.V3beta.PolicyBinding.Target, deprecated: false

  field :policy_kind, 11,
    type: Google.Iam.V3beta.PolicyBinding.PolicyKind,
